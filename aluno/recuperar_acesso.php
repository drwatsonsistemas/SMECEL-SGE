...
<main>
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
          ...
          <p>
          <img src="../img/logo_smecel_card.png" width="250px">
          </p>
  ...
  <?php } else { ?>
      <div class="card-panel">
		...
		<small>Anote essas informações em um local seguro. <a href="index.php" target="_blank">Fazer login</a></small>
  ...
  <?php } ?>
        ...
        <form class="col s12" action="<?php echo $loginFormAction; ?>" method="POST" name="form1" class="box" style="width:350px; height:360px;">
            ...
            <div class='input-field col s6'>
                <input class='validate cpf' id='cpf' name="cpf" type="text" required>
