  ...
  <!-- row white -->
    ...
    <div class="col s12 m10">
      ...
      <div class="center">
        ...
        <small><?php echo $row_Conteudo['disciplina_nome']; ?></small> 
		</div>
      ...
      <div class="leitura">
        ...
        <div class="card-panel deep-purple lighten-5">
          ...
          <a class="btn" href="https://meet.jit.si/<?php echo $row_Conteudo['plano_aula_id']; ?>-<?php echo url_limpa($row_Matricula['escola_nome']); ?>-<?php echo url_limpa($row_Conteudo['disciplina_nome']); ?>-<?php echo url_limpa($row_Matricula['turma_nome']); ?>" target="_blank">ASSISTIR AULA AO VIVO</a>
          <?php } ?>
          <br>
          <p> 
          <small> DICAS:<br>
        ...
        <div class="card-panel light-green lighten-5">
          ...
          <div class="card-panel">
            ...
            <div class="row">
			  ...
			  <div class="col s12">
			  <textarea name="texto" id="texto" class="materialize-textarea" placeholder="Escreva sua resposta ou envie uma foto da atividade" rows="5"></textarea>
			  </div>
			  
			  <div class="col s12">
                <div class="file-field input-field">
                  <div class="btn-small orange"> <span>ARQUIVO</span>
                ...
                <input type="button" value="ENVIAR" id="btnAtividade" onclick="uploadFile()" class="btn-small">
