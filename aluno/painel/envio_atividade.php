...
if ($_GET['texto']<>"") {
	...
	$nova_data		= date('Y-m-d H:i:s');
	  ...
	  $insertSQL = sprintf("INSERT INTO smc_plano_aula_anexo_atividade (plano_aula_anexo_atividade_id_aluno, plano_aula_anexo_atividade_id_atividade, plano_aula_anexo_atividade_texto, plano_aula_anexo_atividade_data_hora, plano_aula_anexo_atividade_visualizada_professor) VALUES ('$id_aluno', '$id_resposta', '$texto', '$nova_data', 'N')");
