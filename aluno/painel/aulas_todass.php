...
$query_AulasNovas = "
SELECT 
plano_aula_id, plano_aula_id_turma, plano_aula_id_disciplina, plano_aula_id_professor, 
plano_aula_data, plano_aula_texto, plano_aula_conteudo, plano_aula_video, plano_aula_publicado, plano_aula_hash,
visualiza_aula_id, visualiza_aula_id_aula, visualiza_aula_id_matricula
FROM smc_plano_aula
LEFT JOIN smc_visualiza_aula ON visualiza_aula_id_aula = plano_aula_id 
...
";
$AulasNovas = mysql_query($query_AulasNovas, $SmecelNovo) or die(mysql_error());
$row_AulasNovas = mysql_fetch_assoc($AulasNovas);
$totalRows_AulasNovas = mysql_num_rows($AulasNovas);
...
<div class="container">
 ...
 <h5><strong>Matricula:<?php echo $row_Matricula['vinculo_aluno_id']; ?> ID Aluno:<?php echo $row_Matricula['vinculo_aluno_id_aluno']; ?></strong></h5>
 <hr>
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td>visualiza_aula_id</td>
    <td>visualiza_aula_id_aula</td>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_AulasNovas['plano_aula_id']; ?></td>
      <td><?php echo $row_AulasNovas['plano_aula_texto']; ?></td>
    </tr>
    <?php } while ($row_AulasNovas = mysql_fetch_assoc($AulasNovas)); ?>
</table>
