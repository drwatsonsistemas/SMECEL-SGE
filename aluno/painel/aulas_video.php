...
plano_aula_texto, plano_aula_conteudo, plano_aula_video, plano_aula_hash, func_id, func_nome, disciplina_id, disciplina_nome 
FROM smc_plano_aula 
...
<h6><?php echo inverteData($row_Conteudo['plano_aula_data']); ?></h6> 
<h5>AULA: <?php echo $row_Conteudo['plano_aula_texto']; ?></h5>
<h6><?php echo $row_Conteudo['func_nome']; ?> - <?php echo $row_Conteudo['disciplina_nome']; ?></h6>
...
<p>
<?php
    $url = $row_Conteudo['plano_aula_video'];
