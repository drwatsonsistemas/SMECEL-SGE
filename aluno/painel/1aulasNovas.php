...
<div class="container">
 ...
 <h5><strong>AULAS PENDENTES</strong></h5>
 <hr>
 <a href="index.php" class="waves-effect waves-light btn-small btn-flat"><i class="material-icons left">arrow_back</i>VOLTAR</a>
 <a href="aulasNovas.php" class="waves-effect waves-light purple btn-small btn disabled"><i class="material-icons left">new_releases</i>NOVAS</a>
...
<table class="table">
  ...
  do { ?>
	...
	<tr>
	  ...
	  <a style="background-color:<?php echo $row_Aulas['disciplina_cor_fundo']; ?>; padding:3px; margin: 5px 0; color: white" href="aulasTodas.php?disciplina=<?php echo $row_Aulas['disciplina_id']; ?>"><?php echo $row_Aulas['disciplina_nome']; ?></a><br><br> 	
	  
	  <?php echo $row_Aulas['plano_aula_data_nome']; ?><br>
	  <strong><?php echo $row_Aulas['plano_aula_id']; ?> - <?php echo $row_Aulas['plano_aula_texto']; ?></strong><br>
	  <?php echo $row_Aulas['func_nome']; ?>
	  </div>
	  </td>
      <td>
	  	   ...
	  	   <a class="waves-effect waves-light btn-small right btn <?php if ($totalRows_Visualizou > 0) { ?><?php } else { ?> red<?php } ?>" href="aulas_conteudo.php?aula=<?php echo $row_Aulas['plano_aula_hash']; ?>"><?php if ($totalRows_Visualizou > 0) { ?>ACESSAR<?php } else { ?>ACESSAR<?php } ?></a>
