...
WHERE vinculo_aluno_situacao = '1' AND vinculo_aluno_id_turma = '$row_Matricula[vinculo_aluno_id_turma]' AND vinculo_aluno_dependencia = 'N'
...
$totalRows_Colegas = mysql_num_rows($Colegas);
  ...
  <head>
    ...
    <title><?php echo $row_AlunoLogado['aluno_nome']; ?> - Smecel - Sistema de Gestão Escolar</title>
  ...
  <div class="container">
    <div class="row white" style="margin: 10px 0;">
      ...
      <div class="col s12 m10">
       ...
       <h5><strong>Meus colegas de sala (<?php echo $totalRows_Colegas; ?>)</strong></h5>
       <hr>
...
if (!empty($row_Colegas['aluno_foto2'])) { ?>
    <img src="<?php echo URL_BASE . 'aluno/fotos2/' . $row_Colegas['aluno_foto2']; ?>" width="100%" class="hoverable aluno <?php if ($row_Colegas['aluno_aceite_termos'] == "S") { echo "aceitou"; } ?>"><br>
<?php } elseif (!empty($row_Colegas['aluno_foto'])) { ?>
    <img src="<?php echo URL_BASE . 'aluno/fotos/' . $row_Colegas['aluno_foto']; ?>" width="100%" class="hoverable aluno <?php if ($row_Colegas['aluno_aceite_termos'] == "S") { echo "aceitou"; } ?>"><br>
<?php } else { ?>
    <img src="<?php echo URL_BASE . 'aluno/fotos2/semfoto.jpg'; ?>" width="100%" class="hoverable aluno"><br>
<?php } ?>
