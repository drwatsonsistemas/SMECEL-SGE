...
$query_FansAlunoLogado = sprintf("
  ...
  INNER JOIN smc_aluno ON aluno_id = aluno_fan_aluno_para_id
  WHERE
  aluno_perfil_ativo = 'S' AND aluno_fan_aluno_de_id = %s", GetSQLValueString($row_Perfil['aluno_id'], "int"));
...
<head>
  ...
  <title>Favoritos de <?php echo $row_Perfil['aluno_nome']; ?> - EduConnect</title>
      ...
      <div>
        <div class="col s12 m7">
          ...
          <div class="hide-on-small-only">
            <blockquote>
              <h5 class="truncate">
                <i class="material-icons left small green-text">favorite_border</i> Pessoas que <strong><?php echo current( str_word_count($row_Perfil['aluno_nome'],2)); ?></strong> é fã
          ...
          <div class="hide-on-med-and-up">
            <blockquote>
              <h5 class="truncate">
                <i class="material-icons left small green-text">favorite_border</i> Pessoas que <?php echo current( str_word_count($row_Perfil['aluno_nome'],2)); ?> é fã
              <?php $word = explode(" ", trim($row_Perfil['aluno_nome'])); ?>
              </h5>
            </blockquote>
          </div>
