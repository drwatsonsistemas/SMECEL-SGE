...
$disciplinaNome = $row_Aulas['disciplina_nome_abrev'];	
$codProfessor = $row_Aulas['ch_lotacao_professor_id'];
$nomeProfessor = $row_Aulas['func_nome'];
$primeiroNome = explode(" ",trim($row_Aulas['func_nome']));
	
//return $row_Aulas['disciplina_nome']." <small>(<b>".$row_Aulas['ch_lotacao_professor_id']."</b>)</small>";

return "<small><b>$disciplinaNome</b> <br><i>$primeiroNome[0]</i></small>";
