...
vinculo_aluno_vacina_data_retorno, escola_id, escola_nome, escola_logo, sec_id, sec_logo  
FROM smc_vinculo_aluno
INNER JOIN smc_escola ON escola_id = vinculo_aluno_id_escola 
INNER JOIN smc_sec ON sec_id = vinculo_aluno_id_sec
WHERE vinculo_aluno_id_aluno = '$row_AlunoLogado[aluno_id]' 
...
plano_aula_texto, plano_aula_conteudo, plano_aula_atividade, plano_aula_atividade_resposta_obrigatoria, plano_aula_atividade_resposta_obrigatoria_data_limite, plano_aula_video, plano_aula_hash, 
func_id, func_nome, disciplina_id, disciplina_nome, turma_id, turma_nome 
FROM smc_plano_aula 
...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons1" rel="stylesheet">
<!--Import materialize.css-->
<link type="text/css" rel="stylesheet" href="../css/materialize.min.css1"  media="screen,projection"/>
<link type="text/css" rel="stylesheet" href="../css/app.css"  media="screen,projection"/>
<link rel="apple-touch-icon" sizes="180x180" href="https://www.smecel.com.br/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="https://www.smecel.com.br/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="https://www.smecel.com.br/favicon-16x16.png">
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
<link href="../lib/css/emoji.css1" rel="stylesheet">
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css1">
<style>
table {
	width:100%;
...
<tr>
	<td width="100">
		<?php if ($row_Matricula['escola_logo']<>"") { ?><img src="../../img/logo/<?php echo $row_Matricula['escola_logo']; ?>" alt="" width="100px" /><?php } else { ?><img src="../../img/brasao_republica.png" alt="" width="80px" /><?php } ?>
	</td>
	<td class="ls-txt-left">	
		<h2 class="ls-txt-center"><strong><?php echo $row_Matricula['escola_nome']; ?></strong></h2>
		<strong>DATA:</strong> <?php echo inverteData($row_Conteudo['plano_aula_data']); ?> | <strong>UNIDADE:</strong>_______<br>
		<strong>PROFESSOR(A):</strong> <?php echo $row_Conteudo['func_nome']; ?> <br>
		<strong>TURMA:</strong> <?php echo $row_Conteudo['turma_nome']; ?><br>
		<strong>CÓDIGO DA AULA: </strong><?php echo $row_Conteudo['plano_aula_id']; ?>	
	</td>
	<td width="100">
	
              	<?php if ($row_Matricula['sec_logo'] <> "") { ?>
				  <img src="../../img/logo/secretaria/<?php echo $row_Matricula['sec_logo']; ?>" alt="" title=""  width="100px" />
				<?php } else { ?>
				  <img src="../../img/brasao_republica.png" width="100px">
				<?php } ?>	
...
<tr>
	<th colspan="3" style="background-color:#FFFFF0">
		<h2>ATIVIDADE DE <?php echo $row_Conteudo['disciplina_nome']; ?></h2>
	</th>
</tr>
...
<tr>
	<td colspan="3">
	<h2 class="ls-txt-center"><?php echo $row_Conteudo['plano_aula_texto']; ?></h2>
...
<tr>
 ...
 <?php } ?>
	  ...
	  <small>Relatório impresso em <?php echo date('d/m/Y'); ?> às <?php echo date('H:i'); ?>. <br>SMECEL - Sistema de Gestão Escolar</i></small>
	  </p>	
