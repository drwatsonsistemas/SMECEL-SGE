...
<div class="container">
  <div class="row white" style="margin: 10px 0;">
    ...
    <a href="boletimConceitosLegenda.php" class="waves-effect waves-light btn-small"><i class="material-icons left">font_download</i>VER LEGENDA DE ACOMPANHAMENTO</a> 


<hr>    
    
<a class="waves-effect waves-light btn <?php if ($colname_Periodo == $i) { echo "disabled"; } ?>" href="boletimConceitos.php">Anual</a>    
<?php for ($i = 1; $i <= $row_criteriosAvaliativos['ca_qtd_periodos']; $i++) { ?>
<a class="waves-effect waves-light btn <?php if ($colname_Periodo == $i) { echo "disabled"; } ?>" href="boletimConceitos.php?periodo=<?php echo $i; ?>"><?php echo $i; ?>º período</a>
<?php } ?>
...
<?php do { ?>
   ...
   ?>
    ...
    ?>
      ...
      <table class="table bordasimples" width="100%">
      <?php do { ?>
      ...
      <h4 class="ls-title-3"><?php if ( $pontos > 0) { echo number_format((($pontos/$total)*100),0)."%"; } else { echo ""; } ?></h4>
