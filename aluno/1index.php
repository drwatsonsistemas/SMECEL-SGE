...
<main>
    ...
    <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
        ...
        <form class="col s12" action="<?php echo $loginFormAction; ?>" method="POST" name="login" class="box" style="width:350px; height:360px;">
            
            <div class='input-field col s12'>
                <input class='validate date' id='nascimento' name="nascimento" type="text" inputmode="numeric" required autofocus>
            ...
            <center>
            <div class='row'>
                <button name="entrar" value="entrar" type="submit" class='btn waves-effect indigo'>ENTRAR</button>
                 <a class='btn btn-flat waves-effect' href="../">Voltar</a>
              </div>
           <a href="recuperar.php" class="blue-text grey lighten-2">Receber os dados de acesso do aluno</a>
          </center>
          </form>
      </div>
      </div>
