...
<body>
	...
	<div class="header_section" style="background-color:#006699">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-7">
						...
						<h1 class="branca">Facilite a administração educacional em sua cidade com um sistema completo e intuitivo, projetado especialmente para ser uma ferramenta de suporte na Educação Pública Municipal.</h1>
					</div>
		...
		<div class="container">
			<div class="row  animated fadeInLeft wow">
				...
				<div class="col-md-9">
					...
					<p class="ipsum_text">O desenvolvimento do SMECEL teve início por volta de 2015, destinado inicialmente ao uso na Secretaria de Educação do município de Itagimirim-BA. Esse processo foi conduzido através do contato direto com Coordenadores, Secretários Escolares, Professores, Alunos e demais atores diretamente envolvidos na área educacional. Dessa forma, o SMECEL evoluiu para se tornar uma ferramenta integralmente adaptada à realidade cotidiana dos municípios, refletindo as necessidades e demandas específicas do ambiente educacional.</p>
					<p class="ipsum_text">É relevante destacar que o sistema continua a evoluir diariamente, sendo aprimorado com base nas necessidades e particularidades de cada município. Essa abordagem dinâmica garante que o SMECEL permaneça atualizado e alinhado com as demandas em constante mudança no campo da educação.</p>
				</div>
			</div>
		</div>
	</div>
...
<div class="choose_section layout_padding" data-wow-delay="1.0s">	
<div class="container">
  <div class="row" data-wow-delay="<?php //echo $delay; ?>1.0s">
	...
	do { ?>
         ...
         <div class="col-sm-12 col-md-3 center animated wow fadeInUp"  style="text-align:center" >
  ...
  <div class="container p-4">
    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 mb-4 mb-md-0">
        <p><h5 class="text-uppercase">DR WATSON SISTEMAS LTDA</h5></p>
