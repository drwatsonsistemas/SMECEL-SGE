...
try {
     ...
     $mail->Username = 'secretaria@smecel.com.br'; // Usuário do servidor SMTP (endereço de email)
     $mail->Password = 'sec@smecel1'; // Senha do servidor SMTP (senha do email usado)
	 $mail->IsHTML(true);
	 $mail->CharSet = "UTF-8";
 
     //Define o remetente
     // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=    
     $mail->SetFrom('secretaria@smecel.com.br', 'Suporte SMECEL'); //Seu e-mail
    ...
    //header("Location: ". $MM_redirectLoginFailed );
		...
		echo "<div class=\"card-panel red darken-4\" style=\"color:white\"><i class=\"material-icons\">error_outline</i> E-mail não é válido ou não existe.</div>";
