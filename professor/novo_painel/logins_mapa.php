...
<script>
  $(document).ready(function() {
    $('#aulas_calendario').fullCalendar({
      ...
      events: [
        <?php
        // Consultar os logins com PDO
        $query_Logins = "SELECT login_professor_data_hora FROM smc_login_professor WHERE login_professor_id_professor = :professor_id ORDER BY login_professor_id DESC";
        ...
        // Gerar os eventos para o FullCalendar
        foreach ($logins as $login) {
          $loginDate = strtotime($login['login_professor_data_hora']);
          echo "{
            title: '" . date("H\hi", $loginDate) . "',
            start: '" . date("Y-m-d", $loginDate) . " 00:00:00',
            end: '" . date("Y-m-d", $loginDate) . " 23:59:59'
          },";
        }
        ?>
      ]
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">Mapa de acessos</h1>
