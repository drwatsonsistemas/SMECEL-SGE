...
vinculo_aluno_rel_aval, aluno_id, aluno_nome, aluno_foto, disciplina_id, disciplina_nome, turma_id, turma_nome, turma_matriz_id, turma_id_escola, turma_ano_letivo, turma_etapa, matriz_id, matriz_criterio_avaliativo, ca_id, ca_questionario_conceitos,
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <p>COMPONENTE/C. EXPERIÊNCIA.: <strong><?php echo $row_Alunos['disciplina_nome']; ?></strong></p>
    ...
    <a href="rendimento_mapa.php?componente=<?php echo $row_Alunos['disciplina_id']; ?>&turma=<?php echo $row_Alunos['turma_id']; ?>" class="ls-btn">MAPA DE NOTAS</a> 
