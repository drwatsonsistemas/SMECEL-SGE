  ...
  <div class="container-fluid">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form ls-form-horizontal row">
      ...
      <hr>
        ...
        <label class="ls-label col-md-12">
        <a href="#" data-ls-module="modal" data-target="#modalHabilidades" class="ls-ico-help ls-float-left <?php if ($totalRows_bncc_ef == 0) { ?> ls-display-none<?php } ?>"></a> &nbsp;<small>Habilidades</small>
        </label>
      ...
      <div class="ls-actions-btn">
        <input type="submit" class="ls-btn-primary" value="REGISTRAR AC">
