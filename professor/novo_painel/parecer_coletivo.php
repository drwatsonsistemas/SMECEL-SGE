...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/locastyle.css">  <link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.css" rel="stylesheet">
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#salvar").click(function(){
      // Captura o conteúdo formatado do Summernote
      var conteudo = $("#rel_avaliativo").summernote('code');
