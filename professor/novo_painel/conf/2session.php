...
$query_ProfLogado = sprintf("SELECT func_id, func_nome, func_email, func_foto, func_sexo, func_data_nascimento FROM smc_func WHERE func_id = %s", GetSQLValueString($colname_ProfLogado, "text"));
