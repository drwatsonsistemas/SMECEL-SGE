    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['MM_update']) && $_POST['MM_update'] === 'form1') {
        ...
        if (isset($_POST['estrategias_metodologicas']) && is_array($_POST['estrategias_metodologicas'])) {
            try {
                ...
                // Atualização da estratégia metodológica personalizada

                $stmtUpdateEstrategiaPersonalizada = $SmecelNovo->prepare("
                        UPDATE smc_planejamento 
                        SET estrategia_metodologica_personalizada = :estrategia_personalizada
                        WHERE smc_id_planejamento = :plan_id
                    ");
                $stmtUpdateEstrategiaPersonalizada->execute([
                    ':plan_id' => $_POST['plan_id'],
                    ':estrategia_personalizada' => $_POST['estrategia_metodologica_personalizada']
                ]);
            ...
            <form method="post" name="form1" action="<?php echo $editFormAction; ?>"
                ...
                <?php if ($row_Etapa['etapa_id_filtro'] == "1") { ?>
                    ...
                    <label class="ls-label col-md-12">
                        ...
                        <input type="text" name="smc_atv_dev_tema_integrador"
                            value="<?php echo htmlspecialchars($row_plan_edit['smc_atv_dev_tema_integrador'], ENT_COMPAT, 'utf-8'); ?>">
                    </label>
                    <hr>
                    ...
                    if ($EstrategiasMetodologicas) {
                        ...
                        <label class="ls-label col-md-12">
                            ...
                            <textarea name="estrategia_metodologica_personalizada" id="summernote1"
