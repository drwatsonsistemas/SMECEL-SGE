...
<div class="1ls-box">
			<span class="ls-float-left" style="margin-right:20px;"><?php if ($row_Escola['escola_logo']<>"") { ?><img src="../../img/logo/<?php echo $row_Escola['escola_logo']; ?>" alt="" width="100px" /><?php } else { ?><img src="../../img/brasao_republica.png" alt="" width="80px" /><?php } ?></span>
			<?php echo $row_Escola['escola_nome']; ?><br>
			<small>
				<?php echo $row_Escola['escola_endereco']; ?>, 
				<?php echo $row_Escola['escola_num']; ?> - 
				<?php echo $row_Escola['escola_bairro']; ?> - 
				<?php echo $row_Escola['escola_cep']; ?><br>
				CNPJ:<?php echo $row_Escola['escola_cnpj']; ?> INEP:<?php echo $row_Escola['escola_inep']; ?><br>
				<?php echo $row_Escola['escola_telefone1']; ?> <?php echo $row_Escola['escola_telefone2']; ?> <?php echo $row_Escola['escola_email']; ?>
			</small>
		</div>
      ...
      <?php } else { ?>
        ...
        <div class="1ls-box ls-txt-center" style="text-transform: uppercase;margin-top:20px;">
        <?php echo $row_Alunos['disciplina_nome']; ?> - <?php echo $row_Alunos['turma_nome']; ?>
        </div>
