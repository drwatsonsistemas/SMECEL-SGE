    ...
    <div class="row white" style="margin: 10px 0;">
      ...
      <div class="col s12 m10">
		...
		<?php } while ($row_RespostaAtividadeOutras = mysql_fetch_assoc($RespostaAtividadeOutras)); ?>
         ...
         <?php if ($row_RespostaAtividade['plano_aula_anexo_atividade_texto']<>"") {  ?>
		 <blockquote><?php echo $row_RespostaAtividade['plano_aula_anexo_atividade_texto']; ?></blockquote>
         <?php } ?>

        <?php if ($row_RespostaAtividade['plano_aula_anexo_atividade_caminho']<>"") {  ?>
