        ...
        <thead>
		  ...
		  do { ?>
			...
			<?php //echo $row_Alunos['aluno_nome']; ?>
			  ...
			  <small>
			  <?php echo $row_Alunos['aluno_nome']; ?>
              <?php if ( $row_Alunos['vinculo_aluno_situacao']<>"1") { ?><br><span class="red-text"><?php echo $row_Alunos['vinculo_aluno_situacao_nome']; ?></span><?php } ?>
              </small>
			  ...
			  <!-- Switch -->
				  ...
				  <div class="switch">
					<label>
					  ...
					  <input <?php if($totalRows_Verifica > 0) { echo "checked"; }?> type="checkbox" aluno="<?php echo $row_Alunos['aluno_nome']; ?>" data="<?php echo $data; ?>" matricula="<?php echo $row_Alunos['vinculo_aluno_id']; ?>" disciplina="<?php echo $row_Aula['disciplina_id']; ?>" aula_numero="<?php echo $row_Aula['ch_lotacao_aula']; ?>" <?php if ( $row_Alunos['vinculo_aluno_situacao']<>"1") { ?> disabled <?php } ?>>
