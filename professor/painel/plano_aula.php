...
plano_aula_data, plano_aula_texto, plano_aula_conteudo, plano_aula_atividade, plano_aula_video, plano_aula_google_form, plano_aula_publicado, plano_aula_hash 
FROM smc_plano_aula
WHERE plano_aula_id_turma = '$colname_Turma' AND plano_aula_id_disciplina = '$colname_Disciplina'
ORDER BY plano_aula_data DESC, plano_aula_id DESC
";
...
$hoje = date('Y-m-d');
$data_aula = inverteData($_POST['plano_aula_data']);

if ($data_aula < $hoje) {
	
//header("Location: plano_aula.php?disciplina=$row_AulasMinistradas[plano_aula_id_disciplina]&turma=$row_AulasMinistradas[plano_aula_id_turma]&dataInvalida");	
//break;	
...
<blockquote>
<h6><?php echo $row_Escolas['escola_nome']; ?><br><strong><?php echo $row_Disciplina['disciplina_nome']; ?><br><?php echo $row_Turma['turma_nome']; ?></strong></h6>
</blockquote>

<p>	
<a class="waves-effect waves-light btn modal-trigger" href="#modal1">CADASTRAR AULA</a>
</p>
  ...
  <ul class="collapsible">
    ...
    <li>
      <div class="collapsible-header">
		...
		<?php echo $row_AulasMinistradas['plano_aula_id']; ?> - <?php echo inverteData($row_AulasMinistradas['plano_aula_data']); ?> - <?php echo $row_AulasMinistradas['plano_aula_texto']; ?>	  
	  
	  </div>
      <div class="collapsible-body grey lighten-4"><span>
	  
		<a href="plano_aula_editar.php?hash=<?php echo $row_AulasMinistradas['plano_aula_hash']; ?>&turma=<?php echo $colname_Turma; ?>&disciplina=<?php echo $colname_Disciplina; ?>" class="waves-effect waves-light btn-small"><i class="material-icons tooltipped" data-position="bottom" data-tooltip="Editar">edit</i><span class="hide-on-small-only"></span></a>
		<a href="forum.php?hash=<?php echo $row_AulasMinistradas['plano_aula_hash']; ?>&turma=<?php echo $colname_Turma; ?>&disciplina=<?php echo $colname_Disciplina; ?>" class="waves-effect waves-light btn-small green darken-4"><i class="material-icons tooltipped" data-position="bottom" data-tooltip="Visualizar">search</i><span class="hide-on-small-only"></span></a>
		<a href="frequencia_aula.php?aula=<?php echo $row_AulasMinistradas['plano_aula_hash']; ?>&turma=<?php echo $colname_Turma; ?>&disciplina=<?php echo $colname_Disciplina; ?>" class="waves-effect waves-light btn-small pink"><i class="material-icons tooltipped" data-position="bottom" data-tooltip="Frequência dos alunos">rate_review</i><span class="hide-on-small-only"></span></a>
		<a href="javascript:func()" class="waves-effect waves-light btn-small red right" onclick="confirmaExclusao('disciplina=<?php echo $colname_Disciplina; ?>&turma=<?php echo $colname_Turma; ?>&deletar=<?php echo $row_AulasMinistradas['plano_aula_hash']; ?>')"><i class="material-icons white-text tooltipped" data-position="bottom" data-tooltip="Deletar aula">delete_forever</i></a>		  
...
<?php $diferenca = $row_disciplinaMatriz['matriz_disciplina_ch_ano'] - $totalRows_AulasMinistradasTotal; ?>
  ...
  <div class="card-panel center white-text <?php if ($diferenca > 0) { echo "red"; } else if ($diferenca < 0) { echo "green"; } else { echo "green"; } ?> lighten-2">
...
<?php if (isset($_GET["dataInvalida"])) { ?>
  <script>
M.toast({html: '<i class=\"material-icons\">block</i>&nbsp;<button class="btn-flat toast-action">NÃO É PERMITIDO O LANÇAMENTO DE AULAS RETROATIVAS</button>'});
</script>
  <?php } ?>
