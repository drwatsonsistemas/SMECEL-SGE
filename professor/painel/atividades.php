...
<a href="index.php" class="waves-effect waves-light btn-small btn-flat"><i class="material-icons left">arrow_back</i> Voltar</a>    
		...
		<h5><i class="tiny material-icons orange-text">featured_play_list</i> Aulas cadastradas (<?php echo $totalRows_UltimasAulas; ?>)</h5>
        
        <?php if ($totalRows_UltimasAulas <> 0) { ?>
		<table class="striped">
          <?php do { ?>
            <tr>
              <td width="80" class="center"><?php echo inverteData($row_UltimasAulas['plano_aula_data']); ?></td>
			  <td width="150"><?php echo $row_UltimasAulas['disciplina_nome']; ?><br><?php echo $row_UltimasAulas['turma_nome']; ?></td>
              <td><a href="forum.php?hash=<?php echo $row_UltimasAulas['plano_aula_hash']; ?>&turma=<?php echo $row_UltimasAulas['plano_aula_id_turma']; ?>&disciplina=<?php echo $row_UltimasAulas['plano_aula_id_disciplina']; ?>"><?php echo $row_UltimasAulas['plano_aula_id']; ?> - <?php echo $row_UltimasAulas['plano_aula_texto']; ?></a></td>
            </tr>
            <?php } while ($row_UltimasAulas = mysql_fetch_assoc($UltimasAulas)); ?>
        </table>
         <?php } else { ?>
