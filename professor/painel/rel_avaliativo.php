...
<small style="font-size:14px;">
    ...
    <div class="col s12 m10">
	  ...
	  <h5>RELATÓRIO AVALIATIVO</h5>
	  
	  <hr>
      
      <p> <a href="alunos.php?disciplina=<?php echo $colname_Disciplina; ?>&turma=<?php echo $colname_Turma; ?>" class="waves-effect waves-light btn-small btn-flat"><i class="material-icons left">arrow_back</i> Voltar</a>   
...
<div class="row">
    <form class="col s12">
      ...
      <a href="alunos.php?disciplina=<?php echo $colname_Disciplina; ?>&turma=<?php echo $colname_Turma; ?>" class="waves-effect waves-light btn-small btn-flat"><i class="material-icons left">arrow_back</i> Voltar</a>
