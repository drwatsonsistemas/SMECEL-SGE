...
INNER JOIN smc_turma ON turma_id = plano_aula_id_turma
WHERE plano_aula_id_professor = '$row_ProfLogado[func_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND com_at_aluno_comentario_professor IS NULL
...
plano_aula_video, plano_aula_publicado, plano_aula_hash, disciplina_id, disciplina_nome, turma_id, turma_ano_letivo 
FROM smc_plano_aula
INNER JOIN smc_disciplina ON disciplina_id = plano_aula_id_disciplina 
INNER JOIN smc_turma ON turma_id = plano_aula_id_turma
WHERE plano_aula_id_professor = '$row_ProfLogado[func_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
...
<!--card stats start-->
      <div class="row">
		 ...
		 <div class="col s12 m3 center">
            <div class="card white-text indigo lighten-2">
               <div class="card-content center">
                     <i class="material-icons background-round mt-5 medium">featured_play_list</i>
         ...
         <div class="col s12 m3 center">
            <div class="card white-text red lighten-2">
               <div class="card-content center">
                     <i class="material-icons background-round mt-5 medium">insert_comment</i>
                     <h5 class="white-text lighten-4"><?php echo $totalRows_ComentariosFull; ?></h5>
                     <p class="white-text lighten-4">comentários</p>
                     <small class="white-text lighten-3">(<?php echo $totalRows_Comentarios; ?> sem respostas)</small>
                  </div>
            </div>
         </div>
		 </a>
         ...
         <a href="#">
         <div class="col s12 m3 center">
            <div class="card white-text amber lighten-1">
               <div class="card-content center">
                     <i class="material-icons background-round mt-5 medium">notifications</i>
         ...
         <div class="col s12 m3 center">
            <div class="card white-text green lighten-1">
               <div class="card-content center">
                     <i class="material-icons background-round mt-5 medium">local_library</i>
   ...
   <!--card stats end-->
		...
		<h5><i class="tiny material-icons green-text">local_library</i> Minha(s) escola(s)</h5>
...
<div style="border: 1px solid #fafafa; padding:5px; margin:10px 0;">
<h5><i class="tiny material-icons blue-text">date_range</i> Calendário de aulas</h5>
<div id='calendar'></div> 
</div>        
