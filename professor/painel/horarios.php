...
ch_lotacao_aula, ch_lotacao_obs, ch_lotacao_escola, disciplina_id, disciplina_nome, turma_id, turma_nome, turma_ano_letivo, 
	CASE ch_lotacao_dia
	WHEN 1 THEN 'SEGUNDA'
	WHEN 2 THEN 'TERÇA'
	WHEN 3 THEN 'QUARTA'
	...
	CASE ch_lotacao_dia
	WHEN 1 THEN 'indigo lighten-3'
	WHEN 2 THEN 'blue lighten-3'
	WHEN 3 THEN 'red lighten-3'
	WHEN 4 THEN 'green lighten-3'
	WHEN 5 THEN 'orange lighten-3'
...
WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND ch_lotacao_professor_id = '$row_ProfLogado[func_id]' AND ch_lotacao_escola = %s
...
<thead>
  ...
  <tbody>
  <?php $cod = 1; do { ?>
    <tr class="<?php echo $row_Vinculo['ch_lotacao_dia_cor']; ?>">
...
<h6><?php echo $totalRows_Vinculo; ?> aulas/semana.</h6>
