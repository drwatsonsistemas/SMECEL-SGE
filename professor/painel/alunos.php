...
<ul class="collection">
      ...
      <span class="title"><strong><?php echo $row_Alunos['aluno_nome']; ?></strong></span>
     ...
     <small>
     <p>
     <a class="btn-small" href="<?php echo $linkAvaliar; ?>.php?cod=<?php echo $row_Alunos['vinculo_aluno_hash']; ?>&disciplina=<?php echo $colname_Disciplinas; ?>&turma=<?php echo $colname_Turma; ?>" id="<?php echo $row_Alunos['boletim_id']; ?>"><?php echo $nomeAvaliar; ?></a> 
     <a href="rel_avaliativo.php?cod=<?php echo $row_Alunos['vinculo_aluno_hash']; ?>&disciplina=<?php echo $colname_Disciplinas; ?>&turma=<?php echo $colname_Turma; ?>" class="btn-small green" id="<?php echo $row_Alunos['boletim_id']; ?>">PARECER COLETIVO</a>
     <a href="parecer_individual.php?cod=<?php echo $row_Alunos['vinculo_aluno_hash']; ?>&disciplina=<?php echo $colname_Disciplinas; ?>&turma=<?php echo $colname_Turma; ?>" class="btn-small orange">PARECER INDIVIDUAL</a>
     </p>
	 </small>
      	
      		<?php if ( $row_Alunos['vinculo_aluno_rel_aval'] <> "") { ?>
            
            <a href="rel_avaliativo.php?cod=<?php echo $row_Alunos['vinculo_aluno_hash']; ?>&disciplina=<?php echo $colname_Disciplinas; ?>&turma=<?php echo $colname_Turma; ?>" class="secondary-content" id="<?php echo $row_Alunos['boletim_id']; ?>"><i class="material-icons green-text">textsms</i></a>	
