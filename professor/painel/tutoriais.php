...
<small style="font-size:14px;">
    ...
    <li>
      <div class="collapsible-header"><i class="material-icons">ondemand_video</i> <?php echo $row_Tutoriais['tutoriais_video_titulo']; ?></div>
      <div class="collapsible-body"><span>
		<div class="video-container">
			<iframe width="853" height="480" src="//www.youtube.com/embed/<?php echo $link[1]; ?>?rel=0" frameborder="0" allowfullscreen></iframe>
		</div>
	  </span></div>
    </li>
