...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Vinculos = "
SELECT vinculo_id, vinculo_id_escola, vinculo_id_sec, vinculo_id_funcionario, escola_id, escola_nome 
FROM smc_vinculo 
            ...
            <div class="input-field col s12">
             ...
             <div class="input-field col s12">
              ...
              <select name="escola" required>
                ...
                <?php do { ?>
                <option value="<?php echo $row_Vinculos['vinculo_id_escola']; ?>" <?php if (isset($_GET['escola']) && ($row_Vinculos['vinculo_id_escola'] == $_GET['escola'])) {echo "SELECTED";} ?>><?php echo $row_Vinculos['escola_nome']; ?></option>
                <?php } while ($row_Vinculos = mysql_fetch_assoc($Vinculos)); ?>
              </select>
              <label>Turmas</label>
              <?php } else { ?>
              <option value="" disabled selected>Não há escola vinculada</option>
              <?php } ?>
            </div>           
