...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE smc_plano_aula SET plano_aula_google_form=%s WHERE plano_aula_id=%s",
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Plano = sprintf("SELECT plano_aula_id, plano_aula_id_turma, plano_aula_id_disciplina, plano_aula_id_professor, plano_aula_data, plano_aula_texto, plano_aula_conteudo, plano_aula_video, plano_aula_google_form, plano_aula_hash FROM smc_plano_aula WHERE plano_aula_hash = %s", GetSQLValueString($colname_Plano, "text"));
...
<small style="font-size:14px;">
    ...
    <div class="col s12 m10">
	  ...
	  <h5>AULA: <?php echo htmlentities($row_Plano['plano_aula_texto'], ENT_COMPAT, ''); ?></h5>
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="col s12">
	   ...
	   <textarea id="plano_aula_google_form" name="plano_aula_google_form" rows="10" id="mytextarea" class="materialize-textarea"><?php echo htmlentities($row_Plano['plano_aula_google_form'], ENT_COMPAT, ''); ?></textarea>
	   <label for="plano_aula_google_form"></label>
       </div>
	   
	   
       <div class="col s12">
        
       <input type="submit" value="INSERIR CÓDIGO" class="waves-effect waves-light btn">

	   <a href="#" class="waves-effect waves-light right btn orange">VOLTAR</a>	
