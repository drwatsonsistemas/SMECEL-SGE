...
WHERE com_at_aluno_duvida = 'N' AND plano_aula_id_professor = '$row_ProfLogado[func_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND com_at_aluno_comentario_professor IS NULL
...
<small style="font-size:14px;">
    ...
    <div class="col s12 m10">
	  ...
	  <a href="comentarios.php" class="waves-effect waves-light btn-small right">Ver apenas dúvidas</a>	
 ...
 <div style="border: 1px solid #fafafa; padding:5px; margin:10px 0;">
		...
		<h5><i class="tiny material-icons blue-text">insert_comment</i> Todos os comentários (<?php echo $totalRows_Comentarios; ?>)</h5>
