...
<?php include ("menu_top.php"); ?>
  ...
  <div class="section no-pad-bot" id="index-banner">
	...
	<a href="impressao/mapa.php?disciplina=<?php echo $row_Alunos['disciplina_id']; ?>&turma=<?php echo $row_Alunos['turma_id']; ?>" target="_blank" class="waves-effect waves-light btn-small btn-flat"><i class="material-icons left">print</i> IMPRIMIR</a>
	<a href="media.php?disciplina=<?php echo $row_Alunos['disciplina_id']; ?>&turma=<?php echo $row_Alunos['turma_id']; ?>" class="waves-effect waves-light btn-small btn right"><i class="material-icons left">map</i> MEDIAS</a>
	<a href="alunos.php?disciplina=<?php echo $row_Alunos['disciplina_id']; ?>&turma=<?php echo $row_Alunos['turma_id']; ?>" class="waves-effect waves-light btn-small btn right"><i class="material-icons left">people</i> LANÇAMENTOS</a>
		...
		<?php do { ?>
          <tr>
		    <td><a href="aluno.php?cod=<?php echo $row_Alunos['boletim_id']; ?>&disciplina=<?php echo $colname_Disciplinas; ?>&turma=<?php echo $colname_Turma; ?>">
			...
			<td class="light-green lighten-5"><strong><?php $mv1 = mediaUnidade($row_Alunos['boletim_1v1'],$row_Alunos['boletim_2v1'],$row_Alunos['boletim_3v1']); ?></strong></td>

			<td><?php echo $row_Alunos['boletim_1v2']; ?></td>
			<td><?php echo $row_Alunos['boletim_2v2']; ?></td>
			<td><?php echo $row_Alunos['boletim_3v2']; ?></td>						
            <td class="light-green lighten-5"><strong><?php $mv2 = mediaUnidade($row_Alunos['boletim_1v2'],$row_Alunos['boletim_2v2'],$row_Alunos['boletim_3v2']); ?></strong></td>
						
			<td><?php echo $row_Alunos['boletim_1v3']; ?></td>
			<td><?php echo $row_Alunos['boletim_2v3']; ?></td>
			<td><?php echo $row_Alunos['boletim_3v3']; ?></td>									
            <td class="light-green lighten-5"><strong><?php $mv3 = mediaUnidade($row_Alunos['boletim_1v3'],$row_Alunos['boletim_2v3'],$row_Alunos['boletim_3v3']); ?></strong></td>

			<td><?php echo $row_Alunos['boletim_1v4']; ?></td>
			<td><?php echo $row_Alunos['boletim_2v4']; ?></td>
			<td><?php echo $row_Alunos['boletim_3v4']; ?></td>												
            <td class="light-green lighten-5"><strong><?php $mv4 = mediaUnidade($row_Alunos['boletim_1v4'],$row_Alunos['boletim_2v4'],$row_Alunos['boletim_3v4']); ?></strong></td>
