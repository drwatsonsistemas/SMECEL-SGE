...
<?php include ("menu_top.php"); ?>
  ...
  <div class="section no-pad-bot" id="index-banner">
    ...
    <br>
		...
		<p class="red-text"><i class="small material-icons">sentiment_very_dissatisfied</i> Algo de muito errado aconteceu. Um e-mail foi enviado ao administrador do sistema.</p>
		</div>
		<?php } ?>

         <h5><i class="material-icons left">school</i></a>ESCOLAS MUNICIPAIS</h5>

         <strong class="right">Selecione abaixo a Unidade Escolar:</strong><br>
         ...
         <a href="disciplinas.php?cod=<?php echo $row_Escolas['ch_lotacao_escola']; ?>" class="collection-item"><i class="material-icons right">folder_open</i><?php echo $row_Escolas['escola_nome']; ?></a>
		 ...
		 Nenhuma escola encontrada com turma ativa para este professor.
