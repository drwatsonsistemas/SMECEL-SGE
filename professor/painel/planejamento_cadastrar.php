    ...
    <div class="row white" style="margin: 10px 0;">
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
        ...
        <div class="row">
          <div class="col s12">
            <ul class="tabs">
              <li class="tab col s6 <?php if ($row_Etapa['etapa_id_filtro']=="3") { echo "disabled"; } ?>"><a class="<?php if ($row_Etapa['etapa_id_filtro']=="1") { echo "active"; } ?>" href="#ei">EDUCAÇÃO INFANTIL</a></li>
              <li class="tab col s6 <?php if ($row_Etapa['etapa_id_filtro']=="1") { echo "disabled"; } ?>"><a class="<?php if ($row_Etapa['etapa_id_filtro']=="3") { echo "active"; } ?>" href="#ef">ENSINO FUNDAMENTAL</a></li>
            </ul>
          </div>
          <div id="ei" class="col s12">
            ...
            <div class="row"> 
              ...
              <div class="input-field col s12 <?php if ($row_Componente['disciplina_id_campos_exp']=="2") { echo ""; } else { echo " hide";}?>">
              ...
              <div class="input-field col s12 <?php if ($row_Componente['disciplina_id_campos_exp']=="1") { echo ""; } else { echo " hide";}?>">
              ...
              <div class="input-field col s12 <?php if ($row_Componente['disciplina_id_campos_exp']=="4") { echo ""; } else { echo " hide";}?>">
              ...
              <div class="input-field col s12 <?php if ($row_Componente['disciplina_id_campos_exp']=="3") { echo ""; } else { echo " hide";}?>">
              ...
              <div class="input-field col s12 <?php if ($row_Componente['disciplina_id_campos_exp']=="5") { echo ""; } else { echo " hide";}?>">
              ...
              <div class="input-field col s12 <?php if ($row_Componente['disciplina_id_campos_exp']=="") { echo ""; } else { echo " hide";}?>">
                <h5 for="textarea1"><?php echo $row_Componente['disciplina_nome']; ?> (Parte diversificada)<a class="waves-effect waves-light modal-trigger" href="#modal-di"><i class="material-icons">class</i></a> </h5>
                
                <!-- Modal Structure -->
                <div id="modal-di" class="modal modal-fixed-footer">
                  <div class="modal-content">
                ...
                <textarea name="ac_ce_di" id="" class="materialize-textarea"></textarea>
              </div>
            </div>
          ...
          <div id="ef" class="col s12">
            ...
            <!-- Modal Trigger -->
  <a class="waves-effect waves-light btn-small modal-trigger right<?php if ($totalRows_bncc_ef == 0) { ?> disabled<?php } ?>" href="#modal-habilidades">HABILIDADES</a>

  <!-- Modal Structure -->
  <div id="modal-habilidades" class="modal modal-fixed-footer">
    <div class="modal-content">
      <h4>HABILIDADES NA BNCC</h4>
      <p>
      ...
      <table border="0" cellpadding="0" cellspacing="0">
        ...
        <?php do { ?>
          <tr>
            ...
            <td>
			<strong>-Componente</strong>: <?php echo $row_bncc_ef['bncc_ef_componente']; ?><br>
            <strong>-Ano/Faixa</strong>: <?php echo $row_bncc_ef['bncc_ef_ano']; ?>º ano(s)<br>
            <?php if ($row_bncc_ef['bncc_ef_campos_atuacao']<>"") { ?><strong>-Campo de atuação</strong>: <?php echo $row_bncc_ef['bncc_ef_campos_atuacao']; ?><br><?php } ?>
            <?php if ($row_bncc_ef['bncc_ef_eixo']<>"") { ?><strong>-Eixo</strong>: <?php echo $row_bncc_ef['bncc_ef_eixo']; ?><br><?php } ?>
            <?php if ($row_bncc_ef['bncc_ef_un_tematicas']<>"") { ?><strong>-Unidades Temáticas</strong>: <?php echo $row_bncc_ef['bncc_ef_un_tematicas']; ?><br><?php } ?>
            <?php if ($row_bncc_ef['bncc_ef_prat_ling']<>"") { ?><strong>-Práticas de Linguagem</strong>: <?php echo $row_bncc_ef['bncc_ef_prat_ling']; ?><br><?php } ?>
            <strong>-Objetos de conhecimento</strong>: <?php echo $row_bncc_ef['bncc_ef_obj_conhec']; ?><br>
            <strong>-Habilidades</strong>: <?php echo $row_bncc_ef['bncc_ef_habilidades']; ?>
            </td>
            <td>
            <a class="btn tooltipped left orange" data-position="left" data-tooltip="<?php echo $row_bncc_ef['bncc_ef_comentarios']; ?>"><i class="material-icons">extension</i></a>
			</td>
            <td>
            <a class="btn tooltipped green" data-position="left" data-tooltip="<?php echo $row_bncc_ef['bncc_ef_poss_curr']; ?>"><i class="material-icons">directions_run</i></a>
			</td>
      ...
      <a href="#!" class="modal-close waves-effect waves-green btn-flat">FECHAR</a>
            ...
            <div class="row">
              <div class="input-field col s12">
                <h6 for="textarea1">Unidades Temáticas/Eixo/Práticas de linguagem</h6>
