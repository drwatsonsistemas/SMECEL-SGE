...
vinculo_aluno_historico_transferencia, vinculo_aluno_vacina_atualizada, vinculo_aluno_vacina_data_retorno, vinculo_aluno_conselho, vinculo_aluno_conselho_parecer, vinculo_aluno_dependencia, 
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <a href="mapa_faltas.php?escola=<?php echo $colname_Escola; ?>&turma=<?php echo $colname_Turma; ?>&target=frequencia&data=<?php echo $data; ?>&todas=s&ct=<?php echo $row_Turma['turma_id']; ?>" class="ls-btn ls-ico-calendar">MAPA DE FALTAS</a>
