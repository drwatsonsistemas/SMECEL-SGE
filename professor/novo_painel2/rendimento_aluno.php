        ...
        $totalRows_PeriodosBloqueio = $stmt_PeriodosBloqueio->rowCount();
                ...
                $ru = $ru + $row_Notas['nota_valor'];
                            ...
                            <input 
                              ...
                              value="<?php if ($row_Notas['nota_valor']<>"") { echo number_format($row_Notas['nota_valor'],$row_Criterios['ca_digitos']); } ?>" 
                              notaAnterior="<?php if ($row_Notas['nota_valor']<>"") { echo number_format($row_Notas['nota_valor'],$row_Criterios['ca_digitos']); } ?>"
							  ...
							  style=" width:100%; <?php if ($row_Notas['nota_valor'] >= $row_Criterios['ca_nota_min_av']) { echo "; color:blue;"; } else { echo "; color:red;"; }; ?>" 
              ...
              $totalRows_notaRecPar = $stmt_notaRecPar->rowCount();
						...
						?>
                          ...
                          <?php } ?>
                          <td width="30"><?php $mu = mediaUnidade($ru,$row_Criterios['ca_arredonda_media'],$row_Criterios['ca_aproxima_media'],$row_Criterios['ca_media_min_periodo'],$row_Criterios['ca_calculo_media_periodo'],$row_Criterios['ca_qtd_av_periodos'],$row_Criterios['ca_digitos']); ?>
                            <?php $tmu = $tmu + $mu; ?></td>
                        </tr>
                        <?php } ?>
                      </tbody>
