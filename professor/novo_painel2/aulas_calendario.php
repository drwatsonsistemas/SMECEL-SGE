...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <p>
        ...
        <a href="mapa_aulas.php" class="ls-btn-primary ls-ico-folder-open">MAPA DE AULAS</a>
        <a href="aulas_data.php" class="ls-btn-primary ls-ico-plus">REGISTRAR AULA</a>
        <a href="aulas_avulsas.php" class="ls-btn-primary ls-ico-plus">REGISTRAR AULA AVULSA (NOVO)</a>
    </p>
    <div class="row">
