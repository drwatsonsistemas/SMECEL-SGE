...
<div data-ls-module="dropdown" class="ls-dropdown ls-label col-md-12 col-xs-12">
  ...
  <ul class="ls-dropdown-nav" aria-hidden="true">
    <?php do { ?>
      <li><a href="planejamento.php?escola=<?php echo $row_escolas['escola_id']; ?>"><?php echo substr($row_escolas['escola_nome'],0,33); ?>...</a></li>
...
<div data-ls-module="dropdown" class="ls-dropdown ls-label col-md-12 col-xs-12">
  ...
  <ul class="ls-dropdown-nav" aria-hidden="true">
    <?php do { ?>
      <li><a href="planejamento.php?escola=<?php echo $escola; ?>&turma=<?php echo $row_turmas['turma_id']; ?>"><?php echo $row_turmas['turma_nome']; ?></a></li>
...
<div data-ls-module="dropdown" class="ls-dropdown ls-label col-md-12 col-xs-12">
  <a href="#" style="background-color:#066;" class="ls-btn-primary ls-btn-block ls-btn-lg" role="combobox" aria-expanded="false">COMPONENTES/CAMPOS DE EXPERIÊNCIA (<?php echo $totalRows_componente; ?>)</a>
  <ul class="ls-dropdown-nav" aria-hidden="true">
    <?php do { ?>
      <li><a href="planejamento_lancar_novo.php?escola=<?php echo $escola; ?>&etapa=<?php echo $row_componente['turma_etapa']; ?>&componente=<?php echo $row_componente['disciplina_id']; ?>"><?php echo $row_componente['disciplina_nome']; ?></a></li>
