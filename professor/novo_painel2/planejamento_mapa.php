  ...
  <main class="ls-main">
    <div class="container-fluid">
      ...
      <p>
        ...
        <a href="planejamento.php" class="ls-btn-primary">PLANEJAMENTO</a>
        <a href="planejamento_turma.php" class="ls-btn-primary">PLANEJAMENTO POR TURMA</a>
        <a href="planejamento_anual.php" class="ls-btn-primary">PLANEJAMENTO ANUAL</a>
        <a href="planejamento_ver.php" class="ls-btn-primary ls-ico-list ls-ico-right"></a>
      </p>
