...
$query_ac_edit = sprintf("
SELECT ac_id, ac_id_professor, ac_id_escola, ac_id_componente, ac_id_etapa, ac_ano_letivo, ac_data_inicial, ac_data_final, ac_status, ac_correcao, ac_feedback, ac_conteudo, ac_objetivo_especifico, 
...
FROM smc_ac 
WHERE ac_id = %s", GetSQLValueString($colname_ac_edit, "int"));
$ac_edit = mysql_query($query_ac_edit, $SmecelNovo) or die(mysql_error());
$row_ac_edit = mysql_fetch_assoc($ac_edit);
$totalRows_ac_edit = mysql_num_rows($ac_edit);
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE smc_ac SET ac_data_inicial=%s, ac_data_final=%s, ac_conteudo=%s, ac_objetivo_especifico=%s, ac_objeto_conhecimento=%s, ac_metodologia=%s, ac_recursos=%s, ac_avaliacao=%s, ac_criacao=%s, ac_da_conviver=%s, ac_da_brincar=%s, ac_da_participar=%s, ac_da_explorar=%s, ac_da_expressar=%s, ac_da_conhecerse=%s, ac_ce_eo=%s, ac_ce_ts=%s, ac_ce_ef=%s, ac_ce_cg=%s, ac_ce_et=%s, ac_ce_di=%s, ac_correcao=%s WHERE ac_id=%s",
                       GetSQLValueString($_POST['ac_data_inicial'], "date"),
                       GetSQLValueString($_POST['ac_data_final'], "date"),
                       GetSQLValueString($_POST['ac_conteudo'], "text"),
                       GetSQLValueString($_POST['ac_objetivo_especifico'], "text"),
                       ...
                       GetSQLValueString($_POST['ac_recursos'], "text"),
                       GetSQLValueString($_POST['ac_avaliacao'], "text"),
                       GetSQLValueString($_POST['ac_criacao'], "date"),
                       GetSQLValueString(isset($_POST['ac_da_conviver']) ? "true" : "", "defined","'S'","'N'"),
                       GetSQLValueString(isset($_POST['ac_da_brincar']) ? "true" : "", "defined","'S'","'N'"),
                       GetSQLValueString(isset($_POST['ac_da_participar']) ? "true" : "", "defined","'S'","'N'"),
                       GetSQLValueString(isset($_POST['ac_da_explorar']) ? "true" : "", "defined","'S'","'N'"),
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form ls-form-horizontal row">
        ...
        <input type="date" name="ac_data_inicial" value="<?php echo htmlentities($row_ac_edit['ac_data_inicial'], ENT_COMPAT, 'utf-8'); ?>" size="32" required>
        </label>
        <label class="ls-label col-md-6">
        <b class="ls-label-text">ATÉ</b>
        <p class="ls-label-info">Informe a data final</p>
        <input type="date" name="ac_data_final" value="<?php echo htmlentities($row_ac_edit['ac_data_final'], ENT_COMPAT, 'utf-8'); ?>" size="32" required>
        </label>
      ...
      <label class="ls-label col-md-12">
        ...
        <div class="ls-label col-md-12">
          ...
          <label class="ls-label-text">
            <input name="ac_da_conviver" type="checkbox" <?php if (!(strcmp(htmlentities($row_ac_edit['ac_da_conviver'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?> />
            CONVIVER </label>
          <label class="ls-label-text">
            <input  name="ac_da_brincar" type="checkbox" <?php if (!(strcmp(htmlentities($row_ac_edit['ac_da_brincar'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?> />
            BRINCAR </label>
          <label class="ls-label-text">
            <input name="ac_da_participar" type="checkbox" <?php if (!(strcmp(htmlentities($row_ac_edit['ac_da_participar'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?> />
            PARTICIPAR </label>
          <label class="ls-label-text">
            <input  name="ac_da_explorar" type="checkbox" <?php if (!(strcmp(htmlentities($row_ac_edit['ac_da_explorar'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?> />
            EXPLORAR </label>
          <label class="ls-label-text">
            <input name="ac_da_expressar" type="checkbox" <?php if (!(strcmp(htmlentities($row_ac_edit['ac_da_expressar'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?> />
            EXPRESSAR </label>
          <label class="ls-label-text">
            <input name="ac_da_conhecerse" type="checkbox" <?php if (!(strcmp(htmlentities($row_ac_edit['ac_da_conhecerse'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?> />
            CONHECER-SE </label>
        </div>
      </fieldset>
      <label class="ls-label col-md-12 <?php if ($row_Componente['disciplina_id_campos_exp']=="2") { echo ""; } else { echo " ls-display-none";}?>"> <b class="ls-label-text">EO – O eu, o outro e o nós &nbsp;<a href="#" data-ls-module="modal" data-target="#modalLargeEO" class="ls-ico-help ls-float-right"></a> </b>
        <textarea name="ac_ce_eo" id=""  rows="4"><?php echo htmlentities($row_ac_edit['ac_ce_eo'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12 <?php if ($row_Componente['disciplina_id_campos_exp']=="1") { echo ""; } else { echo " ls-display-none";}?>"> <b class="ls-label-text">TS – Traços, sons, cores e formas &nbsp;<a href="#" data-ls-module="modal" data-target="#modalLargeTS" class="ls-ico-help ls-float-right"></a> </b>
        <textarea name="ac_ce_ts" id=""  rows="4"><?php echo htmlentities($row_ac_edit['ac_ce_ts'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12 <?php if ($row_Componente['disciplina_id_campos_exp']=="4") { echo ""; } else { echo " ls-display-none";}?>"> <b class="ls-label-text">EF – Escuta, fala, pensamento e imaginação &nbsp;<a href="#" data-ls-module="modal" data-target="#modalLargeEF" class="ls-ico-help ls-float-right"></a> </b>
        <textarea name="ac_ce_ef" id=""  rows="4"><?php echo htmlentities($row_ac_edit['ac_ce_ef'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12 <?php if ($row_Componente['disciplina_id_campos_exp']=="3") { echo ""; } else { echo " ls-display-none";}?>"> <b class="ls-label-text">CG – Corpo, gestos e movimento &nbsp; <a href="#" data-ls-module="modal" data-target="#modalLargeCG" class="ls-ico-help ls-float-right"></a> </b>
        <textarea name="ac_ce_cg" id=""  rows="4"><?php echo htmlentities($row_ac_edit['ac_ce_cg'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12 <?php if ($row_Componente['disciplina_id_campos_exp']=="5") { echo ""; } else { echo " ls-display-none";}?>"> <b class="ls-label-text">ET – Espaços, tempos, quantidades, relações e transformações &nbsp;<a href="#" data-ls-module="modal" data-target="#modalLargeET" class="ls-ico-help ls-float-right"></a> </b>
        <textarea name="ac_ce_et" id=""  rows="4"><?php echo htmlentities($row_ac_edit['ac_ce_et'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12 <?php if ($row_Componente['disciplina_id_campos_exp']=="") { echo ""; } else { echo " ls-display-none";}?>"> <b class="ls-label-text"><?php echo $row_Componente['disciplina_nome']; ?> (Parte diversificada) <a href="#" data-ls-module="modal" data-target="#modalLargeN" class="ls-ico-help ls-float-right"></a> </b>
        <textarea name="ac_ce_di" id=""  rows="4"><?php echo htmlentities($row_ac_edit['ac_ce_di'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      
      <label class="ls-label col-md-12">
      <b class="ls-label-text">Metodologia</b>
      <p class="ls-label-info"></p>
      <textarea name="ac_metodologia" id="" class="materialize-textarea"><?php echo htmlentities($row_ac_edit['ac_metodologia'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12">
      <b class="ls-label-text">Avaliação</b>
      <p class="ls-label-info"></p>
      <textarea name="ac_avaliacao" id="" class="materialize-textarea"><?php echo htmlentities($row_ac_edit['ac_avaliacao'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12">
      <b class="ls-label-text">Observação</b>
      <p class="ls-label-info"></p>
      <textarea name="ac_conteudo" id="" class="materialize-textarea"><?php echo htmlentities($row_ac_edit['ac_conteudo'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      
      <?php } ?>
      <?php if ($row_Etapa['etapa_id_filtro']=="3") { ?>
      <hr>
        <label class="ls-label col-md-12">
      ...
      <p class="ls-label-info"></p>
      <textarea name="ac_recursos" id="" class="materialize-textarea"><?php echo htmlentities($row_ac_edit['ac_recursos'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12">
      <b class="ls-label-text">Objetos de Conhecimento (EF)</b>
      <p class="ls-label-info"></p>
      <textarea name="ac_objeto_conhecimento" id="" class="materialize-textarea"><?php echo htmlentities($row_ac_edit['ac_objeto_conhecimento'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12">
      <b class="ls-label-text">Habilidades (EF)</b>
      <p class="ls-label-info"></p>
      <textarea name="ac_objetivo_especifico" id="" class="materialize-textarea"><?php echo htmlentities($row_ac_edit['ac_objetivo_especifico'], ENT_COMPAT, 'utf-8'); ?></textarea>
      </label>
      <label class="ls-label col-md-12">
      <b class="ls-label-text">Metodologia</b>
      <p class="ls-label-info"></p>
           ...
           <div class="ls-box ls-box-gray"><?php echo nl2br($row_ac_edit['ac_feedback']); ?></div>
                  ...
                  <div class="ls-custom-select">
                    <select class="ls-custom" name="ac_correcao">
                      <option value="1" <?php if (!(strcmp(1, htmlentities($row_ac_edit['ac_correcao'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Não</option>
                      <option value="2" <?php if (!(strcmp(2, htmlentities($row_ac_edit['ac_correcao'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Sim</option>
                    </select>
                  </div>
                  </label>
      ...
      <div class="ls-actions-btn">
        <input type="submit" class="ls-btn-primary" value="ATUALIZAR AC">
