...
<body>
	...
	<main class="ls-main">
				...
				<div data-ls-module="dropdown" class="ls-dropdown ls-label col-md-12 col-xs-12">
                    ...
                    ";
									...
									if ($vinculo_total == 0 && isset($escola['escola_nome'])) { ?>
										<li><a href="rendimento.php?escola=<?php echo $escola['escola_id']; ?>">
					...
					<div data-ls-module="dropdown" class="ls-dropdown ls-label col-md-12 col-xs-12">
						...
						<ul class="ls-dropdown-nav" aria-hidden="true">
							<?php foreach ($row_turmas as $turma) { ?>
								<li><a
										href="rendimento.php?escola=<?php echo htmlspecialchars($escola['escola_id'], ENT_QUOTES, 'UTF-8'); ?>&turma=<?php echo htmlspecialchars($turma['turma_id'], ENT_QUOTES, 'UTF-8'); ?>">
				...
				<?php if (isset($_GET['turma'])) { ?>
					<div data-ls-module="dropdown" class="ls-dropdown ls-label col-md-12 col-xs-12">
						<a href="#" style="background-color:#066;" class="ls-btn-primary ls-btn-block ls-btn-lg"
							role="combobox" aria-expanded="false">
							COMPONENTES (<?php echo count($row_componente); ?>)
						</a>
						<ul class="ls-dropdown-nav" aria-hidden="true">
        ...
        ";
								...
								$escola_id = htmlspecialchars(isset($escola['escola_id']) ? $escola['escola_id'] : '', ENT_QUOTES, 'UTF-8');
