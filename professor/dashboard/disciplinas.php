...
<body>
    ...
    <div class="ui-app">
        ...
        <div class="ui-app__wrapper" id="app-layout-control">
			...
			<a href="index.php" class="waves-effect waves-light btn-small"><i class="material-icons left">arrow_back</i> Voltar</a>
                ...
                <div class="row ui-app__row">
                    <div class="col s12 ui-app__header">
                        <!-- title -->
                        <h1 class="ui-app__header__title display-1"><?php echo $row_Escola['escola_nome']; ?></h1>
                        <!-- bookmark -->
                        <!-- sub heading -->
                    </div>
                </div>
                    ...
                    <div class="col s12">
                        ...
                        <div class="1card ui-app__page-content">
                            <div class="card-content">
                                <!-- title -->
                                <div class="card-title headline">Selecione uma disciplina:</div>
         ...
         <?php } while ($row_Disciplinas = mysql_fetch_assoc($Disciplinas)); ?>
			...
			<p><a href="horarios.php?escola=<?php echo $colname_Escola; ?>" class="btn-flat">Distribuição das aulas</a></p>
