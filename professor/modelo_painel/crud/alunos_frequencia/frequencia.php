...
if (empty($matricula)) {
			...
			*/
			...
			echo "<script>Swal.fire({ position: 'top-end', icon: 'success', title: 'Presença Lançada',  text: '$aluno', showConfirmButton: false, timer: 2000 })</script>";
			...
			exit;
			  ...
			  */
			  ...
			  echo "<script>Swal.fire({ position: 'top-end', icon: 'success', title: 'Falta lançada', text: '$aluno', showConfirmButton: false, timer: 2000 })</script>";
