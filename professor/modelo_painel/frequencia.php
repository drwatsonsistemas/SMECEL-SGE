...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">FREQUÊNCIA DOS ALUNOS</h1>
    ...
    <div class="ls-pagination-filter">
      <ul class="ls-pagination ls-float-left">
        <?php do { ?>
          <li class="<?php if ($row_Outras['ch_lotacao_id']==$row_Aula['ch_lotacao_id']) {?>ls-active<?php } ?>"><a href="frequencia.php?escola=<?php echo $colname_Escola; ?>&turma=<?php echo $row_Outras['ch_lotacao_id']; ?>&target=<?php echo $colname_Target; ?>&data=<?php echo $data; ?>"><?php echo $row_Outras['ch_lotacao_aula']; ?>ª</a></li>
      ...
      <tbody>
        <?php 
          ...
          <tr>
            ...
            <td><small> <?php echo $row_Alunos['aluno_nome']; ?>
            ...
            <td class="center card-panel1"><div data-ls-module="switchButton" class="ls-switch-btn ls-float-right">
                <input type="checkbox" id="<?php echo $row_Alunos['vinculo_aluno_id']; ?>" aluno="<?php echo $row_Alunos['aluno_nome']; ?>" data="<?php echo $data; ?>" matricula="<?php echo $row_Alunos['vinculo_aluno_id']; ?>" disciplina="<?php echo $row_Aula['disciplina_id']; ?>" aula_numero="<?php echo $row_Aula['ch_lotacao_aula']; ?>" <?php if ( $row_Alunos['vinculo_aluno_situacao']<>"1") { ?> disabled  <?php } else { ?> <?php if($totalRows_Verifica == 0) { echo "checked"; }?> <?php } ?>>
                <label class="ls-switch-label" for="<?php echo $row_Alunos['vinculo_aluno_id']; ?>" name="label-<?php echo $row_Alunos['vinculo_aluno_id']; ?>" ls-switch-off="Ausente" ls-switch-on="Presente"><span></span></label>
              </div></td>
          </tr>
