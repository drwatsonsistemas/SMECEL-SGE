  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS QUE UTILIZAM TRANSPORTE ESCOLAR (<?php echo $nomeFiltro; ?>)
			</div>
		...
		WHERE vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_transporte = 'S' AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
