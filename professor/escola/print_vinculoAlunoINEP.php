...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>RELATÓRIO DE ALUNOS SEM TIPO SANGUÍNEO | SMECEL - Sistema de Gestão Escolar</title>
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS COM CÓDIGO INEP CADASTRADO
			</div>
		...
		aluno_id, aluno_nome, aluno_nome_social, aluno_cod_inep, aluno_nascimento, aluno_sangue_tipo, aluno_sangue_rh, aluno_hash
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE aluno_cod_inep IS NOT NULL AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<thead>
			<tr>
				...
				<th width="40%" class="ls-txt-center">INEP</th>
			</tr>
			<tbody>
			<?php do { ?>
		...
		<p>Alunos com código INEP vinculados: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong></p>
		...
		<?php } ?>
         ...
         <?php $totalAlunosEscola = $totalAlunosEscola + $totalRows_ExibirAlunosVinculados; ?> 
		  ...
		  <p>Total de alunos com código INEP vinculados na escola: <strong><?php echo $totalAlunosEscola; ?></strong></p>
		  </div>
		  <?php } ?> 
