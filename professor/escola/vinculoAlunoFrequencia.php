...
<div class="ls-group-btn ls-group-active ls-float-right">
  <a href="vinculoAlunoFrequencia.php" class="ls-btn ls-active">TODOS</a>
  <a href="vinculoAlunoFrequenciaAlerta.php" class="ls-btn">EM ALERTA</a>
  ...
  <?php do { ?>
    ...
    aluno_id, aluno_cod_inep, aluno_cpf, aluno_nome, aluno_nome_social, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_sexo, aluno_aluno_com_deficiencia, aluno_tipo_deficiencia
     ...
     <?php if ($totalRows_ExibirAlunosVinculados > 0) { ?>
      ...
      <table class="ls-table ls-table-striped ls-sm-space fonte-tabela">
        ...
        <tbody>
         ...
         <td> <?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != ""? $row_ExibirAlunosVinculados["aluno_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?> <?php if ($row_ExibirAlunosVinculados['vinculo_aluno_dependencia']=="S") { echo "<span class='ls-color-danger'>(DEPENDÊNCIA)</span>"; } ?> 
