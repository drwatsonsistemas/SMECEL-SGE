...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>RELATÓRIO DE ALUNOS COM NÚMERO DO SUS <?php echo $nomeFiltro; ?> | SMECEL - Sistema de Gestão Escolar</title>
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS COM NÚMERO DO SUS <?php echo $nomeFiltro; ?>
			</div>
		...
		aluno_id, aluno_cod_inep, aluno_nome, aluno_nome_social,aluno_cpf, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_sus
		...
		<thead>
			<tr>
				...
				<th width="17%" class="ls-txt-center">SUS</th>
