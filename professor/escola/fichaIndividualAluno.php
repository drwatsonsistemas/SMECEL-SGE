...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
                ...
                <body onLoad="print()">
                    ...
                    <table width="100%">
                      ...
                      <?php } ?>
                        ...
                        <tr><td colspan="3"><br><h2 class="ls-txt-center">FICHA INDIVIDUAL DO ALUNO - <?= $row_matricula['vinculo_aluno_ano_letivo'] ?></h2></td></tr>
                    ...
                    <table class="ls-table1 ls-sm-space bordasimples" width="100%">
                    	<tr>
                        	<td>ALUNO(A): <strong><?php if($row_matricula['aluno_nome_social'] == ''){ echo $row_matricula['aluno_nome']; }else{ echo $row_matricula['aluno_nome_social']; } ?></strong></td>
				...
				?></td>
                    ...
                    <small>
                      ...
                      <table class="ls-table1 ls-sm-space bordasimples" width="100%">
                      	<tr>
                        	<td><br>Resultado final: <br><br></td>
                        ...
                        <tr>
                        	<td colspan="2"><br>Assinatura do responsável: ____________________________________________________________________<br><br></td>
                        </tr>
