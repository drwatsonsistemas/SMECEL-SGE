  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS SEM TIPO SANGUÍNEO
			</div>
		...
		WHERE aluno_sangue_tipo IS NULL AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<thead>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-center"><?php echo "SEM INFORMAÇÃO"; ?></td>
				</tr>
				<?php } while ($row_ExibirAlunosVinculados = mysql_fetch_assoc($ExibirAlunosVinculados)); ?>
		</tbody>
		</table>
		 
		<p>Alunos sem tipo sanguíneo vinculados na turma: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong></p>
		...
		<?php } ?>
         ...
         <?php $totalAlunosEscola = $totalAlunosEscola + $totalRows_ExibirAlunosVinculados; ?> 
		  ...
		  <p>Total de alunos sem tipo sanguíneo vinculados na escola: <strong><?php echo $totalAlunosEscola; ?></strong></p>
		  </div>
		  <?php } ?>
