...
COUNT(vinculo_aluno_situacao) AS total_situacao,
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">GRÁFICO POR SITUAÇÃO</h1>
		<!-- CONTEÚDO -->
    ...
    title: {
        text: 'Gráfico de alunos por situação no ano letivo de <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>'
    },
    tooltip: {
    ...
    series: [{
		...
		<?php do { ?>
			{ 
				name: '<?php echo $row_Matriculas['vinculo_aluno_situacao_nome']; ?>', 
				y: <?php echo $row_Matriculas['total_situacao']; ?> 
			},
