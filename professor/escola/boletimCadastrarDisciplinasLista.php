...
$query = mysql_query("INSERT INTO smc_boletim_disciplinas (boletim_id_vinculo_aluno, boletim_id_disciplina) VALUES ('$idVinculo','$idDisciplina')");
  ...
  $updateGoTo = "boletimCadastrar.php?boletimcadastrado";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
		...
		<label class="ls-label col-md-4">
		  <b class="ls-label-text">Filiação</b>
		...
		<div class="ls-actions-btn">
		  ...
		  <a class="ls-btn-danger" href="turmasAlunosVinculados.php">Cancelar</a>
		</div>		  
