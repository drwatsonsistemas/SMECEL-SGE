...
SELECT 
vinculo_id, vinculo_id_escola, vinculo_id_funcionario, func_id, func_nome, func_data_nascimento,
...
WHERE vinculo_id_escola = '$row_EscolaLogada[escola_id]' AND Month(func_data_nascimento) = '$mes'
AND vinculo_status != 2 
ORDER BY aniversario, func_nome ASC";
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">FUNCIONÁRIOS ANIVERSARIANTES DO MÊS</h1>
		<!-- CONTEÚDO -->
		
		 <a href="funcionariosAniversariantesMes.php?mes=<?php echo $mesAnterior; ?>" class="ls-btn-primary ls-ico-chevron-left"> MÊS ANTERIOR</a>
        <a href="funcionariosAniversariantesMes.php?mes=<?php echo $mesSeguinte; ?>" class="ls-btn-primary">PRÓXIMO MÊS <span class="ls-ico-chevron-right"></span></a>
		...
		<p class="ls-txt-center"><a class="ls-btn ls-ico-paint-format" href="print_funcionariosAniversariantesMes.php?mes=<?php echo $mes; ?>" target="_blank">Versão para impressão</a></p>
