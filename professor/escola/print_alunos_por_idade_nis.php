...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body>
		...
		<h3>RELAÇÃO DE ALUNOS de <?php echo $idade_de; ?> e <?php echo $idade_ate; ?> ANOS</h3>
		...
		do { ?>
          ...
          <?php 
			...
			aluno_endereco, aluno_numero, aluno_bairro, aluno_telefone, aluno_celular, aluno_sexo, aluno_nis, aluno_cpf,
			CASE aluno_sexo
			WHEN 1 THEN 'M'
			WHEN 2 THEN 'F'
		  ...
		  <tr>
          	<th width="40"></th>
          	<th width="" class="ls-txt-left">NOME</th>
          	<th width="60px" class="ls-txt-center">IDADE</th>
          	<th width="60px" class="ls-txt-center">SEXO</th>
          	<th width="120px" class="ls-txt-center">CPF</th>
          	<th width="120px" class="ls-txt-center">NIS</th>
          </tr>
		  </thead>
		  <tbody>
          <?php 
          ...
          <td class="ls-txt-center"><?php echo $row_Alunos['aluno_nis']; ?></td>
          <tr>
