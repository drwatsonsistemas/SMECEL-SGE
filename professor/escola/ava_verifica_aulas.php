  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Aulas postadas em <?php echo date("d/m/Y", strtotime($data)); ?> (<?php echo $diasemana[$diasemana_numero]; ?>)
        </h1>
		<!-- CONTEÚDO -->
      ...
      <a href="ava_verifica_aulas.php" class="ls-btn">Hoje</a>
        ...
        <table class="ls-table ls-sm-space ls-table-striped" width="100%">
          ...
          <?php
			...
			WHERE plano_aula_id_turma = '$row_AulasHoje[turma_id]' AND plano_aula_id_disciplina = '$row_AulasHoje[disciplina_id]' AND plano_aula_id_professor = '$row_AulasHoje[func_id]' AND plano_aula_data = '$data'
		  ...
		  ?>
            ...
            <tr>
              <td><?php echo $row_AulasHoje['func_nome']; ?></td>
              ...
              <td class="ls-txt-center"><?php if ($totalRows_Postadas == $row_AulasHoje['total_dia']) { $sim++; ?><span class="ls-ico-checkmark ls-color-success" style="font-size:20px"></span><?php } else { $nao++; ?><span class="ls-ico-question ls-color-danger" style="font-size:10px"></span><?php } ?></td>
            </tr>
            <?php } while ($row_AulasHoje = mysql_fetch_assoc($AulasHoje)); ?>
            </tbody>
        </table>
