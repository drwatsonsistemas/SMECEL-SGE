...
func_id, func_nome, funcao_id, funcao_nome, func_regime, func_senha_ativa, func_acesso, id_regime,regime_nome
FROM smc_vinculo 
      ...
      <table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
        <thead>
          <tr>
            ...
            <th class="ls-txt-center hidden-xs" width="100px">FALTAS</th>
            <th class="ls-txt-center hidden-xs" width="60px">C/H</th>
            <th class="ls-txt-center" width="100px">OPÇÕES</th>
          </tr>
        </thead>
        <tbody>
         <?php
  ...
  do {
    ?>
            ...
            <td class="ls-txt-center hidden-xs">
             <?php
              ...
              $contagem++;
                ...
                $acesso_cor = '';
                if ($row_ListaVinculos['func_acesso'] == 'N') {
          ...
          ?></td>
           ...
           <td><a href="funcionarios_detalhes.php?codigo=<?php echo $row_ListaVinculos['func_id']; ?>"><?php echo $row_ListaVinculos['func_nome']; ?></a></td>
           <td class="ls-txt-center"><?php echo $row_ListaVinculos['funcao_nome']; ?></td>
           <td class="ls-txt-center hidden-xs"><?php if ($row_ListaVinculos['func_regime'] == '1') {
      echo 'EFETIVO';
    } else {
      echo 'TEMPORÁRIO';
    }; ?></td>
           ...
           <a href="funcionarios_detalhes.php?codigo=<?php echo $row_ListaVinculos['func_id']; ?>" title="Exibir informações do funcionário" class="ls-ico-search">&nbsp</a> 
            </td>
