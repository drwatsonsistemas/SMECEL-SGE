...
aluno_id, aluno_nome, aluno_nascimento, aluno_nome_social, DATE_FORMAT(aluno_nascimento, '%m%d') AS aniversario, DATE_FORMAT(aluno_nascimento, '%d/%m') AS data_aniversario, turma_id, turma_nome, DATE_FORMAT(aluno_nascimento, '%d') as dia_aniversario, DATE_FORMAT(aluno_nascimento, '%m') as mes_aniversario
FROM smc_vinculo_aluno
INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma 
WHERE vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' AND Month(aluno_nascimento) = '$mes' ORDER BY aniversario, aluno_nome ASC";
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
		...
		<p> <a href="aniversariantesMes.php?mes=<?php echo $mesAnterior; ?>" class="ls-btn-primary ls-ico-chevron-left"> MÊS ANTERIOR</a>
        ...
        <?php if ($totalRows_aniversariantesMes > 0) { ?>
        ...
        <table width="100%" class="ls-table ls-no-hover ls-table-striped ls-bg-header">
          ...
          <?php do { ?>
            <tr>
              ...
              <td><?php echo $row_aniversariantesMes['aluno_nome_social'] != ""? $row_aniversariantesMes["aluno_nome_social"] : $row_aniversariantesMes["aluno_nome"]; ?></td>
			...
			<hr>
       		...
       		<p class="ls-txt-center"><a class="ls-btn ls-ico-paint-format" href="print_aniversariantesMes.php?mes=<?php echo $mes; ?>" target="_blank">Versão para impressão</a></p>
