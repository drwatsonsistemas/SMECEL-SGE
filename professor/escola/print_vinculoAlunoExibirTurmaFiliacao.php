...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		aluno_id, aluno_cod_inep, aluno_nome, aluno_cpf, aluno_nascimento, aluno_filiacao1, aluno_filiacao2, aluno_hash, aluno_nome_responsavel_legal, aluno_cpf_responsavel_legal, 
		CASE aluno_grau_responsavel_legal
		WHEN 1 THEN 'IRMÃO/IRMÃ'
		WHEN 2 THEN 'TIO/TIA'
		WHEN 3 THEN 'AVÔ/AVÓ'
		WHEN 4 THEN 'OUTROS'
		END AS aluno_grau_responsavel_legal
		...
		<thead>
			<tr>
				<th width="10px" class="ls-txt-center" width="35px">Nº</th>
				<th width="">ALUNO</th>
				<th width="80px" class="ls-txt-center">CPF</th>
				<th width="10px" class="ls-txt-center">NASCIMENTO</th>
				<th width="" class="ls-txt-center">FILIAÇÃO 1</th>
				<th width="" class="ls-txt-center">FILIAÇÃO 2</th>
				<th width="" class="ls-txt-center">RESPONSÁVEL</th>
			</tr>
			<tbody>
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_filiacao2']; ?></td>
			<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_nome_responsavel_legal']; ?><?php if ($row_ExibirAlunosVinculados['aluno_grau_responsavel_legal']<>"") { ?> (<?php echo $row_ExibirAlunosVinculados['aluno_grau_responsavel_legal']; ?>) <?php } ?></td>
				</tr>
