...
if(isset($_POST) AND !empty($_POST)){
	...
	vinculo_aluno_ano_letivo, vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_nao_reprova,vinculo_aluno_reprovado_faltas,
	...
	do { ?>
		...
		if($row_AlunoBoletim['vinculo_aluno_situacao'] == '1'){  
			if ($row_AlunoBoletim['vinculo_aluno_nao_reprova'] == "S" OR $row_AlunoBoletim['vinculo_aluno_reprovado_faltas'] == "N") { 
				//echo "APROVADO(A)";
