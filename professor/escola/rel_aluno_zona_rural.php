...
aluno_id, aluno_nome, aluno_localizacao, COUNT(aluno_localizacao) AS total_localizacao,
...
<script src="js/locastyle.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Percentual de alunos por Zona de residência'
        };
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Alunos Zona Urbana/Rural</h1>
