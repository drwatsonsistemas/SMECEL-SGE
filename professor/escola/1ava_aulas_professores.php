  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Total de aulas por professor</h1>
	...
	<input type="text" class="buscar-funcionario" alt="fonte-tabela" placeholder="Digite o nome ou parte do nome de um funcionário" autofocus/>
		...
		<table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
          ...
          <tr>
            ...
            <th class="ls-txt-center">VER AULAS</th>
            <th class="ls-txt-center">VER PLANO</th>
          </tr>
          </thead>
           <tbody>
           <?php
...
turma_id, turma_id_escola, turma_ano_letivo 
FROM smc_plano_aula
LEFT JOIN smc_turma ON turma_id = plano_aula_id_turma
WHERE turma_id_escola = '$row_EscolaLogada[escola_id]' AND plano_aula_id_professor = '$row_ListaVinculos[func_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
";
...
$totalRows_AulasCadastradas = mysql_num_rows($AulasCadastradas);
		   ...
		   ?>
            ...
            <tr>
			  ...
			  <td class="ls-txt-center"><a href="aulas_virtuais_calendario_professor.php?professor=<?php echo $row_ListaVinculos['func_id']; ?>">Ver</a></td>
        ...
        <p class="ls-txt-right">Professores que postaram aula: <strong><?php echo $totalRows_ListaVinculos - $semAulas; ?></strong></p>
        <p class="ls-txt-right">Professores que não postaram aula: <strong><?php echo $semAulas; ?></strong></p>
        <p class="ls-txt-right">Total de aulas postadas:<strong> <?php echo $totalAulas; ?></strong></p>
        <p class="ls-txt-right">Média de <strong><?php $media = $totalAulas / ($totalRows_ListaVinculos - $semAulas); echo number_format($media, 1); ?> aulas</strong> por professor</p>
