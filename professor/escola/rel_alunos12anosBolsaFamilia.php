...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Turmas = "SELECT * FROM smc_turma
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">RELAÇÃO DE ALUNOS ATÉ 12 ANOS</h1>
		<!-- CONTEÚDO -->
		...
		do { ?>
          ...
          <?php 
			...
			aluno_endereco, aluno_numero, aluno_bairro, aluno_telefone, aluno_celular, aluno_sexo, aluno_recebe_bolsa_familia,
			CASE aluno_sexo
			WHEN 1 THEN 'M'
			WHEN 2 THEN 'F'
			END AS aluno_sexo 
			...
			WHERE aluno_recebe_bolsa_familia = '1' AND vinculo_aluno_id_turma = $row_Turmas[turma_id] AND vinculo_aluno_situacao = '1'
		  ...
		  $num = 1;
		  do { ?>
		  	<?php if (idade($row_Alunos['aluno_nascimento']) <= 12) { 
				if ($row_Alunos['aluno_sexo']=="M") { $m++; } else { $f++; } 
			?>
		  ...
		  <p><strong>MASCULINO: <?php echo $m; ?></strong></p>
		  <p><strong>FEMININO: <?php echo $f; ?></strong></p>
		  
		  
		  <p class="ls-txt-center">
		  <a href="print_alunos12anos.php" class="ls-ico-paint-format ls-btn" target="_blank">Imprimir relação de alunos</a>
		  </p>
