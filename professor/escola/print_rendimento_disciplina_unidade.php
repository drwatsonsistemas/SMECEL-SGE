...
?>
  ...
  gtag('config', 'UA-117872281-1');
            ...
            <script src="js/locastyle.js"></script>
                ...
                <h3 class="ls-txt-center"><?php echo $unidade; ?>º PERÍODO</h3>
                <hr>
                <!-- CONTEÚDO -->
                ...
                <div class="row1">
                  ...
                  <div style="float:left; border:#CCC solid 1px; margin:5px; padding:5px; width:330px; height:250px; page-break-inside: avoid;">
	...
	?>
      ...
      function drawChart() {
        ...
        chart.draw(data, options);
                    ...
                    <div id="piechart_<?php echo $row_Matriz_disciplinas['disciplina_id']; ?>" style="width: 100%; height: 100%; float:left"></div>
