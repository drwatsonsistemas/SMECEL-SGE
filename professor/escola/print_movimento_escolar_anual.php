				...
				<table width="100%" class="ls-sm-space ls-table-striped bordasimples">
					...
					<tbody>
						<?php do { ?>
							...
							$query_Aprovados = "
								SELECT 
									SUM(CASE WHEN aluno_sexo = 1 AND vinculo_aluno_repetente = 'S' AND vinculo_aluno_situacao = 1 
										AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS MasculinoReprovadoS,
									SUM(CASE WHEN aluno_sexo = 1 AND vinculo_aluno_repetente = 'N' AND vinculo_aluno_situacao = 1 
										AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS MasculinoReprovadoN,
									SUM(CASE WHEN aluno_sexo = 2 AND vinculo_aluno_repetente = 'S' AND vinculo_aluno_situacao = 1 
										AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS FemininoReprovadoS,
									SUM(CASE WHEN aluno_sexo = 2 AND vinculo_aluno_repetente = 'N' AND vinculo_aluno_situacao = 1 
										AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS FemininoReprovadoN
								FROM smc_vinculo_aluno 
								INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
								WHERE vinculo_aluno_id_escola = $row_EscolaLogada[escola_id] 
								AND vinculo_aluno_id_turma = $row_Turmas[turma_id]";
							...
							$query_Reprovados = "
								SELECT 
									SUM(CASE WHEN aluno_sexo = 1 AND vinculo_aluno_repetente = 'S' AND vinculo_aluno_situacao = 1 AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS MasculinoReprovadoS,
									SUM(CASE WHEN aluno_sexo = 1 AND vinculo_aluno_repetente = 'N' AND vinculo_aluno_situacao = 1 AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS MasculinoReprovadoN,
									SUM(CASE WHEN aluno_sexo = 2 AND vinculo_aluno_repetente = 'S' AND vinculo_aluno_situacao = 1 AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS FemininoReprovadoS,
									SUM(CASE WHEN aluno_sexo = 2 AND vinculo_aluno_repetente = 'N' AND vinculo_aluno_situacao = 1 AND vinculo_aluno_resultado_final = 2 AND vinculo_aluno_nao_reprova != 'S' THEN 1 ELSE 0 END) AS FemininoReprovadoN
								FROM smc_vinculo_aluno 
								INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
								WHERE vinculo_aluno_id_escola = $row_EscolaLogada[escola_id] 
								AND vinculo_aluno_id_turma = $row_Turmas[turma_id];
