...
vinculo_aluno_vacina_atualizada, aluno_id, aluno_nome, aluno_nascimento, aluno_observacao, aluno_foto, aluno_filiacao1, aluno_hash, turma_id, turma_nome, turma_turno,
CASE turma_turno
		...
		?>
                    ...
                    <br>
                      ...
                      <table class="ls-table1 ls-sm-space bordasimples" width="100%">
                        ...
                        <tr>
                        	<td colspan="2">Observações: <br><br><b><?php echo $row_matricula['aluno_observacao']; ?></b><br><br></td>
                        </tr>
                        <tr>
