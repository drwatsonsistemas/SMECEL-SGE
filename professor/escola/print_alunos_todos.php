...
<body onload="self.print();">
	...
	<div class="container-fluid">
		...
		vinculo_aluno_hash, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_multietapa, etapa_id, etapa_nome, etapa_nome_abrev, vinculo_aluno_situacao
		aluno_id, aluno_nome, aluno_nome_social, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_nis
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
		LEFT JOIN smc_etapa ON etapa_id = vinculo_aluno_multietapa  
		WHERE vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_aluno_situacao = '1'
				...
				<table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
					<thead>
						<tr>
							...
							<th width="22%" class="ls-txt-center">NIS</th>
