...
turma_id, turma_nome, turma_matriz_id, turma_turno, turma_etapa, turma_ano_letivo,
CASE turma_turno
...
-o-transform: rotate(180deg); */
		...
		<body onload="1alert('Atenção: Configure sua impressora para o formato RETRATO');1self.print();">
...
<table>
<tr>
<td width="150" class="ls-txt-center">
<?php if ($row_EscolaLogada['escola_logo']<>"") { ?><img src="../../img/logo/<?php echo $row_EscolaLogada['escola_logo']; ?>" alt="" width="70%" /><?php } else { ?><img src="../../img/brasao_republica.png" alt="" width="70%" /><?php } ?><br>
</td>
...
?> terminou-se o processo de apuração das notas finais e nota global do Ano Letivo de <strong><?php echo $row_AlunoBoletim['turma_ano_letivo']; ?></strong> dos alunos da turma <strong><?php echo $row_AlunoBoletim['turma_nome']; ?></strong>, turno <strong><?php echo $row_AlunoBoletim['turma_turno_nome']; ?></strong>, deste estabelecimento de ensino, com os seguintes resultados:
<br>
</div>	
</p> 
  ...
  ?>	
		  ...
		  <?php do { ?>
		   ...
		   <tr>
			...
			?>
				...
				<td width="40%" align="left"><?php echo $row_AlunoBoletim['aluno_nome']; ?> <?php if ($row_AlunoBoletim['vinculo_aluno_conselho']=="S") { ?>*<?php } ?></td>
				<td width="10%" align="center"><?php echo inverteData($row_AlunoBoletim['aluno_nascimento']); ?></td>
			

				
				 <?php if ($row_AlunoBoletim['vinculo_aluno_situacao'] <> "1") { ?>
		...
		?>
				 ...
				 <td align="center" style="border:1px solid #808080; border-right:1px solid #808080; letter-spacing:15px; font-size:9px;" colspan="<?php echo $totalRows_disciplinasMatriz; ?>"><?php echo $row_AlunoBoletim['vinculo_aluno_situacao_nome']; ?></td>
				...
				FROM smc_nota 
				WHERE nota_id_matricula = '$row_AlunoBoletim[vinculo_aluno_id]' 
				AND nota_id_disciplina = '$row_disciplinasMatriz[disciplina_id]' 
				AND nota_periodo = '$p' AND nota_num_avaliacao = '$a'";
			...
			<small><i>*Aprovado pelo Conselho de Classe;</i></small> <small><i>(Nota entre parênteses indica que o aluno fez Avaliação Final)</i></small>
