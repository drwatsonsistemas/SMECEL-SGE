...
<div class="row">
  ...
  Aluno: <strong><?php echo $row_Matricula['aluno_nome']; ?></strong><br>
  ...
  <div class="ls-box" style="background-color:transparent !important">
	<strong>PARECER COLETIVO: </strong><br><?php echo $row_Matricula['vinculo_aluno_rel_aval']; ?>
  </div>
  ...
  <tr>
  	<td width="100"><?php echo $row_parecer['p_ind_periodo']; ?>º período</td>
  	<td width="200"><?php echo $row_parecer['func_nome']; ?></td>
  	<td><?php echo $row_parecer['p_ind_texto']; ?></td>
  </tr>
