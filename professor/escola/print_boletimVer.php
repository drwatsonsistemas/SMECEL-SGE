...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Disciplinas = "
SELECT boletim_id, boletim_id_vinculo_aluno, boletim_id_disciplina, boletim_1v1, boletim_2v1, boletim_3v1, boletim_1v2, boletim_2v2, boletim_3v2, boletim_1v3, boletim_2v3, boletim_3v3, boletim_1v4, boletim_2v4, boletim_3v4, boletim_af, disciplina_id, disciplina_nome 
...
<main class="ls-main ">
  <div class="container-fluid">
	...
	<br>
	<p class="ls-txt-center" style="font-size:10px;"><i>Este documento foi emido em <?php echo date('d-m-Y'); ?> às <?php echo date('H:i'); ?>. <br>Para comprovar sua autenticidade, acesse www.smecel.com.br/boletim e informe o código <?php echo $row_Boletim['vinculo_aluno_verificacao']; ?> </i></p>
