...
escola_telefone2, escola_email, escola_inep, escola_cnpj, escola_logo, escola_tema, escola_assinatura, 
sec_id, sec_cidade, sec_uf, sec_termo_matricula 
FROM smc_escola
...
<head>
  ...
  <title>DADOS DE MATRÍCULA | SMECEL - Sistema de Gestão Escolar</title>
  <meta charset="utf-8">
...
<body onload="self.print();">
  ...
  <page size="A4">
    ...
    <table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
      ...
      <tr>
        <td><?php if ($row_Matricula['aluno_nacionalidade'] == "3") { ?><small><strong>Pais de
            ...
            <?php echo $row_Matricula['municipio_sigla_uf']; ?>&nbsp;<?php } ?>
        </td>
        <td><small><strong>RG:</strong></small><br><?php echo $row_Matricula['aluno_identidade']; ?>
          <?php echo $row_Matricula['aluno_emissor']; ?> <?php echo $row_Matricula['aluno_uf_emissor']; ?>&nbsp;
        </td>
        <td>
      ...
      <tr>
        ...
        <?php if ($row_Matricula['aluno_tipo_certidao'] == '1') { ?>
          <td><small><strong>Termos/Folhas/Livro:</strong></small><br><?php echo $row_Matricula['aluno_termo']; ?> /
            <?php echo $row_Matricula['aluno_folhas']; ?> / <?php echo $row_Matricula['aluno_livro']; ?>&nbsp;
          </td>
      ...
      <tr>
        <td><small><strong>Endereço:</strong></small><br><?php echo $row_Matricula['aluno_endereco']; ?>,
          <?php echo $row_Matricula['aluno_numero']; ?>&nbsp;
        </td>
      ...
      <tr>
        <td><small><strong>Cidade:</strong></small><br><?php echo $row_Matricula['aluno_municipio']; ?> -
          <?php echo $row_Matricula['aluno_uf']; ?>&nbsp;
        </td>
        <td colspan="2"><small><strong>Telefones:</strong></small><br><?php echo $row_Matricula['aluno_telefone']; ?> /
          <?php echo $row_Matricula['aluno_celular']; ?>&nbsp;
        </td>
      </tr>
    ...
    <table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
      <tr>
        <td><small><strong>Deficiência:</strong></small><br><?php echo $row_Matricula['aluno_aluno_com_deficiencia']; ?>
          <?php echo $row_Matricula['aluno_tipo_deficiencia']; ?>&nbsp;
        </td>
        <td><small><strong>Alergia:</strong></small><br><?php echo $row_Matricula['aluno_alergia']; ?>
          <?php echo $row_Matricula['aluno_alergia_qual']; ?>&nbsp;
        </td>
      ...
      <tr>
        ...
        <td><small><strong>Telefones de
          ...
          <?php echo $row_Matricula['aluno_emergencia_tel2']; ?>&nbsp;
        </td>
      </tr>
    </table>
    ...
    <br>
    <h3 class="ls-txt-center"><strong>TERMO DE RESPONSABILIDADE</strong></h3><br>
