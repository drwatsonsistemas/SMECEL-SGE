...
<title><?php echo "DECLARAÇAO PARA BOLSA FAMÍLIA (FALTAS) - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<table>
	<tr>
		<td width="20%"><?php if ($row_EscolaLogada['escola_logo']<>"") { ?><img src="../../../img/logo/<?php echo $row_EscolaLogada['escola_logo']; ?>" alt="" width="100%" /><?php } else { ?><img src="../../../img/brasao_republica.png" alt="" width="100%" /><?php } ?></td>
		<td width="60%">
        ...
        <td width="20%"><img src="https://presenca.mec.gov.br/seb/assets/images/logos/logoPresenca.jpeg" width="100%"></td>
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><p><h1>DECLARAÇÃO PARA BOLSA FAMÍLIA</h1></p><br><br><br><br><br><br>
...
<div class="row">
  ...
  Declaro para os devidos fins de localização e regularização no <strong>Projeto Presença</strong> e <strong>Bolsa Família</strong>, que <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong>, 
  ...
  <?php if ( $row_Matricula['aluno_nacionalidade'] == "3") {  ?>extrangeiro nascido no país <strong><?php echo $row_Matricula['pais_nome']; ?></strong><?php } else { ?>natural de <strong><?php echo $row_Matricula['municipio_nome']; ?>-<?php echo $row_Matricula['municipio_sigla_uf']; ?></strong><?php } ?>
  ...
  está devidamente matriculado(a) e frequente nesta Unidade de Ensino, cursando o <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $multietapa; ?>)</strong>, no turno <strong><?php 
...
<br>
<p class="ls-txt-center">FALTAS POR MÊS</p>
<table class="bordasimples" width="100%">
    ...
    <tr>
    	<td colspan="12" class="ls-txt-center">TOTAL DE FALTAS: <strong><?php echo $row_Faltas['total']; ?></strong></td>
    </tr>
...
<br><br><br><p style="line-height: 180%; text-align:justify; font-size:16px;">Por ser verdade, assino a presente declaração.</p>
</div>
