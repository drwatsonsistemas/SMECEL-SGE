...
<div class="row">
  ...
  Certificamos para os devidos fins que <strong><?php echo $row_Matricula['aluno_nome']; ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  <br><br>Sua documentação segue no prazo máximo de 60 dias a contar da data deste documento, servindo o presente como documento hábil condicional à matrícula.
