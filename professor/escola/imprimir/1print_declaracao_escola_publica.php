...
<div class="row">
  ...
  Declaramos para os devidos fins que <strong><?php echo $row_Matricula['aluno_nome']; ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
