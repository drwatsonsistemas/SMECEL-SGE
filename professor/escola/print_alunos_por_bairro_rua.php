...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>ALUNOS POR ENDEREÇO | SMECEL - Sistema de Gestão Escolar</title>
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
	...
	<body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_localizacao, aluno_endereco, aluno_numero,  aluno_nome_social, aluno_bairro, aluno_filiacao1, aluno_hash
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $CodZona $stqry
		ORDER BY aluno_bairro, aluno_endereco ASC";
		...
		<h5 class="ls-title-5 ls-txt-center"><?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno']; ?></h5>
