...
<title><?php echo "DECLARAÇÃO DE TRANSFERÊNCIA (DESISTENTE) - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><br><br><br><br><p><h1>CERTIFICADO DE TRANSFERÊNCIA</h1></p><br><br><br><br><br><br><br><br><br><br>
...
<div class="row">
  ...
  Certificamos para os devidos fins que <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  foi aluno(a) regularmente matriculado(a) nesta Unidade de Ensino, cursou o <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $multietapa; ?>)</strong>, no turno <strong><?php 
  ...
  ?></strong>, neste ano letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>, tendo sido <strong>DESISTENTE</strong>, portanto, tem o direito de ser matriculado(a) na mesma etapa de ensino.
