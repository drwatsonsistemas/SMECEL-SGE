    ...
    <div class="container-fluid">
      ...
      <table class="ls-table ls-sm-space ls-table-striped ">
        ...
        do { ?>
          ...
          <td class="ls-txt-center hidden-xs"><a href="print_resultados_conservados.php?ct=<?php echo $row_Turmas['turma_id']; ?>&ano=<?php echo $anoLetivo; ?>" target="_blank" class="ls-btn ls-btn-xs"><span class="ls-ico-text2"></span></a></td>
        </tr>
