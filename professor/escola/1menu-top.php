<div class="ls-topbar ">
  <div class="ls-notification-topbar">
    ...
    <div data-ls-module="dropdown" class="ls-dropdown ls-user-account"> <a href="#" class="ls-ico-user"> <img src="../../img/funcionarios/<?php echo $row_UsuLogado['usu_foto']; ?>" alt="" /> <span class="ls-name"><?php echo $row_UsuLogado['usu_nome']; ?></span> (<?php echo $row_UsuLogado['usu_email']; ?>) </a>
