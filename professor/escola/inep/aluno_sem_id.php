...
<?php  if ($row_alunosemid['aluno_nascimento'] <> "0000-00-00") { ?>
...
if ( ($row_alunosemid['aluno_nascimento'] == "0000-00-00") || (preg_match('/\d+/', mb_convert_kana(retiraAcentos($row_alunosemid['aluno_nome']), 'n')) > 0) || (preg_match('/\d+/', mb_convert_kana(retiraAcentos($row_alunosemid['aluno_filiacao1']), 'n')) > 0) || (preg_match('/\d+/', mb_convert_kana(retiraAcentos($row_alunosemid['aluno_filiacao2']), 'n')) > 0)) {
} else {
