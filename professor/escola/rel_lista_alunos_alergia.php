...
aluno_id, aluno_nome, aluno_nome_social,aluno_nascimento, aluno_aluno_com_deficiencia, aluno_tipo_deficiencia, aluno_laudo, aluno_alergia, aluno_alergia_qual,
turma_id, turma_nome, 
CASE turma_turno
...
WHERE aluno_alergia = '1' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' 
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Relação de alunos com alergia/intolerância</h1>
		<!-- CONTEÚDO -->
		...
		<table width="100%" class="ls-table">
		  ...
		  <tr>
            ...
            <th class="ls-txt-center">ALERGIA/INTOLERÂNCIA</th>
          </tr>
		  </thead>
		  <tbody>
		  <?php $num = 1; ?>
          <?php do { ?>
            <tr>
              ...
              <td class="ls-txt-center"><?php echo $row_ListaAlunos['aluno_alergia_qual']; ?></td>
            </tr>
		...
		<div class="ls-txt-center">
			<a class="ls-btn ls-ico-windows" href="print_lista_alunos_alergia.php" target="_blank"> Imprimir</a>
		</div>
