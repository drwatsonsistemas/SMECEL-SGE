...
if ((isset($_GET['extra'])) && ($_GET['extra'] != "")) {
  ...
  $deleteSQL = sprintf("DELETE FROM smc_folha_extra WHERE  folha_extra_id=%s",
                       GetSQLValueString($_GET['extra'], "int"));

  mysql_select_db($database_SmecelNovo, $SmecelNovo);
  $Result1 = mysql_query($deleteSQL, $SmecelNovo) or die(mysql_error());

  $deleteGoTo = "extrasFuncionarioCadastrar.php?deletado";
...
mysql_free_result($FaltaFuncionarioExcluir);
?>
