...
vinculo_data_inicio, vinculo_obs, func_id, func_nome, func_cpf, func_data_nascimento, func_telefone, func_celular1, func_celular2, func_email, funcao_id, funcao_nome 
FROM smc_vinculo 
...
<script src="js/locastyle.js"></script>
	...
	table.bordasimples tr td {border:1px solid #808080; padding:2px; font-size:9px;}
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
		...
		<br><br>
		<p><strong>RELAÇÃO DE FUNCIONÁRIOS (COMPLETO)</strong></p>
		...
		<table width="100%" class="ls-sm-space ls-table-striped bordasimples">
          <thead>
            <tr>
              ...
              <th class="ls-data-descending ls-txt-center">NOME</th>
              <th class="ls-data-descending ls-txt-center">FUNÇÃO</th>
              <th class="ls-data-descending ls-txt-center" width="13%">CPF</th>
              <th class="ls-data-descending ls-txt-center">DATA DE NASCIMENTO</th>
              <th class="ls-data-descending ls-txt-center" width="13%">TELEFONE</th>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td class="ls-txt-center"><?php echo $row_FuncionariosVinculados['func_data_nascimento']; ?></td>
                <td class="ls-txt-center"><?php echo $row_FuncionariosVinculados['func_telefone']; ?></td>
