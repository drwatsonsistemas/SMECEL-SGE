...
<body onload="self.print();">
    <div style="page-break-inside: avoid;">
        <div class="ls-box1 ls-txt-center">
            ...
            <p>
            <h2 class="ls-txt-center">RESULTADO DE RENDIMENTO - ANO LETIVO <?= $row_AnoLetivo['ano_letivo_ano'] ?></h2>
            </p>
            ...
            <table width="100%" class="ls-sm-space ls-table-striped bordasimples" style="display:none">
                <?php
                        ...
                        <?php } else { ?>
                            ...
                            $query_AlunosAprovados = "
                                ...
                                WHERE vinculo_aluno_boletim = '1'
                                  ...
                                  AND vinculo_aluno_resultado_final = 1
                            ...
                            $query_AlunosReprovados = "
                                ...
                                WHERE vinculo_aluno_boletim = '1'
                                  AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]'
                                  AND vinculo_aluno_ano_letivo = '$anoLetivo'
                                  AND vinculo_aluno_resultado_final = 2
                                  AND vinculo_aluno_situacao = 1
                                GROUP BY vinculo_aluno_resultado_final;
                                ";
                            $Reprovados = mysql_query($query_AlunosReprovados, $SmecelNovo) or die(mysql_error());
                            $row_Reprovados = mysql_fetch_assoc($Reprovados);
                            $totalRows_Reprovados = mysql_num_rows($Reprovados);
                            ?>
                        <?php } ?>
                    </tr>
        ...
        <table width="100%" class="ls-sm-space ls-table-striped bordasimples">
            ...
            <tr>
                ...
                <td>
                    <?php echo $totalRows_AlunoBoletim; ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $row_Aprovados['aluno_total']; ?>
                    (<?php echo number_format((($row_Aprovados['aluno_total'] / $totalRows_AlunoBoletim) * 100), 1); ?>%)
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                <?php echo $row_Reprovados['aluno_total']; ?>
                (<?php echo number_format((($row_Reprovados['aluno_total'] / $totalRows_AlunoBoletim) * 100), 1); ?>%)
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $contaDesistentes; ?>
                    (<?php echo number_format((($contaDesistentes / $totalRows_AlunoBoletim) * 100), 1); ?>%)
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo $contaTransferidos; ?>
                    (<?php echo number_format((($contaTransferidos / $totalRows_AlunoBoletim) * 100), 1); ?>%)
                </td>
            </tr>
