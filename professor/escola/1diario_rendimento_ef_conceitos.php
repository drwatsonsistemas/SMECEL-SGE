...
$row_matricula = mysql_fetch_assoc($AlunoBoletim);
...
?>
  ...
  gtag('config', 'UA-117872281-1');
                ...
                <br><span class="ls-txt-center"><a href="#" onClick="window.print()" class="ls-txt-center ls-btn-danger hidden-print">IMPRIMIR</a></span>
                <hr>
  ...
  <div style="page-break-inside: avoid;">
    ...
    <p class="ls-ico-text ls-txt-center">RENDIMENTO ESCOLAR <?php echo $row_matricula['vinculo_aluno_ano_letivo']; ?></p>
...
<?php } while ($row_GrupoConceitos = mysql_fetch_assoc($GrupoConceitos)); ?> 
	...
	<?php do { ?>
       ...
       <th class="ls-txt-center"><h3 style="font-size:20px;"><?php echo $row_disciplinasMatriz['disciplina_nome']; ?></h3></th>
       ...
       <?php for ($i = 1; $i <= $row_criteriosAvaliativos['ca_qtd_periodos']; $i++) { ?>
       <td width="50" class="ls-txt-center"><strong><?php echo number_format((($tot[$i]/($row_criteriosAvaliativos['ca_qtd_periodos']*$totalRows_Acompanhamento))*100),0); ?>%</strong></td>
       <?php } ?>
       </tr> 
