...
function calcularIdade($dataNascimento) {
    ...
    $dataBase = strtotime('31-03-' . date('Y'));
...
<body onload="self.print();">
	...
	<div class="container-fluid">
		...
		<div class="ls-box ls-txt-center" style="text-transform: uppercase;">
			RELATÓRIO DE ALUNOS <?php echo $nomeFiltro; ?>
		</div>
		...
		<?php do { ?>
			...
			aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_hash,aluno_sexo,aluno_municipio_nascimento,aluno_municipio_nascimento_ibge, aluno_cpf,aluno_nis,aluno_identidade,aluno_cpf_mae,aluno_rg_mae,aluno_sus,municipio_nome,municipio_cod_ibge
			FROM smc_vinculo_aluno 
			INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
			LEFT JOIN smc_etapa ON etapa_id = vinculo_aluno_multietapa  
			INNER JOIN smc_municipio ON aluno_municipio_nascimento_ibge = municipio_cod_ibge
					...
					<table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
						<thead>
							<tr>
								...
								<th width="5%" class="ls-txt-center" width="35px">IDADE</th>
								<th width="5%" class="ls-txt-center" width="35px">SEXO</th>
								<th width="20%">ALUNO</th>
								<th width="6%"class="ls-txt-center">NATURALIDADE</th>
								<th width="5%"class="ls-txt-center">CARTÃO DE VACINA (S/N)</th>
								<th width="10%"class="ls-txt-center">CPF/RG/NIS - ALUNO</th>
								<th width="20%" class="ls-txt-center">MÃE OU RESPONSÁVEL</th>
							...
							<tbody>
								<?php do { ?>
									...
									?></td>
									<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_sexo'] == 1 ? 'M' : ($row_ExibirAlunosVinculados['aluno_sexo'] == 2 ? 'F' : ''); ?></td>
									...
									<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['vinculo_aluno_vacina_atualizada'] == 'I' ? 'N' : $row_ExibirAlunosVinculados['vinculo_aluno_vacina_atualizada']; ?></td>
									<td class="">
										<?php 
									...
									<td class="">
										<?php 
										echo "CPF: ". $row_ExibirAlunosVinculados['aluno_cpf_mae'] ."<br>" . "RG: ".$row_ExibirAlunosVinculados['aluno_rg_mae'];
									?></td>
								</tr>
