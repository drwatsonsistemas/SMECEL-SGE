...
aluno_id, aluno_nome, aluno_nome_social,aluno_nascimento, aluno_aluno_com_deficiencia, aluno_tipo_deficiencia, aluno_laudo, aluno_alergia, aluno_alergia_qual,vinculo_aluno_situacao,vinculo_aluno_id_cuidador,
turma_id, turma_nome, vinculo_id, vinculo_id_funcionario, func_id, func_nome,
CASE turma_turno
...
LEFT JOIN smc_func ON vinculo_id_funcionario = func_id
WHERE aluno_aluno_com_deficiencia = '1' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_aluno_situacao='1' 
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Relação de alunos com deficiência</h1>
		<!-- CONTEÚDO -->
		...
		<table width="100%" class="ls-table">
		  ...
		  <tr>
            ...
            <th class="ls-txt-center">CUIDADOR</th>
          ...
          <?php do { ?>
            <tr>
              ...
              <td class="ls-txt-center"><?php echo $row_ListaAlunos['func_nome']; ?></td>
