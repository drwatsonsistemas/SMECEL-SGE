      ...
      <div class="container-fluid">
		...
		do { ?>
          ...
          <?php 
			...
			aluno_endereco, aluno_numero, aluno_bairro, aluno_telefone, aluno_celular, aluno_cpf, aluno_nis 
		  ...
		  <tr>
			<th width="40"></th>
          	...
          	<th width="100px" class="ls-txt-center">CPF</th>
          	<th width="100px" class="ls-txt-center">NIS</th>
          </tr>
		  </thead>
		  <tbody>
          <?php 
          ...
          <td width="30px" class="ls-txt-center" align="center"> <?php echo idade($row_Alunos['aluno_nascimento']); ?></td>
          <td align="center"><?php echo $row_Alunos['aluno_cpf']; ?></td>
          <td align="center"><?php echo $row_Alunos['aluno_nis']; ?></td>
          <tr>
