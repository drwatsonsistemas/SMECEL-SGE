...
$cod1 = "-1";
if (isset($_GET['cod1'])) {
  $cod1 = anti_injection($_GET['cod1']);
}
$cod2 = "-1";
if (isset($_GET['cod2'])) {
  $cod2 = anti_injection($_GET['cod2']);
}
$cod3 = "-1";
if (isset($_GET['cod3'])) {
  $cod3 = anti_injection($_GET['cod3']);
}
$cod4 = "-1";
if (isset($_GET['cod4'])) {
  $cod4 = anti_injection($_GET['cod4']);
}


  $colname_Matricula = $cod1."-".$cod2."-".$cod3."-".$cod4;
...
WHERE vinculo_aluno_verificacao = %s", GetSQLValueString($colname_Matricula, "text"));
...
WHERE sec_id = '$row_EscolaLogada[escola_id_sec]'";
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><p><h1>DECLARAÇÃO DE MATRÍCULA</h1></p><br><br><br><br><br><br>
...
<div class="row">
  ...
  Declaro para os devidos fins que <strong><?php echo $row_Matricula['aluno_nome']; ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  está devidamente matriculado(a) e frequente nesta Unidade de Ensino, cursando o <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $row_Matricula['etapa_nome']; ?>)</strong>, no turno <strong><?php 
...
<div class="row"><div class="col-xs-12"><p><br></div></div>
...
<div class="col-xs-12">
			...
			<?php
			$aux = 'https://www.smecel.com.br/sistema/escola/fnc/qr/php/qr_img.php?';
