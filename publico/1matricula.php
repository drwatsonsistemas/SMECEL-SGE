...
$colname_Matricula = "-1";
if (isset($_GET['chave'])) {
  $colname_Matricula = anti_injection($_GET['chave']);
}
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><p><h1>COMPROVANTE DE MATRÍCULA</h1></p><br><br><br><br><br><br>
...
<div class="row">
  ...
  está devidamente matriculado(a) nesta Unidade de Ensino, cursando o <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $row_Matricula['etapa_nome']; ?>)</strong>, no turno <strong><?php 
