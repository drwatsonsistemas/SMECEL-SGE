...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_ContarImpressoesHojeHoje = "SELECT smc_ativ_id, smc_ativ_data, smc_ativ_id_escola, smc_ativ_id_turma, smc_ativ_qtd, smc_ativ_folhas, smc_ativ_duplex, smc_ativ_caminho, smc_ativ_hash, smc_ativ_obs FROM smc_atividade WHERE smc_ativ_data BETWEEN '$dataInicio' AND '$dataFinal'";
...
<div class="row">
	<div class="small-12 columns">
		<?php if (isset($_GET["sucesso"])) { ?>
			<div data-alert class="alert-box info radius"> ATIVIDADE CADASTRADA COM SUCESSO <a href="#" class="close">&times;</a> </div>
			<?php } ?>
		...
		?>
				...
				<tr>
					...
					<td class="text-center">
					<?php echo $row_ListarAtividades['smc_ativ_qtd']; 
		...
		Período: De <?php echo inverteData($dataInicio); ?> até <?php echo inverteData($dataFinal); ?> 
		</p>
		<?php } else { ?>
