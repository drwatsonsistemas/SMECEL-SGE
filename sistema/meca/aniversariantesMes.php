...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_aniversariantesMes = "SELECT func_id, func_id_sec, func_nome, func_data_nascimento, DATE_FORMAT(func_data_nascimento, '%m%d') AS aniversario, DATE_FORMAT(func_data_nascimento, '%d/%m') AS data_aniversario, func_situacao FROM smc_func WHERE Month(func_data_nascimento) = '$mes' ORDER BY aniversario ASC";
...
<div class="row">
	<div class="small-12 columns">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <?php do { ?>
            <tr>
              <td class="text-center"><?php echo $row_aniversariantesMes['data_aniversario']; ?></td>
              <td><?php echo $row_aniversariantesMes['func_nome']; ?></td>
            </tr>
            <?php } while ($row_aniversariantesMes = mysql_fetch_assoc($aniversariantesMes)); ?>
        </table>
        
        <a href="aniversariantesMes.php?mes=<?php echo $mesAnterior; ?>" class="button tiny left secondary">MÊS ANTERIOR</a>
        <a href="aniversariantesMes.php?mes=<?php echo $mesSeguinte; ?>" class="button tiny right secondary">PRÓXIMO MÊS</a>
