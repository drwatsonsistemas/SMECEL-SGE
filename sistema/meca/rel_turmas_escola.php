...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_TurmasEscola = "SELECT turma_id, turma_id_escola, turma_nome, turma_etapa, turma_turno, turma_total_alunos, COUNT(*) AS total_turmas, escola_id, escola_nome FROM smc_turma INNER JOIN smc_escola ON escola_id = turma_id_escola WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' GROUP BY turma_id_escola";
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_ContaTurmas = "SELECT * FROM smc_turma WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'";
  ...
  <h1>Turmas por escola</h1>
      ...
      <thead>
        <tr>
          ...
          <th class="text-center">TOTAL DE TURMAS</th>
        </tr>
        </thead>
        <tbody>
        <?php do { ?>
          <tr>
            ...
            <td class="text-center"><?php echo $row_TurmasEscola['total_turmas']; ?></td>
          </tr>
          <?php } while ($row_TurmasEscola = mysql_fetch_assoc($TurmasEscola)); ?>
		  <tr>
            <td class="text-center"><strong>TOTAL DE TURMAS</strong></td>
            <td class="text-center"><strong><?php echo $totalRows_ContaTurmas ?></strong></td>
          </tr>
      </tbody>
      </table>
