  ...
  <div class="small-12 columns">
	...
	<div class="small-12 columns">
      ...
      <legend>EDITAR FUNCIONÁRIO</legend>
            ...
            <div class="small-12 columns">
            <label>Nome completo:
          <input type="text" name="func_nome" value="<?php echo htmlentities($row_EditaFunc['func_nome'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-6 columns">
            <label>Nome da mãe:
          <input type="text" name="func_mae" value="<?php echo htmlentities($row_EditaFunc['func_mae'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-6 columns">
            <label>Nome do pai:
          <input type="text" name="func_pai" value="<?php echo htmlentities($row_EditaFunc['func_pai'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-3 columns">
            <label>Data de Nascimento:
          <input type="text" name="func_data_nascimento" value="<?php echo htmlentities(inverteData($row_EditaFunc['func_data_nascimento']), ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled class="placeholder">
            </label>
            </div>

            <div class="small-12 medium-2 columns">
            <label>UF Nascimento:
          <select name="func_uf_nascimento" disabled>
          ...
          <input type="text" name="func_municipio_nascimento" value="<?php echo htmlentities($row_EditaFunc['func_municipio_nascimento'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
            ...
            <div class="small-12 medium-3 columns">
            <label>Estado Civil:
          <select name="func_estado_civil" disabled>
            ...
            <div class="small-12 medium-3 columns">
            <label>Sexo:
          <select name="func_sexo" disabled>
            ...
            <div class="small-12 medium-3 columns">
            <label>Escolaridade:
          <select name="func_escolaridade" disabled>
            ...
            <div class="small-12 medium-3 columns">
            <label>Área Concurso:
            <select name="func_area_concurso" disabled>
            ...
            <label>CPF:
           <input type="text" name="func_cpf" id="cpf" value="<?php echo htmlentities($row_EditaFunc['func_cpf'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled onblur="javascript: validarCPF(this);" onkeypress="javascript: mascara(this, cpf_mask);">
           </label>
            </div>
         
            <div class="small-12 medium-4 columns">
            <label>RG:
          <input type="text" name="func_rg_numero" value="<?php echo htmlentities($row_EditaFunc['func_rg_numero'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-4 columns">
            <label>Órgão Emissor:
          <input type="text" name="func_rg_emissor" value="<?php echo htmlentities($row_EditaFunc['func_rg_emissor'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-5 columns">
            <label>Título de Eleitor:
          <input type="text" name="func_titulo" value="<?php echo htmlentities($row_EditaFunc['func_titulo'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-5 columns">
            <label>Seção:
          <input type="text" name="func_titulo_secao" value="<?php echo htmlentities($row_EditaFunc['func_titulo_secao'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-2 columns">
            <label>Zona Eleitoral:
           <input type="text" name="func_titulo_zona" value="<?php echo htmlentities($row_EditaFunc['func_titulo_zona'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
           </label>
            </div>

            <div class="small-12 medium-6 columns">
            <label>PIS/PASEP:
          <input type="text" name="func_pis" value="<?php echo htmlentities($row_EditaFunc['func_pis'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-4 columns">
            <label>CNH:
          <input type="text" name="func_cnh_num" value="<?php echo htmlentities($row_EditaFunc['func_cnh_num'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-2 columns">
            <label>Categoria:
          <select name="func_categoria" disabled>
            ...
            <div class="small-12 medium-4 columns">
            <label>CTPS:
           <input type="text" name="func_ctps" value="<?php echo htmlentities($row_EditaFunc['func_ctps'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
           </label>
            </div>

            <div class="small-12 medium-4 columns">
            <label>Série:
          <input type="text" name="func_ctps_serie" value="<?php echo htmlentities($row_EditaFunc['func_ctps_serie'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Reservista:
          <input type="text" name="func_reservista" value="<?php echo htmlentities($row_EditaFunc['func_reservista'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-10 columns">
            <label>Endereço:
          <input type="text" name="func_endereco" value="<?php echo htmlentities($row_EditaFunc['func_endereco'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-2 columns">
            <label>Número:
          <input type="text" name="func_endereco_numero" value="<?php echo htmlentities($row_EditaFunc['func_endereco_numero'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-8 columns">
            <label>Bairro:
          <input type="text" name="func_endereco_bairro" value="<?php echo htmlentities($row_EditaFunc['func_endereco_bairro'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>CEP:
          <input type="text" name="func_endereco_cep" value="<?php echo htmlentities($row_EditaFunc['func_endereco_cep'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled class="cep">
            </label>
            </div>
          
            <div class="small-12 medium-6 columns">
            <label>UF:
          <select name="func_endereco_uf" disabled>
            ...
            <div class="small-12 medium-6 columns">
            <label>Cidade:
          <input type="text" name="func_endereco_cidade" value="<?php echo htmlentities($row_EditaFunc['func_endereco_cidade'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Matrícula:
          <input type="text" name="func_matricula" value="<?php echo htmlentities($row_EditaFunc['func_matricula'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
            ...
            <div class="small-12 medium-4 columns">
            <label>Admissão:
          <input type="text" name="func_admissao" value="<?php echo htmlentities(inverteData($row_EditaFunc['func_admissao']), ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled class="placeholder">
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Decreto:
          <input type="text" name="func_decreto" value="<?php echo htmlentities($row_EditaFunc['func_decreto'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-6 columns">
            <label>Cargo/Função:
          <select name="func_cargo" disabled>
            ...
            <div class="small-12 medium-6 columns">
            <label>Lotação:
          <input type="text" name="func_lotacao" value="<?php echo htmlentities($row_EditaFunc['func_lotacao'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Regime:
          <select name="func_regime" disabled>
          ...
          <select name="func_grupo_sanquineo" disabled>
            ...
            <div class="small-12 medium-4 columns">
            <label>Fator RH:
           <select name="func_fator_rh" disabled>
            ...
            <div class="small-12 medium-4 columns">
            <label>E-mail:
          <input type="email" name="func_email" value="<?php echo htmlentities($row_EditaFunc['func_email'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Telefone:
          <input type="text" name="func_telefone" value="<?php echo htmlentities($row_EditaFunc['func_telefone'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>

            <div class="small-12 medium-4 columns">
            <label>Celular:
           <input type="text" name="func_celular1" value="<?php echo htmlentities($row_EditaFunc['func_celular1'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
           </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Celular:
          <input type="text" name="func_celular2" value="<?php echo htmlentities($row_EditaFunc['func_celular2'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Agência:
          <input type="text" name="func_agencia_banco" value="<?php echo htmlentities($row_EditaFunc['func_agencia_banco'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Conta:
          <input type="text" name="func_conta_banco" value="<?php echo htmlentities($row_EditaFunc['func_conta_banco'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-8 columns">
            <label>Banco:
          <input type="text" name="func_nome_banco" value="<?php echo htmlentities($row_EditaFunc['func_nome_banco'], ENT_COMPAT, 'utf-8'); ?>" size="32" class="unavailable" disabled>
            </label>
            </div>
          
            <div class="small-12 medium-4 columns">
            <label>Situação:
           <select name="func_situacao" disabled>
            ...
            <div class="small-12 columns">
          <a href="funcionarioEditar.php?c=<?php echo $row_EditaFunc['func_id']; ?>" class="button">EDITAR DADOS</a>  
