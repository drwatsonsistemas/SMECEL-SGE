...
$colname_FiltraCadastrado = "-1";
if (isset($_GET['nome'])) {
  $colname_FiltraCadastrado = $_GET['nome'];
}
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_FiltraCadastrado = sprintf("SELECT func_id, func_id_sec, func_nome, func_mae, func_pai, func_data_nascimento, func_uf_nascimento, func_municipio_nascimento, func_estado_civil, func_sexo, func_escolaridade, func_cpf, func_rg_numero, func_rg_emissor, func_titulo, func_titulo_secao, func_titulo_zona, func_pis, func_cnh_num, func_categoria, func_ctps, func_ctps_serie, func_reservista, func_endereco, func_endereco_numero, func_endereco_bairro, func_endereco_cep, func_endereco_uf, func_endereco_cidade, func_matricula, func_admissao, func_decreto, func_lotacao, func_cargo, func_regime, func_grupo_sanquineo, func_fator_rh, func_email, func_telefone, func_celular1, func_celular2, func_agencia_banco, func_conta_banco, func_nome_banco, func_area_concurso, func_formacao, func_situacao, func_foto FROM smc_func WHERE func_nome = %s", GetSQLValueString($colname_FiltraCadastrado, "text"));
$FiltraCadastrado = mysql_query($query_FiltraCadastrado, $SmecelNovo) or die(mysql_error());
$row_FiltraCadastrado = mysql_fetch_assoc($FiltraCadastrado);
$totalRows_FiltraCadastrado = mysql_num_rows($FiltraCadastrado);
...
<div class="row">
	<div class="small-12 columns">
  	...
  	<div data-alert class="alert-box success radius">
  		"<?php echo $row_FiltraCadastrado['func_nome']; ?>" cadastrado com sucesso! <a href="funcionarioEditar.php?c=<?php echo $row_FiltraCadastrado['func_id']; ?>" class="label secondary">EDITE</a> ou <a href="titulacaoCadastrar.php?c=<?php echo $row_FiltraCadastrado['func_id']; ?>" class="label secondary">INCLUA UMA FORMAÇÃO</a>
    <a href="#" class="close">&times;</a>
    </div>

	  <a href="funcionarioCadastrar.php" class="button tiny">Cadastrar Funcionário</a> <a href="funcionarioExibir.php" class="button tiny alert">Voltar</a>
      ...
      <thead>
        <tr>
          ...
          <td align="center" class="text-center"><small>MAT</small></td>
          <td align="center" class="text-center"><small>ADM</small></td>
          <td align="center" class="text-center"><small>FORMAÇÃO</small></td>
        </tr>
        </thead>
        <tbody>
        <?php do { ?>
...
mysql_free_result($FiltraCadastrado);
?>
