...
<div class="row">
  <div class="small-12 columns"> <a href="atividadesCadastrar.php" class="tiny button">CADASTRAR ATIVIDADE</a> <a href="atividadesListar.php" class="tiny info button">LISTAR ATIVIDADES</a> <a href="#" data-reveal-id="myModal" class="tiny warning button">FILTRAR</a>
    <?php if (isset($_GET["sucesso"])) { ?>
      <div data-alert class="alert-box success radius"> ATIVIDADE CADASTRADA COM SUCESSO <a href="#" class="close">&times;</a> </div>
      <?php } ?>
    <?php if (isset($_GET["excluido"])) { ?>
      <div data-alert class="alert-box warning radius"> ATIVIDADE EXCLUÍDA COM SUCESSO <a href="#" class="close">&times;</a> </div>
      <?php } ?>
  </div>
</div>
<div class="row">
  <div class="small-12 columns">
    <h5 class="text-center">ATIVIDADES CADASTRADAS HOJE (<?php echo date('d/m/Y') ?>)</h5>
    ...
    <table width="100%" role="grid">
      ...
      <tbody>
        ...
        <?php do { ?>
        <tr>
          <td class="text-center"><span class="info label">ATIV Nº <?php echo $row_ListarAtividades['smc_ativ_id']; ?></span><br>
          ...
          <td class="text-center"><?php echo $row_ListarAtividades['smc_ativ_qtd']; 
    ...
    <p class="panel"> <strong>Resultado</strong><br>
      Atividades cadastradas: <?php echo $totalRows_ContarImpressoesHojeHoje ?><br>
      Atividades impressas: <?php echo $totalAtividades; ?><br>
      Folhas utilizadas: <?php echo $totalFolhas; ?><br>
    </p>
    <?php } else { ?>
...
<div id="myModal" class="reveal-modal tiny" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
  <form action="atividadesListarData.php" method="get" autocomplete="off">
    <fieldset>
