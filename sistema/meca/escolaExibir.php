...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Escolas = "SELECT escola_id, escola_id_sec, escola_nome, escola_cep, escola_endereco, escola_num, escola_bairro, escola_telefone1, escola_telefone2, escola_email FROM smc_escola WHERE escola_id_sec = '$row_UsuarioLogado[usu_sec]'";
...
<div class="row">
  ...
  <hr>
  <a href="escolaCadastrar.php" class="button tiny">Cadastrar Escola</a>
  
    <table width="100%">
    <caption>Relação de Escolas Cadastradas</caption>
    <thead>
      <tr>
        <td>ESCOLA</td>
        <td>E-MAIL</td>
    ...
    <tbody>  
	  <?php do { ?>
        <tr>
          <td scope="row"><?php echo $row_Escolas['escola_nome']; ?></td>
          <td scope="row"><?php echo $row_Escolas['escola_email']; ?></td>
          <td scope="row"><a href="escolaEditar.php?c=<?php echo $row_Escolas['escola_id']; ?>">Editar</a></td>
        </tr>
