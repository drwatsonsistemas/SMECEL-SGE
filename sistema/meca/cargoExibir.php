...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Cargos = "SELECT funcao_id, funcao_nome, funcao_observacoes FROM smc_funcao ORDER BY funcao_nome ASC";
$Cargos = mysql_query($query_Cargos, $SmecelNovo) or die(mysql_error());
...
<div class="row">
	<div class="small-12 columns">
      ...
      <hr>
	  <a href="cargoCadastrar.php" class="button tiny">Cadastrar cargo</a>

      <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <caption>Relação de Cargos/Funções</caption>
        <thead>
        <tr>
          <td>CARGO/FUNÇÃO</td>
        </tr>
        ...
        <?php do { ?>
          <tr>
            <td><?php echo $row_Cargos['funcao_nome']; ?></td>
          </tr>
          <?php } while ($row_Cargos = mysql_fetch_assoc($Cargos)); ?>
      </table>
	</div>
</div>
