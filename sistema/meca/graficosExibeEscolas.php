...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Escolas = "SELECT smc_ativ_id, smc_ativ_id_escola, smc_ativ_id_turma, COUNT(smc_ativ_id) AS 'total_atividades', escola_id, escola_nome FROM smc_atividade INNER JOIN smc_escola ON escola_id = smc_ativ_id_escola GROUP BY smc_ativ_id_escola ORDER BY total_atividades DESC";
	...
	<table class="ls-table ls-no-hover ls-table-striped" width="100%">
      <thead>
        ...
        <tbody>
		     ...
		     <?php do { ?>
			 <tr>
		     	<td><a href="graficosTurmasEscola.php?c=<?php echo $row_Escolas['escola_id']; ?>"><?php echo $row_Escolas['escola_nome']; ?></a></td>
			 	<td class="text-center"><?php echo $row_Escolas['total_atividades']; ?></td>
			 </tr>	
