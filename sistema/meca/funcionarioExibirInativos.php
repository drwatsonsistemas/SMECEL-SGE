...
<?php } ?>
	  <p class="text-right"><small><a href="funcionarioExibir.php">Exibir ativos</a></small></p>
      Total de funcionários cadastrados (inativos): <?php echo $totalRows_ExibeFuncionarios ?>
