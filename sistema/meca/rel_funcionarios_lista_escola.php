...
$colname_Vinculos = "-1";
if (isset($_GET['cod'])) {
  $colname_Vinculos = $_GET['cod'];
}
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Vinculos = sprintf("
SELECT vinculo_id, vinculo_id_escola, vinculo_id_funcionario, vinculo_id_funcao, vinculo_data_inicio, vinculo_obs, func_id, func_nome, funcao_id, funcao_nome 
FROM smc_vinculo
...
ORDER BY func_nome
", GetSQLValueString($colname_Vinculos, "int"));
...
<div class="small-12 columns">
  ...
  <a href="rel_funcionarios_escola.php">Voltar</a>
  <table class="ls-table ls-no-hover ls-table-striped" width="100%">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_Vinculos['func_nome']; ?></td>
        <td><?php echo $row_Vinculos['funcao_nome']; ?></td>
        <td><?php echo $row_Vinculos['vinculo_data_inicio']; ?></td>
      </tr>
      <?php } while ($row_Vinculos = mysql_fetch_assoc($Vinculos)); ?>
  </tbody>
  </table>
  <p class="text-right">Total: <?php echo $totalRows_Vinculos ?></p>
</div>
