...
WHEN 'S' THEN 'ATUALIZADA' 
WHEN 'N' THEN 'DESATUALIZADA' 
WHEN 'I' THEN 'SEM INFORMAÇÃO' 
ELSE 'SEM DADOS'
END AS vacina
...
ORDER BY vinculo_aluno_vacina_atualizada ASC";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	<?php do { ?>
	  ...
	  ['<?php echo $row_matriculasTurno['vacina']; ?> (<?php echo $row_matriculasTurno['matriculas_total']; ?>)', <?php echo $row_matriculasTurno['matriculas_total']; ?>],
	...
	<?php } while ($row_matriculasTurno = mysql_fetch_assoc($matriculasTurno)); ?>
        ...
        var options = {
          title: 'TOTAL DE MATRÍCULAS POR SITUAÇÃO VACINAL NO ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>',
		  pieHole: 0.4,
        };
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">MATRÍCULAS POR SITUAÇÃO VACINAL</h1>
    <!-- CONTEUDO -->
