...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Componente = "SELECT disciplina_id, disciplina_area_conhecimento_id, disciplina_codigo_inep, disciplina_ordem, disciplina_nome, disciplina_nome_abrev, disciplina_cor_fundo, disciplina_bncc, disciplina_diversificada, disciplina_id_campos_exp FROM smc_disciplina";
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">PROFESSOR POR COMPONENTE</h1>
    <!-- CONTEUDO -->
    
    <a href="impressao/rel_professor_por_componente.php" class="ls-btn" target="_blank" aria-expanded="false">IMPRIMIR</a>
    ...
    <table class="ls-table ls-sm-space">
	  <thead>
       <tr>
        <th>
		  <?php echo $row_Componente['disciplina_nome']; ?>
        </th>
       </tr>
      </thead>
	  ...
	  <?php 
		...
		WHERE ch_lotacao_disciplina_id = '$row_Componente[disciplina_id]' AND turma_id_sec = '$row_UsuarioLogado[usu_sec]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
		GROUP BY func_id
      ...
      <tr>
	  	<td class="ls-float-right">Total de profissionais vinculados neste componente: <strong><?php echo $totalRows_Vinculo; ?></strong></td>
      </tr>
