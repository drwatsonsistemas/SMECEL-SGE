...
<body>
    ...
    <main class="ls-main">
        <div class="container-fluid">
            ...
            <a href="folha_pagamento_escolas.php?folha=<?= $folha ?>"
                class="ls-btn-primary ls-ico-chevron-left">Voltar</a>

            <a target="_blank"
                href="impressao/print_folha_pagamentoOrdemAlfabetica.php?folha=<?= $folha ?>&escola=<?= $escola ?>"
                class="ls-btn-primary ls-ico-folder ls-float-right">IMPRIMIR (ORDEM ALFABÉTICA)</a>
            <a target="_blank"
                href="impressao/print_folha_pagamentoPorFuncao.php?folha=<?= $folha ?>&escola=<?= $escola ?>"
                class="ls-btn-primary ls-ico-folder ls-float-right">IMPRIMIR POR FUNÇÃO</a>
            <hr>
                    ...
                    <tbody>
                        <?php do { ?>
                            <tr>
                                ...
                                <td class="ls-txt-center"><?= $row_ListaVinculos['total_extras_dias'] ?></td>
                                <!-- Exibe o total de dias extras -->
                                <td class="ls-txt-center"><?= $row_ListaVinculos['total_extras_aulas'] ?></td>

                                <td class="ls-txt-center"><?= $row_ListaVinculos['total_faltas_dias'] ?></td>
                                <!-- Exibe o total de dias de faltas -->
                                <td class="ls-txt-center"><?= $row_ListaVinculos['total_faltas_aulas'] ?></td>
