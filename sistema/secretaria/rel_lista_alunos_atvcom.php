...
<body>
    ...
    <main class="ls-main">
        <div class="container-fluid">
            <h1 class="ls-title-intro ls-ico-home">Relação de alunos por turma (ATIVIDADE COMPLEMENTAR)</h1>
            <!-- CONTEUDO -->

            <div class="ls-txt-right">
                <a class="ls-btn ls-ico-windows" href="impressao/rel_lista_alunos_atvcom.php" target="_blank">
                    Imprimir</a>
            </div>

            <?php
            // Inicializa o total do município
            $totalMunicipio = 0;
            ?>
    ...
    WHERE vinculo_aluno_situacao = '1' AND turma_tipo_atendimento = '3' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
    ...
    ";
                ...
                // Adiciona o total de alunos da escola ao total do município
                $totalMunicipio += $totalRows_ListaAlunos;
                ?>
                        ...
                        <tbody>
                            ...
                            <?php do { ?>
                                <tr>
                                    ...
                                    <td class="ls-txt-center"><?php echo $row_ListaAlunos['turma_nome']; ?> -
                                        <?php echo $row_ListaAlunos['turma_turno_nome']; ?>
                                    </td>
                                </tr>
                            <?php } while ($row_ListaAlunos = mysql_fetch_assoc($ListaAlunos)); ?>
                        </tbody>
                    </table>
                    <p><strong>Total de alunos: <?php echo $totalRows_ListaAlunos; ?></strong></p>
                    <hr>
                <?php } else { ?>
                    <hr>
            ...
            <!-- Exibe o total do município após o loop -->
            <div class="ls-box"><h3>Total de alunos do município: <?php echo $totalMunicipio; ?></h3></div>
