...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">CONCEITOS DO ENSINO FUNDAMENTAL</h1>
    <!-- CONTEUDO -->

    <p>
      <a href="matrizdisciplina.php?hash=<?php echo $colname_Matriz; ?>" class="ls-btn">VOLTAR</a>
      <a href="impressao/print_questionario_conceitos.php?matriz=<?php echo $row_Matriz['matriz_hash']; ?>&comp=<?php echo $colname_Componente; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>
      <a href="impressao/print_questionario_conceitos_resumido.php?matriz=<?php echo $row_Matriz['matriz_hash']; ?>&comp=<?php echo $colname_Componente; ?>" class="ls-btn" target="_blank">IMPRIMIR (RESUMIDO)</a>
    </p>
...
<button data-ls-module="modal" data-target="#myAwesomeModal" class="ls-btn-primary ls-ico-plus">CADASTRAR CRITÉRIO AVALIATIVO</button>
    ...
    <table class="ls-table ls-sm-space">
      ...
      <?php $num = 1; do { ?>
        <tr>
          ...
          <td><p class="ls-box">
		  <?php echo $row_questoes['quest_conc_descricao']; ?><br>
          <a href="questionario_conceitos.php?matriz=<?php echo $row_Matriz['matriz_hash']; ?>&comp=<?php echo $colname_comp; ?>&criterio=<?php echo $row_questoes['quest_conc_hash']; ?>"><span class="ls-ico-cancel-circle ls-color-danger ls-float-right"></span></a>
          </p></td>
          <td>
            <?php 
			mysql_select_db($database_SmecelNovo, $SmecelNovo);
		  ...
		  ?>
			...
			do { ?>
              <p class=""><?php echo utf8_decode($row_Habilidades['bncc_ef_habilidades']); ?>  <a href="questionario_conceitos.php?matriz=<?php echo $row_Matriz['matriz_hash']; ?>&comp=<?php echo $colname_comp; ?>&quest_hab=<?php echo $row_Habilidades['quest_hab_hash']; ?>"><span class="ls-ico-cancel-circle ls-color-danger ls-float-right"></span></a></p>
            <?php } while ($row_Habilidades = mysql_fetch_assoc($Habilidades)); 
			}
			?>
            
			<a href="questionario_conceitos_habilidades.php?matriz=<?php echo $row_Matriz['matriz_hash']; ?>&comp=<?php echo $colname_comp; ?>&habilidade=<?php echo $row_questoes['quest_conc_hash']; ?>" class="ls-ico-plus">Adicionar</a>
