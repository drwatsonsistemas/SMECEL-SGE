...
vinculo_aluno_vacina_data_retorno, count(*) as matriculas_total, turma_id, turma_turno,
CASE turma_turno
...
WHERE vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_situacao = '1' AND turma_tipo_atendimento = '1'
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	<?php do { ?>
	  ...
	  ['<?php echo $row_matriculasTurno['turno_nome']; ?> (<?php echo $row_matriculasTurno['matriculas_total']; ?>)', <?php echo $row_matriculasTurno['matriculas_total']; ?>],
	...
	<?php } while ($row_matriculasTurno = mysql_fetch_assoc($matriculasTurno)); ?>
        ...
        var options = {
          title: 'TOTAL DE MATRÍCULAS POR TURNO NO ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>',
		  pieHole: 0.4,
        };
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">MATRÍCULAS POR TURNO</h1>
