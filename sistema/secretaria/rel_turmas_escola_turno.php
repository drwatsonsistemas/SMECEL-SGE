...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">TURMAS POR TURNO (ESCOLAS)</h1>
...
<a href="impressao/rel_turmas_escola_turno.php?<?php echo $url_atual[1]; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>    
