      ...
      <p>
        ...
        <div class="ls-custom-select">
          <select name="ce_tipo" required>
            ...
            <option value="7" <?php if (!(strcmp(6, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>7 - JORNADA PEDAGÓGICA</option>
            <option value="8" <?php if (!(strcmp(7, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 8 - ENCONTRO P/ PLANEJAMENTO</option>
            <option value="9" <?php if (!(strcmp(8, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 9 - CONSELHO DE CLASSE</option>
            <option value="10" <?php if (!(strcmp(9, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 10 - ESTUDO DE RECUPERAÇÃO</option>
            <option value="11" <?php if (!(strcmp(10, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 11 - ANO LETIVO 2020</option>
            <option value="12" <?php if (!(strcmp(11, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 12 - ANO LETIVO 2021</option>
            <option value="13" <?php if (!(strcmp(12, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 13 - PLANTÃO PEDAGÓGICO</option>
            <option value="14" <?php if (!(strcmp(13, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 14 - CONSELHO DE CLASSE</option>
            <option value="15" <?php if (!(strcmp(14, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 15 - RESULTADOS FINAIS</option>
            <option value="16" <?php if (!(strcmp(15, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 16 - FÉRIAS COLETIVAS</option>
            <option value="17" <?php if (!(strcmp(16, htmlentities($row_calendarioListar['ce_tipo'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>> 17 - ATIVIDADE SUSPENSA</option>
