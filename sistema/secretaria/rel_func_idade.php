...
<div class="ls-actions-btn">
    <a href="impressao/rel_func_idade.php" class="ls-btn" target="_blank">IMPRIMIR</a>
  </div>
    ...
    <tbody>
	  ...
	  do { ?>
        <tr>
          ...
          <td><?php echo $row_FuncionariosGraduacao['func_mae']; ?></td>
          <td><?php echo idade($row_FuncionariosGraduacao['func_data_nascimento']); ?></td>
          <td><?php echo $row_FuncionariosGraduacao['func_cpf']; ?></td>
