...
<main class="ls-main">
  ...
  <?php
	...
	vinculo_aluno_vacina_atualizada, turma_id, turma_nome, turma_turno, turma_etapa, turma_ano_letivo, turma_total_alunos, COUNT(*) as total, escola_id, escola_situacao,
