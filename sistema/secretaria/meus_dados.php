...
<body>
    ...
    <main class="ls-main">
        <div class="container-fluid">
            <h1 class="ls-title-intro ls-ico-home">ALTERAR DADOS DE USUÁRIO</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form">
                            ...
                            <label
                                class="ls-label col-sm-12 col-md-12 <?php if (empty($row_UsuarioLogado['usu_contato']))
                                    echo "ls-warning"; ?>">
                            ...
                            <label
                                class="ls-label col-sm-12 col-md-12 <?php if (empty($row_UsuarioLogado['usu_cargo']))
                                    echo "ls-warning"; ?>">
