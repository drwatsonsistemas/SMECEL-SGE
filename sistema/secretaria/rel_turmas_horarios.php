...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">GRADES DE HORÁRIOS</h1>
 ...
 <div data-ls-module="dropdown" class="ls-dropdown">
  ...
  <li><a href="rel_turmas.php">TODAS</a></li>
    <?php do { ?>
      <li><a href="rel_turmas_horarios.php?cod=<?php echo $row_listaEscolas['escola_id']; ?>"><?php echo $row_listaEscolas['escola_nome']; ?></a></li>
    <?php } while ($row_listaEscolas = mysql_fetch_assoc($listaEscolas)); ?>
  </ul>
</div>

<a href="professorDisciplina.php" class="ls-btn-primary">DISTRIBUIÇÃO (POR PROFESSOR)</a>
    ...
    <tbody>
      <?php do { ?>
        <tr>
          ...
          <td><a href="rel_horarios.php?turma=<?php echo $row_Turmas['turma_id']; ?>"><?php echo $row_Turmas['turma_nome']; ?></a></td>
