...
<body>
	...
	<main class="ls-main">
		<div class="container-fluid">
			...
			<div class="ls-box">
				...
				<div class="ls-alert-info"><strong>Atenção:</strong>
					Clique sobre o dia no calendário para informar o evento (dia letivo, sábado letivo, feridado etc.)
					ou clique no botão abaixo para informar um intervalo de datas.
				</div>
				...
				<?php if (isset($_GET["lancado"])) { ?>
					<div class="ls-alert-success ls-dismissable"> <span data-ls-module="dismiss"
							class="ls-dismiss">&times;</span> Evento lançado com sucesso no calendário letivo! </div>
				<?php } ?>

				<?php if (isset($_GET["erro"])) { ?>
					<div class="ls-alert-danger ls-dismissable"> <span data-ls-module="dismiss"
							class="ls-dismiss">&times;</span> <strong>Ops! </strong> Isso não deveria ter acontecido. Um
						e-mail foi enviado ao administrador do sistema! </div>
				<?php } ?>

				<?php if (isset($_GET["maior"])) { ?>
					<div class="ls-alert-danger ls-dismissable"> <span data-ls-module="dismiss"
							class="ls-dismiss">&times;</span> <strong>Ops! </strong> A data inicial não pode ser maior do
						que a data final. </div>
				<?php } ?>
				...
				$contar['feriascoletivas'] = 0;
				$contar['atividadessuspensas'] = 0;
				$contar['accoletivo'] = 0;
					...
					<div class="col-lg-3 col-md-3 col-sm-1">
						<div class="mes">
							...
							<div class="nome-mes ls-txt-center">
								<?php echo nomeMes($mesInicio); ?>/<?php echo $anoInicio; ?></div>
							<?php
							...
							for ($dia = 1; $dia <= $dias; $dia++) { ?>
								...
								switch ($row_ListaCalendario['ce_tipo']) {
									...
									case 16:
										...
										$contar['feriascoletivas']++;
										break;

									case 17:
										$corDia = "#81d5fc";
										$corTexto = "black";
										$titulo = "ATIVIDADES SUSPENSAS";
										$contar['atividadessuspensas']++;
										break;
		...
		WHEN 16 THEN 'FÉRIAS COLETIVAS'
		WHEN 17 THEN 'ATIVIDADES SUSPENSAS'
		WHEN 18 THEN 'AC COLETIVO'
		END AS ce_tipo_nome 
		...
		WHERE ce_id_sec = '$row_UsuarioLogado[usu_sec]' AND ce_tipo <> '1' AND MONTH(STR_TO_DATE(ce_data, '%Y-%m-%d')) = '$mesInicio' AND YEAR(STR_TO_DATE(ce_data, '%Y-%m-%d')) = '$anoInicio'";
			...
			<div class="ls-box">
				...
				<p>
					...
					- FÉRIAS COLETIVAS <strong><?php echo $contar['feriascoletivas']; ?></strong><br>
					- ATIVIDADES SUSPENSAS <strong><?php echo $contar['atividadessuspensas']; ?></strong><br>
			...
			<div class="ls-modal-body" id="myModalBody">
				...
				<form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form">
					...
					<label class="ls-label col-md-06">
						...
						<input type="date" name="ce_data_de" value="<?php echo $row_AnoLetivo['ano_letivo_inicio']; ?>"
							size="32" required>
					</label>

					<label class="ls-label col-md-06">
						<b class="ls-label-text">DATA FINAL</b>
						<input type="date" name="ce_data_ate" value="<?php echo $row_AnoLetivo['ano_letivo_inicio']; ?>"
							size="32" required>
					</label>
