...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">TURMAS POR TURNO</h1>
     
    <!-- CONTEUDO -->
    
<a href="impressao/rel_turmas_turno.php?<?php echo $url_atual[1]; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>    
...
?>
    <?php 
    	mysql_select_db($database_SmecelNovo, $SmecelNovo);
		$query_Turmas = "
SELECT turma_etapa, etapa_nome, turma_turno,turma_id_sec, turma_tipo_atendimento, COUNT(*) AS total_turmas,
CASE turma_turno
  ...
  <div class="ls-box ls-board-box">
    ...
    <table class="ls-table ls-sm-space">
        ...
        <tbody>
            ...
            <?php 
                $turmasEscola = $turmasEscola + $row_Turmas['total_turmas'];
                ?>
