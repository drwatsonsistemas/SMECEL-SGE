...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <a href="impressao/matriculas.php?<?php echo $url_atual[1]; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>
    <a href="matriculas_anteriores.php" class="ls-btn-info">PESQUISAR HISTÓRICO DE MATRÍCULAS</a>
...
<div class="ls-box-filter">
  ...
  <?php
	...
	vinculo_aluno_vacina_atualizada, turma_id, turma_nome, turma_turno, turma_etapa, turma_tipo_atendimento, turma_ano_letivo, COUNT(*) as total, escola_id, escola_situacao,
	...
	WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_id_escola = '$row_Escolas[escola_id]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_situacao = '1' AND escola_situacao = '1' AND vinculo_aluno_dependencia = 'N' AND turma_tipo_atendimento = '1'
  ...
  ?>      
		...
		do { ?>
          <tr>
            ...
            <td class="ls-txt-center"><?php echo $row_Alunos['total']; ?>/<?php echo $row_Alunos['etapa_limite_turma']; ?></td>
            <td class="ls-txt-center"> 
					
					<?php
					
					$perc = (($row_Alunos['total']/$row_Alunos['etapa_limite_turma'])*100);
...
<script src="../escola/js/maiuscula.js"></script> 
<script src="../escola/js/semAcentos.js"></script> 
