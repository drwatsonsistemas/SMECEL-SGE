...
vinculo_aluno_vacina_data_retorno, count(*) as matriculas_total, aluno_id, aluno_sexo, aluno_uf_nascimento,turma_id, turma_turno
...
ORDER BY aluno_uf_nascimento ASC";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	<?php do { ?>
	  ...
	  ['<?php echo $row_matriculasTurno['aluno_uf_nascimento']; ?> (<?php echo $row_matriculasTurno['matriculas_total']; ?>)', <?php echo $row_matriculasTurno['matriculas_total']; ?>],
	...
	<?php } while ($row_matriculasTurno = mysql_fetch_assoc($matriculasTurno)); ?>
        ...
        var options = {
          title: 'TOTAL DE MATRÍCULAS POR NATURALIDADE (UF) NO ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>',
		  pieHole: 0.4,
        };
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">MATRÍCULAS POR NATURALIDADE (UF)</h1>
    <!-- CONTEUDO -->
