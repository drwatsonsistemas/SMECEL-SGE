...
SELECT 
vinculo_id, vinculo_id_escola, vinculo_id_sec, vinculo_id_funcionario, vinculo_id_funcao,
func_id, func_id_sec, func_nome, func_mae, func_pai, func_data_nascimento, func_uf_nascimento, func_municipio_nascimento, 
...
WHERE func_id_sec = '$row_Secretaria[sec_id]' AND func_situacao = '1' $nivelQry
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_funcoes = "
SELECT funcao_id, funcao_secretaria_id, funcao_nome, funcao_observacoes, funcao_docencia FROM smc_funcao
WHERE funcao_secretaria_id = '$row_Secretaria[sec_id]'
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">FUNCIONÁRIOS POR IDADE</h1>
    <!-- CONTEUDO -->
    
    <a href="impressao/rel_func_contatos.php<?php echo $url; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>

<div data-ls-module="dropdown" class="ls-dropdown">
  <a href="#" class="ls-btn-primary">Função</a>
  <ul class="ls-dropdown-nav">
	  <?php do { ?>
        <li><a href="rel_func_contatos.php?funcao=<?php echo $row_funcoes['funcao_id']; ?>"><?php echo $row_funcoes['funcao_nome']; ?></a></li>
    ...
    <tbody>
	  ...
	  do { ?>
        <tr>
          ...
          <td><?php echo $row_FuncionariosGraduacao['func_telefone']; ?></td>
          <td><?php echo $row_FuncionariosGraduacao['func_celular1']; ?></td>
          <td><?php echo $row_FuncionariosGraduacao['func_celular2']; ?></td>
          <td><?php echo $row_FuncionariosGraduacao['func_email']; ?></td>
