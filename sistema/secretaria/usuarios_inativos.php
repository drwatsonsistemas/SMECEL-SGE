...
WHERE usu_sec = '$row_Secretaria[sec_id]'  AND usu_status = '2' $tipo_query
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">USUÁRIOS INATIVOS DO SISTEMA</h1>
    <div class="ls-box ls-board-box">
	  ...
	  <a href="usuarios_inativos.php" class="ls-btn-primary <?php if ($tipo=="0") { ?> ls-active<?php } ?>">TODOS</a> 
	  <a href="usuarios_inativos.php?tipo=1" class="ls-btn-primary <?php if ($tipo=="1") { ?> ls-active<?php } ?>">SECRETARIA</a> 
	  <a href="usuarios_inativos.php?tipo=2" class="ls-btn-primary <?php if ($tipo=="2") { ?> ls-active<?php } ?>">ESCOLAS</a> 
	  </div>
      
      <a href="usuarios.php" class="ls-btn">Ver ativos</a> 
