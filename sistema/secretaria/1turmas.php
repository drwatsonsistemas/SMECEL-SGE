...
WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND  turma_id_sec = '$row_Secretaria[sec_id]' AND escola_situacao = '1'
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">TURMAS</h1>
