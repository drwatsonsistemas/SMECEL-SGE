...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <a href="impressao/rel_professor_por_etapa.php" class="ls-btn" target="_blank" aria-expanded="false">IMPRIMIR</a>
    ...
    INNER JOIN smc_escola ON escola_id = turma_id_escola
		WHERE turma_etapa = '$row_Etapas[etapa_id]' AND turma_id_sec = '$row_UsuarioLogado[usu_sec]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
		GROUP BY func_id
      ...
      <tr>
	  	<td class="ls-float-right">Total de profissionais vinculados nesta etapa: <strong><?php echo $totalRows_Vinculo; ?></strong></td>
      </tr>
