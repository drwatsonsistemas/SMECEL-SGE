...
<body>
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form ls-form-horizontal row">
          <fieldset>
            ...
            <label class="ls-label col-md-4 col-xs-12">
              ...
              <div class="ls-custom-select">
                <select name="func_uf_nascimento">
                  ...
                  <option value="AC" <?php if (!(strcmp("AC", ""))) {
                    echo "SELECTED";
                  } ?>>AC</option>
                  <option value="AL" <?php if (!(strcmp("AL", ""))) {
                    echo "SELECTED";
                  } ?>>AL</option>
                  <option value="AP" <?php if (!(strcmp("AP", ""))) {
                    echo "SELECTED";
                  } ?>>AP</option>
                  <option value="AM" <?php if (!(strcmp("AM", ""))) {
                    echo "SELECTED";
                  } ?>>AM</option>
                  <option value="BA" <?php if (!(strcmp("BA", ""))) {
                    echo "SELECTED";
                  } ?>>BA</option>
                  <option value="CE" <?php if (!(strcmp("CE", ""))) {
                    echo "SELECTED";
                  } ?>>CE</option>
                  <option value="DF" <?php if (!(strcmp("DF", ""))) {
                    echo "SELECTED";
                  } ?>>DF</option>
                  <option value="ES" <?php if (!(strcmp("ES", ""))) {
                    echo "SELECTED";
                  } ?>>ES</option>
                  <option value="GO" <?php if (!(strcmp("GO", ""))) {
                    echo "SELECTED";
                  } ?>>GO</option>
                  <option value="MA" <?php if (!(strcmp("MA", ""))) {
                    echo "SELECTED";
                  } ?>>MA</option>
                  <option value="MT" <?php if (!(strcmp("MT", ""))) {
                    echo "SELECTED";
                  } ?>>MT</option>
                  <option value="MS" <?php if (!(strcmp("MS", ""))) {
                    echo "SELECTED";
                  } ?>>MS</option>
                  <option value="MG" <?php if (!(strcmp("MG", ""))) {
                    echo "SELECTED";
                  } ?>>MG</option>
                  <option value="PA" <?php if (!(strcmp("PA", ""))) {
                    echo "SELECTED";
                  } ?>>PA</option>
                  <option value="PB" <?php if (!(strcmp("PB", ""))) {
                    echo "SELECTED";
                  } ?>>PB</option>
                  <option value="PR" <?php if (!(strcmp("PR", ""))) {
                    echo "SELECTED";
                  } ?>>PR</option>
                  <option value="PE" <?php if (!(strcmp("PE", ""))) {
                    echo "SELECTED";
                  } ?>>PE</option>
                  <option value="PI" <?php if (!(strcmp("PI", ""))) {
                    echo "SELECTED";
                  } ?>>PI</option>
                  <option value="RJ" <?php if (!(strcmp("RJ", ""))) {
                    echo "SELECTED";
                  } ?>>RJ</option>
                  <option value="RN" <?php if (!(strcmp("RN", ""))) {
                    echo "SELECTED";
                  } ?>>RN</option>
                  <option value="RS" <?php if (!(strcmp("RS", ""))) {
                    echo "SELECTED";
                  } ?>>RS</option>
                  <option value="RO" <?php if (!(strcmp("RO", ""))) {
                    echo "SELECTED";
                  } ?>>RO</option>
                  <option value="RR" <?php if (!(strcmp("RR", ""))) {
                    echo "SELECTED";
                  } ?>>RR</option>
                  <option value="SC" <?php if (!(strcmp("SC", ""))) {
                    echo "SELECTED";
                  } ?>>SC</option>
                  <option value="SP" <?php if (!(strcmp("SP", ""))) {
                    echo "SELECTED";
                  } ?>>SP</option>
                  <option value="SE" <?php if (!(strcmp("SE", ""))) {
                    echo "SELECTED";
                  } ?>>SE</option>
                  <option value="TO" <?php if (!(strcmp("TO", ""))) {
                    echo "SELECTED";
                  } ?>>TO</option>
                </select>
              </div>
            ...
            <label class="ls-label col-md-6 col-xs-12"> <b class="ls-label-text">CPF</b>
              <input type="text" name="func_cpf" value="" class="cpf" size="32" id="cpf"
            ...
            <label class="ls-label col-md-4 col-xs-12">
              ...
              <div class="ls-custom-select">
                <select name="func_categoria">
                  ...
                  <option value="A" <?php if (!(strcmp("A", ""))) {
                    echo "SELECTED";
                  } ?>>A</option>
                  <option value="B" <?php if (!(strcmp("B", ""))) {
                    echo "SELECTED";
                  } ?>>B</option>
                  <option value="AB" <?php if (!(strcmp("AB", ""))) {
                    echo "SELECTED";
                  } ?>>AB</option>
                  <option value="C" <?php if (!(strcmp("C", ""))) {
                    echo "SELECTED";
                  } ?>>C</option>
                  <option value="D" <?php if (!(strcmp("D", ""))) {
                    echo "SELECTED";
                  } ?>>D</option>
                  <option value="E" <?php if (!(strcmp("E", ""))) {
                    echo "SELECTED";
                  } ?>>E</option>
                </select>
              </div>
            ...
            <label class="ls-label col-md-4 col-xs-12">
              ...
              <div class="ls-custom-select">
                <select name="func_cargo" required>
                  ...
                  <?php do { ?>
                    <option value="<?php echo $row_Funcoes['funcao_id'] ?>"><?php echo $row_Funcoes['funcao_nome'] ?>
                    </option>
              ...
              <div class="ls-custom-select">
                <select name="func_regime" required>
                  ...
                  do {
                    $count += 1
                      ?>
                    <option value="<?php echo $rowRegimes['id_regime'] ?>">
                      <?php echo $count . " - " . $rowRegimes['regime_nome'] ?>
                    </option>
            ...
            <label class="ls-label col-md-6 col-xs-12">
              ...
              <div class="ls-custom-select">
                <select name="func_carga_horaria_semanal">
                  ...
                  <option value="30" <?php if (!(strcmp("40", ""))) {
                    echo "SELECTED";
                  } ?>>40h</option>
                </select>
              </div>
            ...
            <div id="medico" class="">
              <label class="ls-label col-md-3">
                <b class="ls-label-text">Funcionário com alguma deficiência?</b><br>
                <label class="ls-label-text">
                  <input type="radio" name="func_func_com_deficiencia" value="1"
                    onclick="javascript:habilita_deficiencia();" />
                  Sim </label>
                <label class="ls-label-text">
                  <input type="radio" name="func_func_com_deficiencia" value="2"
              ...
              <label class="ls-label col-md-7"><b class="ls-label-text">Descreva a deficiência:</b>
                <input type="text" name="func_tipo_deficiencia" value="" size="32" id="func_tipo_deficiencia">
              </label>
              <label class="ls-label col-md-2">
                <b class="ls-label-text">Possui Laudo Médico?</b> <br>
                <label class="ls-label-text">
                  <input type="radio" name="func_laudo" value="1" />
                  Sim </label>
                <label class="ls-label-text">
                  <input type="radio" name="func_laudo" value="2" checked />
                  Não </label>
              </label>

              <div id="deficiencia" class="" style="display:none">

                <div class="ls-label col-md-12">
                  <p>Deficiência:</p>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_bvisao" value="" /> Baixa
                    visão</label>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_cegueira" value="" />
                    Cegueira</label>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_auditiva" value="" /> Deficiência
                    auditiva</label>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_fisica" value="" /> Deficiência
                    física</label>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_intelectual" value="" />
                    Deficiência intelectual</label>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_surdez" value="" /> Sudez</label>
                  <label class="ls-label-text"><input type="checkbox" name="func_def_surdocegueira" value="" />
                    Surdocegueira</label>
                ...
                <div class="ls-label col-md-12">
                  ...
                  <label class="ls-label-text"><input type="checkbox" name="func_def_autista" value="" /> Transtorno do
                ...
                <div class="ls-label col-md-12">
                  ...
                  <label class="ls-label-text"><input type="checkbox" name="func_def_superdotacao" value="" /> Altas
              ...
              <label class="ls-label col-md-3">
                ...
                <label class="ls-label-text">
                  <input type="radio" name="func_alergia" value="1" onclick="javascript:habilita_alergia();" />
                  Sim </label>
                <label class="ls-label-text">
                  <input type="radio" name="func_alergia" value="2" onclick="javascript:desabilita_alergia();"
                    checked />
                  Não </label>
              </label>
              <label class="ls-label col-md-7"><b class="ls-label-text">Descreva a alergia/intolerância:</b>
                <input type="text" name="func_alergia_qual" value="" size="32" id="func_alergia_qual">
              </label>
              <label class="ls-label col-md-2">
                <b class="ls-label-text">Destro/Canhoto</b> <br>
                <label class="ls-label-text">
                  <input type="radio" name="func_destro" value="1" />
                  Destro </label>
                <label class="ls-label-text">
                  <input type="radio" name="func_destro" value="2" />
                  Canhoto </label>
              </label>
              ...
              <label class="ls-label col-md-6 col-xs-12">
                ...
                <div class="ls-custom-select">
                  <select name="func_grupo_sanquineo">
                    ...
                    <option value="O" <?php if (!(strcmp("O", ""))) {
                      echo "SELECTED";
                    } ?>>O</option>
                  </select>
                </div>
              ...
              <label class="ls-label col-md-6"><b class="ls-label-text">Em caso de emergência, avisar a:</b>
                <input type="text" name="func_emergencia_avisar" value="" size="32">
              </label>
              <label class="ls-label col-md-3"><b class="ls-label-text">Telefone 1:</b>
                <input type="text" name="func_emergencia_tel1" value="" size="32" class="celular">
              </label>
              <label class="ls-label col-md-3"><b class="ls-label-text">Telefone 2:</b>
                <input type="text" name="func_emergencia_tel2" value="" size="32" class="celular">
              </label>
            </div>
  ...
  <script type="text/javascript">
    ...
    function habilita_alergia() {
      document.getElementById("func_alergia_qual").disabled = false; //Habilitando
    }
    function desabilita_alergia() {
      document.getElementById("func_alergia_qual").disabled = true; //Desabilitando
    }
