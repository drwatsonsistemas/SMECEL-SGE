...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Matriz = "SELECT matriz_id, matriz_id_secretaria, matriz_id_etapa, matriz_nome, matriz_obs, matriz_anoletivo, matriz_hash, matriz_ativa FROM smc_matriz WHERE matriz_ativa = 'S' AND matriz_id_secretaria = '$row_Secretaria[sec_id]'";
$Matriz = mysql_query($query_Matriz, $SmecelNovo) or die(mysql_error());
$row_Matriz = mysql_fetch_assoc($Matriz);
$totalRows_Matriz = mysql_num_rows($Matriz);

mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Matriz2 = "SELECT matriz_id, matriz_id_secretaria, matriz_id_etapa, matriz_nome, matriz_obs, matriz_anoletivo, matriz_hash, matriz_ativa FROM smc_matriz WHERE matriz_ativa = 'N' AND matriz_id_secretaria = '$row_Secretaria[sec_id]'";
        ...
        <table class="ls-table">
          <thead>
            <tr>
              ...
              <th class="ls-txt-center" width="200">Comp. Curricular / Campos de Exp.</th>
              <th width="100"></th>
              <th width="150">Objetivos de aprendizagem e desenvolvimento</th>
              <th width="100"></th>
            </tr>
          </thead>
          <tbod>
          <?php do { ?>
            <tr>
			  ...
			  <?php 
				...
				SELECT matriz_disciplina_id, matriz_disciplina_id_matriz, matriz_disciplina_id_disciplina, disciplina_id, disciplina_nome, disciplina_cor_fundo
				...
				<?php $num = 1; do { ?>
                  <small class="ls-tag" style="background-color:<?php echo $row_MatrizDisciplinas['disciplina_cor_fundo']; ?>; margin:2px 0;"><?php echo $num; $num++; ?> - <?php echo $row_MatrizDisciplinas['disciplina_nome']; ?> </small>
                ...
                <?php } ?>
				  ...
				  <small><a href="matrizdisciplina.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-ico-plus ls-float-left">Campos de Experiência</a></small>
				  
                  <?php } else { ?>
                  
                  <small><a href="matrizdisciplina.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-ico-plus ls-float-left">Componentes Curriculares</a></small>
                  ...
                  <?php if ($row_Matriz['matriz_id_etapa'] == "1") { ?>
                  <small><a href="bncc_camp_exp_cad.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-ico-plus ls-float-left">Inserir</a></small>
                  <?php } ?>
                  </td>
          ...
          <?php do { ?>
            <tr>
			  ...
			  <?php 
				...
				FROM smc_matriz_disciplinas
				INNER JOIN smc_disciplina ON disciplina_id = matriz_disciplina_id_disciplina
				WHERE matriz_disciplina_id_matriz = '$row_Matriz2[matriz_id]'";
				...
				<?php $num1 = 1; do { ?>
                  <small class="ls-tag" style="background-color:<?php echo $row_MatrizDisciplinas2['disciplina_cor_fundo']; ?>; margin:2px 0;"><?php echo $num1; $num++; ?> - <?php echo $row_MatrizDisciplinas2['disciplina_nome']; ?> </small>
                <?php } while ($row_MatrizDisciplinas2 = mysql_fetch_assoc($MatrizDisciplinas2)); ?>
                ...
                <?php } ?>
                  ...
                  <?php if ($row_Matriz2['matriz_id_etapa'] == "1") { ?>
                  

				  <small><a href="matrizdisciplina.php?hash=<?php echo $row_Matriz2['matriz_hash']; ?>" class="ls-ico-plus ls-float-left">Campos de Experiência</a></small>
				  
                  <?php } else { ?>
                  
                  <small><a href="matrizdisciplina.php?hash=<?php echo $row_Matriz2['matriz_hash']; ?>" class="ls-ico-plus ls-float-left">Componentes Curriculares</a></small>
                  ...
                  <?php if ($row_Matriz2['matriz_id_etapa'] == "1") { ?>
                  <small><a href="bncc_camp_exp_cad.php?hash=<?php echo $row_Matriz2['matriz_hash']; ?>" class="ls-ico-plus ls-float-left">Inserir</a></small>
                  <?php } ?>
                  </td>
                  
              <td class="ls-txt-center"><a href="matriz_editar.php?matriz=<?php echo $row_Matriz2['matriz_hash']; ?>" class="ls-ico-pencil ls-float-right">Editar</a></td>
            </tr>
