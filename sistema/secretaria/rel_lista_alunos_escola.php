...
<body>
	...
	<main class="ls-main">
		<div class="container-fluid">
			<h1 class="ls-title-intro ls-ico-home">Relação de alunos por escola</h1>
			<!-- CONTEUDO -->
			...
			<?php do { ?>
				...
				WHERE  vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
