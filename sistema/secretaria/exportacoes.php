...
<body>
  ...
  <main class="ls-main">
    <div class="container-fluid">
      <h1 class="ls-title-intro ls-ico-home">EXPORTAÇÕES</h1>
      ...
      <table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
        ...
        <tbody>
          <tr>
            <td>SETE - Sistema Eletrônico de Gestão do Transporte Escolar</td>
            <td>Exportar dados dos alunos que utilizam o transporte escolar</td>
            <td><a class="ls-btn ls-color-success ls-btn-block ls-ico-multibuckets" target="_blank" href="exportacoes/exportacao_sete.php">XLSX</a></td>  
          </tr>
