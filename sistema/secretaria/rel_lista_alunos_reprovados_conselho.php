...
<body>
	...
	<main class="ls-main">
		<div class="container-fluid">
			<h1 class="ls-title-intro ls-ico-home">Relação de alunos reprovados pelo conselho de classe</h1>
			<!-- CONTEUDO -->
			...
			<div class="ls-txt-right">
				<a class="ls-btn ls-ico-windows" href="impressao/rel_lista_alunos_reprovados_conselho.php" target="_blank"> Imprimir</a>
			</div> 
			...
			<?php do { ?>
				...
				vinculo_aluno_ano_letivo, vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_conselho_reprovado,
				...
				WHERE  vinculo_aluno_situacao = '1' AND vinculo_aluno_conselho_reprovado = 'S' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
