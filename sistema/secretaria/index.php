...
WHERE turma_tipo_atendimento = '1' AND vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND escola_situacao = '1' GROUP BY vinculo_aluno_id_aluno";
...
// Consulta para alunos sem etapa vinculada
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_AlunosSemEtapa = "
SELECT COUNT(*) AS total_sem_etapa
FROM smc_vinculo_aluno
INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma
WHERE turma_etapa = 23
...
$row_AlunosSemEtapa = mysql_fetch_assoc($AlunosSemEtapa);
$total_sem_etapa = $row_AlunosSemEtapa['total_sem_etapa'];
...
vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_boletim, 
vinculo_aluno_situacao, vinculo_aluno_datatransferencia, vinculo_aluno_da_casa, vinculo_aluno_historico_transferencia, 
vinculo_aluno_vacina_atualizada, escola_id, escola_situacao, aluno_id, aluno_aluno_com_deficiencia,turma_id, turma_tipo_atendimento,turma_ano_letivo
FROM smc_vinculo_aluno
INNER JOIN smc_escola ON escola_id = vinculo_aluno_id_escola
INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma
WHERE vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND escola_situacao = '1' AND aluno_aluno_com_deficiencia = '1' AND turma_tipo_atendimento = '1'";
...
vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_boletim, 
vinculo_aluno_situacao, vinculo_aluno_datatransferencia, vinculo_aluno_da_casa, vinculo_aluno_historico_transferencia, 
vinculo_aluno_vacina_atualizada, escola_id, escola_situacao, aluno_id, aluno_aluno_com_deficiencia, aluno_laudo,turma_id, turma_tipo_atendimento,turma_ano_letivo 
FROM smc_vinculo_aluno
INNER JOIN smc_escola ON escola_id = vinculo_aluno_id_escola
INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma
WHERE vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND escola_situacao = '1' AND aluno_aluno_com_deficiencia = '1' AND aluno_laudo = '1' AND turma_tipo_atendimento = '1'";
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Atualizacoes = "SELECT atualizacoes_id, atualizacoes_painel, atualizacoes_modulo, atualizacoes_texto, atualizacoes_data 
...
$atualizacao = 'N'; // Valor padrão

if ($totalRows_Atualizacoes > 0 && $totalRows_AtualizacoesVisualizadas == 0) {
  $atualizacao = 'S'; // Apenas se o usuário ainda NÃO tiver visualizado
}
...
<body>
  ...
  <main class="ls-main">
    ...
    <div class="container-fluid">
      ...
      <?php if ($row_Secretaria['sec_aviso_bloqueio'] == "S") { ?>
        <div class="ls-alert-danger"><strong>Atenção:</strong> Existem pendências financeiras em relação ao sistema. Favor
          entrar em contato com o setor responsável.</div>
      <?php } ?>

      <?php if (isset($_GET["erro"])) { ?>
        <div class="ls-alert-danger ls-dismissable"> <span data-ls-module="dismiss" class="ls-dismiss">&times;</span>
          <strong>Ops! </strong> Isso não deveria ter acontecido. Um e-mail foi enviado ao administrador do sistema!
        </div>
      <?php } ?>
      ...
      <div class="ls-box ls-board-box">
        ...
        <div id="sending-stats" class="row ls-clearfix">
            ...
            <div class="ls-box" style="background-color:#D9FFB3;">
              ...
              <div class="ls-box-body">
                <span class="ls-board-data">
                  <strong class="ls-color-theme"><span class="count"><?php echo $totalRows_EscolasAtivas; ?></span>
                    <small>EM ATIVIDADE</small></strong>
                </span>
              </div>
              <div class="ls-box-footer">
                <?php if ($row_UsuarioLogado['usu_m_administrativo'] == "S") { ?><a href="escolas.php"
                    class="ls-btn ls-btn-xs">Listar</a><?php } ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-2" style="background-color:#FFC4C4;">
            <div class="ls-box" style="background-color:#FFC4C4;">
              ...
              <div class="ls-box-body">
                <span class="ls-board-data">
                  <strong class="ls-color-danger"><span class="count"><?php echo $totalRows_Turmas; ?></span>
                    <small>CADASTRADAS</small></strong>
                </span>
              </div>
              <div class="ls-box-footer">
                <?php if ($row_UsuarioLogado['usu_m_administrativo'] == "S") { ?><a href="turmas.php"
                    class="ls-btn ls-btn-xs">Listar</a><?php } ?>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-md-2" style="background-color:#FFE8DD;">
            <div class="ls-box" style="background-color:#FFE8DD;">
              ...
              <div class="ls-box-body">
                <span class="ls-board-data">
                  <strong class="ls-color-warning"><span class="count"><?php echo $totalRows_MatriculasAtivas; ?></span>
                    <small>ATIVAS</small></strong>
                </span>
              </div>
              <div class="ls-box-footer">
                <?php if ($row_UsuarioLogado['usu_m_administrativo'] == "S") { ?>
                  <a href="matriculas.php" class="ls-btn ls-btn-xs">Listar</a>
                <?php } ?>
                <br><br>
                <?php if ($total_sem_etapa > 0) { ?>
                  <small>Existem <?php echo $total_sem_etapa; ?> alunos em turmas multietapa sem etapa
                    vinculada.</small>
                <?php } ?>
              </div>
          ...
          <div class="col-sm-6 col-md-2" style="background-color:#DEF;">
            <div class="ls-box" style="background-color:#DEF;">
              <div class="ls-box-head">
                <h6 class="ls-title-4">PcD</h6>
              </div>
              <div class="ls-box-body">
                <span class="ls-board-data">
                  <strong class="ls-color-info"><span
                      class="count"><?php echo $totalRows_MatriculasAtivasEspeciais; ?></span>
                    <?php if ($totalRows_MatriculasAtivasEspeciais > 0) { ?><small><?php echo number_format((($totalRows_MatriculasAtivasEspeciais / $totalRows_MatriculasAtivas) * 100), 2, '.', ''); ?>%</small><?php } ?></strong>
                </span>
              </div>
              <div class="ls-box-footer">
                <small><?php echo $totalRows_MatriculasAtivasEspeciaisLaudo; ?> com laudo</small>
          ...
          <div class="col-sm-6 col-md-2" style="background-color:#D9FFD9;">
            <div class="ls-box" style="background-color:#D9FFD9;">
              <div class="ls-box-head">
                <h6 class="ls-title-4">TRANSPORTE</h6>
              </div>
              <div class="ls-box-body">
                <span class="ls-board-data">
                  <strong class="ls-color-success"><span
                      class="count"><?php echo $totalRows_MatriculasAtivasTransporteEscolar; ?></span>
                    <?php if ($totalRows_MatriculasAtivasTransporteEscolar > 0) { ?><small><?php echo number_format((($totalRows_MatriculasAtivasTransporteEscolar / $totalRows_MatriculasAtivas) * 100), 2, '.', ''); ?>%</small><?php } ?></strong>
                </span>
              </div>
              <div class="ls-box-footer">
                <!-- <?php if ($row_UsuarioLogado['usu_m_administrativo'] == "S") { ?><a href="matriculas.php" class="ls-btn ls-btn-xs">Ver Matrículas</a><?php } ?> -->
          ...
          <div class="col-sm-6 col-md-2" style="background-color:#F4F4F4;">
            <div class="ls-box" style="background-color:#F4F4F4;">
              <div class="ls-box-head">
                <h6 class="ls-title-4">SERVIDORES</h6>
              </div>
              <div class="ls-box-body">
                <span class="ls-board-data">
                  <strong class="ls-color-dark"><span class="count"><?php echo $totalRows_Funcionarios; ?></span>
                    <small>VINCULADOS</small></strong>
                </span>
              </div>
              <div class="ls-box-footer">
                <?php if ($row_UsuarioLogado['usu_m_administrativo'] == "S") { ?><a href="funcionarios_vinculados.php"
                    class="ls-btn ls-btn-xs">Listar</a><?php } ?>
              </div>
            </div>
          </div>
        ...
        <div class="ls-box ls-board-box">
          <h5 class="ls-title-3 ls-txt-center"><?php echo $contaMatriculas; ?> matrícula(s) e
            <?php echo $contaTransferencias; ?> transferência(s) realizadas nos últimos 10 dias <a
              href="matriculas_por_data.php">Ver mais...</a>
          </h5>
        ...
        <?php } else { ?>
          <div class="ls-box ls-board-box">GRÁFICO MATRÍCULAS POR ESCOLA<br><small>(Disponível após preenchimento de dados
              feito pelas Unidades Escolares)</small></div>
        <?php } ?>
        ...
        <?php if ($totalRows_MatriculasPorEtapa > 0) { ?>
          <div class="ls-box ls-board-box">
            ...
            <a href="impressao/rel_matriculas_etapa.php" target="_blank" class="ls-btn">IMPRESSÃO</a>
          </div>
        <?php } else { ?>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      Swal.fire({
        title: 'Atenção!',
        text: 'Verifique as pendências em Administrativo > Verificações administrativas.',
        icon: 'warning',
        toast: true,
        position: 'top-end',
