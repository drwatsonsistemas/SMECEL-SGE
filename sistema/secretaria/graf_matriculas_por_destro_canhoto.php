...
vinculo_aluno_vacina_data_retorno, count(*) as matriculas_total, aluno_id, aluno_sexo, aluno_destro,turma_id, turma_turno,
CASE aluno_destro
WHEN 1 THEN 'DESTRO' 
WHEN 2 THEN 'CANHOTO' 
ELSE 'SEM INFORMAÇÃO'
END AS destro_canhoto
...
GROUP BY aluno_destro 
ORDER BY aluno_destro ASC";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	<?php do { ?>
	  ...
	  ['<?php echo $row_matriculasTurno['destro_canhoto']; ?> (<?php echo $row_matriculasTurno['matriculas_total']; ?>)', <?php echo $row_matriculasTurno['matriculas_total']; ?>],
	...
	<?php } while ($row_matriculasTurno = mysql_fetch_assoc($matriculasTurno)); ?>
        ...
        var options = {
          title: 'TOTAL DE MATRÍCULAS POR CLASSIFICAÇÃO DESTRO/CANHOTO NO ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>',
		  pieHole: 0.4,
        };
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">MATRÍCULAS POR CLASSIICAÇÃO DESTRO/CANHOTO</h1>
    <!-- CONTEUDO -->
