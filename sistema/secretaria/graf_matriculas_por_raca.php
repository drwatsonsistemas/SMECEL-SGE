...
vinculo_aluno_vacina_data_retorno, count(*) as matriculas_total, aluno_id, aluno_raca, turma_id, turma_turno,
CASE aluno_raca
WHEN 1 THEN 'BRANCA' 
WHEN 2 THEN 'PRETA' 
WHEN 3 THEN 'PARDA' 
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	...
	<?php do { ?>
	  ...
	  ['<?php echo $row_matriculasTurno['raca']; ?> (<?php echo $row_matriculasTurno['matriculas_total']; ?>)', <?php echo $row_matriculasTurno['matriculas_total']; ?>],
	...
	<?php } while ($row_matriculasTurno = mysql_fetch_assoc($matriculasTurno)); ?>
        ...
        var options = {
          title: 'TOTAL DE MATRÍCULAS POR RAÇA NO ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>',
		  pieHole: 0.4,
        };
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">MATRÍCULAS POR RAÇA</h1>
    <!-- CONTEUDO -->
