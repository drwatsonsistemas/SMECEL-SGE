...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Ibge_AI = "SELECT * FROM smc_ideb_iniciais_municipio WHERE CO_MUNICIPIO = $row_Secretaria[sec_ibge_municipio]";
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Ibge_AF = "SELECT * FROM smc_ideb_finais_municipio WHERE CO_MUNICIPIO = $row_Secretaria[sec_ibge_municipio]";
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-chart-bar-up">INDICADORES IDEB</h1>
    <!-- CONTEUDO -->
    ...
    <table class="ls-table">
      ...
      <td class="ls-txt-center"><span class="ls-btn <?php if ($row_Ibge_AI['VL_OBSERVADO_2007'] > $row_Ibge_AI['VL_OBSERVADO_2005']) { ?> ls-ico-shaft-up ls-color-success<?php } else { ?> ls-ico-shaft-down ls-color-danger<?php } ?>"><?php echo $row_Ibge_AI['VL_OBSERVADO_2007']; ?></span></td>
