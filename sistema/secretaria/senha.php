...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE smc_usu SET usu_senha=%s WHERE usu_id=%s",
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">ALTERAR SENHA</h1>
    <div class="ls-box ls-board-box">
      ...
      <?php if (isset($_GET["alterada"])) { ?>
        ...
        <strong>Aviso:</strong> Senha alterada com sucesso! </div>
     <hr>
	 <?php } ?>
     ...
     <label class="ls-label col-md-3 col-sm-12">
      ...
      <div class="ls-prefix-group">
        <input type="password" maxlength="20" id="password_field" name="usu_senha" value="" required>
...
<div class="ls-actions-btn">
            <input type="submit" value="ALTERAR SENHA" class="ls-btn">
