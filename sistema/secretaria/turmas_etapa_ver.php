...
if (isset($_GET['etapa_id'])) {
    $etapa_id = anti_injection($_GET['etapa_id']);
} else {
    $red = "index.php?erro";
...
SELECT etapa_id, etapa_id_filtro, etapa_nome, 
       etapa_filtro_id, etapa_filtro_nome
FROM smc_etapa 
INNER JOIN smc_etapa_filtro ON etapa_filtro_id = etapa_id_filtro
WHERE (etapa_id BETWEEN 1 AND 25 OR etapa_id IN (36, 37, 38))
";
...
<body>
    ...
    <main class="ls-main">
        <div class="container-fluid">
            <h1 class="ls-title-intro ls-ico-home">TURMAS POR ETAPA - <?php echo $row_TurmasPorEtapaFiltro['etapa_nome'] ?></h1>

            <!-- CONTEUDO -->

            <a href="turmas.php" class="ls-btn-primary">VOLTAR</a>
            <div data-ls-module="dropdown" class="ls-dropdown">
                <a href="#" class="ls-btn-primary">ETAPA</a>

                <ul class="ls-dropdown-nav">
                    <?php do { ?>
                        <li><a
                                href="turmas_etapa_ver.php?etapa_id=<?php echo $row_TurmasPorEtapaFiltro['etapa_id']; ?>"><?php echo $row_TurmasPorEtapaFiltro['etapa_nome']; ?></a>
                        </li>
    ...
    -->
		...
		FROM smc_turma WHERE turma_etapa = '$etapa_id' AND turma_id_escola = '$row_Escolas[escola_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
