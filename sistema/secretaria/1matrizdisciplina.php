...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO smc_matriz_disciplinas (matriz_disciplina_id_matriz, matriz_disciplina_ch_ano, matriz_disciplina_reprova, matriz_disciplina_id_disciplina, matriz_disciplina_eixo) VALUES (%s, %s, %s, %s, %s)",
...
SELECT matriz_disciplina_id, matriz_disciplina_id_matriz, matriz_disciplina_id_disciplina, disciplina_cor_fundo, matriz_disciplina_ch_ano, matriz_disciplina_reprova, disciplina_id, disciplina_nome, disciplina_nome_abrev, disciplina_bncc,
  ...
  <main class="ls-main">
    <div class="container-fluid">
      ...
      <div class="ls-box ls-board-box">
        ...
        <button data-ls-module="modal" data-target="#myAwesomeModal" class="ls-btn-primary ls-ico-plus"><?php if ($row_Matriz['matriz_id_etapa'] == "1") { ?>CAMPO DE EXPERIÊNCIA<?php } else { ?>COMPONENTE CURRICULAR<?php } ?></button>

        <?php if ($row_Matriz['matriz_id_etapa'] == "1") { ?><a href="bncc_camp_exp_cad.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-btn-primary ls-ico-plus">ACOMPANHAMENTO DO PROCESSO DE APRENDIZAGEM</a><?php } ?>
        ...
        <?php if ($totalRows_ListarDisciplinas > 0) { // Show if recordset not empty ?>
          ...
          <table class="ls-table">
            ...
            <tr>
             <th><?php echo $totalRows_ListarDisciplinas ?> <?php if ($row_Matriz['matriz_id_etapa'] == "1") { ?>CAMPO(S) DE EXPERIÊNCIA(S)<?php } else { ?>COMPONENTE(S) CURRICULAR(ES)<?php } ?></th>
             <th></th>
           ...
           <?php do { ?>
            <tr>
              <td><span style="color:<?php echo $row_ListarDisciplinas['disciplina_cor_fundo']; ?>;"><?php echo $row_ListarDisciplinas['disciplina_nome']; ?></span></td>
              <td><?php if ($row_Matriz['ca_questionario_conceitos']=="S") { ?><a href="questionario_conceitos.php?matriz=<?php echo $row_Matriz['matriz_hash']; ?>&comp=<?php echo $row_ListarDisciplinas['disciplina_id']; ?>" class="ls-btn-primary ls-ico-plus ls-btn-xs">Questionário de conceitos</a><?php } else { ?><?php } ?></td>
    ...
    <?php if (isset($_GET["deletado"])) { ?>
      <div class="ls-alert-warning ls-dismissable"> <span data-ls-module="dismiss" class="ls-dismiss">&times;</span> Excluido com sucesso! </div>
    <?php } ?>
    <p>&nbsp;</p>
  </div>
</div>
...
<div class="ls-modal" id="myAwesomeModal">
  <div class="ls-modal-box ls-modal-large">
    <div class="ls-modal-header">
      ...
      <h4 class="ls-modal-title">INSERIR <?php if ($row_Matriz['matriz_id_etapa'] == "1") { ?>CAMPO DE EXPERIÊNCIA<?php } else { ?>COMPONENTE CURRICULAR<?php } ?></h4>
    </div>
    <div class="ls-modal-body" id="myModalBody">
     ...
     <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form">
      ...
      <label class="ls-label col-md-12">
        <b class="ls-label-text"><?php if ($row_Matriz['matriz_id_etapa'] == "1") { ?>CAMPO DE EXPERIÊNCIA<?php } else { ?>COMPONENTE CURRICULAR<?php } ?></b>
    ...
    <label class="ls-label col-md-12">
      <b class="ls-label-text">Componente reprova? <input type="checkbox" name="matriz_disciplina_reprova" value="S" checked></b>
