...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <div class="ls-box">
      ...
      <button data-ls-module="modal" data-target="#myAwesomeModal" class="ls-btn-primary">INCLUIR</button>
    ...
    <div class="ls-box">
      <h6 class="ls-title-4">CURSOS</h6>
       <button data-ls-module="modal" data-target="#myAwesomeModalCursos" class="ls-btn-primary">INCLUIR</button>
      <?php if ($totalRows_ListarCursos > 0) { // Show if recordset not empty ?>
          ...
          <tbody>
            <?php do { ?>
              <tr>
                ...
                <td class="ls-txt-center"><?php if ($row_ListarCursos['curso_recebe']=="S") { ; ?>SIM<?php } ?></td>
                ...
                <a class="ls-btn ls-ico-remove ls-btn-xs" href="javascript:func()" onclick="confirmaExclusaoCurso('<?php echo $row_Funcionario['func_id']; ?>','<?php echo $row_ListarCursos['curso_id']; ?>')"></a>
        ...
        <?php } else { ?>
        <span class="panel">Nenhum curso cadastrado</span>
        <?php } // Show if recordset not empty ?>
    </div>
