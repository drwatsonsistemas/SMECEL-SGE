...
func_id, func_nome, funcao_id, funcao_nome, funcao_docencia, escola_id, escola_nome 
FROM smc_vinculo
...
WHERE vinculo_id_sec = '$row_UsuarioLogado[usu_sec]' AND funcao_docencia = 'S'
";
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <a href="rel_turmas_horarios.php" class="ls-btn-primary">VOLTAR</a>
 ...
 <?php do { ?>
  <?php
	...
	WHERE ch_lotacao_professor_id = '$row_VinculosProfessor[func_id]' AND turma_id_sec = '$row_UsuarioLogado[usu_sec]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
...
<header class="ls-info-header">
    <h2 class="ls-title-3"><?php echo $row_VinculosProfessor['func_nome']; ?></h2><br> 
    <h4 class="ls-title-4"><?php echo $row_VinculosProfessor['escola_nome']; ?></h4> 
    ...
    <tbody>
	  ...
	  do { ?>
        <tr class="<?php echo $row_CargaHoraria['ch_lotacao_dia_cor']; ?>">
          ...
          <td class="ls-txt-center"><?php echo $row_CargaHoraria['ch_lotacao_aula']; ?>ª AULA</td>
