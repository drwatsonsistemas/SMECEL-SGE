...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Usuario = "SELECT usu_escola_id, usu_escola_id_usu, usu_escola_id_escola FROM smc_usu_escolas";
$Usuario = mysql_query($query_Usuario, $SmecelNovo) or die(mysql_error());
$row_Usuario = mysql_fetch_assoc($Usuario);
$totalRows_Usuario = mysql_num_rows($Usuario);

if ((isset($_GET['escola'])) && ($_GET['escola'] != "")) {
  $deleteSQL = sprintf("DELETE FROM smc_usu_escolas WHERE usu_escola_id=%s",
                       GetSQLValueString($_GET['escola'], "int"));

  mysql_select_db($database_SmecelNovo, $SmecelNovo);
  $Result1 = mysql_query($deleteSQL, $SmecelNovo) or die(mysql_error());

  $deleteGoTo = "usuario_incluir_escola.php?deletado";
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">DELETAR</h1>
