...
<body>
  ...
  <main class="ls-main">
    <div class="container-fluid">
      <h1 class="ls-title-intro ls-ico-home">PROFESSORES POR REGIME/CH</h1>
      <!-- CONTEUDO -->
      ...
      <div class="ls-box-filter">
        <form action="" class="ls-form ls-form-inline">
          ...
          <div class="ls-actions-btn">
            ...
            <a href="impressao/rel_func_professores.php?regime=<?php echo $regime; ?><?php ?>&ch=<?php echo $ch; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>
            <a href="rel_func_professores.php" class="ls-btn">LIMPAR</a>
          </div>
      ...
      <hr>
      <h3>RELAÇÃO DE PROFESSORES <?php echo $regimeTitulo; ?></h3>
      ...
      <?php if ($totalRows_FuncionariosGraduacao > 0) { // Show if recordset not empty ?>
          ...
          <tbody>
            ...
            do { ?>
              <tr>
                ...
                <td><?php echo $row_FuncionariosGraduacao['func_id']." - ".$row_FuncionariosGraduacao['func_nome']; ?></td>
                <td><?php echo $row_FuncionariosGraduacao['funcao_nome']; ?></td>
                <td><?php echo $row_FuncionariosGraduacao['regime_nome']; ?></td>
                <td><?php echo $row_FuncionariosGraduacao['func_carga_horaria_semanal']; ?></td>
              </tr>
        ...
        <p>TOTAL DE PROFESSORES: <?php echo $totalRows_FuncionariosGraduacao; ?></p>
