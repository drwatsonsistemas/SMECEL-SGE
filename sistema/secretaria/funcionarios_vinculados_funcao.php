...
if (isset($_GET['funcao'])) {
  $colname_Funcionarios = $_GET['funcao'];
}
mysql_select_db($database_SmecelNovo, $SmecelNovo);
...
vinculo_data_inicio, vinculo_obs, func_id, func_nome, func_regime, funcao_id, funcao_nome, escola_id, escola_nome,
CASE func_regime
WHEN 1 THEN 'EFETIVO'
...
FROM smc_vinculo
INNER JOIN smc_funcao ON funcao_id = vinculo_id_funcao
WHERE vinculo_id_funcao = $row_Escola[escola_id]
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <header class="ls-info-header">
      ...
      <h2 class="ls-title-3"><?php echo $row_Funcionarios['funcao_nome']; ?></h2>
    </header>
    <table class="ls-table ls-sm-space ls-table-striped">
	  ...
	  do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php echo $row_Funcionarios['escola_nome']; ?></td>
