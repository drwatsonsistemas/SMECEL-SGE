...
<body>
	...
	<main class="ls-main">
		<div class="container-fluid">
			<h1 class="ls-title-intro ls-ico-home">Relação de alunos por turma (AEE)</h1>
			<!-- CONTEUDO -->

			<div class="ls-txt-right">
				<a class="ls-btn ls-ico-windows" href="impressao/rel_lista_alunos_aee.php" target="_blank">
					Imprimir</a>
			</div>
...
WHERE vinculo_aluno_situacao = '1' AND turma_tipo_atendimento = '2' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
...
";
			...
			<div class="ls-box">
				<h3>Total de alunos do município: <?php echo $totalMunicipio; ?></h3>
			</div>
