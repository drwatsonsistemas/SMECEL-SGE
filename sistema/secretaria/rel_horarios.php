...
<?php include "../escola/fnc/exibeHorarioSecretaria.php"; ?>
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_TurmasListar = "
SELECT turma_id, turma_id_escola, turma_id_sec, turma_nome, turma_etapa, turma_turno, turma_total_alunos, turma_ano_letivo, turma_matriz_id, etapa_id, etapa_nome,
CASE turma_turno
...
WHERE turma_id_sec = '$row_UsuarioLogado[usu_sec]' AND turma_id = '$turma' 
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">GRADE DE HORÁRIOS DA TURMA</h1>
    <!-- CONTEUDO -->
    
    <a href="rel_turmas_horarios.php" class="ls-btn">VOLTAR</a>
    <hr> 

    <h2>TURMA: <?php echo $row_TurmasListar['turma_nome']; ?> - <?php echo $row_TurmasListar['turma_turno_nome']; ?></h2>
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_matriz = "SELECT matriz_id, matriz_id_secretaria, matriz_id_etapa, matriz_nome, matriz_obs, matriz_anoletivo, matriz_hash, matriz_dias_letivos, matriz_semanas_letivas, matriz_dias_semana, matriz_minutos_aula, matriz_aula_dia, matriz_criterio_avaliativo FROM smc_matriz WHERE matriz_id = $row_TurmasListar[turma_matriz_id]  ";
