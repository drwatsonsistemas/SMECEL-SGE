...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <div class="ls-box"> 
      ...
      <?php for ($mes = 1; $mes <= $meses; $mes++) { ?>
      
      <div class="col-lg-3 col-md-3 col-sm-1">
      <div class="mes">
      
        <div class="nome-mes"> <?php echo nomeMes($mes); ?> </div>
        <?php
        ...
        <?php $domingo = (date('w', strtotime($ano.'-'.$mes.'-'.$dia))); ?>
        ...
        <a href="calendario_escolar_cadastrar.php?data=<?php echo $ano."-".$mes."-".$dia; ?>" title="<?php echo $titulo." - ".$row_ListaCalendario['ce_descricao']; ?>">
        <?php } else { ?>
		...
		WHERE ce_id_sec = '$row_UsuarioLogado[usu_sec]' AND ce_tipo <> '1' AND MONTH(STR_TO_DATE(ce_data, '%Y-%m-%d')) = '$mes' AND YEAR(STR_TO_DATE(ce_data, '%Y-%m-%d')) = '$ano'";
  ...
  <div class="ls-modal-box">
    ...
    <div class="ls-modal-body" id="myModalBody">
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form">
        ...
        <input type="date" name="ce_data_de" value="" size="32" required>
        </label>

        <label class="ls-label col-md-06">
        <b class="ls-label-text">DATA FINAL</b>
        <input type="date" name="ce_data_ate" value="" size="32" required>
        </label>
