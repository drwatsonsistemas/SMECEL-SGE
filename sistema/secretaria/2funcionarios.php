		...
		$num++;
		 ?></td>
                ...
                <div class="ls-group-btn ls-group-active ls-float-right">
                  <a title="Editar dados" href="funcionarios_editar.php?cod=<?php echo $row_Funcionarios['func_id']; ?>" class="ls-btn ls-ico-pencil ls-btn-xs"></a>
                  <a title="Formação" href="titulacao_cadastrar.php?cod=<?php echo $row_Funcionarios['func_id']; ?>" class="ls-btn ls-ico-attachment ls-btn-xs"></a>
                </div>
