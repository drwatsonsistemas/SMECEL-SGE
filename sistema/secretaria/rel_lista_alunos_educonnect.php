...
<body>
	...
	<main class="ls-main">
		<div class="container-fluid">
			<h1 class="ls-title-intro ls-ico-home">Relação de alunos no Educonnect</h1>
			<!-- CONTEUDO -->

			<div class="ls-txt-right">
				<a class="ls-btn ls-ico-windows" href="impressao/rel_lista_alunos_escola.php" target="_blank"> Imprimir</a>
			</div> 
			...
			do { ?>
				...
				aluno_id, aluno_nome, aluno_nascimento, aluno_aluno_com_deficiencia, aluno_tipo_deficiencia, aluno_laudo, aluno_alergia, aluno_alergia_qual,
				aluno_aceite_termos, aluno_perfil_ativo,
				...
				WHERE turma_tipo_atendimento = '1' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
					...
					<table width="100%" class="ls-table">
						<thead>
							<tr>
								...
								<th class="ls-txt-center">TERMOS ACEITOS</th>
								<th class="ls-txt-center">PERFIL ATIVO</th>
						...
						<tbody>
							...
							<?php do { ?>
								...
								<?php 
									if ($row_ListaAlunos['aluno_aceite_termos']=="S") { 
										$totalEscola++; 
										$totalMunicipio++;
									}
								?>	
								...
								<tr>
									...
									<td class="ls-txt-center"><?php if ($row_ListaAlunos['aluno_aceite_termos']=="S") { echo "<span class=\"ls-ico-checkmark-circle ls-tag-success ls-ico-left\">SIM</span>"; } else { echo "<span class=\"ls-ico-info ls-tag-warning ls-ico-left\">NÃO</span>"; } ?></td>
									<td class="ls-txt-center"><?php if ($row_ListaAlunos['aluno_perfil_ativo']=="S") { echo "<span class=\"ls-ico-checkmark-circle ls-tag-success ls-ico-left\">SIM</span>"; } else { echo "<span class=\"ls-ico-info ls-tag-warning ls-ico-left\">NÃO</span>"; } ?></td>
							...
							<tr>
							<td colspan="6">
								<span class="ls-tag">TOTAL DE ALUNOS QUE ATIVARAM O EDUCONNECT ESCOLA: <strong><?php echo $totalEscola; ?></strong></span> 
								<span class="ls-tag">TOTAL DE ALUNOS NA ESCOLA: <strong><?php echo $totalRows_ListaAlunos; ?></strong></span></td>
							</tr>	
			...
			<span class="ls-tag-success">TOTAL DE ALUNOS QUE ATIVARAM O PERFIL NO MUNICÍPIO: <?php echo $totalMunicipio; ?></span>
