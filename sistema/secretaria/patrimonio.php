...
patrimonio_item_situacao, patrimonio_item_observacoes, patrimonio_grupo_bens_id, patrimonio_grupo_bens_descricao, COUNT(*) AS grupo_total,
...
INNER JOIN smc_escola ON escola_id = patrimonio_item_escola_id
WHERE escola_id_sec = '$row_Secretaria[sec_id]'
GROUP BY patrimonio_grupo_bens_id";
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <table class="ls-table ls-sm-space">
      ...
      <?php do { ?>
        <tr>
          <td class=""><?php echo $row_Patrimonio['patrimonio_grupo_bens_descricao']; ?></td>
          <td class="ls-txt-center"><?php echo $row_Patrimonio['grupo_total']; ?></td>
        </tr>
	...
	<a href="patrimonio_itens.php" class="ls-btn-primary">RELAÇÃO DE ÍTENS</a>
	<?php } else { ?>
