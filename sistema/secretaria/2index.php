...
WHERE vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND escola_situacao = '1'";
...
INNER JOIN smc_escola ON escola_id = vinculo_aluno_id_escola
WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND escola_situacao = '1'
...
WHERE turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND turma_id_sec = '$row_Secretaria[sec_id]' AND escola_situacao = '1'
GROUP BY etapa_id, etapa_nome, etapa_nome_abrev
ORDER BY etapa_id 
";
...
FROM smc_vinculo_aluno
INNER JOIN smc_escola ON escola_id = vinculo_aluno_id_escola
WHERE escola_ue = '1' AND vinculo_aluno_id_sec = '$row_Secretaria[sec_id]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_situacao = '1' AND escola_situacao = '1'
...
FROM smc_turma
INNER JOIN smc_escola ON escola_id = turma_id_escola  
WHERE turma_id_sec = '$row_Secretaria[sec_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND escola_situacao = '1'";
      ...
      function drawChart() {
		...
		<?php
				...
				while (strtotime($date_ini) <= strtotime($date_fim)) {
					...
					FROM smc_vinculo_aluno
					WHERE vinculo_aluno_data = '$date_ini' AND vinculo_aluno_id_sec = $row_UsuarioLogado[usu_sec]";
