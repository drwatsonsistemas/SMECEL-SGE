...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE smc_criterios_avaliativos SET ca_id_secretaria=%s, ca_descricao=%s, ca_qtd_periodos=%s, ca_qtd_av_periodos=%s, ca_nota_min_av=%s, ca_nota_max_av=%s, ca_calculo_media_periodo=%s, ca_media_min_periodo=%s, ca_arredonda_media=%s, ca_aproxima_media=%s, ca_min_pontos_aprovacao_final=%s, ca_min_media_aprovacao_final=%s, ca_nota_min_recuperacao_final=%s, ca_detalhes=%s, ca_grupo_etario=%s, ca_grupo_conceito=%s, ca_rec_paralela=%s WHERE ca_id=%s",
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_CriteriosAvaliativos = sprintf("SELECT ca_id, ca_id_secretaria, ca_descricao, ca_qtd_periodos, ca_qtd_av_periodos, ca_nota_min_av, ca_nota_max_av, ca_calculo_media_periodo, ca_media_min_periodo, ca_arredonda_media, ca_aproxima_media, ca_min_pontos_aprovacao_final, ca_min_media_aprovacao_final, ca_nota_min_recuperacao_final, ca_detalhes, ca_forma_avaliacao, ca_grupo_etario, ca_rec_paralela, ca_grupo_conceito FROM smc_criterios_avaliativos WHERE ca_id_secretaria = '$row_UsuarioLogado[usu_sec]' AND ca_id = %s", GetSQLValueString($colname_CriteriosAvaliativos, "int"));
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form">
          ...
          <input type="text" name="ca_forma_avaliacao" value="<?php if ($row_CriteriosAvaliativos['ca_forma_avaliacao']=="N") { echo "NOTA"; } else { echo "CONCEITO"; } ?>" size="32" disabled>
          </label>
