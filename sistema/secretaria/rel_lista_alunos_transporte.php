...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">Relação de alunos que utilizam transporte público</h1>
    <!-- CONTEUDO -->
<!-- 
...
<div class="ls-txt-center">
			<a class="ls-btn ls-ico-windows ls-md-margin-bottom" href="impressao/rel_lista_transporte.php" target="_blank"> Imprimir</a>
		</div> 
...
<div class="ls-box ls-box-gray">
  <h5 class="ls-title-5">Total de alunos que utilizam o transporte público<?php ; ?>: <?php echo $total_alunos; ?></h5>
  <p></p>
</div>
