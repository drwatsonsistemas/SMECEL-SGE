...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home"><?php echo $row_Matriz['matriz_nome']; ?></h1>
    <!-- CONTEUDO --> 
    
    <a href="matrizdisciplina.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-btn-primary">VOLTAR</a>
    <a target="_blank" href="bncc_camp_exp_cad_print.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-btn">IMPRIMIR</a>
    <?php do { ?>
	 ...
	 ?>
        <table class="ls-table ls-lg-space">
          <thead>
            <tr>
	   ...
	   ?>
            ...
            <tr>
              <td><a href="bncc_acomp_proc_aprendizagem.php?hash=<?php echo $colname_Matriz; ?>&campo=<?php echo $row_Objetivos['campos_exp_obj_id']; ?>" class="" title="Adicionar novo campo"><?php echo utf8_encode($row_Objetivos['campos_exp_obj_campos_exp']); ?></a></td>
              <td><a href="bncc_acomp_proc_aprendizagem.php?hash=<?php echo $colname_Matriz; ?>&campo=<?php echo $row_Objetivos['campos_exp_obj_id']; ?>" class="ls-ico-plus ls-ico-right" title="Adicionar novo campo"></a></td>
