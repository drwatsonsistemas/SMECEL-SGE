...
usu_m_ava, usu_m_administrativo, usu_m_formacao, usu_m_transporte, usu_m_merenda, usu_m_patrimonio, usu_m_relatorios, usu_m_graficos, usu_m_configuracoes
  ...
  <div class="container-fluid">
    ...
    <div class="ls-box ls-board-box">
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form-horizontal">
        ...
        <input type="text" name="usu_email" value="<?php echo htmlentities($row_Usuarios['usu_email'], ENT_COMPAT, 'utf-8'); ?>" size="32" required>
        </label>
        <label class="ls-label col-md-6">
