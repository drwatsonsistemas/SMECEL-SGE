...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <div class="ls-txt-right">
			<a class="ls-btn ls-ico-windows" href="impressao/rel_lista_alunos_deficiencia.php" target="_blank"> Imprimir</a><br>
		</div> 
<?php do { ?>
...
aluno_id, aluno_nome, aluno_nascimento, aluno_cpf, aluno_aluno_com_deficiencia, aluno_tipo_deficiencia, aluno_laudo, aluno_alergia, aluno_alergia_qual,
turma_id, turma_nome, aluno_filiacao1, aluno_filiacao2,
CASE turma_turno
...
WHERE aluno_aluno_com_deficiencia = '1' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
...
<h2><?php echo $row_EscolaLogada['escola_nome']; ?></h2>
		...
		<table width="100%" class="ls-table">
		  ...
		  <tr>
            ...
            <th class="ls-txt-center">RESPONSÁVEIS</th>
          </tr>
		  </thead>
		  <tbody>
		  <?php $num = 1; ?>
          <?php do { ?>
            <tr>
              ...
              <td><?php echo $row_ListaAlunos['aluno_cpf']; ?></td>
              ...
              <td class="ls-txt-center"><?php echo $row_ListaAlunos['aluno_filiacao1']; ?> - <?php echo $row_ListaAlunos['aluno_filiacao2']; ?></td>
            </tr>
