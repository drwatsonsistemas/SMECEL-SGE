...
func_senha, func_senha_ativa, func_carga_horaria_semanal, func_vacina_covid19,
...
CASE func_vacina_covid19 
WHEN 0 THEN 'NENHUMA DOSE'
WHEN 1 THEN '1ª DOSE'
WHEN 2 THEN '2ª DOSE'
WHEN 3 THEN 'DOSE ÚNICA'
END AS func_vacina_covid19_nome 
FROM smc_func
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">FUNCIONÁRIOS POR SITUAÇÃO VACINAL</h1>
    <!-- CONTEUDO -->
    
<div class="ls-actions-btn">
    <a href="impressao/rel_func_vacinacao.php" class="ls-btn" target="_blank">IMPRIMIR</a>
  </div>
  ...
  <table class="ls-table ls-sm-space">
    <thead>
      <tr>
        ...
        <th class="ls-txt-center">DOSE</th>
    ...
    <tbody>
	  ...
	  do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php echo $row_FuncionariosGraduacao['func_vacina_covid19_nome']; ?></td>
          <td class="ls-txt-center"><?php if (($row_FuncionariosGraduacao['func_vacina_covid19']=="2") || ($row_FuncionariosGraduacao['func_vacina_covid19']=="U")) { ?><span class="ls-ico-checkmark-circle ls-ico-right ls-color-success"></span><?php } else { ?><span class="ls-ico-info ls-ico-right ls-color-warning"></span><?php } ?></td>
        </tr>
