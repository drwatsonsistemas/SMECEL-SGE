...
<body onload="self.print();">
    ...
    <br>
    <h3 class="ls-txt-center">RELAÇÃO DE FUNCIONÁRIOS <?php echo $tituloSituacao; ?></h3>
    <br>
        ...
        <table class="bordasimples" width="100%">
          <thead>
            <tr>
              <th width="30"></th>
              <th>NOME</th>
              <th class="ls-txt-center" width="100">CPF</th>
              <th class="ls-txt-center">CARGO</th>
              <th class="ls-txt-center" width="100">REGIME</th>
            </tr>
          </thead>
          <?php 
	$num = 1;		
?>
        ...
        <br><p class="ls-txt-right"><small>SMECEL | Sistema de Gestão Escolar - www.smecel.com.br <br>Impresso em <?php echo date("d/m/Y à\s H\hi"); ?></small></p>
