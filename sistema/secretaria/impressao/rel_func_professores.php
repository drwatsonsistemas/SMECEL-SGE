...
if (isset($_GET['regime'])) {
  ...
  $regime = anti_injection($_GET['regime']);


  switch ($regime) {

    case 1:
    $regimeQry = " AND func_regime = '1' ";
    $regimeTitulo = "(EFETIVOS)";
    break;

    case 2:
    $regimeQry = " AND func_regime = '2' ";
    $regimeTitulo = "(TEMPORÁRIOS)";
    break;

    case 3:
    $regimeQry = " AND func_regime = '3' ";
    $regimeTitulo = "(COMISSIONADOS)";
    break;

    case 4:
    $regimeQry = " AND func_regime = '4' ";
    $regimeTitulo = "(NOMEADOS)";
    break;
...
if (isset($_GET['ch'])) {
  ...
  $ch = anti_injection($_GET['ch']);

  switch ($ch) {

    case 20:
    $chQry = " AND func_carga_horaria_semanal = '20' ";
    break;

    case 30:
    $chQry = " AND func_carga_horaria_semanal = '30' ";
    break;

    case 40:
    $chQry = " AND func_carga_horaria_semanal = '40' ";
    break;
...
WHERE func_id_sec = '$row_Secretaria[sec_id]' AND func_situacao = '1' AND funcao_docencia='S' $regimeQry $chQry
...
<h2 class="ls-txt-center">RELATÓRIO DE PROFESSORES</h2>
<br>
<h3 class="ls-txt-center">Dados de contato</h3>
<br>    
  ...
  <table class="bordasimples" width="100%">
    <thead>
      <tr>
        ...
        <th class="ls-txt-center" width="13%">CPF</th>
        <th class="ls-txt-center">DATA DE NASCIMENTO</th>
        <th class="ls-txt-center" width="13%">CELULAR</th>
    ...
    <tbody>
      ...
      do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php echo $row_FuncionariosGraduacao['func_nome']; ?></td>
          ...
          <td class="ls-txt-center"><?php echo date('d/m/Y', strtotime($row_FuncionariosGraduacao['func_data_nascimento'])); ?></td>
          <td class="ls-txt-center"><?php echo empty($row_FuncionariosGraduacao['func_celular1']) ? $row_FuncionariosGraduacao['func_celular2'] : $row_FuncionariosGraduacao['func_celular1']; ?></td>
          <td class="ls-txt-center"><?php echo $row_FuncionariosGraduacao['func_email']; ?></td>
          <td class="ls-txt-center"><?php echo $row_FuncionariosGraduacao['regime_nome']; ?></td>
          <td class="ls-txt-center"><?php echo $row_FuncionariosGraduacao['func_carga_horaria_semanal']; ?></td>
        </tr>
