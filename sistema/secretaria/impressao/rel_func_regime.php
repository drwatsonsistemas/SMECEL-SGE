...
<br>
<h3 class="ls-txt-center">POR REGIME E FUNÇÃO</h3>
<br>  
        ...
        <tbody>
            ...
            do { ?>
                <tr>
                    ...
                    <td><?php echo $row_FuncionariosGraduacao['func_regime_nome']; ?></td>
                </tr>
...
RELATÓRIO GERADO EM <?php echo date("d/m/Y"); ?> ÀS <?php echo date("H\hi"); ?> | SMECEL - SISTEMA DE GESTÃO ESCOLAR MUNICIPAL (www.smecel.com.br)
</small></span>
