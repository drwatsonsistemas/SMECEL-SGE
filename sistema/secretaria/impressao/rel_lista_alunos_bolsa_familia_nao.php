...
<body onload="self.print();">
    ...
    <h2 class="ls-txt-center">RELAÇÃO DE ALUNOS QUE NÃO RECEBEM BOLSA FAMÍLIA POR ESCOLA</h2>
    <br>
...
aluno_id, aluno_nome, aluno_nascimento, aluno_aluno_com_deficiencia, aluno_tipo_deficiencia, aluno_laudo, aluno_alergia, aluno_alergia_qual,aluno_recebe_bolsa_familia,
turma_id, turma_nome, 
CASE turma_turno
...
WHERE vinculo_aluno_situacao = '1' AND aluno_recebe_bolsa_familia = '0' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
