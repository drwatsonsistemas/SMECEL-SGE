...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Usuarios = "
SELECT usu_id, usu_nome, usu_email, usu_senha, usu_tipo, usu_sec, usu_escola, usu_status, usu_cadastro, usu_contato, usu_cargo, escola_id, escola_nome,
CASE usu_tipo
...
WHERE usu_sec = '$row_Secretaria[sec_id]' $tipo_query 
...
<body onload="self.print();">
    ...
    <br>
    <h3 class="ls-txt-center">Usuários do sistema</h3>
    <br>
      
      
      <table class="bordasimples ls-sm-space1" width="100%">
        <thead>
          <tr>
            <th width="30"></th>
            <th width="200">USUÁRIO</th>
            <th class="ls-txt-center">E-MAIL (login)</th>
            <th class="ls-txt-center">CONTATO</th>
            <th width="" class="ls-txt-center">PAINEL</th>
            <th width="" class="ls-txt-center">FUNÇÃO</th>
            <th width="" class="ls-txt-center">UNIDADE ESCOLAR/SETOR</th>
          </tr>
        </thead>
        <?php 
$num = 1;		
?>
		...
		$num++;
		 ?></td>
            ...
            <td class="ls-txt-center"><?php echo $row_Usuarios['usu_email']; ?></td>
            <td class="ls-txt-center" width="100"><?php echo $row_Usuarios['usu_contato']; ?></td>
            ...
            <td class="ls-txt-center"><?php echo $row_Usuarios['escola_nome']; ?></td>
          </tr>
