...
<body onload="self.print();">
    ...
    <h2 class="ls-txt-center">Relação de alunos por turma (ATIVIDADE COMPLEMENTAR)</h2>
    <br>
    <h3 class="ls-txt-center">&nbsp;</h3>
    <br>
...
";
        ...
        <?php if ($totalRows_ListaAlunos > 0) { ?>
            ...
            <br><p><strong>Total de alunos: <?php echo $totalRows_ListaAlunos; ?></strong></p>
