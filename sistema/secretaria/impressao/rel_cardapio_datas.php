...
<body onload="self.print();">
    ...
    <br>
    <h3 class="ls-txt-center ls-title-3">CARDÁPIO SEMANAL</h3>
    <br> 
    ...
    <div class="">
      ...
      <div id="sending-stats" class="row">
        ...
        <table width="100%" class="bordasimples" style="margin:10px">
        <tr>
        <?php do { ?>
        <td class="ls-txt-center" style="padding:10px">
          <?php $diasemana_numero = date('w', strtotime($row_Dias['cardapio_dia_data'])); ?>
          	
			<h2 style="border-bottom:#CCC dotted 1px; margin-bottom:5px; padding-bottom:5px"><?php echo date('d/m', strtotime($row_Dias['cardapio_dia_data'])); ?></h2>
			<h4 style="border-bottom:#CCC dotted 1px; margin-bottom:5px; padding-bottom:5px"><?php echo $diasemana[$diasemana_numero]; ?></h4>
                ...
                <?php do { ?>
                  ...
                  <li><?php echo $row_PreparacaoDia['preparacao_nome_preparacao']; ?>  </li>
