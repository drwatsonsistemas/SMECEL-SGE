...
<br>
<h3 class="ls-txt-center">TURMAS POR ESCOLA</h3>
<br>
<hr>
<br>
...
<?php
$totalGeral = 0;
$totalTurmas = 0; // Initialize totalTurmas variable outside the loop
do {
  ?>
  <?php
  mysql_select_db($database_SmecelNovo, $SmecelNovo);
  ...
  vinculo_aluno_vacina_atualizada, turma_id, turma_nome, turma_turno, turma_etapa, turma_ano_letivo,turma_tipo_atendimento, turma_total_alunos, turma_multisseriada, COUNT(*) as total, escola_id, escola_situacao,
  ...
  WHERE turma_tipo_atendimento = '1' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_id_escola = '$row_Escolas[escola_id]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_situacao = '1' AND escola_situacao = '1'
    ...
    <table class="bordasimples ls-sm-space" width="100%">
      <thead>
        <tr>
          <th width="50"></th>
          <th>TURMA</th>
          <th class="ls-txt-center" width="150">TURNO</th>
      ...
      <tbody>
        ...
        do { ?>
          <tr>
            ...
            <td class="ls-txt-center"><?php echo $row_Alunos['total']; ?></td>
          </tr>
          <?php $total = $total+$row_Alunos['total']; ?>
          <?php $totalTurmas++; ?> 
        <?php } while ($row_Alunos = mysql_fetch_assoc($Alunos)); ?>
        <tr>
          <td class="ls-txt-center" colspan="3">TOTAL DE ALUNOS</td>
...
<p>Total de matrículas no município: <?php echo $totalGeral; ?></p>
<p>Total de turmas no município: <?php echo $totalTurmas; ?></p>
