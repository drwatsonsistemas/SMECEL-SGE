...
@media print {
  /* Garante que o footer fique na parte inferior de cada página ao imprimir */
  body {
  ...
  #footer {
    ...
    text-align: center;
    padding: 10px 0;
    page-break-after: always; /* Garante que o rodapé seja repetido nas páginas */
  }
}
...
<body onload="self.print();">
    ...
    <table class="bordasimples ls-sm-space" width="100%">
      <thead>
      <tr>
        <th width="30" class="ls-txt-center"></th>
        <th width="80" class="ls-txt-center">INEP</th>
	  ...
	  do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php echo $row_Escolas['escola_endereco']; ?> <?php echo $row_Escolas['escola_num']; ?> <?php echo $row_Escolas['escola_bairro']; ?> <?php echo $row_Escolas['escola_cep']; ?></td>
          <td class="ls-txt-center"><?php echo $row_Escolas['escola_telefone1']; ?> <?php echo $row_Escolas['escola_telefone2']; ?> <?php echo $row_Escolas['escola_email']; ?> </td>
    ...
    <div id="footer">
    <p><small></small>SMECEL - SISTEMA DE GESTÃO ESCOLAR | <?php echo date("H\hi - d/m/Y"); ?> | www.smecel.com.br</small></p>
  </div>
