...
<body onload="self.print();alert('Configure a impressora para o formato PAISAGEM')">
    ...
    ";
      ...
      <tr>
	  	<td colspan="4"><i class="ls-float-right">Total de profissionais vinculados nesta etapa: <strong><?php echo $totalRows_Vinculo; ?></strong></i></td>
      </tr>


      <?php } else { ?>
      <tr>
	  	<td colspan="4">- Nenhum professor vinculado nesta etapa</td>
      </tr>
      <?php } ?>
      </tbody>
