...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO smc_funcao (funcao_secretaria_id, funcao_nome, funcao_docencia, funcao_observacoes) VALUES (%s, %s, %s, %s)",
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Funcoes = "SELECT funcao_id, funcao_secretaria_id, funcao_nome, funcao_observacoes FROM smc_funcao WHERE funcao_secretaria_id = '$row_Secretaria[sec_id]' ORDER BY funcao_nome ASC";
...
<body onload="self.print();">
    ...
    <br>
    <h3 class="ls-txt-center">RELAÇÃO DE CARGOS/FUNÇÕES</h3>
    <br>
...
?>
		...
		$num++;
		 ?></td>
            ...
            <tr>
            	<td></td>
            	<td>Total: <?php echo $totalRows_Funcoes ?></td>
            </tr>
        </table>
