...
<body onload="self.print();">
    ...
    <br>
    <h3 class="ls-txt-center">Relação de turmas por escola</h3>
    <br>
...
do { ?>
  ...
  <h2 class="ls-title-3 ls-txt-center"><?php echo $row_Escolas['escola_nome']; ?></h2>
    ...
    <tbody>
      <?php do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php echo $row_Turmas['turma_nome']; ?></td>
