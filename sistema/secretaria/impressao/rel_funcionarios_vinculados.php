...
SELECT vinculo_id, vinculo_id_escola, vinculo_id_funcionario, vinculo_id_funcao, vinculo_carga_horaria, 
vinculo_data_inicio, vinculo_obs, escola_id, escola_id_sec, escola_nome, escola_ue, func_id, func_id_sec, COUNT(*) AS total_funcionarios,
CASE escola_ue
      ...
      <table class="ls-table ls-sm-space">
		...
		do { ?>
          <tr>
            ...
            <td class="ls-txt-center"><a href="../funcionarios_vinculados_escola.php?escola=<?php echo $row_VinculosPorEscola['escola_id']; ?>"><?php echo $row_VinculosPorEscola['total_funcionarios']; ?></a></td>
          </tr>
