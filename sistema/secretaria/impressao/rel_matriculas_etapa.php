...
<head>
  ...
  <title>TOTAL DE ALUNOS POR ETAPA DE ENSINO | <?php echo $row_Secretaria['sec_prefeitura']; ?> | SMECEL - Sistema de
    Gestão Escolar</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" href="../css/footer_impressao.css">
...
<body onload="self.print();">
  ...
  <h2 class="ls-txt-center">ALUNOS POR ETAPA</h2>
  <br>
  <h3 class="ls-txt-center">ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?></h3>
  <br>
    ...
    <table class="ls-table ls-sm-space">
      ...
      <?php do { ?>
        ...
        <tr>
          ...
          $num++; ?></td>
          <td class="ls-txt-center"><?php echo $row_MatriculasPorEtapa['etapa_nome']; ?></td>
          <td class="ls-txt-center"><?php echo $row_MatriculasPorEtapa['total']; ?></td>
        </tr>

        <?php $totAlunos = $totAlunos + $row_MatriculasPorEtapa['total']; ?>

      <?php } while ($row_MatriculasPorEtapa = mysql_fetch_assoc($MatriculasPorEtapa)); ?>

      <tr>
        <td></td>
        <td class="ls-txt-right">Total de alunos:</td>
        <td class="ls-txt-center"><?php echo $totAlunos; ?></td>
      </tr>
  ...
  <div class="footer">
    <?php include_once '../footer_impressao.php'; ?>
  </div>
  <!-- CONTEUDO -->
