...
<body onload="self.print();alert('Configure a impressora para o formato PAISAGEM')">
    ...
    <br>
    <h3 class="ls-txt-center">Professores - 2º ano</h3>
    <br>  
    ...
    <table class="ls-table1 ls-sm-space bordasimples" width="100%">
	  ...
	  <?php 
		...
		WHERE ch_lotacao_disciplina_id = '$row_Componente[disciplina_id]' AND turma_id_sec = '$row_UsuarioLogado[usu_sec]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND turma_etapa = 15
		GROUP BY func_id
