...
WHERE usu_sec =  '$row_UsuarioLogado[usu_sec]' AND usu_tipo <> '99' AND usu_id = '$usuario'
...
<a href="logs.php" class="ls-btn">VOLTAR</a>
    ...
    <table class="ls-table ls-sm-space ls-table-striped ls-bg-header">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><a href="registros_usuario.php?usuario=<?php echo $row_logs['usu_id']; ?>"><?php echo $row_logs['usu_nome']; ?></a></td>
