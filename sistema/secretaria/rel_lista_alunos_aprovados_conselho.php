...
<body>
	...
	<main class="ls-main">
		<div class="container-fluid">
			<h1 class="ls-title-intro ls-ico-home">Relação de alunos aprovados pelo conselho de classe</h1>
			<!-- CONTEUDO -->

			<div class="ls-txt-left">
				<a class="ls-btn-primary" href="relatorios_alunos.php"> VOLTAR</a>
			</div>

			<div class="ls-txt-right">
				<a class="ls-btn ls-ico-windows" href="impressao/rel_lista_alunos_aprovados_conselho.php"
			...
			<?php do { ?>
				...
				vinculo_aluno_ano_letivo, vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_conselho,
				...
				WHERE  vinculo_aluno_situacao = '1' AND vinculo_aluno_conselho = 'S' AND vinculo_aluno_ano_letivo = $row_AnoLetivo[ano_letivo_ano] AND vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]' 
							...
							<?php do { ?>
								<tr>
									...
									<td class="ls-txt-center"><?php echo $row_ListaAlunos['turma_nome']; ?> -
										<?php echo $row_ListaAlunos['turma_turno_nome']; ?></td>
