...
turma_total_alunos, turma_ano_letivo, turma_multisseriada, escola_id, escola_nome  
FROM smc_turma
...
vinculo_aluno_historico_transferencia, vinculo_aluno_vacina_atualizada, vinculo_aluno_multietapa, aluno_id, aluno_cod_inep, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_cpf, 
      ...
      <table class="ls-table ls-table-striped">
		...
		?>
          <tr>
            ...
            <td class="ls-txt-left"><?php echo $row_Alunos['aluno_nome']; ?>
            
			<?php if (($row_Turma['turma_multisseriada']==1) && ($row_Alunos['vinculo_aluno_multietapa']==0)) { ?>
                    <br><i class="ls-color-danger">*informe a etapa do aluno na turma multi</i> 
					<?php } else { ?>
                    <br><b class="ls-color-success"><?php echo $row_Alunos['etapa_nome_abrev']; ?></b> 
					<?php } ?>
