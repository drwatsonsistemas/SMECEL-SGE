...
WHERE func_id_sec = '$row_Secretaria[sec_id]' AND func_situacao = '1' AND func_grupo_sanquineo <> '-1' AND func_fator_rh <> '-1' $graduacaoQry
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">FUNCIONÁRIOS POR TIPO SANGUINEO</h1>
    <!-- CONTEUDO -->

    <a href="funcionarios_vinculados.php" class="ls-btn">VOLTAR</a> 

<br><br>

<div class="ls-alert-info"><strong>Atenção:</strong> Clique sobre o nome do servidor para exibir a lista de doares compatíveis com seu tipo sanguíneo.</div>
  ...
  <table class="ls-table ls-sm-space fonte-tabela">
    <thead>
      <tr>
        <th width="50"></th>
        <th>FUNCIONÁRIO</th>
        <th class="ls-txt-center" width="150">NASCIMENTO</th>
        <th class="ls-txt-center" width="280">FILIAÇÃO</th>
    ...
    <tbody>
	  ...
	  do { ?>
        <tr>
          ...
          <td><a href="rel_func_tipo_sanguineo_compatibilidade.php?codigo=<?php echo $row_FuncionariosGraduacao['func_id']; ?>"><?php echo $row_FuncionariosGraduacao['func_nome']; ?></a></td>
