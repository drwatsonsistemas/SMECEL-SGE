...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">FUNCIONÁRIOS POR ESCOLARIDADE</h1>
    <!-- CONTEUDO -->
    
    
<div data-ls-module="dropdown" class="ls-dropdown">
  <a href="#" class="ls-btn-primary">Tipo de graduação</a>

  <ul class="ls-dropdown-nav">
      <li><a href="rel_func_graduacao.php?nivel=1">Fundamental</a></li>
      <li><a href="rel_func_graduacao.php?nivel=2">Médio</a></li>
      <li><a href="rel_func_graduacao.php?nivel=3">Graduação</a></li>
      <li><a href="rel_func_graduacao.php?nivel=4">Pós</a></li>
      <li><a href="rel_func_graduacao.php?nivel=5">Mestrado</a></li>
  </ul>
</div>
    ...
    <tbody>
	  ...
	  do { ?>
        <tr>
          ...
          <td><?php echo $row_FuncionariosGraduacao['func_escolaridade_nome']; ?></td>
        </tr>
