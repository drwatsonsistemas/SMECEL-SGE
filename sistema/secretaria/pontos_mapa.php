...
<style>
 ...
 <script src="https://maps.google.com/maps/api/js?key=AIzaSyBtM38OqsFbYPjwQEcWkWW1T6ed6heKD4Y&sensor=false"
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <script type="text/javascript">
        var locations = [
		<?php $num = 1; do { ?>
			['<?php echo substr($row_Pontos['te_ponto_descricao'],0,25); ?>',<?php echo $row_Pontos['te_ponto_latitude']; ?>, <?php echo $row_Pontos['te_ponto_longitude']; ?>, <?php echo $num; $num++; ?>],
			
			<?php 
			
			$lat = $row_Pontos['te_ponto_latitude'];
			$long = $row_Pontos['te_ponto_longitude'];
