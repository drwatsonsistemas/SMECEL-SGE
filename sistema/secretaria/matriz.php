...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO smc_matriz (matriz_id_secretaria, matriz_id_etapa, matriz_criterio_avaliativo, matriz_nome, matriz_obs, matriz_anoletivo, matriz_dias_letivos, matriz_semanas_letivas, matriz_dias_semana, matriz_minutos_aula, matriz_aula_dia, matriz_ch_professor, matriz_hash) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, '$hash')",
...
WHERE matriz_ativa = 'S' AND matriz_id_secretaria = '$row_Secretaria[sec_id]' ORDER BY matriz_anoletivo DESC, matriz_nome ASC";
                        ...
                        <td class="ls-txt-center" width="150">
                          ...
                          <a href="matrizdisciplina.php?hash=<?php echo $row_Matriz['matriz_hash']; ?>" class="ls-btn-primary ls-btn-xs ls-ico-plus" data-ls-module="popover" data-trigger="hover" data-title="DETALHES" data-content="
                            ...
                            <p>
                              ...
                              SELECT matriz_disciplina_id, matriz_disciplina_id_matriz, matriz_disciplina_id_disciplina, matriz_disciplina_ch_ano,matriz_disciplina_eixo, disciplina_id, disciplina_nome, disciplina_cor_fundo,disciplina_eixo_id, disciplina_eixo_nome
                                ...
                                <table class='ls-table ls-sm-space'>
                                  <thead>
                                    <tr>
                                     ...
                                     <th class='ls-txt-center'>EIXO</th>
                                 ...
                                 <tbody>
                                  <?php $ch = 0; $num = 1; do { ?>
                                    <tr>
                                     ...
                                     <td class='ls-txt-center'><small  style='color:<?php echo $row_MatrizDisciplinas['disciplina_cor_fundo']; ?>; margin:2px 0;'><?php if($row_MatrizDisciplinas['disciplina_eixo_id'] != ''){ echo $row_MatrizDisciplinas['disciplina_eixo_nome']; } ?></small></td>
                                ...
                                <?php if ($totalRows_MatrizDisciplinas2 > 0) { ?>
                                  <table class='ls-table ls-sm-space'>
                                    <thead>
                                      <tr>
                                       <th class='ls-txt-center'>Comp. Curricular/Campo Experiência</th>
                                       <th class='ls-txt-center' width='50px'>EIXO</th>
                                       <th class='ls-txt-center' width='80px'>C.H/ANO</th>
            ...
            <p>
              <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form-horizontal">
                ...
                <label class="ls-label col-md-12">
                  ...
                  <input type="text" name="matriz_ch_professor" value="" size="32" required>
                </label>
                <label class="ls-label col-md-12">
