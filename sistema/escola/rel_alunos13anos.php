  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">RELAÇÃO DE ALUNOS ATÉ 13 ANOS</h1>
		<!-- CONTEÚDO -->
		...
		do { ?>
		  ...
		  $num = 1;
		  do { ?>
		  	<?php if (idade($row_Alunos['aluno_nascimento']) <= 13) { 
		  ...
		  <a href="print_alunos13anos.php" class="ls-ico-paint-format ls-btn" target="_blank">Imprimir relação de alunos</a>
		  <a href="print_alunos13anosCpf.php" class="ls-ico-paint-format ls-btn" target="_blank">Imprimir relação de alunos - CPF/NIS</a>
		  </p>
