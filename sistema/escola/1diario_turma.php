    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <div class="ls-box1">
	  	...
	  	<a href="diarios_preenchidos.php?ano=<?php echo $anoLetivo; ?>" class="ls-btn ls-float-left"><span class="ls-ico-chevron-left ls-ico-right"></span>&nbsp;VOLTAR</a>
	  	<a href="print_diario_turma.php?turma=<?php echo $colname_Turma; ?>&ano=<?php echo $anoLetivo; ?>" target="_blank" class="ls-btn-primary"><span class="ls-ico-paint-format ls-ico-right"></span>&nbsp;IMPRIMIR</a>
		...
		<?php do { ?>
          ...
          <p>Turma: <strong><?php echo $row_Turma['turma_nome']; ?></strong></p>
           ...
           <table class="ls-table ls-sm-space">
            ...
            <tr>
            	...
            	<th width="20" class="ls-txt-center"></th>
          ...
          <?php do { ?>
                ...
                <a href="javascript:func()" onclick="confirmaExclusao('<?php echo $row_Aulas['plano_aula_id']; ?>','<?php echo $row_Aulas['plano_aula_hash']; ?>','<?php echo $row_Aulas['plano_aula_id_turma']; ?>','<?php echo $anoLetivo; ?>')" ><span class="ls-ico-remove ls-color-danger ls-ico-center"></span></a>
          ...
          <?php } while ($row_Aulas = mysql_fetch_assoc($Aulas)); ?>   
            ...
            <br><br><br><p class="ls-txt-center">________________________________________________________<br>Assinatura do(a) professor(a)<br><?php echo $row_AulasAss['func_nome']; ?> (<?php echo $row_AulasAss['func_id']; ?>)</p>
...
<!-- CONTEÚDO -->
  ...
  <script>
	function confirmaExclusao(aula,hash,turma,ano) {
		
		
		
     var resposta = confirm("Deseja realmente remover a aula "+aula+"? A exclusão não poderá ser desfeita.");
     	if (resposta == true) {
     	     window.location.href = "aula_deletar.php?turma="+turma+"&ano="+ano+"&aula="+hash;
    	 }
