...
aluno_id, aluno_nome, aluno_foto, turma_id, turma_nome, turma_id_escola, turma_ano_letivo,
...
WHERE vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
ORDER BY aluno_nome";
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="alert('Atenção: Configure sua impressora para o tamanho A4 e formato HORIZONTAL');self.print();">
      ...
      <div class="container-fluid1">
		...
		<span class="ls-float-left" style="margin-right:15px;">
        <img src="../../img/logo/<?php echo $row_EscolaLogada['escola_logo']; ?>" alt="" width="75px" />
        </span>
		<strong><h2><?php echo $row_EscolaLogada['escola_nome']; ?> | ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?></h2></strong><br><br>
		<strong>PROFESSOR(A): _______________________________________________________________________ </strong>&nbsp;&nbsp;
        <strong>COMPONENTE CURRICULAR: ____________________________________________________</strong><br><br>
		
		<br><br><h1 class="ls-txt-center"> <?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno']; ?> - REGISTRO DE AULAS</h1><br>
                 ...
                 <thead>
                 <tr>
                 	<th width="40px">AULA</th>
                 	<th width="80px">DATA</th>
                 	<th>CONTEÚDO PROGRAMÁTICO</th>
                 	<th>OBSERVAÇÃO</th>
                 	<th width="120px">ASSINATURA</th>
                 </tr>
                 </thead>
