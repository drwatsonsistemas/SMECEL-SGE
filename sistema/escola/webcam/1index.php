        ...
        <script type="text/javascript">
			...
			function my_completion_handler(msg) {
                if (msg.match(/(http\:\/\/\S+)/)) {
					...
					document.getElementById('nome_curso').value = msg;
                    webcam.reset();
                }
                else {
                    alert("PHP Erro: " + msg);
            ...
            <div class="ls-modal-body" id="myModalBody">
              ...
              <div class="row">
				...
				<p>
                  ...
                  <input type="hidden" id="nome_curso" name="aluno_foto" value="<?php echo htmlentities($row_AlunoFoto['aluno_foto'], ENT_COMPAT, 'UTF-8'); ?>" size="32">
