  ...
  <main class="ls-main ">
    <div class="container-fluid">
        ...
        <thead>
          <tr height="30">
            ...
            <?php for ($p = 1; $p <= $row_criteriosAvaliativos['ca_qtd_periodos']; $p++) { ?>
              ...
              colspan="<?php echo $row_criteriosAvaliativos['ca_qtd_av_periodos'] + ($row_criteriosAvaliativos['ca_rec_paralela'] == "S" ? 2 : 1); ?>"><?php echo $p; ?>ª UNIDADE
              </th>
            ...
            <tr>
              ...
              <?php for ($p = 1; $p <= $row_criteriosAvaliativos['ca_qtd_periodos']; $p++) { ?>
                ...
                if ($row_criteriosAvaliativos['ca_rec_paralela'] == "S") {
                  ...
                  <?php
                  // Se tiver nota de recuperação paralela, substitui o RU
      ...
      <div class="ls-box">
        ...
        <a href="boletimLancar.php?c=<?php echo $colname_matricula; ?>" class="ls-btn">LANÇAR NOTAS</a>
        <a href="boletimVerImprimir.php?c=<?php echo $colname_matricula; ?>" class="ls-btn" target="_blank">IMPRIMIR</a>
      </div>
      <p><a href="boletimVerAntigo.php?c=<?php echo $colname_matricula; ?>" class="ls-float-right">Ver boletim no
          formato antigo</a></p>
      <hr>
      <!-- CONTEÚDO -->
    </div>
