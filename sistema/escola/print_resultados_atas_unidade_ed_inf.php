	...
	<div style="page-break-inside: avoid;">
		...
		<div class="ls-box1 ls-txt-center ls-sm-space">
			<div class="ls-btn-group">
				<a href="?ct=<?php echo $codTurma; ?>&unidade=<?php echo $codUnidade; ?>&ano=<?php echo $anoLetivo; ?>&tipo=legenda"
					class="ls-btn <?php echo ($tipo == 'legenda') ? 'ls-btn-primary' : 'ls-btn-default'; ?>" >LEGENDAS</a>
				<a href="?ct=<?php echo $codTurma; ?>&unidade=<?php echo $codUnidade; ?>&ano=<?php echo $anoLetivo; ?>&tipo=porcentagem"
			...
			<p>
			<div style="text-align:justify; line-height:150%;"> Apuração das notas finais da
				<strong><?php echo $codUnidade; ?>ª Unidade</strong> do Ano Letivo de
			...
			<table>
					...
					<tr>
						<td class="ls-txt-left">
							...
							<span class="ls-tag-info">
								<?php echo $row_GrupoConceitosCab['conceito_itens_legenda']; ?>:
								<?php echo $row_GrupoConceitosCab['conceito_itens_descricao']; ?>
							</span>
						</td>
					</tr>
				...
				// Calcular as faixas de porcentagem
				...
				<tr>
					...
					<?php do { ?>
						<th width="" height="180px" align="center"
							...
							<div class="foo"><?php echo utf8_encode($row_CamposCab['campos_exp_nome']); ?></div>
						</th>
					...
					<tr>
						...
						<?php } else { ?>
							...
							<?php do { ?>
								...
								?>
								<td>
									<?php if ($tipo == "porcentagem") { ?>
										<?php if ($pontos > 0) {
											echo number_format((($pontos / $total) * 100), 0) . "%";
										} else {
											echo "-";
										} ?>
									<?php } else { ?>
										...
										$porcentagem = ($pontos > 0) ? number_format((($pontos / $total) * 100), 0) : 0;
