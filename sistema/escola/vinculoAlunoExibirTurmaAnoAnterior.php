...
<div class="ls-box-filter">
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
				...
				<?php do { ?>
				<li><a href="vinculoAlunoExibirTurma.php?ct=<?php echo $row_ListarTurmas['turma_id']; ?>"><?php echo $row_ListarTurmas['turma_nome']; ?> - <?php echo $row_ListarTurmas['turma_turno']; ?></a></li>
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav">
				  ...
				  <li><a href="vinculoAlunoExibirTurmaAnoAnterior.php?st=1<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Matriculados</a></li>
				  <li><a href="vinculoAlunoExibirTurmaAnoAnterior.php?st=2<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Transferidos</a></li>
				  <li><a href="vinculoAlunoExibirTurmaAnoAnterior.php?st=3<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Desistentes</a></li>
				  <li><a href="vinculoAlunoExibirTurmaAnoAnterior.php?st=4<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Falecidos</a></li>
				  <li><a href="vinculoAlunoExibirTurmaAnoAnterior.php?st=5<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Outros</a></li>
			  ...
			  <a href="vinculoAlunoExibirTurma.php" class="ls-btn ls-float-right">Voltar para a relação de alunos do Ano Letivo atual</a>
...
<div class="ls-box">
    ...
    <b class="ls-label-text">BUSQUE UM ALUNO</b>
	  ...
	  <div class="suggestionList" id="autoSuggestionsList"> </div>
		...
		aluno_id, aluno_cod_inep, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_sexo
		...
		<thead>
			<tr>
				...
				<th class="ls-txt-center" width="60px">MAT</th>
				<th class="ls-txt-center" width="120px">INEP</th>
			...
			<?php do { ?>
				<tr>
					...
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_cod_inep']; ?></td>
...
<script type="text/javascript">
	...
	function lookup(inputString) {
		if(inputString.length == 0) {
			...
			$.post("busca_aluno_anterior.php", {queryString: ""+inputString+""}, function(data){
				if(data.length > 5) {
					$('#suggestions').show();
