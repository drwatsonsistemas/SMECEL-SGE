...
<body onLoad="print()">
	...
	<div style="page-break-inside: avoid;">
		...
		<p>
			...
			<span class="ls-float-left" style="margin-right:20px;"> <img src="../../img/logo/<?php echo $row_EscolaLogada['escola_logo']; ?>" alt="" width="60px" /></span> 
			...
			<small> Aluno(a): <strong><?php echo $row_matricula['aluno_nome']; ?></strong><br>
			 ...
			 <h3 class="ls-ico-text ls-txt-center">BOLETIM ESCOLAR <?php echo $row_matricula['vinculo_aluno_ano_letivo']; ?></h3><br>
