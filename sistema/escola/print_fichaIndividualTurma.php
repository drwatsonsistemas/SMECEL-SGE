...
aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_foto,aluno_nome_social, aluno_hash, vinculo_aluno_conselho_parecer,
turma_id, turma_nome, turma_matriz_id, turma_turno, turma_etapa 
FROM 
smc_vinculo_aluno
INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma 
WHERE vinculo_aluno_situacao = '1' AND vinculo_aluno_boletim = '1' AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' $buscaTurma
...
ca_media_min_periodo, ca_arredonda_media, ca_aproxima_media, ca_min_pontos_aprovacao_final, ca_forma_avaliacao,
...
if ($row_CriteriosAvaliativos['ca_forma_avaliacao'] == "Q") {
    header('Location: print_fichaIndividualTurmaQQ.php?' . $linkBoletimQQ);
    exit;
}
         ...
         WHERE matriz_disciplina_id_matriz = '$row_AlunoBoletim[turma_matriz_id]'";
            ...
            <div style="page-break-inside: avoid;"> <br>
                ...
                <div class="ls-box1"> <span class="ls-float-right" style="margin-left:20px;">
                    ...
                    <small> Aluno(a): <strong><?php echo $row_AlunoBoletim['aluno_nome_social']!= "" ? $row_AlunoBoletim["aluno_nome_social"] : $row_AlunoBoletim["aluno_nome"]; ?></strong><br>
                ...
                <br><br><br><br>
                <h4 class="ls-txt-center">FICHA INDIVIDUAL DO ALUNO - ANO LETIVO <?= isset($_GET['ano']) && $_GET['ano'] != '' ? $_GET['ano'] :  $row_AnoLetivo['ano_letivo_ano']; ?></h4><br>
                <?php
                if ($row_CriteriosAvaliativos['ca_questionario_conceitos'] == 'N') {
                            ...
                            <tr height="30">
                                ...
                                <?php for ($p = 1; $p <= $row_CriteriosAvaliativos['ca_qtd_periodos']; $p++) { ?>
                                    <th class="ls-txt-center" style="background-color:#F5F5F5;"
                                        colspan="<?php echo $row_CriteriosAvaliativos['ca_qtd_av_periodos'] + 1; ?>">
                                        <strong><?php echo $p; ?>ª UNIDADE</strong></th>
                                <?php } ?>
                    ...
                    echo 'window.location.href = "print_fichaIndividualTurmaConceito.php?ct=' . $_GET['ct'] . '&ano='.$anoLetivo.'";';
                    echo '</script>';
                }
                ?>
                ...
                <table class="ls-table1 ls-sm-space bordasimples" width="100%">
                    ...
                    <?php if($row_AlunoBoletim['vinculo_aluno_conselho_parecer'] != ''){ ?>
                          <tr>
                        	<td colspan="2">Parecer do conselho de classe: <br><br><?php echo $row_AlunoBoletim['vinculo_aluno_conselho_parecer']; ?><br><br></td>
                        </tr>
                        <?php } ?>
                    <tr>
