...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_LoginAlunos = "
SELECT login_aluno_id, login_aluno_id_aluno, login_aluno_data_hora, login_aluno_ip, login_aluno_ano,
...
turma_nome, turma_turno, turma_id_escola,
CASE turma_turno
...
WHERE turma_id_escola = '$row_EscolaLogada[escola_id]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Login Aluno</h1>
		<!-- CONTEÚDO -->
    ...
    <tbody>
      <?php do { ?>
        <tr>
		  ...
		  <div class="row">
			<div class="col-md-2 col-sm-12">
<?php echo date('d/m/Y à\s H\hi ', strtotime($row_LoginAlunos['login_aluno_data_hora'])); ?>
			</div>
			<div class="col-md-4 col-sm-12">
<strong><?php echo $row_LoginAlunos['aluno_nome']; ?></strong>
			</div>
			<div class="col-md-4 col-sm-12">
<?php echo $row_LoginAlunos['turma_nome']; ?> - <?php echo $row_LoginAlunos['turma_turno_nome']; ?>
			</div>
			<div class="col-md-2 col-sm-12">
<?php echo $row_LoginAlunos['login_aluno_ip']; ?>
			</div>
		  </div>
