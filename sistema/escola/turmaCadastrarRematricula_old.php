...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO smc_turma (turma_id_escola, turma_id_sec, turma_matriz_id, turma_nome, turma_etapa, turma_turno, turma_ano_letivo, turma_total_alunos) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
