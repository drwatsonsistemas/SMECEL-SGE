...
func_id, func_nome, func_cpf, func_matricula, func_mae, func_pai, func_data_nascimento, funcao_id, funcao_nome 
FROM smc_vinculo 
INNER JOIN smc_func ON func_id = vinculo_id_funcionario 
INNER JOIN smc_funcao ON funcao_id = vinculo_id_funcao 
WHERE vinculo_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_status != 2 ORDER BY func_nome ASC";
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<br><br>
		<p><strong>RELAÇÃO DE FUNCIONÁRIOS</strong></p>
        ...
        <table width="100%" class="ls-sm-space ls-table-striped bordasimples">
          <thead>
            <tr>
              <th class="ls-data-descending" width="25"></th>
              <th class="ls-data-descending" width="40">MAT</th>
              <th class="ls-data-descending">NOME</th>
              <th class="ls-data-descending ls-txt-center">FILIACAO</th>
              <th class="ls-data-descending ls-txt-center">NASCIMENTO</th>
              <th class="ls-data-descending ls-txt-center" width="100">CPF</th>
            </tr>
          </thead>
          <tbody>
            <?php 
			...
			?>
              <tr>
                ...
                <td class="ls-txt-center"><?php echo $row_FuncionariosVinculados['func_matricula']; ?></td>
                <td><?php echo $row_FuncionariosVinculados['func_nome']; ?></td>
                <td class="ls-txt-center"><?php echo $row_FuncionariosVinculados['func_pai']; ?><br><?php echo $row_FuncionariosVinculados['func_mae']; ?></td>
                <td class="ls-txt-center"><?php echo date("d/m/Y", strtotime($row_FuncionariosVinculados['func_data_nascimento'])); ?></td>
