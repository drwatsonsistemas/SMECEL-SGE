...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_TurmasListar = "
SELECT turma_id, turma_id_escola, turma_nome, turma_etapa, turma_turno, turma_total_alunos, turma_ano_letivo, turma_parecer, turma_matriz_id, 
            ...
            <table class="ls-table ls-table-striped ls-sm-space">
			  ...
			  do { ?>
                  ...
                  <tr>
                    ...
                    <td class="ls-txt-center hidden-xs"><?php echo $row_TurmasListar['matriz_nome']; ?> <?php if ($row_TurmasListar['matriz_ativa']=="N") { ?><a href="#" class="ls-ico-help ls-float-right" data-trigger="hover" data-ls-module="popover" data-placement="left" data-content="Esta matriz está <strong class='ls-color-danger'>desatualizada</strong>. Clique em EDITAR TURMA e selecione a matriz correta." data-title="ATENÇÃO"></a><?php } ?></td>
