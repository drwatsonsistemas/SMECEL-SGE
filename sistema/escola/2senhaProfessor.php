...
try {
	 ...
	 <img src=\"https://www.smecel.com.br/img/logo_smecel_email.png\" width=\"150\">
	 </p>
	 "); 
  ...
  <div class="ls-modal-box ls-modal-small">
    ...
    <div class="ls-modal-body" id="myModalBody">
	  ...
	  <b class="ls-label-text">E-MAIL:</b>
		<input class="ls-field-lg" type="text" name="func_email" value="<?php echo htmlentities($row_Funcionario['func_email'], ENT_COMPAT, 'utf-8'); ?>" size="32" required>
	  <p class="ls-label-info"></p>
	  </label>
	  
	  
	  <div class="ls-actions-btn ls-group-btn ls-group-active">
      <input type="submit" value="<?php if ($row_Funcionario['func_senha_ativa']=="1") { ?>ATUALIZAR<?php } else { ?>CADASTRAR<?php } ?>" class="ls-btn-primary ls-btn-lg">
