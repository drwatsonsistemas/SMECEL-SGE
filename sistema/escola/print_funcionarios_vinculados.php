...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_FuncionariosVinculados = "SELECT vinculo_id, vinculo_id_escola, vinculo_id_funcionario, vinculo_id_funcao, vinculo_carga_horaria, vinculo_data_inicio, vinculo_obs, func_id, func_nome, func_cpf, func_matricula, funcao_id, funcao_nome FROM smc_vinculo INNER JOIN smc_func ON func_id = vinculo_id_funcionario INNER JOIN smc_funcao ON funcao_id = vinculo_id_funcao WHERE vinculo_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_status != 2 ORDER BY func_nome ASC";
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
        ...
        <table width="100%" class="ls-sm-space ls-table-striped bordasimples">
          <thead>
            <tr class="ls-page-break">
              <th class="ls-data-descending">ORD</th>
              <th class="ls-data-descending">MAT</th>
              <th class="ls-data-descending">NOME</th>
              <th class="ls-data-descending ls-txt-center">FUNÇÃO</th>
              <th class="ls-data-descending ls-txt-center">C/H</th>
              <th class="ls-data-descending ls-txt-center">CPF</th>
            </tr>
          </thead>
          <tbody>
            <?php 
