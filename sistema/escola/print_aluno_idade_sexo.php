...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>Alunos por turma/idade/sexo | SMECEL - Sistema de Gestão Escolar</title>
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS POR TURMA/IDADE/SEXO <?php echo $nomeFiltro; ?>
			</div>
		...
		aluno_id, aluno_nome, aluno_nome_social, aluno_nascimento, aluno_sexo, aluno_filiacao1, aluno_hash,
		CASE aluno_sexo
		...
		ORDER BY aluno_nascimento DESC, aluno_sexo DESC";
		...
		<thead>
			<tr>
				...
				<th width="15%" class="ls-txt-center">IDADE</th>
				<th width="40%" class="ls-txt-center">SEXO</th>
			...
			<?php do { ?>
				...
				<td><?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != "" ? $row_ExibirAlunosVinculados["aluno_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?></td>
					<td class="ls-txt-center"><?php echo idade($row_ExibirAlunosVinculados['aluno_nascimento']); ?></td>
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_sexo_nome']; ?></td>
					<td class="ls-txt-center hidden-xs"><?php echo $row_ExibirAlunosVinculados['vinculo_aluno_situacao_nome']; ?></td>
				</tr>
				<?php if ($row_ExibirAlunosVinculados['aluno_sexo']==1) { $masculino++; } else { $feminino++; } ?>
		...
		<p>MASCULINO: <strong><?php echo $masculino; ?> (<?php echo number_format((($masculino/$totalRows_ExibirAlunosVinculados)*100),1); ?>%)</strong> </p>
		<p>FEMININO: <strong><?php echo $feminino; ?> (<?php echo number_format((($feminino/$totalRows_ExibirAlunosVinculados)*100),1); ?>%)</strong></p>
