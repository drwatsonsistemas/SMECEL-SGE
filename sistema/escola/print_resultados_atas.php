...
vinculo_aluno_verificacao, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_nao_reprova, vinculo_aluno_multietapa, vinculo_aluno_datatransferencia, vinculo_aluno_conselho, vinculo_aluno_reprovado_faltas,
			...
			<table width="100%" class="ls-sm-space ls-table-striped bordasimples">
				...
				<?php do { ?>
					...
					<tr>
						...
						$contaAlunos++;
						?></td>
						<td width="40%" align="left"><?php echo $row_AlunoBoletim['aluno_nome_social'] != ""?$row_AlunoBoletim["aluno_nome_social"] : $row_AlunoBoletim["aluno_nome"]; ?>
							...
							<?php do { ?>
								<div style="display:none;">
									...
									<?php for ($p = 1; $p <= $row_CriteriosAvaliativos['ca_qtd_periodos']; $p++) { ?>
										...
										<?php 
										// Verifica se tem recuperação paralela para este período
