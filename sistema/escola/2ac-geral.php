...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Ac = "
SELECT ac_id, ac_id_professor, ac_id_etapa, ac_id_componente, ac_id_escola, ac_ano_letivo, ac_data_inicial, ac_data_final, 
ac_conteudo, ac_objetivo_especifico, ac_objeto_conhecimento, ac_metodologia, ac_recursos, ac_avaliacao, 
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <table class="ls-table ls-sm-space">
    ...
    <tbody>
      ...
      <div class='ls-box'>
		  <h4>UNIDADES TEMÁTICAS/EIXO/PRÁTICAS DE LINGUAGEM</h4>
