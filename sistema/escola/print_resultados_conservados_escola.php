...
WHERE vinculo_aluno_boletim = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]'
...
.foo {
	...
	-o-transform: rotate(180deg); */
      ...
      <p>
      <h2 class="ls-txt-center">RESULTADO FINAL | ANO LETIVO <?php echo $row_AlunoBoletim['vinculo_aluno_ano_letivo']; ?><BR><BR><?php echo $row_AlunoBoletim['turma_nome']; ?></h2>
				...
				<table width="100%" class="ls-sm-space ls-table-striped bordasimples" style="display:block">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['SITUAÇÃO', 'TOTAL'],
          ['APROVADOS',     <?php echo $aprovados_turma; ?>],
          ['CONSERVADOS',      <?php echo $reprovados_turma; ?>]
        ]);
