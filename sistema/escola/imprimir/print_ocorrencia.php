...
<title><?php echo $row_Ocorrencia['ocorrencia_tipo_nome']; ?> | SMECEL - Sistema de Gestão Escolar</title>
<meta charset="utf-8">
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><br><p><h1><?php echo $row_Ocorrencia['ocorrencia_tipo_nome']; ?></h1></p><br><br><br><br><br><br><br>
...
<div class="row">
  ...
  Foi registrada a <?php echo $row_Ocorrencia['ocorrencia_tipo_nome']; ?> do(a) aluno(a) <strong><?php echo $row_Matricula['aluno_nome']; ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
...
<br><br>
<p style="text-align:center">_________________________________________________________<br>Direção</p>
