...
<title>ALUNOS QUE ACESSARAM</title>
<meta charset="utf-8">
...
<?php $totalAcessaram = 0; ?>
		...
		<div class="ls-box1 ls-sm-space1">
		...
		<table class="ls-sm-space1 ls-table1 bordasimples" width="100%" style="font-size:8px;">
		<thead>
			<tr>
				<th class="ls-txt-center" width="20px">Nº</th>
				<th>ALUNO</th>
				<th width="300px" class="ls-txt-center">CONTATO</th>
                <th width="12px" class="ls-txt-center"></th>
                <th width="25px" class="ls-txt-center"></th>
			...
			mysql_select_db($database_SmecelNovo, $SmecelNovo);
			$query_Acessos = "SELECT login_aluno_id, login_aluno_id_aluno, login_aluno_data_hora, login_aluno_ip FROM smc_login_aluno WHERE login_aluno_id_aluno = '$row_ExibirAlunosVinculados[aluno_id]'";
			...
			?>
				...
				<tr style="border-bottom:black solid 1 px;">
					...
					<td><small><strong><?php echo $row_ExibirAlunosVinculados['aluno_nome']; ?></strong></small><br>
				    ...
				    <td class="ls-txt-center"><?php if ($totalRows_Acessos > 0) { ?> <span class="ls-ico-checkmark-circle ls-color-success"> </span><?php $totalAcessaram++; $cont++; ?><?php } else { ?> <span class="1ls-ico-cancel-circle ls-color-danger"> </span><?php } ?></td>
		...
		<small>
        Alunos vinculados na turma: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong><br>
        Alunos que acessaram o painel: <strong><?php echo $cont; ?></strong><br> 
        Percentual de acesso: <strong><?php $percAcessaramSala = ($cont * 100) / $totalRows_ExibirAlunosVinculados; ?><?php echo number_format($percAcessaramSala, 1, ',', ' '); ?>%</strong>
        </small>
