...
SELECT 
vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_ano_letivo, vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao,vinculo_aluno_situacao,
aluno_id,
aluno_cod_inep,
aluno_cpf,
aluno_nome,
...
WHERE vinculo_aluno_hash = %s AND vinculo_aluno_situacao = 1", GetSQLValueString($colname_Matricula, "text"));
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Pontos = "
SELECT te_ponto_id, te_ponto_id_sec, te_ponto_descricao, te_ponto_endereco, te_ponto_num, te_ponto_bairro, te_ponto_latitude, te_ponto_longitude, te_ponto_obs FROM smc_te_ponto
WHERE te_ponto_id_sec = '$row_UsuLogado[usu_sec]'
...
<title>ALUNOS POR PONTO | SMECEL - Sistema de Gestão Escolar</title>
<meta charset="utf-8">
...
<?php do { ?>
  <div class="ls-box">
  <h5 class="ls-title-5 ls-txt-center"><?php echo $row_Pontos['te_ponto_descricao']; ?></h5>
       ...
       <?php
		...
		aluno_id, aluno_nome, aluno_nome_social, turma_id, turma_nome, turma_turno,
		CASE turma_turno
		...
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
		INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma
		WHERE vinculo_aluno_ponto_id = '$row_Pontos[te_ponto_id]'
		AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]'
    AND vinculo_aluno_transporte = 'S'
		";
  ...
  <table class="bordasimples" width="100%">
        ...
        <tbody>
         <?php $n = 1; do { ?>
			 <tr>
			 	<td width="20" class="ls-txt-center"><?php echo $n; $n++; ?></td>
        ...
        <p class="ls-txt-center">Nenhum aluno vinculado neste ponto.</p>
