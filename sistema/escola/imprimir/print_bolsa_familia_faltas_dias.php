...
<head>
  ...
  <style>
    ...
    table.bordasimples tr td { border: 1px solid #808080; padding: 3px; font-size: 15px; font-weight: bold; }
    table.bordasimples tr th { border: 1px solid #808080; padding: 3px; font-size: 15px; }
    .assinatura-fixa { position: relative; margin-top: 50px; width: 100%; text-align: center; }
  </style>
</head>
...
<body onload="self.print();">
  <page size="A4">
    <table>
      <tr>
        <td width="20%"><?php if ($row_EscolaLogada['escola_logo'] <> "") { ?><img src="../../../img/logo/<?php echo $row_EscolaLogada['escola_logo']; ?>" width="100%" /><?php } else { ?><img src="../../../img/brasao_republica.png" width="100%" /><?php } ?></td>
        <td width="60%">
    ...
    <div class="row">
      <div class="col-xs-12">
        <p style="line-height: 180%; text-align:justify; font-size:16px;">
          Declaro para os devidos fins de localização e regularização no <strong>Projeto Presença</strong> e <strong>Bolsa Família</strong>, que
          <strong><?php if ($row_Matricula['aluno_nome_social'] == '') { echo $row_Matricula['aluno_nome']; } else { echo $row_Matricula['aluno_nome_social']; } ?></strong>,
          ...
          <?php if ($row_Matricula['aluno_nacionalidade'] == "3") { ?>estrangeiro nascido no país <strong><?php echo $row_Matricula['pais_nome']; ?></strong><?php } else { ?>natural de <strong><?php echo $row_Matricula['municipio_nome']; ?>-<?php echo $row_Matricula['municipio_sigla_uf']; ?></strong><?php } ?>,
          ...
          está devidamente matriculado(a) e frequente nesta Unidade de Ensino, cursando o <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $multietapa; ?>)</strong>, no turno <strong><?php
            switch ($row_Matricula['turma_turno']) {
              case 0: echo "INTEGRAL"; break;
              case 1: echo "MATUTINO"; break;
              case 2: echo "VESPERTINO"; break;
              case 3: echo "NOTURNO"; break;
              default: echo "-"; break;
    ...
    <p style="font-size: 12px; text-align: justify;">
      <strong>Nota:</strong> A contagem mensal de faltas apresentada acima reflete os dias em que o aluno esteve ausente em pelo menos uma aula. Cada dia com pelo menos uma falta é contado como um dia de falta, independentemente do número de aulas faltadas naquele dia.
    </p>
    ...
    <div class="row">
      <div class="col-xs-12">
        <p style="line-height: 180%; text-align:justify; font-size:16px;">Por ser verdade, assino a presente declaração.</p>
      </div>
    </div>
    <br><br><br><br>
    <div class="row">
