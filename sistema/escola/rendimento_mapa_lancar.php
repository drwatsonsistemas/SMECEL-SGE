          ...
          <thead>
            <tr class="">
              ...
              <?php for ($p = 1; $p <= $row_Criterios['ca_qtd_periodos']; $p++) { ?>
                <th colspan="<?php echo $row_Criterios['ca_qtd_av_periodos'] + ($row_Criterios['ca_rec_paralela'] == "S" ? 2 : 1); ?>"
            ...
            do { ?>
              <tr>
                ...
                <?php for ($p = 1; $p <= $row_Criterios['ca_qtd_periodos']; $p++) { ?>
                  ...
                  <?php if ($row_Criterios['ca_rec_paralela'] == "S") { ?>
                    <td width="40" class="ls-txt-center">
                      ...
                      $query_notaRecPar = "SELECT nota_id, nota_id_matricula, nota_id_disciplina, nota_periodo, nota_num_avaliacao, nota_max, nota_min, nota_valor, nota_hash 
                          FROM smc_nota 
                          WHERE nota_id_matricula = '$row_Alunos[vinculo_aluno_id]' 
                          AND nota_id_disciplina = '$row_Disciplina[disciplina_id]' 
                          AND nota_periodo = '$p' 
                  ...
                  <?php } ?>
                  <td width="10" class="ls-txt-center ls-display-none-xs" style="background-color:#F3F3F3;">
                    <span class="ls-text-md">
                      <?php 
                      $mu = mediaUnidade($ru, $row_Criterios['ca_arredonda_media'], $row_Criterios['ca_aproxima_media'], $row_Criterios['ca_media_min_periodo'], $row_Criterios['ca_calculo_media_periodo'], $row_Criterios['ca_qtd_av_periodos'], $row_Criterios['ca_digitos']); 
                ...
                <td width="10" class="ls-txt-center ls-display-none-xs">
                  <?php
