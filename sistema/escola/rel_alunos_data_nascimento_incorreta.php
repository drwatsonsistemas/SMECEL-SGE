            ...
            <?php if ($totalRows_Turmas > 0) { ?>
                ...
                do { ?>
                    ...
                    SELECT 
                        ...
                        vinculo_aluno_hash,
                        CASE 
                            WHEN aluno_nascimento IS NULL THEN 'Data NULA'
                            WHEN aluno_nascimento > CURDATE() THEN 'Data no futuro'
                            WHEN aluno_nascimento < '1900-01-01' THEN 'Data muito antiga'
                            ELSE 'Data inválida desconhecida'
                        END AS motivo_invalidez
                    FROM smc_aluno
                    INNER JOIN smc_vinculo_aluno ON aluno_id = vinculo_aluno_id_aluno
                    INNER JOIN smc_escola ON escola_id = vinculo_aluno_id_escola
                    WHERE 
                        vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]'
                        AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
                        AND vinculo_aluno_id_turma = '$row_Turmas[turma_id]'
                        AND (
                            aluno_nascimento IS NULL
                            OR aluno_nascimento > CURDATE()
                            OR aluno_nascimento < '1900-01-01'
                        )
                    ORDER BY aluno_nome;
                    ";
                        ...
                        <table class="ls-table ls-sm-space">
                            <thead>
                                <tr>
                                    ...
                                    <th width="100px" class="ls-txt-center">DATA NASCIMENTO</th>
                                    <th width="100px" class="ls-txt-center">PROBLEMA</th>
                                        ...
                                        <td class="ls-txt-center">
                                            <a href="matriculaExibe.php?cmatricula=<?php echo $row_Alunos['vinculo_aluno_hash']; ?>" 
                                               ...
                                               rel="noopener noreferrer">
                                                <?php echo str_pad($row_Alunos['aluno_id'], 5, '0', STR_PAD_LEFT); ?>
                                            </a>
                                        </td>
                                        <td><?php echo $row_Alunos['aluno_nome']; ?></td>
                                        <td class="ls-txt-center">
                                            <?php echo date('d/m/Y', strtotime($row_Alunos['aluno_nascimento'])); ?>
                                        </td>
                                        <td class="ls-txt-center">
                                            <span class="ls-tag ls-tag-danger">
                                                <?php echo $row_Alunos['motivo_invalidez']; ?>
                                            </span>
                                        </td>
                                        <td class="ls-txt-center">
