...
SELECT 
	...
	func_id, func_nome, disciplina_id, disciplina_nome, disciplina_nome_abrev 
FROM 
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="alert('Atenção: Configure sua impressora para o formato RETRATO');self.print();">
      ...
      <h4 class="ls-txt-center">PARECER DA TURMA | ANO LETIVO <?php echo $row_Turma['turma_ano_letivo']; ?></h4>	  
        ...
        <h4>Professores da turma</h4><br>

        <?php do { ?>
        
          <p><small><?php echo $row_Vinculos['func_nome']; ?> - (<?php echo $row_Vinculos['ch_lotacao_professor_id']; ?>) <span class="ls-txt-right">_______________________________________________________ </span></small></p>
