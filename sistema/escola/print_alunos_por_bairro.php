...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
	...
	<body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<p><?php echo $row_ExibirTurmas['turma_nome']; ?> <?php echo $row_ExibirTurmas['turma_turno']; ?>  (<?php echo $nomeFiltro; ?>)</p>
		</div>	
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_localizacao, aluno_endereco, aluno_numero, aluno_bairro, aluno_nome_social,aluno_filiacao1, aluno_hash
		...
		<h5 class="ls-title-5 ls-txt-center"><?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno']; ?> - MORADORES DA ZONA <?php if ($zona=="1") { echo "URBANA"; } else { echo "RURAL"; } ?></h5>
		...
		<thead>
			<tr>
				...
				<th width="">ALUNO</th>
				<th width="" class="ls-txt-center">ENDEREÇO</th>
			</tr>
			<tbody>
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-left"><?php echo $row_ExibirAlunosVinculados['aluno_bairro']; ?> - <?php echo $row_ExibirAlunosVinculados['aluno_endereco']; ?> <?php echo $row_ExibirAlunosVinculados['aluno_numero']; ?> </td>
				</tr>
