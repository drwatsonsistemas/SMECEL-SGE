...
vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_id_sec, vinculo_aluno_ano_letivo,vinculo_aluno_reprovado_faltas, 
vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_boletim, 
vinculo_aluno_situacao, vinculo_aluno_datatransferencia, vinculo_aluno_da_casa, vinculo_aluno_historico_transferencia, vinculo_aluno_rel_aval,
vinculo_aluno_vacina_atualizada, aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_foto, turma_id, turma_nome 
...
<body onload="self.print();">
  <div class="container-fluid">
    ...
    <span class="ls-txt-center"><a href="#" onClick="window.print()"
        class="ls-txt-center ls-btn-danger hidden-print">IMPRIMIR</a></span>
    ...
    <div style="page-break-inside: avoid;" class="ls-box1 ls-txt-center" align="center"> <br>
      ...
      <h1 style="font-size:56px; margin-bottom: 20px;"><span style="border-bottom: solid 5px black">DIÁRIO DE
          CLASSE</span></h1>
      <br>
      <h1>TURMA <?php echo $row_matricula['turma_nome']; ?></h1>
      <br>
      <br>
      <br>
    ...
    <?php do { ?>
      ...
      <div style="page-break-before: always;">
        ...
        <p class="ls-ico-text ls-txt-center">RENDIMENTO ESCOLAR <?php echo $row_matricula['vinculo_aluno_ano_letivo']; ?>
        </p>
          ...
          <table class="ls-table bordasimples ls-bg-header">
            ...
            <tbody>
              ...
              <tr>
                ...
                ?>
                <?php for ($i = 1; $i <= $row_criteriosAvaliativos['ca_qtd_periodos']; $i++) { ?>
                  <td width="50" class="ls-txt-center">
                    <small><?php $res = number_format((($tot[$i] / ($row_criteriosAvaliativos['ca_qtd_periodos'] * $totalRows_Acompanhamento)) * 100), 1); ?><strong><?php if ($res == 0) {
                                 echo "-";
                               } else {
                                 echo $res . "%";
                               } ?></strong></small>
  ...
  WHERE p_ind_mat_aluno = '$row_matricula[vinculo_aluno_id]' ORDER BY p_ind_periodo ASC";
      ...
      <div class="ls-box">
        ...
        <h5 class="ls-title-5">Parecer</h5>
        <?php echo str_replace($procurar, $buscar, $row_matricula['vinculo_aluno_rel_aval']); ?>
        ...
        <table class="ls-table">
          ...
          if ($totalRows_parecer > 0) {
            do { ?>
              <tr>
                <td><strong><?php echo $row_parecer['p_ind_periodo']; ?>º período |
                    <?php echo $row_parecer['func_nome']; ?></strong><br><br><?php echo str_replace($procurar, $buscar, $row_parecer['p_ind_texto']); ?>
                </td>
              </tr>
      ...
      <?php do { ?>
        ...
        <div style="display:block; height:60px; padding: 20px; width:100%; margin: 20px 0;" class="ls-txt-center">
          ...
          <?php echo $row_Funcionarios['ch_lotacao_professor_id'] ?></b> - <?php echo $row_Funcionarios['func_nome'] ?><br>
          Professor(a)
