...
vinculo_aluno_verificacao, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_multietapa, vinculo_aluno_datatransferencia, vinculo_aluno_conselho,
...
echo strftime('Aos %d dias do mês de %B do ano de %Y', strtotime($row_AnoLetivoDesc['ano_letivo_fim']));
		  ...
		  <?php do { ?>
		   ...
		   <tr>
			...
			?>
				...
				<td width="40%" align="left"><?php echo $row_AlunoBoletim['aluno_nome']; ?> <?php if ($row_AlunoBoletim['vinculo_aluno_conselho']=="S") { ?>*<?php } ?>
