  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Pautas por professor</h1>
	...
	<input type="text" class="buscar-funcionario" alt="fonte-tabela" placeholder="Digite o nome ou parte do nome de um funcionário" autofocus/>
		...
		<table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
          ...
          <tr>
            ...
            <th>PROFESSOR(A)</th>
            <th class="ls-txt-center">VER PAUTAS</th>
          </tr>
          </thead>
           <tbody>
           <?php
		   ...
		   ?>
            ...
            <tr>
			  ...
			  <td class="ls-txt-center"><a href="pauta_professor.php?codigo=<?php echo $row_ListaVinculos['func_id']; ?>">Ver</a></td>
            </tr>
