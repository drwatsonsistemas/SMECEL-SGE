...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  // Remover máscaras dos campos com números
  ...
  $cpf_responsavel = preg_replace('/[^0-9]/', '', $_POST['aluno_cpf_responsavel_legal']);
  ...
  $nis = preg_replace('/[^0-9]/', '', $_POST['aluno_nis']);
  $nis_mae = preg_replace('/[^0-9]/', '', $_POST['aluno_nis_mae']);
  $nis_pai = preg_replace('/[^0-9]/', '', $_POST['aluno_nis_pai']);
  $sus = preg_replace('/[^0-9]/', '', $_POST['aluno_sus']);
  $sus_mae = preg_replace('/[^0-9]/', '', $_POST['aluno_sus_mae']);
  $sus_pai = preg_replace('/[^0-9]/', '', $_POST['aluno_sus_pai']);
  ...
  // Montar a query de atualização com os valores limpos
  $updateSQL = sprintf("UPDATE smc_aluno SET aluno_cod_inep=%s, aluno_cpf=%s, aluno_nome=%s, aluno_nascimento=%s, aluno_filiacao1=%s, aluno_filiacao2=%s, 
    ...
    aluno_def_autista=%s, aluno_def_superdotacao=%s, aluno_sangue_tipo=%s, aluno_sangue_rh=%s, aluno_nome_responsavel_legal=%s, aluno_cpf_responsavel_legal=%s, aluno_grau_responsavel_legal=%s, aluno_observacao=%s, aluno_nis_mae=%s, aluno_sus_mae=%s, aluno_nis_pai=%s, aluno_sus_pai=%s, aluno_cid=%s, aluno_nome_social=%s, aluno_rg_responsavel_legal=%s, aluno_nis_responsavel_legal=%s, aluno_sus_responsavel_legal=%s
    WHERE aluno_id=%s",
    GetSQLValueString($_POST['aluno_cod_inep'], "text"),
    GetSQLValueString($cpf, "text"),  // CPF limpo
    ...
    GetSQLValueString($nis, "text"),  // NIS limpo
    ...
    GetSQLValueString($cep, "text"),  // CEP limpo
    ...
    GetSQLValueString($telefone, "text"),  // Telefone limpo
    GetSQLValueString($celular, "text"),  // Celular limpo
    GetSQLValueString($_POST['aluno_email'], "text"),
    GetSQLValueString($sus, "text"),  // SUS limpo
    ...
    GetSQLValueString($emergencia_tel1, "text"),  // Telefone emergência 1 limpo
    GetSQLValueString($emergencia_tel2, "text"),  // Telefone emergência 2 limpo
    GetSQLValueString($_POST['aluno_prof_mae'], "text"),
    GetSQLValueString($tel_mae, "text"),  // Telefone mãe limpo
    GetSQLValueString($_POST['aluno_escolaridade_mae'], "int"),
    GetSQLValueString($_POST['aluno_rg_mae'], "text"),
    GetSQLValueString($cpf_mae, "text"),  // CPF mãe limpo
    GetSQLValueString($_POST['aluno_prof_pai'], "text"),
    GetSQLValueString($tel_pai, "text"),  // Telefone pai limpo
    GetSQLValueString($_POST['aluno_escolaridade_pai'], "int"),
    GetSQLValueString($_POST['aluno_rg_pai'], "text"),
    GetSQLValueString($cpf_pai, "text"),  // CPF pai limpo
    ...
    GetSQLValueString($cpf_responsavel, "text"),  // CPF responsável limpo
    GetSQLValueString($_POST['aluno_grau_responsavel_legal'], "int"),
    GetSQLValueString($_POST['aluno_observacao'], "text"),
    GetSQLValueString($nis_mae, "text"),  // NIS mãe limpo
    GetSQLValueString($sus_mae, "text"),  // SUS mãe limpo
    GetSQLValueString($nis_pai, "text"),  // NIS pai limpo
    GetSQLValueString($sus_pai, "text"),  // SUS pai limpo
    GetSQLValueString($_POST['aluno_cid'], "text"),
    GetSQLValueString($_POST['aluno_nome_social'], "text"),
    GetSQLValueString($rg_responsavel_legal, "text"), // Novo campo
    GetSQLValueString($nis_responsavel_legal, "text"), // Novo campo
    GetSQLValueString($sus_responsavel_legal, "text"), // Novo campo
...
$query_alunoEditar = sprintf("
  ...
  municipio_id, municipio_cod_ibge, municipio_nome, municipio_sigla_uf, aluno_rg_responsavel_legal, aluno_nis_responsavel_legal, aluno_sus_responsavel_legal
  FROM smc_aluno 
        ...
        <fieldset>
          <div id="ident" class="ls-box ls-box-gray">
            ...
            <div class="row">
              <label class="ls-label col-md-12">
                ...
                <input type="text" name="aluno_cod_inep"
              ...
              <label class="ls-label col-md-6">
                ...
                <label class="ls-label-text">
                  <input type="checkbox" name="usar_nome_social" id="usar_nome_social" <?php echo ($row_alunoEditar['aluno_nome_social'] != '') ? 'checked' : ''; ?> onchange="toggleNomeSocial()">
                  Usar Nome Social
                  <a href="#" class="ls-ico-help" data-ls-popover="open" data-trigger="hover" data-ls-module="popover"
                    data-placement="top"
                ...
                <input type="text" name="aluno_nome_social" id="nome_social_input"
                  value="<?php echo htmlentities($row_alunoEditar['aluno_nome_social'], ENT_COMPAT, 'utf-8'); ?>"
                  maxlength="255" style="margin-top: 5px;" <?php echo ($row_alunoEditar['aluno_nome_social'] == '') ? 'disabled' : ''; ?>>
              </label>
            </div>
            <div class="row">
              <label class="ls-label col-md-3">
                <b class="ls-label-text">Data de Nascimento</b>
                <input type="text" name="aluno_nascimento"
                  value="<?php echo htmlentities(inverteData($row_alunoEditar['aluno_nascimento']), ENT_COMPAT, 'utf-8'); ?>"
                  maxlength="10" class="date" required>
              </label>
              <label class="ls-label col-md-3">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_uf_nascimento" id="aluno_uf_nascimento" required>
                    ...
                    foreach ($ufs as $uf) {
                      ...
                      if ($row_alunoEditar['aluno_uf_nascimento'] == $uf)
                        echo " SELECTED";
                      echo ">$uf</option>";
                    }
                    ?>
              ...
              <label class="ls-label col-md-6">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_municipio_nascimento_ibge" id="aluno_municipio_nascimento_ibge" class="ls-select"
                    required data-cidade-salva="<?php echo $row_alunoEditar['aluno_municipio_nascimento_ibge']; ?>">
                    <option value="<?php echo $row_alunoEditar['aluno_municipio_nascimento_ibge'] ?>">
                      <?php echo $row_alunoEditar['municipio_nome']; ?> -
                      <?php echo $row_alunoEditar['municipio_sigla_uf']; ?>
                    </option>
                  </select>
                </div>
              </label>
              ...
              <label class="ls-label col-md-3">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_sexo" required>
                    <option value="">Escolha...</option>
                    <option value="1" <?php if ($row_alunoEditar['aluno_sexo'] == "1")
                      echo "SELECTED"; ?>>Masculino
                    </option>
                    <option value="2" <?php if ($row_alunoEditar['aluno_sexo'] == "2")
              ...
              <label class="ls-label col-md-3">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_raca" required>
                    <option value="">Escolha...</option>
                    <option value="1" <?php if ($row_alunoEditar['aluno_raca'] == "1")
                      echo "SELECTED"; ?>>Branca</option>
                    <option value="2" <?php if ($row_alunoEditar['aluno_raca'] == "2")
                      echo "SELECTED"; ?>>Preta</option>
                    <option value="3" <?php if ($row_alunoEditar['aluno_raca'] == "3")
                      echo "SELECTED"; ?>>Parda</option>
                    <option value="4" <?php if ($row_alunoEditar['aluno_raca'] == "4")
                      echo "SELECTED"; ?>>Amarela
                    </option>
                    <option value="5" <?php if ($row_alunoEditar['aluno_raca'] == "5")
                      echo "SELECTED"; ?>>Indígena
                    </option>
                    <option value="6" <?php if ($row_alunoEditar['aluno_raca'] == "6")
                      echo "SELECTED"; ?>>Não declarada
                    </option>
                  </select>
                </div>
              </label>
              <label class="ls-label col-md-3">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_nacionalidade" id="aluno_nacionalidade">
                    <option value="1" <?php if ($row_alunoEditar['aluno_nacionalidade'] == "1")
                      echo "SELECTED"; ?>>
                      Brasileira</option>
                    <option value="2" <?php if ($row_alunoEditar['aluno_nacionalidade'] == "2")
                      echo "SELECTED"; ?>>
                      Brasileira - Nascido no exterior ou naturalizado</option>
                    <option value="3" <?php if ($row_alunoEditar['aluno_nacionalidade'] == "3")
                      echo "SELECTED"; ?>>
                      Estrangeira</option>
                  </select>
                </div>
              ...
              <label class="ls-label col-md-3">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_pais" id="aluno_pais" required>
                    <?php do { ?>
                      <option value="<?php echo $row_paises['pais_cod'] ?>" <?php if ($row_paises['pais_cod'] == $row_alunoEditar['aluno_pais'])
                           echo "SELECTED"; ?>>
          ...
          <div id="filia" class="ls-box ls-box-gray">
            ...
            <label class="ls-label col-md-4">
              ...
              <input type="text" name="aluno_filiacao1"
                value="<?php echo htmlentities($row_alunoEditar['aluno_filiacao1'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255" required>
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">Profissão da mãe:</b>
              <input type="text" name="aluno_prof_mae"
                value="<?php echo htmlentities($row_alunoEditar['aluno_prof_mae'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="64">
            </label>
            <label class="ls-label col-md-2">
              <b class="ls-label-text">Telefone da mãe:</b>
              <input type="text" name="aluno_tel_mae" class="celular"
                value="<?php echo htmlentities($row_alunoEditar['aluno_tel_mae'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-3">
            ...
            <label class="ls-label col-md-3">
              ...
              <input type="text" name="aluno_rg_mae"
                value="<?php echo htmlentities($row_alunoEditar['aluno_rg_mae'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">CPF da mãe:</b>
              <input type="text" name="aluno_cpf_mae"
                value="<?php echo htmlentities($row_alunoEditar['aluno_cpf_mae'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="20" onblur="javascript: validarCPF(this);" onkeypress="javascript: mascara(this, cpf_mask);"
                class="cpf">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">NIS da mãe:</b>
              <input type="text" name="aluno_nis_mae"
                value="<?php echo htmlentities($row_alunoEditar['aluno_nis_mae'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">SUS da mãe:</b>
              <input type="text" name="aluno_sus_mae"
                value="<?php echo htmlentities($row_alunoEditar['aluno_sus_mae'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-4">
              <b class="ls-label-text">Filiação 2:</b>
              <input type="text" name="aluno_filiacao2"
                value="<?php echo htmlentities($row_alunoEditar['aluno_filiacao2'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">Profissão do pai:</b>
              <input type="text" name="aluno_prof_pai"
                value="<?php echo htmlentities($row_alunoEditar['aluno_prof_pai'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="64">
            </label>
            <label class="ls-label col-md-2">
              <b class="ls-label-text">Telefone do pai:</b>
              <input type="text" name="aluno_tel_pai" class="celular"
                value="<?php echo htmlentities($row_alunoEditar['aluno_tel_pai'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-3">
            ...
            <label class="ls-label col-md-3">
              ...
              <input type="text" name="aluno_rg_pai"
                value="<?php echo htmlentities($row_alunoEditar['aluno_rg_pai'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">CPF do pai:</b>
              <input type="text" name="aluno_cpf_pai"
                value="<?php echo htmlentities($row_alunoEditar['aluno_cpf_pai'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32" onblur="javascript: validarCPF(this);" onkeypress="javascript: mascara(this, cpf_mask);"
                class="cpf">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">NIS do pai:</b>
              <input type="text" name="aluno_nis_pai"
                value="<?php echo htmlentities($row_alunoEditar['aluno_nis_pai'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="15">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">SUS do pai:</b>
              <input type="text" name="aluno_sus_pai"
                value="<?php echo htmlentities($row_alunoEditar['aluno_sus_pai'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="32">
            </label>
            <label class="ls-label col-md-12">
          ...
          <div id="responsavel" class="ls-box ls-box-gray">
            ...
            <div class="row">
              ...
              <label class="ls-label col-md-3">
                ...
                <input type="text" name="aluno_cpf_responsavel_legal"
                  value="<?php echo htmlentities($row_alunoEditar['aluno_cpf_responsavel_legal'], ENT_COMPAT, 'utf-8'); ?>"
                  maxlength="32" onblur="javascript: validarCPF(this);"
            ...
            <div class="row">
              <label class="ls-label col-md-4">
                ...
                <input type="text" name="aluno_rg_responsavel_legal"
                  value="<?php echo htmlentities($row_alunoEditar['aluno_rg_responsavel_legal'], ENT_COMPAT, 'utf-8'); ?>"
                  maxlength="32">
              </label>
              <label class="ls-label col-md-4">
                <b class="ls-label-text">NIS do responsável legal:</b>
                <input type="text" name="aluno_nis_responsavel_legal"
                  value="<?php echo htmlentities($row_alunoEditar['aluno_nis_responsavel_legal'], ENT_COMPAT, 'utf-8'); ?>"
                  maxlength="15">
              </label>
              <label class="ls-label col-md-4">
                <b class="ls-label-text">SUS do responsável legal:</b>
                <input type="text" name="aluno_sus_responsavel_legal"
                  value="<?php echo htmlentities($row_alunoEditar['aluno_sus_responsavel_legal'], ENT_COMPAT, 'utf-8'); ?>"
                  maxlength="32">
              </label>
            </div>
          </div>
          <div id="docum" class="ls-box ls-box-gray">
            ...
            <label class="ls-label col-md-6">
              ...
              <input type="text" name="aluno_cpf"
                value="<?php echo htmlentities($row_alunoEditar['aluno_cpf'], ENT_COMPAT, 'utf-8'); ?>" maxlength="32"
                onblur="javascript: validarCPF(this);" onkeypress="javascript: mascara(this, cpf_mask);" class="cpf">
            </label>
            <label class="ls-label col-md-6">
              <b class="ls-label-text">NIS:</b>
              <input type="text" name="aluno_nis"
                value="<?php echo htmlentities($row_alunoEditar['aluno_nis'], ENT_COMPAT, 'utf-8'); ?>" maxlength="32"
                class="nis">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">Cartão do SUS:</b>
              <input type="text" name="aluno_sus"
                value="<?php echo htmlentities($row_alunoEditar['aluno_sus'], ENT_COMPAT, 'utf-8'); ?>" maxlength="32"
                class="sus">
            </label>
            <label class="ls-label col-md-3">
            ...
            <label class="ls-label col-md-2">
              ...
              <input type="text" name="aluno_emissor"
                value="<?php echo htmlentities($row_alunoEditar['aluno_emissor'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="16">
            </label>
            <label class="ls-label col-md-2">
              ...
              <div class="ls-custom-select">
                <select name="aluno_uf_emissor">
                  ...
                  foreach ($ufs as $uf) {
                    echo "<option value='$uf'";
                    if ($row_alunoEditar['aluno_uf_emissor'] == $uf)
                      echo " SELECTED";
                    echo ">$uf</option>";
                  }
                  ?>
            ...
            <label class="ls-label col-md-2">
              ...
              <input type="text" name="aluno_data_espedicao"
            ...
            <label class="ls-label col-md-2">
              <b class="ls-label-text">Termo:</b>
              <input type="text" name="aluno_termo" id="aluno_termo"
                value="<?php echo htmlentities($row_alunoEditar['aluno_termo'], ENT_COMPAT, 'utf-8'); ?>" maxlength="8">
            </label>
            <label class="ls-label col-md-2">
              <b class="ls-label-text">Folhas:</b>
              <input type="text" name="aluno_folhas" id="aluno_folhas"
                value="<?php echo htmlentities($row_alunoEditar['aluno_folhas'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="6">
            </label>
            <label class="ls-label col-md-2">
              <b class="ls-label-text">Livro:</b>
              <input type="text" name="aluno_livro" id="aluno_livro"
                value="<?php echo htmlentities($row_alunoEditar['aluno_livro'], ENT_COMPAT, 'utf-8'); ?>" maxlength="6">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">Emissão:</b>
              <input type="text" name="aluno_emissao_certidao" id="aluno_emissao_certidao"
            ...
            <label class="ls-label col-md-2">
              ...
              <div class="ls-custom-select">
                <select name="aluno_uf_cartorio" id="aluno_uf_cartorio">
                  ...
                  foreach ($ufs as $uf) {
                    echo "<option value='$uf'";
                    if ($row_alunoEditar['aluno_uf_cartorio'] == $uf)
                      echo " SELECTED";
                    echo ">$uf</option>";
                  }
                  ?>
            ...
            <label class="ls-label col-md-6">
              <b class="ls-label-text">Nome do Cartório:</b>
            ...
            <label class="ls-label col-md-12">
              <b class="ls-label-text">Matrícula Modelo Novo:</b>
          ...
          <div id="local" class="ls-box ls-box-gray">
            ...
            <label class="ls-label col-md-2">
              ...
              <input type="text" name="aluno_cep" id="aluno_cep"
                value="<?php echo htmlentities($row_alunoEditar['aluno_cep'], ENT_COMPAT, 'utf-8'); ?>" maxlength="10"
                class="cep">
            </label>
            <label class="ls-label col-md-6">
              <b class="ls-label-text">Endereço:</b>
              <input type="text" name="aluno_endereco" id="aluno_endereco"
                value="<?php echo htmlentities($row_alunoEditar['aluno_endereco'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255">
            </label>
            <label class="ls-label col-md-2">
              <b class="ls-label-text">Número:</b>
              <input type="text" name="aluno_numero" id="aluno_numero"
                value="<?php echo htmlentities($row_alunoEditar['aluno_numero'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="8">
            </label>
            <label class="ls-label col-md-3">
            ...
            <label class="ls-label col-md-3">
              ...
              <input type="text" name="aluno_bairro" id="aluno_bairro"
                value="<?php echo htmlentities($row_alunoEditar['aluno_bairro'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255">
            </label>
            <label class="ls-label col-md-2">
              ...
              <div class="ls-custom-select">
                <select name="aluno_uf" id="aluno_uf">
                  ...
                  foreach ($ufs as $uf) {
                    echo "<option value='$uf'";
                    if ($row_alunoEditar['aluno_uf'] == $uf)
                      echo " SELECTED";
                    echo ">$uf</option>";
                  }
                  ?>
            ...
            <label class="ls-label col-md-4">
              ...
              <input type="text" name="aluno_municipio" id="aluno_municipio"
                value="<?php echo htmlentities($row_alunoEditar['aluno_municipio'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="64">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">Telefone/Celular:</b>
              <input type="text" name="aluno_telefone"
                value="<?php echo htmlentities($row_alunoEditar['aluno_telefone'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255" class="celular">
            </label>
            <label class="ls-label col-md-3">
              <b class="ls-label-text">Celular/WhatsApp:</b>
              <input type="text" name="aluno_celular"
                value="<?php echo htmlentities($row_alunoEditar['aluno_celular'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255" class="celular">
            </label>
            <label class="ls-label col-md-6">
              <b class="ls-label-text">E-mail:</b>
              <input type="text" name="aluno_email"
                value="<?php echo htmlentities($row_alunoEditar['aluno_email'], ENT_COMPAT, 'utf-8'); ?>"
                maxlength="255">
            </label>
          </div>
          ...
          <div id="deficiencia" class="ls-box ls-box-gray" style="display:block">
            ...
            <label class="ls-label col-md-7">
              <b class="ls-label-text">Detalhar deficiência:</b>
            ...
            <label class="ls-label col-md-7">
              ...
              <input type="text" name="aluno_cid" id="aluno_cid"
                value="<?php echo htmlentities($row_alunoEditar['aluno_cid'], ENT_COMPAT, 'utf-8'); ?>" maxlength="64">
            </label>
          </div>
          ...
          <div id="obs" class="ls-box ls-box-gray">
            ...
            <label class="ls-label">
              ...
              <textarea rows="4" name="aluno_observacao" class="ls-textarea-autoresize"
                maxlength="255"><?php echo htmlentities($row_alunoEditar['aluno_observacao'], ENT_COMPAT, 'utf-8'); ?></textarea>
            </label>
          </div>
