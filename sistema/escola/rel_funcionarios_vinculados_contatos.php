        ...
        <table class="ls-table">
          <thead>
            <tr>
              ...
              <th class="ls-data-descending ls-txt-center">TELEFONE</th>
              <th class="ls-data-descending ls-txt-center">E-MAIL</th>
            </tr>
          </thead>
          <tbody>
            <?php do { ?>
              <tr>
                ...
                <td class="ls-txt-center"><?php echo $row_FuncionariosVinculados['func_telefone']; ?> <?php echo $row_FuncionariosVinculados['func_celular1']; ?> <?php echo $row_FuncionariosVinculados['func_celular2']; ?></td>
...
<a class="ls-btn ls-ico-windows" href="print_funcionarios_vinculados_contatos.php" target="_blank"> Imprimir telefones</a>
<a class="ls-btn ls-ico-windows" href="print_funcionarios_vinculados_email.php" target="_blank"> Imprimir e-mails</a>
</div>
<br>
<hr>
