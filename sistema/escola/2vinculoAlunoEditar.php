...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE smc_vinculo_aluno SET vinculo_aluno_id_turma=%s, vinculo_aluno_situacao=%s, vinculo_aluno_transporte=%s, vinculo_aluno_ponto_id=%s, vinculo_aluno_multietapa=%s, vinculo_aluno_datatransferencia=%s, vinculo_aluno_internet=%s, vinculo_aluno_vacina_atualizada=%s WHERE vinculo_aluno_id=%s",
...
vinculo_aluno_datatransferencia, vinculo_aluno_internet, vinculo_aluno_multietapa, aluno_id, aluno_nome, turma_id, turma_nome, turma_multisseriada 
    ...
    <div class="ls-modal" data-modal-blocked id="myAwesomeModal">
      <div class="ls-modal-box">
        <div class="ls-modal-header">
          ...
          <h4 class="ls-modal-title">EDITAR MATRÍCULA</h4>
          <br>
          <h5><?php echo $row_VinculoEditar['aluno_nome']; ?> - <?php echo $row_VinculoEditar['turma_nome']; ?></h5>
          <h5>Matrícula realizada em <?php echo date("d/m/Y", strtotime($row_VinculoEditar['vinculo_aluno_data'])); ?></h5>
        </div>
          ...
          <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form ls-form-horizontal row">
            <fieldset>
              ...
              <label class="ls-label col-md-12 vinculo_aluno_datatransferencia"><b class="ls-label-text">DATA DA OCORRÊNCIA (transferência, desistência, falecimento etc.</b>
                <input type="text" name="vinculo_aluno_datatransferencia" id="vinculo_aluno_datatransferencia" class="ls-field-lg date" value="<?php 
                  if ($row_VinculoEditar['vinculo_aluno_datatransferencia']<>"") { 
                  echo htmlentities(inverteData($row_VinculoEditar['vinculo_aluno_datatransferencia']), ENT_COMPAT, 'utf-8');
                  } else {
                    echo date("d/m/Y");
                  }
			          ?>" size="32">
      ...
      <p>
        ...
        <label class="ls-label-text">
          ...
          NÃO </label>
              ...
              <label class="ls-label col-sm-12 vinculo_aluno_ponto_id" id="ponto" <?php if (!(strcmp(htmlentities($row_VinculoEditar['vinculo_aluno_transporte'], ENT_COMPAT, 'utf-8'),"N"))) { echo "style=\"display:none\""; } else { echo "style=\"display:block\""; } ?>>
        ...
        <label class="ls-label-text">
          ...
          SEM INFORMAÇÃO </label>
              ...
              <div class="ls-modal-footer">
                ...
                <a href="matriculaExibe.php?cmatricula=<?php echo $row_VinculoEditar['vinculo_aluno_hash']; ?>" class="ls-btn ls-btn-lg">CANCELAR</a> <a href="javascript:func()" onclick="confirmaExclusao('<?php echo $row_VinculoEditar['vinculo_aluno_hash']; ?>','<?php echo $row_VinculoEditar['aluno_nome']; ?>')" class="ls-btn-danger ls-float-right ls-btn-lg">EXCLUIR VINCULO</a> </div>
            </fieldset>
