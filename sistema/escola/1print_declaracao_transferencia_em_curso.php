...
<div class="row">
  ...
  Certifico que deu entrada nesta data um pedido de transferência do(a) aluno(a) <strong><?php echo $row_Matricula['aluno_nome']; ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  é aluno(a) regularmente matriculado(a) e frequente nesta unidade de ensino, cursando o/a <strong><?php echo $multietapa; ?></strong>, no ano letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>. Servindo o presente certificado como documento hábil para inscrição condicional a matrícula.</p>
  
  <br><p style="line-height: 180%; text-align:justify; font-size:16px;">O histórico será emitido no prazo máximo de 30 dias.</p>
