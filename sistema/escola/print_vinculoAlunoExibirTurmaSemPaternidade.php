...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>RELATÓRIO DE ALUNOS SEM VÍNCULO PATERNO | SMECEL - Sistema de Gestão Escolar</title>
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		aluno_id, aluno_nome, aluno_nome_social,aluno_nascimento, aluno_filiacao1, aluno_filiacao2, aluno_hash
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE aluno_filiacao2 IS NULL AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<thead>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					$contaAlunos++;		
					?></td>
					<td><?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != "" ? $row_ExibirAlunosVinculados["aluno_nome_social"]:
					$row_ExibirAlunosVinculados["aluno_nome"]; ?></td>
