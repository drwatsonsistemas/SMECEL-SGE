...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE smc_escola SET escola_nome=%s, escola_cep=%s, escola_endereco=%s, escola_num=%s, escola_complemento=%s, escola_bairro=%s, escola_cod_distrito=%s, escola_telefone1=%s, escola_telefone2=%s, escola_email=%s, escola_tema=%s, escola_unidade_executora=%s, escola_caixa_ux_prestacao_contas=%s, escola_libera_boletim=%s, escola_foto_aluno=%s, escola_assinatura=%s, escola_numero_salas=%s, escola_cnpj=%s WHERE escola_id=%s",
                       ...
                       GetSQLValueString($_POST['escola_complemento'], "text"),
                       GetSQLValueString($_POST['escola_bairro'], "text"),
                       GetSQLValueString($_POST['escola_cod_distrito'], "text"),
    ...
    <div class="row">
      <div class="col-sm-7">
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form ls-form-horizontal row">
          ...
          <label class="ls-label col-md-3"> <b class="ls-label-text">CEP</b>
          ...
          <label class="ls-label col-md-4"> <b class="ls-label-text">COMPLEMENTO</b>
            <input type="text" name="escola_complemento" value="<?php echo htmlentities($row_EscolaLogada['escola_complemento'], ENT_COMPAT, 'utf-8'); ?>" size="32">
          </label>
          
          <label class="ls-label col-md-4"> <b class="ls-label-text">BAIRRO</b>
        ...
        <label class="ls-label col-sm-4">
                <b class="ls-label-text">DISTRITO</b>
                <div class="ls-custom-select">
                  <select name="escola_cod_distrito" id="escola_cod_distrito" class="ls-select" required>
                    <option value="">-</option>
                    <?php do { ?>
                      <option value="<?php echo $row_distritos['distrito_cod_distrito']?>" <?php if (!(strcmp($row_distritos['distrito_cod_distrito'], htmlentities($row_EscolaLogada['escola_cod_distrito'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_distritos['distrito_nome_distrito']?></option>
          ...
          <label class="ls-label col-md-12"> <b class="ls-label-text">CNPJ</b>
            <input type="text" name="escola_cnpj" class="cnpj" value="<?php echo htmlentities($row_EscolaLogada['escola_cnpj'], ENT_COMPAT, 'utf-8'); ?>" size="32" required>
          </label>
