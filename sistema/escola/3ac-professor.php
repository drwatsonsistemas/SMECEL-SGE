...
WHERE ac_id_professor = '$colname_Funcionario' AND ac_id_escola = '$row_EscolaLogada[escola_id]' AND ac_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
ORDER BY ac_id DESC
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">AC</h1>
		<!-- CONTEÚDO -->
  ...
  <p>Nenhum AC cadastrado para este professor</p>
