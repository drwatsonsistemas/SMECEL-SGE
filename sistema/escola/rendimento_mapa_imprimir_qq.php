...
function arredondarNota($nota) {
  ...
  <head>
    ...
    <title>SMECEL | MAPA DE NOTAS | <?php echo $row_Alunos['disciplina_nome']; ?> | <?php echo $row_Alunos['turma_nome']; ?> | <?php echo $row_EscolaLogada['escola_nome']; ?></title>
    <meta charset="utf-8">
...
<body onLoad="print()">
  ...
  <?php } else { ?>
    ...
    <table class="bordasimples" width="100%">
      <thead>
        <tr>
          <th colspan="2" rowspan="2" class="ls-txt-center">IDENTIFICAÇÃO</th>
...
<br>
<p> LEGENDA: </p>
<p> <strong>QNT.</strong>: QUANTITATIVO - <strong>QLT.</strong>: QUALITATIVO - <strong>PRL.</strong>:
  PARALELA - <strong>REC.</strong>: RECUPERAÇÃO FINAL - <strong>TP.</strong>: TOTAL DE PONTOS</p>
  <hr>
<?php } ?>
