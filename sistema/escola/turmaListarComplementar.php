...
<body>
  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <h1 class="ls-title-intro ls-ico-home">Listar Turmas de Atividade Complementar - Ano Letivo
        <?php echo $anoLetivo; ?></h1>
              ...
              do { ?>
                ...
                <tr>
                  ...
                  <td class="ls-txt-left">
                    <?php echo $row_TurmasListar['turma_nome']; ?>    <?php if ($row_TurmasListar['turma_multisseriada'] == "1") { ?><br><i>(multisseriada)</i><?php } ?>
                  </td>
