...
SELECT ch_lotacao_id, ch_lotacao_professor_id, ch_lotacao_disciplina_id, ch_lotacao_turma_id, 
       ...
       func_id, func_nome, disciplina_nome
...
AND ch_lotacao_dia = '$diasemana_numero'
  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <div class="ls-box">
        ...
        <p>DATA PARA REGISTRO DAS FALTAS: <strong><?php echo $dia_semana_nome; ?>,
            <?php echo inverteData($data); ?></strong></p>
        <p>PROFESSOR(A)/S E HORÁRIOS:<br>
          <strong>
            <?php
            if ($totalRows_Aulas > 0) {
              mysql_data_seek($Aulas, 0); // Resetar o ponteiro para o início
              do {
                echo "(".$row_Aulas['ch_lotacao_aula'] . " - " . $row_Aulas['disciplina_nome'] . ") " . $row_Aulas['func_nome'] . "<br>";
              } while ($row_Aulas = mysql_fetch_assoc($Aulas));
            } else {
              echo "Nenhum professor escalado para este dia.";
            }
            ?>
          </strong>
        </p>
        ...
        <table width="100%" class="ls-table ls-sm-space">
          ...
          do { ?>
            <tr>
              ...
              ?></td>
              <td><a
                  href="alunosFaltaLancar.php?hash=<?php echo $row_Alunos['vinculo_aluno_hash']; ?>"><?php echo $row_Alunos['aluno_nome']; ?></a>
              </td>
