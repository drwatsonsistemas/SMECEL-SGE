  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			<p>ALUNOS QUE UTILIZAM TRANSPORTE ESCOLAR (<?php echo $nomeFiltro; ?>)</p>
            <strong>ZONA RURAL</strong>
			</div>
		...
		SELECT 
		vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_transporte, vinculo_aluno_id_escola, vinculo_aluno_ano_letivo, 
		vinculo_aluno_hash, vinculo_aluno_boletim, aluno_nome_social,vinculo_aluno_situacao,
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_localizacao, aluno_endereco, aluno_numero, aluno_bairro, aluno_hash
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE aluno_localizacao = '2' AND vinculo_aluno_ano_letivo = '$anoLetivo' AND vinculo_aluno_transporte = 'S' AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<thead>
			<tr>
				...
				<th width="30%" class="ls-txt-center">FILIAÇÃO</th>
				<th width="20%" class="ls-txt-center">ENDEREÇO</th>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
                    ...
                    <td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_endereco']; ?> <?php echo $row_ExibirAlunosVinculados['aluno_numero']; ?> <?php echo $row_ExibirAlunosVinculados['aluno_bairro']; ?></td>
