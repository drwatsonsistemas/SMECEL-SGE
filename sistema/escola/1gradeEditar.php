    ...
    <div class="ls-modal-body" id="myModalBody">
		...
		<div class="ls-custom-select">
			  <select name="ch_lotacao_disciplina_id" class="ls-select" required>
                <?php do { ?>
                <option value="<?php echo $row_ListarDisciplinasMatriz['disciplina_id']?>" <?php if (!(strcmp($row_ListarDisciplinasMatriz['disciplina_id'], htmlentities($row_gradeEditar['ch_lotacao_disciplina_id'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_ListarDisciplinasMatriz['disciplina_nome']?></option>
