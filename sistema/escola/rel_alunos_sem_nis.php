  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">RELAÇÃO DE ALUNOS SEM INFORMAÇÃO DO NIS NO CADASTRO</h1>
		<!-- CONTEÚDO -->
		...
		do { ?>
          ...
          <?php 
			...
			aluno_endereco, aluno_numero, aluno_bairro, aluno_telefone, aluno_celular, aluno_sexo, aluno_cpf, aluno_nis,
			CASE aluno_sexo
			WHEN 1 THEN 'M'
			WHEN 2 THEN 'F'
			END AS aluno_sexo 
			...
			WHERE vinculo_aluno_id_turma = $row_Turmas[turma_id] AND vinculo_aluno_situacao = '1' AND aluno_nis IS NULL
          ...
          <td><?php echo $row_Alunos['aluno_nome_social'] != "" ? $row_Alunos["aluno_nome_social"] : $row_Alunos["aluno_nome_social"]; ?> </td>
		  ...
		  <a href="print_alunos_sem_nis.php" class="ls-ico-paint-format ls-btn" target="_blank">Imprimir relação de alunos sem NIS</a>
		  </p>
