...
ca_media_min_periodo, ca_arredonda_media, ca_aproxima_media, ca_min_pontos_aprovacao_final, ca_rec_paralela,
ca_min_media_aprovacao_final, ca_nota_min_recuperacao_final, ca_detalhes, ca_grupo_conceito, ca_grupo_etario, ca_questionario_conceitos, ca_digitos,ca_forma_avaliacao   
...
if ($row_CriteriosAvaliativos['ca_forma_avaliacao'] == "Q") {
  header('Location: printBoletimTurmaQQ.php?' . $linkBoletimQQ);
  exit;
}
...
<head>
  ...
  <title>BOLETIM |SMECEL - Sistema de Gestão Escolar</title>
  <meta charset="utf-8">
     ...
     WHERE matriz_disciplina_id_matriz = '$row_AlunoBoletim[turma_matriz_id]'";
      ...
      <div style="page-break-inside: avoid;"> <br>
        ...
        <div class="ls-box1"> <span class="ls-float-right" style="margin-left:20px;">
          ...
          <small> Aluno(a):
            <strong><?php echo $row_AlunoBoletim['aluno_nome_social'] != "" ? $row_AlunoBoletim["aluno_nome_social"] : $row_AlunoBoletim["aluno_nome"]; ?></strong><br>
        ...
        <p class="ls-ico-text ls-txt-center">BOLETIM ESCOLAR <?php echo $row_AlunoBoletim['vinculo_aluno_ano_letivo']; ?>
        </p>
        <?php
        if ($row_CriteriosAvaliativos['ca_questionario_conceitos'] == 'N') {
              ...
              <tr height="30">
                ...
                <?php for ($p = 1; $p <= $row_CriteriosAvaliativos['ca_qtd_periodos']; $p++) { ?>
                  <th class="ls-txt-center" style="background-color:#F5F5F5;"
                    colspan="<?php echo $row_CriteriosAvaliativos['ca_qtd_av_periodos'] + ($row_CriteriosAvaliativos['ca_rec_paralela'] == "S" ? 2 : 1); ?>"><strong><?php echo $p; ?>ª
                      UNIDADE</strong></th>
                <?php } ?>
                    ...
                    if ($row_CriteriosAvaliativos['ca_rec_paralela'] == "S") {
                      ...
                      if ($row_notaRecPar && $row_notaRecPar['nota_valor'] !== null) {
                        if ($row_CriteriosAvaliativos['ca_calculo_media_periodo'] == "MEDIA") {
                          $ru = $row_notaRecPar['nota_valor'] * $row_CriteriosAvaliativos['ca_qtd_av_periodos'];
                        } else {
                          $ru = $row_notaRecPar['nota_valor'];
                        }
                      }
          ...
          echo 'window.location.href = "print_boletimTurmaConceito.php?ct=' . $_GET['ct'] . '";';
          echo '</script>';
        ...
        <div class="ls-box ls-txt-center">
          ...
          <table width="100%" class="ls-sm-space bordasimples">
            <tr>
              <td>Data de Nascimento: <strong><?php echo inverteData($row_AlunoBoletim['aluno_nascimento']); ?></strong>
              </td>
              <td>Código de acesso:
                <strong><?php echo str_pad($row_AlunoBoletim['aluno_id'], 5, '0', STR_PAD_LEFT); ?></strong>
              </td>
