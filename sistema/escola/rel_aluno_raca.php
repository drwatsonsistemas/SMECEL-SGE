...
aluno_id, aluno_nome, aluno_raca, COUNT(aluno_raca) AS total_raca,
CASE aluno_raca
WHEN 1 THEN 'BRANCA'
WHEN 2 THEN 'PRETA'
WHEN 3 THEN 'PARDA'
...
<script src="js/locastyle.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
		...
		<?php do { ?>
		['<?php echo $row_AlunosZonaRural['aluno_raca_descricao']; ?> (<?php echo $row_AlunosZonaRural['total_raca']; ?>)', <?php echo $row_AlunosZonaRural['total_raca']; ?>],
		<?php } while ($row_AlunosZonaRural = mysql_fetch_assoc($AlunosZonaRural)); ?>

        ]);

        var options = {
          title: 'Percentual de alunos por raça'
        };
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Alunos por raça</h1>
