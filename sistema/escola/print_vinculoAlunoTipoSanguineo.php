...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>RELATÓRIO DE ALUNOS COM TIPO SANGUÍNEO | SMECEL - Sistema de Gestão Escolar</title>
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS COM TIPO SANGUÍNEO
			</div>
		...
		aluno_id, aluno_nome, aluno_nome_social, aluno_nascimento, aluno_sangue_tipo, aluno_sangue_rh, aluno_hash
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE aluno_sangue_tipo IS NOT NULL AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<table class="ls-sm-space bordasimples" width="100%" style="font-size:16px;">
		<thead>
			<tr>
				<th width="5%" class="ls-txt-center" width="35px">Nº</th>
				<th width="40%">ALUNO</th>
				<th width="15%" class="ls-txt-center">NASCIMENTO</th>
				<th width="40%" class="ls-txt-center">TIPO SANGÚINEO</th>
			</tr>
			<tbody>
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_sangue_tipo'].$row_ExibirAlunosVinculados['aluno_sangue_rh']; ?></td>
				</tr>
		...
		<p>Alunos com tipo sanguíneo vinculados na turma: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong></p>
		...
		<?php } ?>
         ...
         <?php $totalAlunosEscola = $totalAlunosEscola + $totalRows_ExibirAlunosVinculados; ?> 
		  ...
		  <p>Total de alunos com tipo sanguíneo vinculados na escola: <strong><?php echo $totalAlunosEscola; ?></strong></p>
		  </div>
		  <?php } ?>
