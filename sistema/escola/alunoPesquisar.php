          ...
          <table class="ls-table ls-table-striped ls-sm-space">
            ...
            <tbody>
              ...
              do { ?>
                ...
                mysql_select_db($database_SmecelNovo, $SmecelNovo);
                $query_vinculos = "
                  SELECT vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_ano_letivo, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_id_sec, vinculo_aluno_resultado_final, sec_id, sec_cidade, escola_id, escola_nome, turma_id, turma_nome FROM smc_vinculo_aluno
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      <div class="ls-alert-info ls-dismissable">
                        ...
                        <a href="#" class="ls-btn ls-btn-xs" data-ls-module="popover" data-trigger="hover" data-title="MATRÍCULA EM <?php echo $row_vinculos['vinculo_aluno_ano_letivo']; ?>" data-content="
                        -CIDADE: <?php echo $row_vinculos['sec_cidade']; ?><br>
                        -ESCOLA: <?php echo $row_vinculos['escola_nome']; ?><br>
                        -TURMA: <?php echo $row_vinculos['turma_nome']; ?>
                        " data-placement="top"><?php echo $row_vinculos['vinculo_aluno_ano_letivo']; ?></a>
