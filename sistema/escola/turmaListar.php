              ...
              do {
                ...
                <tr>
                  ...
                  <td class="ls-txt-center"><a
                      href="vinculoAlunoExibirTurma.php?ct=<?php echo $row_TurmasListar['turma_id']; ?><?php if (isset($_GET['ano'])) {
                           echo "&ano=$anoLetivo";
                  ...
                  <td class="ls-txt-center hidden-xs">
                    ...
                    <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                      ...
                      <ul class="ls-dropdown-nav">
                        ...
                        <li><a
                            href="<?php echo $row_TurmasListar['etapa_id_filtro'] == 1 ? 'boletimCadastrarBoletimTurmaConceito.php' : 'boletimCadastrarBoletimTurma.php' ?>?turma=<?php echo $row_TurmasListar['turma_id']; ?>"
                        ...
                        <li><a
                            href="boletimCadastrarDisciplinasTurma.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>"
                            class="ls-ico-text ls-divider" title="Gerar notas da turma">Gerar notas da turma</a> </li>
                    ...
                    <div class="ls-modal-body" id="myModalBody">
                      <form action="print_mapa_de_frequencia_avulso_mensal.php" target="_blank" method="GET"
                        ...
                        <label class="ls-label col-md-12">
                          ...
                          <input type="number" class="ls-no-spin" name="ano" value="<?= $anoLetivo ?>" required>
