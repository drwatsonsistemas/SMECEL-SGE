...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_nome_social, aluno_filiacao1, aluno_hash, aluno_foto, aluno_filiacao2, aluno_localizacao, aluno_endereco, aluno_numero, aluno_bairro, aluno_complemento
        ...
        <?php if ($totalRows_ExibirAlunosVinculados > 0) { ?>
			...
			<div class="cartao" style="">
                ...
                <h2 style="text-align:center; padding:3px; background-color:#CCCCCC"><?php 
				echo $row_ExibirAlunosVinculados['aluno_nome_social'] != ""? $row_ExibirAlunosVinculados["aluno_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?></h2>
