  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELAÇÃO DE ALUNOS COM NÚMEROS DE CONTATO <?php echo $nomeFiltro; ?>
			</div>
		...
		<thead>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					$contaAlunos++;		
					?></td>
					<td><?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != ""? $row_ExibirAlunosVinculados["aluno_nome-social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?></td>
