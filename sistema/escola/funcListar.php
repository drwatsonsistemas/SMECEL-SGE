...
<body>
  ...
  <main class="ls-main ">
    ...
    <a class="ls-btn ls-ico-calendar ls-float-right ls-sm-margin-bottom" href="frequenciaGeralFuncionarios.php" target="_blank">Imprimir folha de ponto</a>
        ...
        <table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
          ...
          <tbody>
           ...
           do {
            ...
            <td class="ls-txt-center"><?php isset($row_ListaVinculos['funcao_nome']) ? print($row_ListaVinculos['funcao_nome']) : print("Função não adicionada") ?></td>
