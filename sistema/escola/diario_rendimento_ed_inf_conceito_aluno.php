...
WHERE vinculo_aluno_boletim = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' $buscaTurma $buscaAlunoTurma
  ...
  <div class="container-fluid">
    ...
    <?php do { ?>
      ...
      <div style="page-break-inside: avoid;"> <br>
        ...
        <h4 class="ls-ico-text ls-txt-center">RENDIMENTO ESCOLAR
		...
		";
                ...
                <?php if ($totalRows_Acompanhamento > 0) { ?>
                  ...
                  <tr>
                    ...
                    <td width="100" rowspan="<?php echo $totalRows_Acompanhamento; ?>" class="ls-txt-center">
                      <strong><?php echo utf8_encode(substr($row_Objetos['campos_exp_obj_campos_exp'], 1, 8)); ?></strong>
                    </td>
                    <?php do { ?>
        ...
        <p class="ls-txt-center">
          <?php do { ?>
            ...
            <small class="ls-tag"><?php echo $row_DescConceitos['conceito_itens_descricao']; ?>
              (<?php echo $row_DescConceitos['conceito_itens_legenda']; ?>) </small>

          <?php } while ($row_DescConceitos = mysql_fetch_assoc($DescConceitos)); ?>
        </p>


        <?php if ($row_AlunoBoletim['vinculo_aluno_rel_aval'] != '') { ?>
          <br>
