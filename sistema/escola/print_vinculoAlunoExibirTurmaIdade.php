...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>Alunos por turma/Idade | <?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno']; ?>  (<?php echo $nomeFiltro; ?>) <?php echo $row_EscolaLogada['escola_nome']; ?> | SMECEL - Sistema de Gestão Escolar</title>
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		aluno_id, aluno_cod_inep, aluno_nome, aluno_cpf, aluno_nascimento, aluno_filiacao1, aluno_hash
		...
		<thead>
			<tr>
				<th width="30" class="ls-txt-center" width="35px">Nº</th>
				<th width="70">INEP</th>
				<th>ALUNO</th>
				<th width="20" class="ls-txt-center">Idade</th>
				<th width="80" class="ls-txt-center">CPF</th>
				<th width="80" class="ls-txt-center">NASCIMENTO</th>
