      ...
      <div style="page-break-inside: avoid;"> <br>
        ...
        <div class="ls-box1"> <span class="ls-float-right" style="margin-left:20px;">
          ...
          <small> Aluno(a):
            ...
            Turma: <strong><?php echo $row_AlunoBoletim['turma_nome']; ?> | Ano Letivo <?php echo $anoLetivo; ?></strong>
          </small>
        </div>
        </p>
            ...
            <tr height="30">
              ...
              <?php for ($p = 1; $p <= $row_CriteriosAvaliativos['ca_qtd_periodos']; $p++) { ?>
                <th class="ls-txt-center" style="background-color:#F5F5F5;"
                  colspan="<?php echo $row_CriteriosAvaliativos['ca_qtd_av_periodos'] + $rec; ?>"><strong><?php echo $p; ?>ª
                    UNIDADE</strong></th>
