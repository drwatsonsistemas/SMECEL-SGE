...
$data = isset($_COOKIE['data']) ? $_COOKIE['data'] : ''; // Fulano
$dataBase = isset($_COOKIE['dataBase']) ? $_COOKIE['dataBase'] : ''; // Fulano
$diasemana_numero = isset($_COOKIE['diasemana_numero']) ? $_COOKIE['diasemana_numero'] : ''; // Fulano
$dia_semana_nome = isset($_COOKIE['dia_semana_nome']) ? $_COOKIE['dia_semana_nome'] : ''; // Fulano
