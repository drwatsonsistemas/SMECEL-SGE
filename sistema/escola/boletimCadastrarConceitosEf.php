...
//Loop disciplinas
		...
		//Loop períodos	
			$query = mysql_query("INSERT INTO smc_conceito_ef (conc_ef_id_quest, conc_ef_id_matr, conc_ef_periodo) VALUES ('$row_questionario[quest_conc_id]', '$idVinculo','$p')");
			}


} while ($row_questionario = mysql_fetch_assoc($questionario));
  

  $updateGoTo = "conceitoEfVer.php?boletimcadastrado";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<main class="ls-main ">
  <div class="container-fluid">
	...
	<div class="ls-alert-info"><strong>Atenção:</strong> Antes de gerar o boletim/questionário, confira os dados abaixo.</div>
    
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form-horizontal " data-ls-module="form">
      <fieldset>
        <div class="row">
      ...
      <div class="ls-actions-btn">
        ...
        <a class="ls-btn-danger" href="matriculaExibe.php?cmatricula=<?php echo $row_AlterarStatus['vinculo_aluno_hash']; ?>">Cancelar</a> </div>
