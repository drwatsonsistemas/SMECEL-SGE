	...
	<input type="text" class="buscar-funcionario" alt="fonte-tabela" placeholder="Digite o nome ou parte do nome de um funcionário" autofocus/>
		...
		<table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
          ...
          <tr>
            ...
            <th>FUNCIONÁRIO</th>
            <th class="ls-txt-center">MAPA DE AULAS</th>
		   ...
		   ?>
            ...
            <tr>
              ...
              <td class="ls-txt-center">
              <a href="aulas_virtuais_calendario_professor.php?professor=<?php echo $row_ListaVinculos['func_id']; ?>">Ver</a>
			  </td>
			  <td class="ls-txt-center"><a href="aulas_por_professor.php?professor=<?php echo $row_ListaVinculos['vinculo_id']; ?>">Ver</a></td>
