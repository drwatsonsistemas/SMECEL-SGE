...
WHERE turma_tipo_atendimento = '1' AND turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' 
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_ContaAlunos = "SELECT turma_id, turma_id_escola, sum(turma_total_alunos) as totalAlunos, turma_ano_letivo, turma_tipo_atendimento FROM smc_turma WHERE turma_tipo_atendimento = '1' AND turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'";
