...
<br>
<br>
<h2 style="font-size:56px; margin-bottom: 20px;"><span style="border-bottom: solid 5px black">REGISTRO DE FREQUÊNCIA</span></h2>
<br>
<h1>TURMA <?php echo $row_AlunoBoletim['turma_nome']; ?><br><br><?php echo $row_AlunoBoletim['turma_turno_descricao']; ?></h1>
<br>
<br>
<br>
<br>
...
<br>
<br>
<h2>ANO LETIVO <?php echo $row_AnoLetivo['ano_letivo_ano']; ?> <span class="ls-ico-calendar ls-ico-right"></span></h2><br>
                ...
                <div style="page-break-inside: avoid;">
				  ...
				  ?>
                    ...
                    <span class="ls-float-right" style="margin-left:20px;">
                      ...
                      <?php } else { ?>
                      <img src="<?php echo URL_BASE.'aluno/fotos/' ?><?php echo $row_AlunoBoletim['aluno_foto']; ?>" width="100%" class="aluno">
                      <?php } ?>
                    </span> 
                      
                     <strong>FREQUENCIA ESCOLAR <?php echo $row_AlunoBoletim['vinculo_aluno_ano_letivo']; ?></strong><br><br>
                      Aluno(a): <strong><?php echo $row_AlunoBoletim['aluno_nome']; ?></strong>&nbsp; 
                      Nascimento: <strong><?php echo inverteData($row_AlunoBoletim['aluno_nascimento']); ?></strong>&nbsp; 
                      Filiação: <strong><?php echo $row_AlunoBoletim['aluno_filiacao1']; ?></strong><br><br>
