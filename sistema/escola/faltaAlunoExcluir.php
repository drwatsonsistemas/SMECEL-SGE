...
if ((isset($_GET['falta'])) && ($_GET['falta'] != "")) {
  $deleteSQL = sprintf("DELETE FROM smc_faltas_alunos WHERE faltas_alunos_id=%s",
                       GetSQLValueString($_GET['falta'], "int"));

  mysql_select_db($database_SmecelNovo, $SmecelNovo);
  $Result1 = mysql_query($deleteSQL, $SmecelNovo) or die(mysql_error());

  $deleteGoTo = "faltasMostrar.php";
...
$colname_falta = "-1";
if (isset($_GET['falta'])) {
  $colname_falta = $_GET['falta'];
}
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_falta = sprintf("SELECT faltas_alunos_id, faltas_alunos_matricula_id, faltas_alunos_disciplina_id, faltas_alunos_numero_aula, faltas_alunos_data, faltas_alunos_justificada, faltas_alunos_justificativa FROM smc_faltas_alunos WHERE faltas_alunos_id = %s", GetSQLValueString($colname_falta, "int"));
$falta = mysql_query($query_falta, $SmecelNovo) or die(mysql_error());
