        ...
        <label class="ls-label-text">
          ...
          SEM INFORMAÇÃO </label>
              ...
              <div class="ls-modal-footer">
                ...
                <a href="matriculaExcluir.php?hash=<?php echo $row_VinculoEditar['vinculo_aluno_hash']; ?>&nome=<?php echo $row_VinculoEditar['aluno_nome']; ?>" class="ls-btn-danger ls-float-right ls-btn-lg">EXCLUIR VINCULO</a> </div>
            </fieldset>
