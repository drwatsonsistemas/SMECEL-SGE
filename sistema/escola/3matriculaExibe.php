    ...
    <div class="row">
      ...
      <div class="ls-box">
        <header class="ls-info-header">
          <h5 class="ls-title-5">Aluno(a) <strong><?php echo $row_Matricula['aluno_nome']; ?></strong><br><br>Turma: <strong><?php echo $row_Matricula['turma_nome']; ?> - <?php echo $row_Matricula['turma_turno_nome']; ?></strong></h5>
        </header>
      ...
      <?php } ?>
      <br>
      <small><a class="" href="celular.php?aluno=<?php echo htmlentities($row_Matricula['aluno_hash'], ENT_COMPAT, 'utf-8'); ?>&cmatricula=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>">ALTERAR FOTO</a></small> 
	  </div>	
...
<div class="ls-tabs-container" id="awesome-tab-content">
  ...
  <div id="tab3" class="ls-tab-content">
    <p>
        ...
        <a class="" href="print_form_matricula.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Ficha de Matrícula do Aluno</a><br><br>
        <a class="" href="print_comprovante_matricula.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Comprovante de Matrícula</a><br><br>
        <a class="" href="print_declaracao_matricula.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Declaração de Matrícula</a><br><br>
        <a class="" href="print_declaracao_transferencia.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Declaração de transferência (aprovado)</a><br><br>
        <a class="" href="print_declaracao_transferencia_desistente.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Declaração de transferência (desistente)</a><br><br>
        <a class="" href="print_declaracao_escola_publica.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Declaração de estudo em Escola Pública</a><br><br>
        <a class="" href="print_declaracao_transferencia.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Declaração de Conclusão de Curso</a><br><br>
        <a class="" href="print_declaracao_transferencia_conservado.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank"> Emitir Declaração de aluno conservado</a><br><br>
        <?php if ($row_Matricula['vinculo_aluno_situacao'] == "2") { ?>
        <a class="" href="print_declaracao_transferencia_em_curso.php?hash=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" target="_blank">- Emitir Declaração de Transferência em Curso</a><br><br>
        <?php } ?>
          ...
          <div class="col-sm-12 col-md-4">
            <div class="ls-box">
              ...
              <div class="ls-box-footer">
                ...
                <a href="boletimCadastrarConceitos.php?c=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>" class="ls-btn ls-btn-xs">Gerar</a>
				<?php } else { ?>
