...
<br>
        ...
        <br>
		  ...
		  <div class="ls-box">
          <p>
          Professor(a): <strong><?php echo $row_Lotacao['func_nome']; ?> (<?php echo $row_Lotacao['ch_lotacao_professor_id']; ?>)</strong><br>
          Componente Curricular: <strong><?php echo $row_Lotacao['disciplina_nome']; ?></strong><br>
          Turma: <strong><?php echo $row_Turma['turma_nome']; ?></strong>
          </p>
          </div>
		  ...
		  ?>
            ...
            <tr>
            	<td colspan="4"><strong>Total de aulas: (<?php echo $totalRows_Aulas ?>)</strong></td>
            </tr>
            ...
            <div class="ls-box">
            <br>
            <p class="ls-txt-center" align="center">________________________________________________________<br><?php echo $row_Lotacao['func_nome']; ?></p>
            <br>
