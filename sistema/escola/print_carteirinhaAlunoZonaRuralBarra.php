...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="1alert('Atenção: Configure sua impressora para o tamanho A4 e formato RETRATO');self.print();">
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_foto, aluno_filiacao2, aluno_localizacao
			...
			<div style="display:block; width:86mm; height:54mm; float:left; padding:1mm; margin:0 1mm 1mm 0; border:dotted 0px #000000;page-break-before: inside; background-image:url('../../img/fundoCarteirinha.jpg');background-repeat: no-repeat;background-size: cover;">
				...
				<table width="100%">
					<tr>
						...
						<td>
							<strong>Aluno(a)</strong><br><?php echo $row_ExibirAlunosVinculados['aluno_nome']; ?><br><br>
						...
						<?php
							geraCodigoBarra(str_pad($row_ExibirAlunosVinculados['vinculo_aluno_id'],11, '0', STR_PAD_LEFT));
							//geraCodigoBarra($row_ExibirAlunosVinculados['vinculo_aluno_id']);
						?>
						<br>MAT <?php echo str_pad($row_ExibirAlunosVinculados['vinculo_aluno_id'], 11, '0', STR_PAD_LEFT); ?>
				...
				<br><i>Válido durante o Ano Letivo de <?php echo $row_AnoLetivo['ano_letivo_ano']; ?></i>
