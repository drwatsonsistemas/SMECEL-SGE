...
etapa_id, etapa_nome, etapa_limite_turma, turma_multisseriada, matriz_id, matriz_nome,
CASE turma_turno
...
WHERE turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$anoLetivoRematricula' 
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_ContaAlunos = "SELECT turma_id, turma_id_escola, sum(turma_total_alunos) as totalAlunos, turma_ano_letivo FROM smc_turma WHERE turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$anoLetivoRematricula'";
...
<body>
  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <h1 class="ls-title-intro ls-ico-home">Listar Turmas - Ano Letivo <?php echo $anoLetivoRematricula; ?> <strong
          class="ls-color-warning">Rematrícula</strong></h1>
      ...
      <div class="ls-actions-btn">
        <!-- Grupo 1: Ações de Cadastro e Remanejamento -->
        <div class="ls-group-btn">
            <a class="ls-btn-primary ls-ico-windows" href="turmaCadastrarRematricula.php">
                Cadastrar Turma (<?php echo $anoLetivoRematricula; ?>)
            </a>
            <a class="ls-btn-primary ls-ico-windows" href="turmas_remanejar.php">
                Remanejar turmas (<?php echo $row_AnoLetivo['ano_letivo_ano']; ?> → <?php echo $anoLetivoRematricula; ?>)
            </a>
            <a class="ls-btn-primary ls-ico-users" href="alunos_remanejar.php">
                Remanejar alunos (<?php echo $row_AnoLetivo['ano_letivo_ano']; ?> → <?php echo $anoLetivoRematricula; ?>)
            </a>
        </div>

        <!-- Grupo 2: Ações de Impressão -->
        <div class="ls-group-btn">
            <a class="ls-btn-primary ls-ico-paint-format" href="print_turmaListarRematricula.php" target="_blank">
                Imprimir turmas
            </a>
            <a class="ls-btn-primary ls-ico-paint-format" href="print_vinculoAlunoExibirTurmaRematricula.php" target="_blank">
                Imprimir alunos das turmas
            </a>
        </div>
      </div>
          ...
          <table class="ls-table ls-table-striped ls-sm-space">
            <thead>
              <tr>
                ...
                <th class="ls-txt-left">TURMA <a href="#" class="ls-ico-help" data-trigger="hover"
            ...
            <tbody>
              ...
              do { ?>
                ...
                <tr>
                  ...
                  <td class="ls-txt-left"><a href="turmaEditar.php?c=<?php echo $row_TurmasListar['turma_id']; ?>"
                      class="ls-ico-edit-admin"></a></td>
                  <td class="ls-txt-left"><a
                      href="vinculoAlunoExibirTurmaRematricula.php?ct=<?php echo $row_TurmasListar['turma_id']; ?>">
                      <?php echo $row_TurmasListar['turma_nome']; ?>
                      (<?php echo $row_TurmasListar['turma_ano_letivo']; ?>)<?php if ($row_TurmasListar['turma_multisseriada'] == "1") { ?><br><i>(multisseriada)</i><?php } ?></a>
                  </td>
                  <td class="ls-txt-center hidden-xs"><?php echo $row_TurmasListar['matriz_nome']; ?></td>
                  ...
                  <td class="ls-txt-left hidden-xs">
                    ...
                    $alunosTurma = alunosConta($row_TurmasListar['turma_id'], $anoLetivoRematricula);
                    ...
                    <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                      ...
                      <ul class="ls-dropdown-nav">
                        ...
                        <li><a href="javascript:func()"
                            onclick="confirmaExclusao('<?php echo $row_TurmasListar['turma_id']; ?>','<?php echo $row_TurmasListar['turma_nome']; ?>')"
