...
aluno_id, aluno_nome, aluno_sexo, COUNT(aluno_sexo) AS total_sexo, turma_id, turma_tipo_atendimento,
CASE aluno_sexo
WHEN 1 THEN 'MASCULINO'
WHEN 2 THEN 'FEMINIMO'
END AS aluno_sexo_descricao  
FROM smc_vinculo_aluno
INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno
INNER JOIN smc_turma ON turma_id = vinculo_aluno_id_turma
WHERE vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND vinculo_aluno_situacao = 1 AND turma_tipo_atendimento = 1
GROUP BY aluno_sexo
";
...
<script src="js/locastyle.js"></script>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
		...
		<?php do { ?>
		['<?php echo $row_AlunosZonaRural['aluno_sexo_descricao']; ?> (<?php echo $row_AlunosZonaRural['total_sexo']; ?>)', <?php echo $row_AlunosZonaRural['total_sexo']; ?>],
		<?php } while ($row_AlunosZonaRural = mysql_fetch_assoc($AlunosZonaRural)); ?>

        ]);

        var options = {
          title: 'Percentual de alunos por gênero'
        };
