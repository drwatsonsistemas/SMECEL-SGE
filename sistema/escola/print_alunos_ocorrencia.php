...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>Alunos com ocorrência | SMECEL - Sistema de Gestão Escolar</title>
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS COM OCORRÊNCIA
			</div>
        ...
        ocorrencia_id_turma, ocorrencia_id_escola, ocorrencia_ano_letivo, ocorrencia_tipo, ocorrencia_data,
		...
		WHERE ocorrencia_tipo IS NOT NULL AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' 
        AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' AND vinculo_aluno_situacao = '1'
        AND ocorrencia_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' 
		...
		<thead>
			<tr>
				...
				<th width="15%" class="ls-txt-center">DATA DA OCORRÊNCIA</th>
                <th width="15%" class="ls-txt-center">TIPO DA OCORRÊNCIA</th>
