...
<head>
    ...
    <style>
                    ...
                    @media screen and (max-width: 767px) {
                        ...
                        .ls-table thead {
                            display: none;
                            /* Hide header on mobile for simplicity */
                        }
                        ...
                        .ls-table td:nth-child(1):before {
                            content: "Nº";
                        }

                        .ls-table td:nth-child(2):before {
                            content: "Funcionário";
                        }

                        .ls-table td:nth-child(3):before {
                            content: "Função";
                        }

                        .ls-table td:nth-child(4):before {
                            content: "CH";
                        }

                        .ls-table td:nth-child(5):before {
                            content: "Situação";
                        }

                        .ls-table td:nth-child(6):before {
                            content: "Extras Dias";
                        }

                        .ls-table td:nth-child(7):before {
                            content: "Extras Aulas";
                        }

                        .ls-table td:nth-child(8):before {
                            content: "Faltas Dias";
                        }

                        .ls-table td:nth-child(9):before {
                            content: "Faltas Aulas";
                        }

                        .ls-table td:nth-child(10):before {
                            content: "Observação";
                        }

                        .ls-table td:nth-child(11):before {
                            content: "Ação";
                        }
                        ...
                        <tbody>
                            ...
                            <?php do { ?>
                                <tr>
                                    ...
                                    <td class="ls-txt-center"><span
                                            class="<?php if ($row_ListaVinculos['total_extras_dias'] > 0) {
                                                echo 'ls-tag-info';
                                            } ?>"><?= $row_ListaVinculos['total_extras_dias'] ?></span>
                                    </td>
                                    <td class="ls-txt-center"><span
                                            class="<?php if ($row_ListaVinculos['total_extras_aulas'] > 0) {
                                                echo 'ls-tag-info';
                                            } ?>"><?= $row_ListaVinculos['total_extras_aulas'] ?></span>
                                    </td>
                                    <td class="ls-txt-center"><span
                                            class="<?php if ($row_ListaVinculos['total_faltas_dias'] > 0) {
                                                echo 'ls-tag-danger';
                                            } ?>"><?= $row_ListaVinculos['total_faltas_dias'] ?></span>
                                    </td>
                                    <td class="ls-txt-center"><span
                                            class="<?php if ($row_ListaVinculos['total_faltas_aulas'] > 0) {
                                                echo 'ls-tag-danger';
                                            } ?>"><?= $row_ListaVinculos['total_faltas_aulas'] ?></span>
                                    </td>
