...
<div class="row">
  ...
  Certifico que deu-se entrada nesta data, um pedido de transferência do(a) aluno(a) <strong><?php echo $row_matricula['aluno_nome']; ?></strong>, nascido(a) em <strong><?php echo inverteData($row_matricula['aluno_nascimento']); ?></strong>, 
  ...
  <br><p style="line-height: 180%; text-align:justify; font-size:16px;">O histórico será emitido no prazo máximo de 30 dias.</p><br><br>
