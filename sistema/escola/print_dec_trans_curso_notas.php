                    ...
                    <table class="ls-table1 ls-sm-space bordasimples" width="100%">
                      <thead>
                        <tr height="30">
                          ...
                          <th class="ls-txt-center" style="background-color:#F5F5F5;" colspan="<?php echo $row_criteriosAvaliativos['ca_qtd_av_periodos'] + ($row_criteriosAvaliativos['ca_rec_paralela'] == "S" ? 2 : 1); ?>"><?php echo $p; ?>ª UNIDADE</th>
                      ...
                      <tbody>
						...
						?>
                        <th class="ls-txt-center" width="50"><?php echo exibeTraco($row_notaRecPar['nota_valor'],$row_criteriosAvaliativos['ca_nota_min_av'],$row_criteriosAvaliativos['ca_digitos']); ?></th>
						<?php } ?>
