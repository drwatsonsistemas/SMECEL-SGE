...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body>
	...
	<!--
	<form method="get" name="form1" action="print_comunicadoReuniao.php" class="ls-form ls-form-horizontal ls-box" data-ls-module="form" target="_blank">
	-->	
	<form method="post" name="form1" action="comunicadosAlunos.php" class="ls-form ls-form-horizontal ls-box" data-ls-module="form">	
	<fieldset>
	
  <label class="ls-label col-md-3 col-sm-12">
                <b class="ls-label-text">DATA</b>
      <input type="date" name="data" class="" placeholder="dd/mm/aaaa" autocomplete="off" required>
  </label>
  
  <label class="ls-label col-md-3 col-sm-12">
  <b class="ls-label-text">HORA</b>
              <input type="text" name="hora" value="" size="32" class="hora" required>
            </label>
	...
	<?php do { ?>
       <option value="<?php echo $row_TurmasListar['turma_id']; ?>"><?php echo $row_TurmasListar['turma_nome']; ?></option>
    <?php } while ($row_TurmasListar = mysql_fetch_assoc($TurmasListar)); ?>
        ...
        <input type="submit" value="GERAR COMUNICADO" class="ls-btn-primary">
      </div>
      <input type="hidden" name="comunicado" value="form1">
	...
	locastyle.datepicker.newDatepicker('#dataInicio);
	</script>
