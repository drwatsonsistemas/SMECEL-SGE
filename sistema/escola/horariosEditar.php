                ...
                <div class="ls-box">
                  ...
                  <table class="ls-table ls-no-hover ls-table-striped ls-sm-space ls-table-bordered ls-bg-header">
                    ...
                    <tbody>
                      ...
                      mysql_select_db($database_SmecelNovo, $SmecelNovo);
                      $query_matriz = "SELECT matriz_id, matriz_id_secretaria, matriz_id_etapa, matriz_nome, matriz_obs, matriz_anoletivo, matriz_hash, matriz_dias_letivos, matriz_semanas_letivas, matriz_dias_semana, matriz_minutos_aula, matriz_aula_dia, matriz_criterio_avaliativo
                      FROM smc_matriz WHERE matriz_id = $row_matriz[matriz_id]";
                      $matriz = mysql_query($query_matriz, $SmecelNovo) or die(mysql_error());
                      $row_matriz = mysql_fetch_assoc($matriz);
                      $totalRows_matriz = mysql_num_rows($matriz);
                      ...
                      <?php for ($a = 1; $a <= $row_matriz['matriz_aula_dia']; $a++) { ?>
                        <tr>
                          ...
                          <td class="ls-txt-center"><?php echo exibeHorario($row_Turma['turma_id'],1,$a,$row_matriz['matriz_id']); ?></td>
                          <td class="ls-txt-center"><?php echo exibeHorario($row_Turma['turma_id'],2,$a,$row_matriz['matriz_id']); ?></td>
                          <td class="ls-txt-center"><?php echo exibeHorario($row_Turma['turma_id'],3,$a,$row_matriz['matriz_id']); ?></td>
                          <td class="ls-txt-center"><?php echo exibeHorario($row_Turma['turma_id'],4,$a,$row_matriz['matriz_id']); ?></td>
                          <td class="ls-txt-center"><?php echo exibeHorario($row_Turma['turma_id'],5,$a,$row_matriz['matriz_id']); ?></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>
                ...
                <form method="post" class="ls-form ls-form-horizontal row" name="form1" action="<?php echo $editFormAction; ?>" data-ls-module="form">
                  <fieldset>
                    ...
                    <label class="ls-label col-md-12">
                      ...
                      <label class="ls-label col-md-12">
                        <b class="ls-label-text">DISCIPLINA/COMPONENTE - (EIXO)</b>
                        <div class="ls-custom-select">
