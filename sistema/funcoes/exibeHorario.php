...
return "<a href='gradeEditar.php?horario=$codHorario'><small>$disciplinaNome (<b>$codProfessor</b>)</small></a>";

} else {
	return "<a href='gradeCadastrar.php?turma=$cTurma&dia=$cDia&aula=$cAula'><small class='ls-color-warning'>VAGA</small></a>";
	}
