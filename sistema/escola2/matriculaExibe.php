...
aluno_endereco, aluno_numero, aluno_bairro, aluno_municipio, aluno_uf, aluno_raca, aluno_cep, aluno_nome_social,aluno_tel_pai, aluno_tel_mae, matriz_id, matriz_criterio_avaliativo, ca_id, ca_questionario_conceitos, ca_forma_avaliacao,
        ...
        <div class="row">
          <div class="col-sm-12">
            <?php if (isset($_GET["erro"])) { ?>
              <div class="ls-alert-danger ls-dismissable"> <span data-ls-module="dismiss"
                    ...
                    <?php } else { ?>
                      <?php if ($row_Matricula['ca_questionario_conceitos'] == "S") { ?>
                        <a href="conceitoEfVer.php?c=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>"
                          class="ls-btn-primary ls-btn-xs">Resetar Questionário - EF (em breve)</a>
                      <?php } ?>
                        ...
                        <div class="ls-modal-box">
                          ...
                          <div class="ls-modal-body">
                            <div class="form-container">
                              ...
                              <form id="form-documento" name="form1" action="<?php echo $editFormAction; ?>"
                  ...
                  <div class="col-sm-12 col-md-4">
                    <div class="ls-box">
                      ...
                      <div class="ls-box-footer"> <a
                          ...
                          class="ls-btn ls-btn-xs">Visualizar</a> </div>
                    </div>
                  </div>
                          ...
                          <div class="ls-box-footer">
                            <div class="ls-display-flex ls-flex-column">
                              <a href="conceitoVer.php?c=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>"
                                class="ls-btn ls-btn-xs ls-btn-primary mb-2">Visualizar</a>
                            ...
                            <?php } else { ?>
                              ...
                              <?php if ($row_Matricula['ca_forma_avaliacao'] == "N") { ?>
                                <a href="boletimVer.php?c=<?php echo $row_Matricula['vinculo_aluno_hash']; ?>"
                                  class="ls-btn ls-btn-xs">Visualizar</a>
