  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <p><a href="matriculaExibe.php?cmatricula=<?php echo $colname_matricula; ?>" class="ls-btn-primary">Voltar</a>
        <a href="conceitoEfVerImprimir.php?c=<?php echo $colname_matricula; ?>" class="ls-btn-primary"
          target="_blank">IMPRIMIR BOLETIM</a>
        <a href="conceitoEfVerImprimirDetalhado.php?c=<?php echo $colname_matricula; ?>" class="ls-btn-primary"
          target="_blank">IMPRIMIR BOLETIM DETALHADO</a>
          <a href="reprovar_faltas.php?c=<?php echo $colname_matricula; ?>" class="ls-btn-primary ls-float-right" id="conselho">Reprovar por faltas</a>
      </p>
              ...
              do {
                ...
                <tr>
                  ...
                  <?php for ($i = 1; $i <= $row_criteriosAvaliativos['ca_qtd_periodos']; $i++) { ?>
                    ...
                    $tot[$i] = $tot[$i] + $row_Avaliacao['conc_ef_avaliac'];
                    ...
                    <td width="60" class="ls-txt-center">
                      <?php if ($row_Avaliacao['conceito_itens_legenda'] == "") { ?>
                        -
                      <?php } else { ?>

                        <span class="" style="font-weight:bolder"><?php echo $row_Avaliacao['conceito_itens_legenda']; ?></span>
                      <?php } ?>
                    </td>
