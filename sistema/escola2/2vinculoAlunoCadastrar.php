...
$ct = $_POST['vinculo_aluno_id_turma']; 
  ...
  $insertSQL = sprintf("INSERT INTO smc_vinculo_aluno (vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_id_sec, vinculo_aluno_ano_letivo, vinculo_aluno_data, vinculo_aluno_vacina_data_retorno, vinculo_aluno_transporte, vinculo_aluno_ponto_id, vinculo_aluno_da_casa, vinculo_aluno_historico_transferencia, vinculo_aluno_vacina_atualizada, vinculo_aluno_internet, vinculo_aluno_hash, vinculo_aluno_verificacao) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, '$hash', '$codVerificacao')",
