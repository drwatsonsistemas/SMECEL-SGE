...
FROM smc_turma 
WHERE turma_id_escola = '$row_UsuLogado[usu_escola]' AND turma_ano_letivo = '$anoLetivoRematricula' 
...
FROM smc_turma
WHERE turma_id_escola = '$row_UsuLogado[usu_escola]' AND turma_ano_letivo = '$anoLetivoRematricula' $buscaTurma 
ORDER BY turma_turno, turma_etapa, turma_nome ASC";
...
<?php include_once ("menu-top.php"); ?>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Alunos matriculados na escola para o Ano Letivo de <?php echo $anoLetivoRematricula; ?></h1>
		<!-- CONTEÚDO -->
...
<div class="ls-box-filter">
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
				...
				<li><a href="vinculoAlunoExibirTurmaRematricula.php">- TODAS -</a></li>
				<?php do { ?>
				<li><a href="vinculoAlunoExibirTurmaRematricula.php?ct=<?php echo $row_ListarTurmas['turma_id']; ?>"><?php echo $row_ListarTurmas['turma_nome']; ?> - <?php echo $row_ListarTurmas['turma_turno']; ?></a></li>
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav">
				  ...
				  <li><a href="vinculoAlunoExibirTurmaRematricula.php?st=1<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Matriculados</a></li>
				  <li><a href="vinculoAlunoExibirTurmaRematricula.php?st=2<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Transferidos</a></li>
				  <li><a href="vinculoAlunoExibirTurmaRematricula.php?st=3<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Desistentes</a></li>
				  <li><a href="vinculoAlunoExibirTurmaRematricula.php?st=4<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Falecidos</a></li>
				  <li><a href="vinculoAlunoExibirTurmaRematricula.php?st=5<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Outros</a></li>
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav">
				  ...
				  <li><a href="print_vinculoAlunoExibirTurma.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Imprimir relação de alunos da(s) turma(s)</a></li>
				  <li><a href="print_boletimTurma.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Imprimir Boletim dos Alunos da Turma</a></li>
				  <li><a href="print_mapa_de_notas.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Imprimir mapa de notas</a></li>
				  <li><a href="print_lista_frequencia.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Imprimir lista de frequência/assinaturas</a></li>
				  <li><a href="print_acessoPainelAluno.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Imprimir dados de acesso ao Painel do Aluno</a></li>
				  <li><a href="print_carteirinhaAluno.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Imprimir Carteirinha de Estudante</a></li>
...
<div class="ls-box">
    ...
    <b class="ls-label-text">BUSQUE UM ALUNO</b>
	  ...
	  <div class="suggestionList" id="autoSuggestionsList"> </div>
		...
		vinculo_aluno_hash, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_multietapa
		...
		aluno_id, aluno_cod_inep, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_hash
...
<table class="ls-table ls-table-striped ls-sm-space fonte-tabela">
		<thead>
			<tr>
				...
				<th class="ls-txt-center hidden-xs" width="130">ID ALUNO (INEP)</th>
		...
		<?php } else { ?>
			...
			<span class="ls-float-right"><a href="alunoPesquisarRematricula.php" class="ls-btn-primary ls-ico-user-add"> Rematricular</a></span>
			</p>
