...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Turmas = "SELECT turma_id, turma_id_escola, turma_nome, turma_etapa, turma_turno, turma_total_alunos, turma_ano_letivo FROM smc_turma WHERE turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' ORDER BY turma_turno, turma_etapa, turma_nome ASC";
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_CabecalhoDisciplinas = "SELECT disciplina_id, disciplina_ordem, disciplina_nome, disciplina_nome_abrev FROM smc_disciplina ORDER BY disciplina_ordem ASC";
...
<main class="ls-main ">
  <div class="container-fluid">
    ...
    <h1 class="ls-title-intro ls-ico-home">ATA DE RESULTADOS FINAIS</h1>
    <!-- CONTEÚDO -->
	  ...
	  <div class="ls-box ls-txt-center">
		...
		ENDEREÇO: <?php echo $row_EscolaLogada['escola_endereco']; ?>, <?php echo $row_EscolaLogada['escola_num']; ?>, <?php echo $row_EscolaLogada['escola_bairro']; ?><br>
		<?php echo $row_EscolaLogada['sec_cidade']; ?>-<?php echo $row_EscolaLogada['sec_uf']; ?> CEP: <?php echo $row_EscolaLogada['escola_cep']; ?><br>
		CNPJ: <?php echo $row_EscolaLogada['escola_cnpj']; ?><br>
		<?php echo $row_EscolaLogada['escola_email']; ?> <?php echo $row_EscolaLogada['escola_telefone1']; ?></small>
   	  </div>
	...
	<hr>
	<div>
	<p>Aos_____ dias do mês de_________________ do ano de________ terminou-se o processo de apuração das notas finais e nota global do ano letivo de_______ dos alunos da(o) <?php echo $row_Turmas['turma_nome']; ?> deste estabelecimento de ensino, com os seguintes resultados:</p>
	<br>
	</div>	
      ...
      <table width="100%" class="ls-sm-space ls-table-striped bordasimples">	
	    <thead>
          <tr>
			...
			<tr>
            <?php do { ?>
            <td width="11%" height="180px" align="center" style="border:0px solid #808080; border-right:1px solid #808080; font-size:12px;"><span class="foo"><?php echo $row_CabecalhoDisciplinas['disciplina_nome']; ?></span></td>
          ...
          <?php do { ?>
            <tr>
			  ...
			  <?php
				...
				<tr>
				<?php do { ?>
				<td align="center" width="11%" style="border:0px solid #808080; border-right:1px solid #808080;"><strong>
	...
	<br>
	<p>E, para constar, eu_____________________________________________________________, secretário(a) escolar autorizado(a), lavrarei a presente Ata que vai assinada por mim e pelo(a) diretor(a) do estabelecimento de ensino.</p>
	<br>
	<div class="row ls-txt-center">
		<div class="col-md-6"><p>________________________________________________<br>Secretário(a) Escolar</p></div>
		<div class="col-md-6"><p>________________________________________________<br>Diretor(a) Escolar</p></div>
