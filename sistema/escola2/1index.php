        ...
        <?php } ?>
              ...
              <?php if (isset($_GET['termoAceito'])) { ?>
                <div class="ls-alert-success ls-dismissable">
                  ...
                  Você aceitou a Declaração de Conscientização sobre Utilização de Dados Pessoais para Fins Educacionais. Lembre-se de proteger a privacidade dos nossos alunos.
                </div>
              <?php } ?>
          ...
          <div id="sending-stats" class="row">
            ...
            <div class="col-sm-6 col-md-3" style="background-color:#C6C;">
              <div class="ls-box" style="background-color:#C6C;">
                <div class="ls-box-head ls-background-warning1">
                  <h6 class="ls-title-4" style="color:#FFFFFF;">ALUNOS ESPECIAIS</h6>
                </div>
                <div class="ls-box-body ls-background-warning1"> <strong style="color:#FFFFFF;"><span class="count"><?php echo $totalRows_ListarAlunosVincularEspeciais; ?></span></strong> <small style="color:#FFFFFF;"><?php echo number_format((($totalRows_ListarAlunosVincularEspeciais / $totalRows_ListarAlunosVincular) * 100), 2, '.', ''); ?>%</small> </div>
                <div class="ls-box-footer ls-background-warning1"> <small style="color:#FFFFFF;"><?php echo $totalRows_ListarAlunosVincularEspeciaisLaudo; ?> aluno(as) com laudo</small> <!-- <a href="vinculoAlunoExibirTurma.php" aria-label="Ver alunos" class="ls-btn ls-btn-sm" title="Ver alunos">Ver alunos</a>--> </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-md-3" style="background-color:#060;">
              <div class="ls-box" style="background-color:#060;">
                ...
                <div class="ls-box-body ls-background-warning1"> <strong style="color:#FFFFFF;"><span class="count"><?php echo $totalRows_ListarAlunosVincularZonaRural; ?></span></strong> <small style="color:#FFFFFF;"><?php echo number_format((($totalRows_ListarAlunosVincularZonaRural / $totalRows_ListarAlunosVincular) * 100), 2, '.', ''); ?>%</small> </div>
            ...
            <div class="col-sm-6 col-md-3" style="background-color:#C90;">
              <div class="ls-box" style="background-color:#C90;">
                ...
                <div class="ls-box-body ls-background-warning1"> <strong style="color:#FFFFFF;"><span class="count"><?php echo $totalRows_Transporte ?></span></strong> <small style="color:#FFFFFF;"><?php echo number_format((($totalRows_Transporte / $totalRows_ListarAlunosVincular) * 100), 2, '.', ''); ?>%</small> </div>
                <div class="ls-box-footer ls-background-warning1"> <!-- <a href="vinculoAlunoExibirTurma.php" aria-label="Ver alunos" class="ls-btn ls-btn-sm" title="Ver alunos">Ver alunos</a> --> </div>
              </div>
            </div>
          </div>
...
<div class="ls-modal" id="atualizacao">
  <div class="ls-modal-box">
    <div class="ls-modal-header">
      <button data-dismiss="modal">&times;</button>
      <h4 class="ls-modal-title">Atualização no sistema em <?php echo date("d/m/Y", strtotime($row_Atualizacoes['atualizacoes_data'])); ?> - Versão 1.<?php echo $row_Atualizacoes['atualizacoes_id']; ?></h4>
    </div>
    <div class="ls-modal-body" id="myModalBody">
