	  ...
	  <tr>
	   ...
	   ?>
		...
		<tr>
		  ...
		  <td class="ls-txt-center"><a class="ls-btn ls-color-theme ls-btn-block ls-ico-book" href="diario_turma.php?turma=<?php echo $row_Turmas['turma_id']; ?>"></a></td>
		  <td class="ls-txt-center"><?php if ($row_Turmas['etapa_id_filtro']==1) {  ?><a class="ls-btn ls-color-success ls-btn-block ls-ico-stats" target="_blank" href="diario_rendimento_ed_inf.php?ct=<?php echo $row_Turmas['turma_id']; ?>"></a><?php } else { ?><a class="ls-btn ls-color-success ls-btn-block ls-ico-stats" target="_blank" href="diario_rendimento.php?ct=<?php echo $row_Turmas['turma_id']; ?>"></a><?php } ?></td>
		  <td class="ls-txt-center"><a class="ls-btn ls-color-warning ls-btn-block ls-ico-list" target="_blank" href="diario_frequencia.php?ct=<?php echo $row_Turmas['turma_id']; ?>"></a></td>
		  <td class="ls-txt-center">
          
          
          <?php if ($row_Turmas['etapa_id_filtro']==1) {  ?><a class="ls-btn ls-color-success ls-btn-block ls-ico-export" target="_blank" href="print_diario_ed_inf.php?turma=<?php echo $row_Turmas['turma_id']; ?>"></a><?php } else { ?><a class="ls-btn ls-color-success ls-btn-block ls-ico-export" target="_blank" href="print_diario.php?turma=<?php echo $row_Turmas['turma_id']; ?>"></a><?php } ?>
