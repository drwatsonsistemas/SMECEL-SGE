...
<head>
	...
	<title>ALUNOS APROVADOS PELO CONSELHO DE CLASSE | SMECEL - Sistema de Gestão Escolar</title>
...
<body onload="self.print();">
	...
	<div class="container-fluid">
		...
		<div class="ls-box ls-txt-center" style="text-transform: uppercase;">
			ALUNOS APROVADOS PELO CONSELHO DE CLASSE
		</div>
		...
		WHERE vinculo_aluno_conselho = 'S' AND vinculo_aluno_ano_letivo = '$anoLetivo' AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' 
