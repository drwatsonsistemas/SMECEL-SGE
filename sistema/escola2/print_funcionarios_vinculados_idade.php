...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_FuncionariosVinculados = "SELECT vinculo_id, vinculo_id_escola, vinculo_id_funcionario, vinculo_id_funcao, vinculo_carga_horaria, 
vinculo_data_inicio, vinculo_obs, func_id, func_nome, func_cpf, func_matricula, func_data_nascimento, funcao_id, funcao_nome 
...
<title>RELAÇÃO DE FUNCIONÁRIOS POR IDADE | SMECEL - Sistema de Gestão Escolar</title>
<meta charset="utf-8">
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<br><br>
		<p><strong>RELAÇÃO DE FUNCIONÁRIOS POR IDADE</strong></p>
        ...
        <table width="100%" class="ls-sm-space ls-table-striped bordasimples">
          <thead>
            <tr>
              ...
              <th class="ls-data-descending ls-txt-center">IDADE</th>
          ...
          <tbody>
			...
			?>
              <tr>
                ...
                <td class="ls-txt-center"><?php echo idade($row_FuncionariosVinculados['func_data_nascimento']); ?></td>
