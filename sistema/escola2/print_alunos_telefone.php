...
if (isset($_GET['zona'])) {
  $zona = $_GET['zona'];
  $CodZona = "AND aluno_localizacao = $zona ";
} else {
	$CodZona = "";
	}
...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>ALUNOS POR BAIRRO | SMECEL - Sistema de Gestão Escolar</title>
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
	...
	<body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<div class="ls-box">
		<span class="ls-float-left"><?php if ($row_EscolaLogada['escola_logo']<>"") { ?><img src="../../img/logo/<?php echo $row_EscolaLogada['escola_logo']; ?>" alt="" width="100px" /><?php } else { ?><img src="../../img/brasao_republica.png" alt="" width="80px" /><?php } ?></span>
		<p><?php echo $row_EscolaLogada['escola_nome']; ?></p>
		<p><?php echo $row_ExibirTurmas['turma_nome']; ?> <?php echo $row_ExibirTurmas['turma_turno']; ?></p>
		</div>	
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_localizacao, aluno_endereco, aluno_numero, aluno_bairro, aluno_filiacao1, aluno_hash,
		aluno_telefone, aluno_celular, aluno_emergencia_tel1, aluno_emergencia_tel2, aluno_tel_mae, aluno_tel_pai
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $CodZona $stqry
		ORDER BY aluno_bairro ASC";
		...
		<h5 class="ls-title-5 ls-txt-center"><?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno']; ?> - CONTATOS</h5>
		...
		<thead>
			...
			<?php do { ?>
				...
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_telefone']; ?></td> 
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_celular']; ?> </td>
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_emergencia_tel1']; ?></td> 
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_emergencia_tel2']; ?> </td>
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_tel_mae']; ?> </td>
					<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_tel_pai']; ?> </td>
