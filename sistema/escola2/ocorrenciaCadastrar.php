...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO smc_ocorrencia (ocorrencia_id_aluno, ocorrencia_id_turma, ocorrencia_id_escola, ocorrencia_ano_letivo, ocorrencia_data, ocorrencia_hora, ocorrencia_tipo, ocorrencia_afastamento_de, ocorrencia_afastamento_ate, ocorrencia_total_dias, ocorrencia_descricao) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['ocorrencia_id_aluno'], "int"),
                       GetSQLValueString($_POST['ocorrencia_id_turma'], "int"),
                       GetSQLValueString($_POST['ocorrencia_id_escola'], "int"),
                       GetSQLValueString($_POST['ocorrencia_ano_letivo'], "text"),
...
// ** REGISTRO DE LOG DE USUÁRIO **
  ...
  $insertGoTo = "matriculaExibe.php?ocorrenciaRegistrada";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['cmatricula'])) {
  $colname_Vinculo = $_GET['cmatricula'];
}
mysql_select_db($database_SmecelNovo, $SmecelNovo);
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">CADASTRAR OCORRÊNCIA</h1>
		<!-- CONTEÚDO -->
...
<div class="ls-modal" data-modal-blocked id="myAwesomeModal">
  <div class="ls-modal-box">
    <div class="ls-modal-header">
      ...
      <p><h3>REGISTRAR OCORRÊNCIA</h3></p>
	  <div class="ls-box">
    ...
    <div class="ls-modal-body" id="myModalBody">
		...
		<fieldset>
              ...
              <input type="text" name="ocorrencia_data" value="<?php echo date('d/m/Y'); ?>" size="32" class="date">
			  </label>

			  <label class="ls-label col-md-6"><b class="ls-label-text">HORA DA OCORRÊNCIA</b>  
              <input type="text" name="ocorrencia_hora" value="" size="32" class="hora">
			  </label>
            ...
            <div class="ls-custom-select">
			  <select name="ocorrencia_tipo" onChange="javascript:desabilita_datas(this.value);" required>
                <option value="" >-</option>
                <option value="1" id="1" <?php if (!(strcmp(1, ""))) {echo "SELECTED";} ?>>ADVERTÊNCIA</option>
                <option value="2" id="2" <?php if (!(strcmp(2, ""))) {echo "SELECTED";} ?>>SUSPENSÃO</option>
                <option value="4" id="4" <?php if (!(strcmp(4, ""))) {echo "SELECTED";} ?>>CONVOCAÇÃO</option>
                <option value="3" id="3" <?php if (!(strcmp(3, ""))) {echo "SELECTED";} ?>>OUTRAS</option>
              </select>
			  </div>
			  </label>
			  
			  <label class="ls-label col-md-6"><b class="ls-label-text">DATA DO AFASTAMENTO</b>  
              <input type="text" id="ocorrencia_afastamento_de" name="ocorrencia_afastamento_de" value="" size="32" class="date">
			  </label>
			  
			  <label class="ls-label col-md-6"><b class="ls-label-text">DATA DO RETORNO</b>  
              <input type="text" id="ocorrencia_afastamento_ate" name="ocorrencia_afastamento_ate" value="" size="32" class="date">
			  </label>

			  <label class="ls-label col-md-6"><b class="ls-label-text">Nº DE DIAS AFASTADOS</b>  		  
              <input type="text" id="ocorrencia_total_dias" name="ocorrencia_total_dias" value="" size="32">
			  </label>

			  <label class="ls-label col-md-12"><b class="ls-label-text">DESCRIÇÃO DA OCORRÊNCIA</b>  
              <textarea name="ocorrencia_descricao" cols="50" rows="5"  required></textarea>
			  </label>
			  
			  </fieldset>
			  
			  <div class="ls-actions-btn">
				<input type="submit" value="REGISTRAR OCORRÊNCIA" class="ls-btn-primary">
				<a href="matriculaExibe.php?cmatricula=<?php echo $row_Vinculo['vinculo_aluno_hash']; ?>" class="ls-btn">CANCELAR</a>
			</div>


		  <input type="hidden" name="ocorrencia_id_aluno" value="<?php echo $row_Vinculo['vinculo_aluno_id_aluno']; ?>">
          <input type="hidden" name="ocorrencia_id_turma" value="<?php echo $row_Vinculo['vinculo_aluno_id_turma']; ?>">
          <input type="hidden" name="ocorrencia_id_escola" value="<?php echo $row_Vinculo['vinculo_aluno_id_escola']; ?>">
          <input type="hidden" name="ocorrencia_ano_letivo" value="<?php echo $row_Vinculo['vinculo_aluno_ano_letivo']; ?>">
          <input type="hidden" name="MM_insert" value="form1">
			...
			<input type="hidden" name="detalhes" value="<?php echo $row_Vinculo['aluno_nome']; ?> - <?php echo $row_Vinculo['turma_nome']; ?>">
