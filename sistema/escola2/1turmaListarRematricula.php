...
<?php include_once ("menu-top.php"); ?>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Listar Turmas - Ano Letivo <?php echo $anoLetivoRematricula; ?> <strong class="ls-color-warning">Rematrícula</strong></h1>
			...
			<a class="ls-btn-primary ls-ico-windows" href="turmaCadastrarRematricula.php"> Cadastrar Turma (<?php echo $anoLetivoRematricula; ?>)</a>
			<a class="ls-btn-primary ls-ico-windows" href="turmas_remanejar.php"> Remanejar turmas (de <?php echo $row_AnoLetivo['ano_letivo_ano']; ?> para <?php echo $anoLetivoRematricula; ?>)</a>
			<a class="ls-btn-primary ls-ico-paint-format" href="print_turmaListarRematricula.php" target="_blank"> Imprimir</a>
            ...
            <table class="ls-table ls-table-striped ls-sm-space">
              <thead>
                <tr>
                  ...
                  <th>TURMA  <a href="#" class="ls-ico-help" data-trigger="hover" data-ls-module="popover" data-placement="right" data-content="Clique para visualizar os alunos da turma." data-title="Atenção"></a></th>
                  ...
                  <th class="ls-txt-center" width="80">REL</th>
                  </tr>
              </thead>
			  <tbody>
              <?php 
			  ...
			  do { ?>
                  ...
                  <tr>
                    ...
                    <td class=""><a href="parecer_turma.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>" title="Parecer da turma"><?php if ($row_TurmasListar['turma_parecer']<>"") { ?><span class="ls-ico-text ls-ico-right"></span></a><?php } ?></td>
                    <td class=""><span class="ls-tooltip-right" aria-label="<?php echo $row_TurmasListar['etapa_nome']; ?>"><a href="vinculoAlunoExibirTurmaRematricula.php?ct=<?php echo $row_TurmasListar['turma_id']; ?>"><?php echo $row_TurmasListar['turma_nome']; ?></a></span></td>
					...
					<div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
					  ...
					  <ul class="ls-dropdown-nav">					  
						  ...
						  <li><a href="javascript:func()" onclick="confirmaExclusao('<?php echo $row_TurmasListar['turma_id']; ?>','<?php echo $row_TurmasListar['turma_nome']; ?>')" class="ls-ico-cancel-circle ls-color-danger">Excluir turma</a></li>
					  </ul>
					</div>
					...
					<div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
					  ...
					  <ul class="ls-dropdown-nav">
					  	  ...
					  	  <li><a href="parecer_turma.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>" class="ls-ico-text" target="_blank" title="Parecer da Turma">Parecer da Turma</a> </li>
