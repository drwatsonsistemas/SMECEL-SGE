...
etapa_id, etapa_nome, etapa_limite_turma, etapa_id_filtro, turma_multisseriada, matriz_id, matriz_nome, matriz_ativa,
CASE turma_turno
...
WHERE turma_tipo_atendimento = '1' AND turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$anoLetivo' 
...
<body>
  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <h1 class="ls-title-intro ls-ico-home">Listar Turmas - Ano Letivo <?php echo $anoLetivo; ?>
      </h1>
      ...
      <div data-ls-module="dropdown" class="ls-dropdown ls-float-right1">
        ...
        <ul class="ls-dropdown-nav">
          ...
          <li>
            <a href="turmaListar.php?ano=<?php echo $anoLetivo;
            if (isset($_GET['st']))
          ...
          <?php do { ?>
            <li>
              <a href="turmaListar.php?ano=<?php echo $row_Ano['ano_letivo_ano'];
              if (isset($_GET['st']))
                echo '&st=' . $_GET['st']; ?>" target="" title="Diários">
          ...
          <table class="ls-table ls-table-striped ls-sm-space">
            <thead>
              <tr>
                ...
                <th class="ls-txt-center hidden-xs">ETAPA</th>
            ...
            <tbody>
              ...
              do {
                ...
                <tr>
                  ...
                  <td class="ls-txt-center"><a
                      href="vinculoAlunoExibirTurma.php?ct=<?php echo $row_TurmasListar['turma_id']; ?><?php if(isset($_GET['ano'])){echo "&ano=$anoLetivo"; } ?>"><?php echo $row_TurmasListar['turma_id']; ?></a>
                  </td>
                  ...
                  <td class="ls-txt-center hidden-xs"><?php echo $row_TurmasListar['etapa_nome']; ?></td>
                  ...
                  <td class="ls-txt-left hidden-xs">
                    ...
                    if (!empty($row_TurmasListar['turma_total_alunos'])) {
                    ...
                    <span
                      ...
                      FROM smc_turma WHERE turma_id = '$row_TurmasListar[turma_id]'
                      ";
                    ...
                    <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                      ...
                      <ul class="ls-dropdown-nav">
                        ...
                        <li><a href="print_mapa_de_frequencia_avulso.php?ct=<?php echo $row_TurmasListar['turma_id']; ?>"
                            class="ls-ico-text" target="_blank" title="Mapa de Notas">Mapa de frequência (avulso)</a> </li>
                        <li><a data-ls-module="modal"
                            data-target="#myAwesomeModal<?php echo $row_TurmasListar['turma_id']; ?>" class="ls-ico-text"
                            style="cursor:pointer" title="Mapa de frequencia avulso">Mapa de frequência (avulso) -
                            MENSAL</a> </li>
                        ...
                        <li><a href="mapa.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>"
                            class="ls-ico-book ls-divider" title="Mapa de alunos">Mapa de alunos (Google Maps)</a>
                        </li>
              ...
              -->
                  ...
                  <td class="ls-txt-center hidden-xs">
                    ...
                    <div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
                      ...
                      <ul class="ls-dropdown-nav">
                        ...
                        <li><a href="<?php echo $row_TurmasListar['etapa_id_filtro'] == 1 ? 'boletimCadastrarBoletimTurmaConceito.php' : 'boletimCadastrarBoletimTurma.php' ?>?turma=<?php echo $row_TurmasListar['turma_id']; ?>"
                            class="ls-ico-edit-admin">Gerar boletim da turma</a></li>
                        <li><a id="resetarBoletim<?php echo $row_TurmasListar['turma_id']; ?>"
                            class="ls-ico-spinner ls-cursor-pointer">Resetar boletim da turma</a></li>
                        <li><a href="javascript:func()"
                            onclick="confirmaExclusao('<?php echo $row_TurmasListar['turma_id']; ?>', '<?php echo htmlspecialchars($row_TurmasListar['turma_nome'], ENT_QUOTES, 'UTF-8'); ?>');"
                ...
                <div class="ls-modal" id="myAwesomeModal<?php echo $row_TurmasListar['turma_id']; ?>">
                  <div class="ls-modal-small">
                    <div class="ls-modal-header">
                      <button data-dismiss="modal">&times;</button>
                      <h4 class="ls-modal-title">Selecione o mês de referência</h4>
                    </div>

                    <div class="ls-modal-body" id="myModalBody">
                      <form action="print_mapa_de_frequencia_avulso_mensal.php" target="_blank" method="GET"
                        class="ls-form ls-form-inline row">
                        <label class="ls-label col-md-12">
                          <b class="ls-label-text">Mês</b>
                          <div class="ls-custom-select">
                            <select class="ls-custom" name="mes">
                        ...
                        <label class="ls-label col-md-12">
                          ...
                          <input type="number" class="ls-no-spin" name="ano" value="<?= $anoLetivo ?>"
                            required>
                          <input type="hidden" name="ct" value="<?php echo $row_TurmasListar['turma_id']; ?>" required>
                        </label>

                    </div>
                    <div class="ls-modal-footer">
                      <button type="submit" class="ls-btn-primary">GERAR MAPA DE FREQUÊNCIA</button>
                    </div>
                    </form>
                  </div>
                </div><!-- /.modal -->
                <script type="text/javascript">
                  $(document).ready(function () {
                    $("#resetarBoletim<?php echo $row_TurmasListar['turma_id']; ?>").click(function () {
                      Swal.fire({
                        title: "Deseja resetar o boletim",
                        ...
                        if (result.isConfirmed) {
                          if(<?php echo $row_TurmasListar['etapa_id_filtro']; ?> == 1){
                            window.location.href = "boletimResetarBoletimTurmaConceito.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>";
                          }else{
                            window.location.href = "boletimResetarBoletimTurma.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>";
                          }
  ...
  <script language="Javascript">
    function confirmaExclusao(c, turma) {
      ...
      if (resposta == true) {
        window.location.href = "turmaExcluir.php?c=" + c + "&turma=" + turmaEncoded;
      }
    }
  </script>
