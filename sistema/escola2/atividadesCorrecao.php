...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_ListaAtividades = "SELECT 
smc_ativ_corr_id, smc_ativ_corr_data, smc_ativ_corr_hora, smc_ativ_corr_id_escola, smc_ativ_corr_id_turma, 
smc_ativ_corr_caminho, smc_ativ_corr_hash, smc_ativ_corr_status, 
smc_ativ_corr_obs, turma_id, turma_nome 
FROM smc_atividade_correcao 
INNER JOIN smc_turma ON turma_id = smc_ativ_corr_id_turma 
WHERE smc_ativ_corr_id_escola = '$codEscola' ORDER BY smc_ativ_corr_id DESC";
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <table  class="ls-table" width="100%">
    ...
    <tbody>
      <?php do { ?>
        <tr>
          <td class="ls-txt-center">#<?php echo $row_ListaAtividades['smc_ativ_corr_id']; ?></td>
          <td class="ls-txt-center"><?php echo inverteData($row_ListaAtividades['smc_ativ_corr_data']); ?></td>
          <td class="ls-txt-center"><?php echo $row_ListaAtividades['turma_nome']; ?></td>
          <td><small><?php echo $row_ListaAtividades['smc_ativ_corr_obs']; ?></small></td>
          <td>
		  
		  <?php 
			if ($row_ListaAtividades['smc_ativ_corr_status']==0) { ?> 
                <a href="atividadesCorrecaoEditar.php?hash=<?php echo $row_ListaAtividades['smc_ativ_corr_hash']; ?>"><img src="../../img/ampulheta.png" width="30" border="0" title="Atividade aguardando visualização"></a>
             <?php } else if ($row_ListaAtividades['smc_ativ_corr_status']==1) { ?> 
             	<img src="../../img/imprimir.png" width="30" border="0" title="Atividade verificada">
             <?php } else if ($row_ListaAtividades['smc_ativ_corr_status']==2) { ?>  
             	<img src="../../img/check.png" width="30" border="0" title="Verificação concluída e impressa">
			 <?php } ?> 
