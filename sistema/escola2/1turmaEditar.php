...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE smc_turma SET turma_nome=%s, turma_etapa=%s, turma_matriz_id=%s, turma_turno=%s, turma_total_alunos=%s, turma_multisseriada=%s WHERE turma_id=%s",
...
// ** REGISTRO DE LOG DE USUÁRIO **
  ...
  $updateGoTo = "turmaListar.php?editada";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_turmaEditar = sprintf("SELECT turma_id, turma_id_escola, turma_matriz_id, turma_nome, turma_etapa, turma_turno, turma_total_alunos, turma_multisseriada FROM smc_turma WHERE turma_id_escola = $row_EscolaLogada[escola_id] AND turma_id = %s", GetSQLValueString($colname_turmaEditar, "int"));
      ...
      <div class="container-fluid">
        ...
        <form method="post" class="ls-form-horizontal" name="form1" action="<?php echo $editFormAction; ?>" data-ls-module="form">
            ...
            <label class="ls-label col-md-12">
              ...
              <input type="text" name="turma_nome" value="<?php echo htmlentities($row_turmaEditar['turma_nome'], ENT_COMPAT, 'utf-8'); ?>" size="32">
           </label>
            ...
            <label class="ls-label col-md-6 col-xs-12">
              ...
              <select name="turma_etapa" class="ls-select">
                <?php do {  ?>
                <option value="<?php echo $row_listarEtapa['etapa_id']?>" <?php if (!(strcmp($row_listarEtapa['etapa_id'], htmlentities($row_turmaEditar['turma_etapa'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_listarEtapa['etapa_nome']?></option>
			...
			<label class="ls-label col-md-6 col-xs-12">
			  ...
			  <option value="">Escolha...</option>
                <?php do {  ?>
                <option value="<?php echo $row_Matriz['matriz_id']?>" <?php if (!(strcmp($row_Matriz['matriz_id'], htmlentities($row_turmaEditar['turma_matriz_id'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_Matriz['matriz_nome']?></option>
            ...
            <label class="ls-label col-md-7 col-xs-12">
              ...
              <select name="turma_turno" class="ls-select">
                <option value="0" <?php if (!(strcmp(0, htmlentities($row_turmaEditar['turma_turno'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Integral</option>
                <option value="1" <?php if (!(strcmp(1, htmlentities($row_turmaEditar['turma_turno'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Matutino</option>
                <option value="2" <?php if (!(strcmp(2, htmlentities($row_turmaEditar['turma_turno'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Vespertino</option>
                <option value="3" <?php if (!(strcmp(3, htmlentities($row_turmaEditar['turma_turno'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Noturno</option>
              </select>
              </div>
            </label>
            ...
            <label class="ls-label col-md-5 col-xs-12">
              ...
              <input type="text" name="turma_total_alunos" value="<?php echo htmlentities($row_turmaEditar['turma_total_alunos'], ENT_COMPAT, 'utf-8'); ?>" size="32">
            </label>
         ...
         <label class="ls-label col-md-4 col-sm-12">
          ...
          <input type="checkbox" name="turma_multisseriada" id="turma_multisseriada" value=""  <?php if (!(strcmp(htmlentities($row_turmaEditar['turma_multisseriada'], ENT_COMPAT, 'utf-8'),"1"))) {echo "checked=\"checked\"";} ?>>
