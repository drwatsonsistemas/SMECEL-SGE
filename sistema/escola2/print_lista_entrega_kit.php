...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>LISTA ENTREGA DE KIT | SMECEL - Sistema de Gestão Escolar</title>
        ...
        <?php $contaAlunos = 1; ?>
			...
			<?php do { ?>
				...
				<div class="ls-box1" style="page-break-inside: avoid; padding: 20px 0; display:block;">
					...
					Declaro, para os devidos fins, que o(a) aluno(a) <strong><?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != "" ? $row_ExibirAlunosVinculados["aluno_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?></strong>,
					...
					recebeu da Secretaria Municipal de Educação de <?php echo $row_EscolaLogada['sec_cidade']; ?>, o "Kit Merenda", referente ao período em que o estudante estaria sendo atendido na unidade escolar.
					</p>
