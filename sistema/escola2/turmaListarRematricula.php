...
<body>
  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <a class="ls-btn-primary ls-ico-windows" href="turmaCadastrarRematricula.php"> Cadastrar Turma
        (<?php echo $anoLetivoRematricula; ?>)</a>
      <a class="ls-btn-primary ls-ico-windows" href="turmas_remanejar.php"> Remanejar turmas (de
        <?php echo $row_AnoLetivo['ano_letivo_ano']; ?> para <?php echo $anoLetivoRematricula; ?>)</a>
      <a class="ls-btn-primary ls-ico-paint-format" href="print_turmaListarRematricula.php" target="_blank"> Imprimir
        turmas</a>
      <a class="ls-btn-primary ls-ico-paint-format" href="print_vinculoAlunoExibirTurmaRematricula.php" target="_blank">
        Imprimir alunos das turmas</a>
