  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">RELAÇÃO DE ALUNOS de 13 e 14 ANOS</h1>
		<!-- CONTEÚDO -->
		...
		do { ?>
		  ...
		  $num = 1;
		  do { ?>
		  	<?php if ( (idade($row_Alunos['aluno_nascimento']) == 13) || (idade($row_Alunos['aluno_nascimento']) == 14) ) { ?>
		  ...
		  <a href="print_alunos13e14anos.php" class="ls-ico-paint-format ls-btn" target="_blank">Imprimir relação de alunos</a>
		  </p>
