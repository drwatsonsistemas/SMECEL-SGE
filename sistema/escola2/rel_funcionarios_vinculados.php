...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_FuncionariosVinculados = "SELECT vinculo_id, vinculo_id_escola, vinculo_id_funcionario, vinculo_id_funcao, vinculo_carga_horaria, vinculo_data_inicio, vinculo_obs, func_id, func_nome, funcao_id, funcao_nome FROM smc_vinculo INNER JOIN smc_func ON func_id = vinculo_id_funcionario INNER JOIN smc_funcao ON funcao_id = vinculo_id_funcao WHERE vinculo_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_status != 2 $ordem";
    ...
    <main class="ls-main ">
      <div class="container-fluid">
		...
		<div class="ls-txt-center">
			<a class="ls-btn ls-ico-windows" href="print_funcionarios_vinculados.php" target="_blank"> RELAÇÃO GERAL</a>
			<a class="ls-btn ls-ico-windows" href="print_funcionarios_vinculados_documentos.php" target="_blank"> DOCUMENTACAO</a>
		</div>
