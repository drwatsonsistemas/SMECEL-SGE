...
WHERE turma_tipo_atendimento = '3' AND turma_id_escola = $row_EscolaLogada[escola_id] AND turma_ano_letivo = '$anoLetivo' 
...
<?php include_once ("menu-top.php"); ?>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Listar Turmas de Atividade Complementar - Ano Letivo <?php echo $anoLetivo; ?></h1>
        ...
        <ul class="ls-dropdown-nav">
          ...
          <li>
            <a href="turmaListarComplementar.php?ano=<?php echo $anoLetivo;
            if (isset($_GET['st']))
          ...
          <?php do { ?>
            <li>
              <a href="turmaListarComplementar.php?ano=<?php echo $row_Ano['ano_letivo_ano'];
              if (isset($_GET['st']))
                echo '&st=' . $_GET['st']; ?>" target="" title="Diários">
            ...
            <table class="ls-table ls-table-striped ls-sm-space">
              <thead>
                <tr>
                  ...
                  <th class="ls-txt-center" width="100px">CÓD <a href="#" class="ls-ico-help" data-trigger="hover" data-ls-module="popover" data-placement="right" data-content="Clique para visualizar os alunos da turma." data-title="Atenção"></a></th>
			  ...
			  do { ?>
                  ...
                  <tr>
                    ...
                    <td class="ls-txt-center"><a href="vinculoAlunoExibirTurma.php?ct=<?php echo $row_TurmasListar['turma_id']; ?><?php if(isset($_GET['ano'])){echo "&ano=$anoLetivo"; } ?>"><?php echo $row_TurmasListar['turma_id']; ?></a></td>
                    <td class="ls-txt-left"><?php echo $row_TurmasListar['turma_nome']; ?><?php if ($row_TurmasListar['turma_multisseriada']=="1") { ?><br><i>(multisseriada)</i><?php } ?></td>
                    <td class="ls-txt-center hidden-xs"><?php if ($row_TurmasListar['matriz_id']==0) { echo "Não se aplica"; } else { echo $row_TurmasListar['matriz_nome']; } ?> <?php if ($row_TurmasListar['matriz_ativa']=="N") { ?><a href="#" class="ls-ico-help ls-float-right" data-trigger="hover" data-ls-module="popover" data-placement="left" data-content="Esta matriz está <strong class='ls-color-danger'>desatualizada</strong>. Clique em EDITAR TURMA e selecione a matriz correta." data-title="ATENÇÃO"></a><?php } ?></td>                    <td class="ls-txt-center hidden-xs"><?php echo $row_TurmasListar['turma_turno_descricao']; ?></td>
                ...
                -->	
					...
					<div data-ls-module="dropdown" class="ls-dropdown ls-pos-right">
					  ...
					  <ul class="ls-dropdown-nav">					  
						  ...
						  <li><a href="turmaEditar_caracteristicas.php?c=<?php echo $row_TurmasListar['turma_id']; ?>" class="ls-ico-edit-admin">Editar características</a></li>
            <li><a href="boletimCadastrarBoletimTurma.php?turma=<?php echo $row_TurmasListar['turma_id']; ?>" class="ls-ico-edit-admin">Gerar boletim da turma</a></li>
