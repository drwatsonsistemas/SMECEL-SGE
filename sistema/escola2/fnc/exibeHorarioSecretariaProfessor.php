...
function exibeHorario($turma, $dia, $aula, $professor){
...
WHERE ch_lotacao_turma_id = $cTurma AND ch_lotacao_dia = $cDia AND ch_lotacao_aula = $cAula AND ch_lotacao_professor_id = $professor
";
...
return "<small><span class=\"ls-display-none-xs\">$disciplinaNome</span><span class=\"ls-display-none-sm ls-display-none-md ls-display-none-lg\">$disciplinaNomeAbrev</span> (<b>$codProfessor</b>)</small>";

} else {
	return "<small class='ls-color-warning'>-</small>";
	}
