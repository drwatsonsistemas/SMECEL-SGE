...
<?php if ($row_matricula['vinculo_aluno_conselho_reprovado']=="S") { ?>
	<br>
    <div class="ls-alert-warning">Aluno reprovado pelo Conselho de Classe.</div>
<?php } ?>
                    ...
                    <table class="ls-table1 ls-sm-space bordasimples" width="100%">
                      ...
                      <tbody>
                        <?php do { ?>
                          ...
                          <?php $ru = 0; ?>
                          <?php for ($a = 1; $a <= $row_criteriosAvaliativos['ca_qtd_av_periodos']; $a++) { ?>
                          <td class="ls-txt-center" style="text-align:center">
                        ...
                        ?>
                          ...
                          <input 
                              ...
                              value="<?php echo $row_nota['nota_valor']; ?>" 
                              notaAnterior="<?php echo $row_nota['nota_valor']; ?>" 
                              disciplina="<?php echo $row_disciplinasMatriz['disciplina_nome']; ?>" 
                              class="ls-field-md nota"
							  style="display:block; text-align:center; width:50px; <?php if ($row_nota['nota_valor'] >= $row_criteriosAvaliativos['ca_nota_min_av']) { echo "; color:blue;"; } else { echo "; color:red;"; }; ?>" 
						...
						?>
                        <td class="ls-txt-center" width="40">
                        ...
                        <input 
							  ...
							  style="display:block; width:50px; <?php if ($row_notaRecPar['nota_valor'] >= $row_criteriosAvaliativos['ca_nota_min_recuperacao_final']) { echo "; color:blue;"; } else { echo "; color:red;"; }; ?>" 
                        ...
                        ?>
                           ...
                           <input 
                              ...
                              disabled="true"
							  style="display:block; width:50px; <?php if ($row_notaAf['nota_valor'] >= $row_criteriosAvaliativos['ca_nota_min_recuperacao_final']) { echo "; color:blue;"; } else { echo "; color:red;"; }; ?>" 
                              <?php if ($totalRows_notaAf==0) { echo "disabled"; } ?>
                          >
                           
                           </td>
                          <td class="ls-txt-center" width="60">
				...
				?>
					 ...
					 <div class="ls-box">
						 <a href="boletimVer.php?c=<?php echo $colname_matricula; ?>" class="ls-btn-primary">Voltar</a>
						 <a href="javascript:void(0);" class="ls-btn ls-float-right" id="av_final">Lançar Avaliação Final</a>
						 <a href="javascript:void(0);" class="ls-btn ls-float-right recarregar">Recalcular médias</a>
						 <a href="conselho_lancar.php?c=<?php echo $colname_matricula; ?>" class="ls-btn ls-float-right" id="conselho">Conselho de Classe</a>
						 <a href="reprovar_faltas.php?c=<?php echo $colname_matricula; ?>" class="ls-btn ls-float-right" id="conselho">Reprovar por faltas</a>
                     </div>
