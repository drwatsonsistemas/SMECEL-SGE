...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		SELECT 
		vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_ano_letivo, aluno_nome_social,
		vinculo_aluno_hash, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_data, vinculo_aluno_multietapa, etapa_id, etapa_nome, etapa_nome_abrev,
		...
		ORDER BY vinculo_aluno_data ASC";
		...
		<thead>
			<tr>
				...
				<th width="25%" class="ls-txt-center">FILIAÇÃO</th>
				<th class="ls-txt-center hidden-xs" width="130">DATA DE MATRÍCULA</th>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-center"><?php echo inverteData($row_ExibirAlunosVinculados['vinculo_aluno_data']); ?></td>
