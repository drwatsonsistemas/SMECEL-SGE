...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>RELAÇÃO DE ENDEREÇO | SMECEL - Sistema de Gestão Escolar</title>
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<p class="ls-txt-center">RELAÇÃO DE ENDEREÇO</p>
		...
		<thead>
			...
			<?php do { ?>
				<tr style="">
					...
					<td>
					<?php if ($row_ExibirAlunosVinculados['aluno_localizacao']=="1") { ?>URBANA<?php } else { ?>RURAL<?php } ?>					
					</td>
