        ...
        <label class="ls-label col-md-12 col-sm-12">
                    ...
                    <div class="ls-custom-select">
                        <select name="turma_pai_id" class="ls-select">
                            <option value="" <?php if (is_null($row_turmaEditar['turma_pai_id'])) {echo "SELECTED";} ?>>Nenhuma (Turma independente ou pai)</option>
                            <?php if ($totalRows_TurmasPai > 0) { do { ?>
                                <option value="<?php echo $row_TurmasPai['turma_id']?>" <?php if (!(strcmp($row_TurmasPai['turma_id'], htmlentities($row_turmaEditar['turma_pai_id'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_TurmasPai['turma_nome']?></option>
