...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		aluno_id, aluno_nome, aluno_nome_social,aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_aceite_termos
		...
		<thead>
			<tr>
				...
				<th width="40%" class="ls-txt-center">ACEITE</th>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					$contaAlunos++;		
					?></td>
					<td><?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != ""? $row_ExibirAlunosVinculados["alunos_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?> 
					...
					<td class="ls-txt-center"><?php if ($row_ExibirAlunosVinculados['aluno_aceite_termos']=="S") { echo "ENTROU"; } ?></td>
