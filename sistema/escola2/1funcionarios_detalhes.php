...
vinculo_id, vinculo_id_funcionario,
CASE func_regime
WHEN 1 THEN 'EFETIVO'
...
WHERE func_id_sec = '$row_EscolaLogada[escola_id_sec]' AND func_id = %s", GetSQLValueString($colname_funcionario, 'int'));
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_logins = "SELECT login_professor_id, login_professor_id_professor, login_professor_data_hora FROM smc_login_professor WHERE login_professor_id_professor = '$colname_funcionario' ORDER BY login_professor_id DESC";
...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Cursos = sprintf('SELECT curso_id, curso_id_funcionario, curso_descricao, curso_instituicao, curso_dt_inicio, curso_dt_final, curso_ch, curso_observacao, curso_recebe FROM smc_curso WHERE curso_id_funcionario = %s', GetSQLValueString($colname_Cursos, 'int'));
...
WHERE titulacao_func_id = $colname_funcionario";
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <div class="ls-box ls-lg-space ls-ico-bg">
          ...
          Regime: <strong><?php echo $row_funcionario['func_regime']; ?></strong><br>
...
<div class="ls-tabs-container">
  ...
  <tbody>
    ...
    <tr>
      <td><small>CNH</small><br><strong><?php echo $row_funcionario['func_cnh_num']; ?> <?php echo $row_funcionario['func_categoria']; ?></strong></td>
  ...
  <div class="ls-tabs-btn">
      <ul class="ls-tabs-btn-nav">
        ...
        <li class="col-md-6 col-xs-6"><a href="senhaProfessor.php?c=<?php echo $colname_funcionario; ?>" class="ls-btn">SENHA DE ACESSO</a></li>
      </ul>
    </div>
  </div>
...
<table class="ls-table">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_formacao['titulacao_tipo']; ?></td>
        <td><?php echo $row_formacao['formacao_nome']; ?></td>
        <td><?php echo $row_formacao['titulacao_horas']; ?></td>
      </tr>
...
<table class="ls-table">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_Cursos['curso_ch']; ?></td>
    </tr>
