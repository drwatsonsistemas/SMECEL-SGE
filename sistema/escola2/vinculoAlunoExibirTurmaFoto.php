...
<?php include_once ("menu-top.php"); ?>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">Cadastro de fotos de alunos</h1>
		<!-- CONTEÚDO -->
...
<div class="ls-box-filter">
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
				...
				<li><a href="vinculoAlunoExibirTurmaFoto.php">- TODAS -</a></li>
				<?php do { ?>
				<li><a href="vinculoAlunoExibirTurmaFoto.php?ct=<?php echo $row_ListarTurmas['turma_id']; ?>"><?php echo $row_ListarTurmas['turma_nome']; ?> - <?php echo $row_ListarTurmas['turma_turno_nome']; ?></a></li>
...
<div class="ls-box-filter">
Clique sobre a foto para cadastrar/alterar a imagem. Utilize um celular para capturar a foto.
</div>
		...
		aluno_id, aluno_cod_inep, aluno_nome, aluno_nome_social, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_sexo, aluno_foto
    ...
    <?php 
    $nomeAluno = "";
    if($row_ExibirAlunosVinculados["aluno_nome_social"] <> ""){
      $nomeAluno = $row_ExibirAlunosVinculados["aluno_nome_social"];
    }  else{
      $nomeAluno = $row_ExibirAlunosVinculados["aluno_nome"];
    }
	...
	<p style="float:left; margin:1px; text-align:center; padding:1px; width:200px; height:240px;" id="<?php echo $row_ExibirAlunosVinculados['aluno_hash']; ?>">
	 
	 
	 <?php if ($row_ExibirAlunosVinculados['aluno_foto']=="") { ?>
	 
			<a href="celular.php?aluno=<?php echo $row_ExibirAlunosVinculados['aluno_hash']; ?>"><img src="<?php echo '../../aluno/fotos/' ?>semfoto.jpg" border="0" width="80%" class="aluno"></a>
			<br>
      
 
            <small style="font-size:9px;">
			<a href="matriculaExibe.php?cmatricula=<?php echo $row_ExibirAlunosVinculados['vinculo_aluno_hash']; ?>" target="_blank"><?php echo current( str_word_count($nomeAluno ,2)); ?> <?php $word = explode(" ", trim($nomeAluno)); echo $word[count($word)-1]; ?></a>
            </small> 
			<?php } else { ?>
			<a href="celular.php?aluno=<?php echo $row_ExibirAlunosVinculados['aluno_hash']; ?>"><img src="<?php echo '../../aluno/fotos/' ?><?php echo $row_ExibirAlunosVinculados['aluno_foto']; ?>" border="0" width="80%" class="aluno"></a>
			<br>
            <small style="font-size:9px;">
			<a href="matriculaExibe.php?cmatricula=<?php echo $row_ExibirAlunosVinculados['vinculo_aluno_hash']; ?>" target="_blank"><?php echo current( str_word_count($nomeAluno,2)); ?> <?php $words = explode(" ", trim($nomeAluno)); echo $words[count($words)-1]; ?></a>
            </small>
	...
	<?php } ?>
				...
				<p class="ls-float-left">Total de alunos vinculados na turma: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong></p>
