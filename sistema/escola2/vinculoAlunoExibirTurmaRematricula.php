...
<div class="ls-box-filter">
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
				...
				<?php do { ?>
				<li><a href="vinculoAlunoExibirTurmaRematricula.php?ct=<?php echo $row_ListarTurmas['turma_id']; ?>"><?php echo $row_ListarTurmas['turma_nome']; ?> - <?php echo $row_ListarTurmas['turma_turno_nome']; ?></a></li>
			  ...
			  <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav">
				  ...
				  <li><a href="vinculoAlunoExibirTurmaRematricula.php">Todos</a></li>
				  <li><a href="vinculoAlunoExibirTurmaRematricula?st=1<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Matriculados</a></li>
				  <li><a href="vinculoAlunoExibirTurmaRematricula?st=2<?php if ($codTurma <> "") { echo "&ct=$codTurma"; } ?>">Transferidos</a></li>
            ...
            <div data-ls-module="dropdown" class="ls-dropdown">
                ...
                <ul class="ls-dropdown-nav">
				  ...
				  <li><a href="print_vinculoAlunoExibirTurmaRematricula.php<?php if ($codTurma <> "") { echo "?ct=$codTurma"; } ?><?php if ($stCod <> "") { echo $sep."st=$stCod"; } ?>" target="_blank">Alunos da(s) turma(s)</a></li>
		...
		vinculo_aluno_hash, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_multietapa, etapa_id, etapa_nome, etapa_nome_abrev,
		...
		WHERE vinculo_aluno_ano_letivo = '$anoLetivoRematricula' AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<div class="ls-box ls-sm-space">
			...
			<h5 class="ls-title-5 ls-txt-center"> <?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno_nome']; ?> (<?php echo $nomeFiltro; ?>)<?php if (($row_ExibirTurmas['turma_multisseriada']==1)) { ?> <br><b>MULTISSERIADA</b> <?php } ?></h5>
		...
		<?php } else { ?>
			...
			<span class="ls-float-right"><a href="alunoPesquisar.php?periodo=rematricula" class="ls-btn-primary ls-ico-user-add"> Vincular aluno</a></span>
			</p>
