  ...
  <main class="ls-main ">
    <div class="container-fluid">
      ...
      <table class="ls-table fonte-tabela">
        ...
        <tbody>
          ...
          <tr>
            <td><a href="print_movimento_escolar_anual.php" title="" target="_blank">- Movimento escolar anual</a></td>
          </tr>
          <tr>
            <td><a href="print_quadro_matricula.php" title="" target="_blank">- Quadro de matrícula</a></td>
          </tr>
          <tr>
            <td><a href="print_movimento_escolar_anual_etapa.php" title="" target="_blank">- Movimento escolar anual
                (ETAPA)</a></td>
          </tr>
          <tr>
    ...
    <tr>
      <td><a href="print_aprovados_conservados.php" title="" target="_blank">- Resultados finais (aprovados/conservados)</a></td>
          ...
          <tr>
            <td><a href="print_aprovados_conservados.php?ano=<?php echo $row_AnoLetivo['ano_letivo_ano'] - 1; ?>" title=""
                target="_blank">- Resultados finais (aprovados/conservados) - ANO ANTERIOR</a></td>
          </tr>
        </tbody>
      </table>
      <hr>
