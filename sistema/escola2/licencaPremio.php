...
vinculo_data_inicio, vinculo_obs, func_id, func_nome, func_cpf, func_rg_numero, func_cargo, funcao_nome,
func_endereco, func_endereco_numero, func_endereco_bairro,func_municipio_nascimento, func_endereco_uf, func_endereco_cidade, func_regime, func_estado_civil, funcao_id, funcao_nome
FROM smc_vinculo
...
?>
  ...
  <p><h1>REQUERIMENTO DE LICENÇA PRÊMIO</h1></p><br><br><br>
...
GOVERNO DE <?php echo $row_EscolaLogada['sec_cidade']; ?>-<?php echo $row_EscolaLogada['sec_uf']; ?>
</p>
...
<br><br>    
  ...
  Eu, <b><?= $row_FrequenciaFuncionario['func_nome'] ?></b>, brasileiro(a), <?= $estado_civil ?>, natural de <?= $row_FrequenciaFuncionario['func_municipio_nascimento'] ?>, 
  portador(a) da Cédula de Identidade nº. <?= $row_FrequenciaFuncionario['func_rg_numero'] ?> 
  ...
  venho respeitosa requerer a Vossa Senhoria, <b>Licença Prêmio de <?= $_GET['duracao_programa'] ?></b>.<br><br> 
  Para garantia de tal beneficio vale-se dos dispostos no Estatuto do Servidor Público Municipal, 
