...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $tipo_deficiencia = isset($_POST['aluno_tipo_deficiencia']) ? $_POST['aluno_tipo_deficiencia'] : null; // Corrigido
  $alergia_qual = isset($_POST['aluno_alergia_qual']) ? $_POST['aluno_alergia_qual'] : null;             // Corrigido
  ...
  $insertSQL = sprintf(
    "INSERT INTO smc_aluno (
      ...
      aluno_sus_mae, aluno_nis_pai, aluno_sus_pai, aluno_cid, aluno_nome_social, aluno_observacao
    ) 
    ...
    GetSQLValueString($tipo_deficiencia, "text"), // Corrigido
    GetSQLValueString($laudo, "int"),
    GetSQLValueString($alergia, "int"),
    GetSQLValueString($alergia_qual, "text"),     // Corrigido
        ...
        <fieldset>
          <div id="ident" class="ls-box ls-box-gray">
            ...
            <div class="row">
              ...
              <label class="ls-label col-md-6">
                ...
                <input type="text" name="aluno_nome_social" id="nome_social_input" value="" size="32"
              ...
              <label class="ls-label col-md-3">
                ...
                <div class="ls-custom-select">
                  <select name="aluno_pais" id="aluno_pais" required>
                    ...
                    <?php
                    // Reset the $row_paises cursor if needed
                    mysql_data_seek($paises, 0);
                    while ($row_paises = mysql_fetch_assoc($paises)) {
                      if ($row_paises['pais_cod'] != 76) { // Evita duplicar o Brasil
                        ?>
          ...
          <div id="filia" class="ls-box ls-box-gray">
            ...
            <label class="ls-label col-md-4"> <b class="ls-label-text">*Filiação 1:</b>
              <input type="text" name="aluno_filiacao1" size="32" required>
            </label>


            <label class="ls-label col-md-3"> <b class="ls-label-text">Profissão da mãe:</b>
              <input type="text" name="aluno_prof_mae" size="32">
            </label>
            <label class="ls-label col-md-2"> <b class="ls-label-text">Telefone da mãe:</b>
              <input type="text" name="aluno_tel_mae" class="celular" size="32">
            </label>
            ...
            <label class="ls-label col-md-3"> <b class="ls-label-text">RG da mãe:</b>
              <input type="text" name="aluno_rg_mae" size="32">
            </label>
            ...
            <label class="ls-label col-md-3"> <b class="ls-label-text">RG do pai:</b>
              <input type="text" name="aluno_rg_pai" size="32">
            </label>
          ...
          <div id="responsavel" class="ls-box ls-box-gray">
            ...
            <label class="ls-label col-md-5"> <b class="ls-label-text">Responsável legal (caso não seja criado
                por pai/mãe):</b>
              <input type="text" name="aluno_nome_responsavel_legal" size="32">
            </label>
            <label class="ls-label col-md-3"> <b class="ls-label-text">CPF do responsável legal:</b>
              <input type="text" maxlength="14" name="aluno_cpf_responsavel_legal" size="32"
          ...
          <div id="docum" class="ls-box ls-box-gray">
            ...
            <label class="ls-label col-md-6"><b class="ls-label-text">Número do CPF</b>
              <input type="text" name="aluno_cpf" class="cpf" value="" size="32" onblur="javascript: validarCPF(this);"
            ...
            <label class="ls-label col-md-3"><b class="ls-label-text">Emissão</b>
              <input type="text" name="aluno_emissao_certidao" id="aluno_emissao_certidao" value="" size="32"
                class="date">
            </label>
            <label class="ls-label col-md-2">
          ...
          <div id="deficiencia" class="ls-box ls-box-gray" style="display:none">
            ...
            <label class="ls-label col-md-7"> <b class="ls-label-text">Informe o CID:</b>
              <input type="text" name="aluno_cid" id="aluno_cid" value="" size="32">
            </label>
          ...
          <div id="obs" class="ls-box ls-box-gray">
            ...
            <label class="ls-label">
              ...
              <textarea rows="4" name="aluno_observacao" class="ls-textarea-autoresize"></textarea>
            </label>
