  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">RENDIMENTO POR UNIDADE</h1>
        <h4>TURMA: <?php echo $row_Turma['turma_nome']; ?></h4>
        
        <hr>
        
        
           <a href="turmaListar.php" target="" class="ls-btn-primary">VOLTAR</a>

     
<div data-ls-module="dropdown" class="ls-dropdown">
    <a href="#" class="ls-btn-primary"><?php echo $unidade; ?>º PERÍODO</a>

  <ul class="ls-dropdown-nav">
  
      <?php for ($i = 1; $i <= $row_CriteriosAvaliativos['ca_qtd_periodos']; $i++) { ?>
      
      	<li><a href="rendimento_disciplina_unidade.php?turma=<?php echo $colname_Turma; ?>&unidade=<?php echo $i; ?>"><?php echo $i; ?>º PERÍODO</a></li>
...
<a href="rendimento_disciplina_ano.php?turma=<?php echo $colname_Turma; ?>" target="" class="ls-btn-primary">GRÁFICO ANUAL</a>
<a href="print_rendimento_disciplina_unidade.php?turma=<?php echo $colname_Turma; ?>&unidade=<?php echo $unidade; ?>" target="_blank" class="ls-btn">IMPRIMIR</a>
...
?>
  ...
  <div class="col-md-3 ls-box">	
  	
	<h5 class="ls-txt-center"><?php echo $row_Matriz_disciplinas['disciplina_nome']; ?></h5>
    
	
	<div class="ls-display-none">
	
	<?php do { ?>
    
    <?php
		mysql_select_db($database_SmecelNovo, $SmecelNovo);
		$query_Nota = "SELECT nota_id, nota_id_matricula, nota_id_disciplina, nota_periodo, nota_num_avaliacao, nota_max, nota_min, nota_valor, nota_hash FROM smc_nota WHERE nota_id_matricula = '$row_Aluno[vinculo_aluno_id]' AND nota_id_disciplina = '$row_Matriz_disciplinas[disciplina_id]' AND nota_periodo = '$unidade'";
    ...
    <div id="piechart_<?php echo $row_Matriz_disciplinas['disciplina_id']; ?>" style="width: 100%; height: 100%;"></div>
    
    <p class="ls-txt-center">
    <span class="ls-ico-shaft-up ls-ico-right ls-color-info"></span>&nbsp; <?php echo $aprovado; ?> &nbsp;&nbsp; <span class="ls-ico-shaft-down ls-ico-right ls-color-danger"></span>&nbsp; <?php echo $reprovado; ?>
    </p>
