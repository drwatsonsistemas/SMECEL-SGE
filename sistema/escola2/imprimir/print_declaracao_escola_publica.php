...
<title><?php echo "DECLARAÇÃO DE ESCOLA PÚBLICA - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><p><h1>DECLARAÇÃO</h1></p><br><br><br><br><br><br><br><br><br><br>
...
<div class="row">
  ...
  Declaramos para os devidos fins que <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  cursou integralmente todo o Ensino Fundamental de 9 anos em <u>Escola Pública</u>, do <strong>Ensino Fundamental de 9 anos - 1º Ano</strong> ao <strong><?php echo $row_Matricula['etapa_nome']; ?></strong>, etapa a qual está matriculado(a) neste Ano Letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>, de acordo com as leis vigentes no País e do Regime Interno deste Estabelecimento de Ensino.</p> 
  </div>
</div>
...
<div class="row"><div class="col-xs-12"><p><br><br><hr></p></div></div>
