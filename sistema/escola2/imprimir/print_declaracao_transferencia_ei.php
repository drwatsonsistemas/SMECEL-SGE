...
<title><?php echo "DECLARAÇÃO DE CONCLUSÃO - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><p><h1>TRANSFERÊNCIA DE CONCLUSÃO</h1></p><br><br><br><br><br><br><br><br><br><br>
...
<div class="row">
  ...
  Declaro para os devidos fins que <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  <strong><u>CONCLUIU</u></strong> o/a <strong><?php echo $row_Matricula['turma_nome']; ?> | <?php echo $multietapa; ?></strong>, no ano letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>, nesta Unidade de Ensino, estando apto(a) à ser matriculado(a) na etapa subsequente.</p> 
