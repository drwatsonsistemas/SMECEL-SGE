...
WHERE p_ind_mat_aluno = '$row_Matricula[vinculo_aluno_id]' ORDER BY p_ind_id_prof, p_ind_periodo ASC";
...
<div class="row">
  <div class="col-xs-12">
  <hr>
  Aluno: <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong> 
  ...
  Turma: <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $multietapa; ?>)</strong> <strong><?php 
  ...
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><h2>PARECER DO ALUNO</h2><br><br>
...
<p style="line-height: 180%; text-align:justify; font-size:16px;">O exposto acima é verdadeiro.</p>
</div>
