...
<title><?php echo "DECLARAÇÃO CONSERVADO - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<div class="row">
  ...
  cursou o/a <strong><?php echo $multietapa; ?></strong>, no ano letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>, nesta Unidade de Ensino, tendo sido <strong>CONSERVADO</strong>, devendo ser matriculado(a) na mesma série/ano.</p> 
