...
<title><?php echo "CERTIFICADO DE TRANSFERÊNCIA - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><br><br><br><br><br><br><br><br><br><br><br><p><h1>CERTIFICADO DE TRANSFERÊNCIA</h1></p><br><br><br><br><br><br><br><br><br><br>
...
<div class="row">
  ...
  Certifico que deu entrada nesta data um pedido de transferência do(a) aluno(a) <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong>, nascido(a) em <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong>, 
  ...
  é aluno(a) regularmente matriculado(a) e frequente nesta unidade de ensino, cursando o/a <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $multietapa; ?>)</strong>, no ano letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>. Servindo o presente certificado como documento hábil para inscrição condicional a matrícula.</p>
...
<div class="row"><div class="col-xs-12"><p><br><br><br><br><br><br><br><br></p></div></div>
