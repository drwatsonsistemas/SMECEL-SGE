...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>ALUNOS POR ZONA | SMECEL - Sistema de Gestão Escolar</title>
		...
		<thead>
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-left"><?php echo $row_ExibirAlunosVinculados['aluno_endereco']; ?> <?php echo $row_ExibirAlunosVinculados['aluno_numero']; ?> <?php echo $row_ExibirAlunosVinculados['aluno_bairro']; ?></td>
				</tr>
