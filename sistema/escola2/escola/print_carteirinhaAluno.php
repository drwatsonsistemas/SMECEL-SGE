...
<body onload="self.print();">
	...
	<?php do { ?>
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_nome_social,aluno_filiacao1, aluno_hash, aluno_foto, aluno_filiacao2
					...
					<table width="100%">
						<tr>
							...
							<td style="font-size:7px;">
								<strong>Aluno(a)</strong><br><?php echo $row_ExibirAlunosVinculados != ""? $row_ExibirAlunosVinculados["aluno_nome_social"]: $row_ExibirAlunosVinculados["aluno_nome"]; ?><br><br>
							...
							//geraCodigoBarra($row_ExibirAlunosVinculados['vinculo_aluno_id']);
									$product_id = str_pad($row_ExibirAlunosVinculados['vinculo_aluno_id'],5, '0', STR_PAD_LEFT);
