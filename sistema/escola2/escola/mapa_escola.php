...
WHERE vinculo_aluno_id_escola = '$row_EscolaLogada[escola_id]'AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' AND aluno_localizacao = '1'
";
  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <h1 class="ls-title-intro ls-ico-home">MAPA DE ALUNOS | <?php echo $row_EscolaLogada['escola_nome']; ?></h1>
		<!-- CONTEÚDO -->

    <p><a href="turmaListar.php" class="ls-btn">VOLTAR</a></p><br>
