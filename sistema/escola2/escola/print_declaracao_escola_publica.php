...
<div class="row">
  ...
  cursou integralmente todo o Ensino Fundamental de 9 anos em <u>Escola Pública</u>, do <strong>Ensino Fundamental de 9 anos - 1º Ano</strong> ao <strong><?php echo $multietapa; ?></strong>, etapa a qual está matriculado(a) neste Ano Letivo de <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>, de acordo com as leis vigentes no País e do Regime Interno deste Estabelecimento de Ensino.</p> 
  </div>
</div>
