...
<head>
  ...
  <title>
    <?php echo "DECLARAÇÃO DE CONCLUSÃO - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?>
  </title>
  <meta charset="utf-8">
  ...
  <page size="A4" style="padding:30px;">
    ...
    <table>
      <tr>
        <td width="20%"><?php if ($row_EscolaLogada['escola_logo'] <> "") { ?><img
              ...
              width="100px" /><?php } else { ?><img src="../../img/brasao_republica.png" alt="" width="80px" /><?php } ?>
        </td>
        <td width="80%">
          ...
          <p>ENDEREÇO: <?php echo $row_EscolaLogada['escola_endereco']; ?>,
            <?php echo $row_EscolaLogada['escola_num']; ?>, <?php echo $row_EscolaLogada['escola_bairro']; ?></p>
          <p><?php echo $row_EscolaLogada['sec_cidade']; ?>-<?php echo $row_EscolaLogada['sec_uf']; ?> CEP:
            <?php echo $row_EscolaLogada['escola_cep']; ?></p>
    ...
    <div class="row">
      <div class="col-xs-12 ls-txt-center">
        ...
        <p>
        <h1>TRANSFERÊNCIA DE CONCLUSÃO</h1>
    ...
    <div class="row">
      <div class="col-xs-12">
        <p style="line-height: 180%; text-align:justify; font-size:16px;">
          ...
          natural de <strong><?php echo $row_Matricula['municipio_nome']; ?> -
            <?php echo $row_Matricula['municipio_sigla_uf']; ?></strong>, filho(a) de
          ...
          <strong><u>CONCLUIU</u></strong> o/a <strong><?php echo $row_Matricula['turma_nome']; ?>
            (<?php echo $multietapa; ?>)</strong>, no ano letivo de
          <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>, nesta Unidade de Ensino, estando apto(a) à
          ser matriculado(a) na etapa subsequente.
        </p>
    ...
    <div class="row">
      ...
      <p style="text-align:center">_________________________________________________________<br>Diretor(a) ou
    ...
    <div class="row">
      <div class="col-xs-12">
        <small>Código de certificação de validade:
          <strong><?php echo $row_Matricula['vinculo_aluno_verificacao']; ?></strong><br>www.smecel.com.br</small>
      </div>
    </div>
