...
$query_Matricula = sprintf("
  SELECT 
  vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_ano_letivo, vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_multietapa, vinculo_aluno_repetente,vinculo_aluno_id_cuidador,
  aluno_id,
  aluno_cod_inep,
  aluno_cpf,
  aluno_nome,
  ...
  aluno_cpf_responsavel_legal,
  aluno_grau_responsavel_legal,
  aluno_nome_social,
  ...
  LEFT JOIN smc_vinculo ON vinculo_aluno_id_cuidador = vinculo_id
  LEFT JOIN smc_func ON func_id = vinculo_id_funcionario
...
if ($row_Matricula['turma_multisseriada'] == 1 && $row_Matricula['vinculo_aluno_multietapa'] != '') {
...
<head>
  ...
  <title><?php echo "DADOS DA MATRÍCULA - $row_Matricula[aluno_nome] - $row_EscolaLogada[escola_nome]" ?></title>
  <meta charset="utf-8">
...
<body>
  ...
  <page size="A4">
    ...
    <table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
      ...
      <tr>
        <td><small><strong>Nome social:</strong></small><br><?php echo $row_Matricula['aluno_nome_social']; ?>&nbsp;
        </td>
      </tr>
      <?php } ?>
      <tr>
    ...
    <table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
      ...
      <tr>
        <?php if ($row_Matricula['vinculo_aluno_id_cuidador'] != '') { ?>
          <td colspan="3"><small><strong>Cuidador:</strong></small><br><?php echo $row_Matricula['func_nome']; ?>&nbsp;
          </td>
        <?php } ?>
      </tr>
    </table>
    ...
    <table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
      ...
      <tr>
        <td><small><strong>Dados do responsável
              legal:</strong></small><br><?php echo $row_Matricula['aluno_nome_responsavel_legal']; ?>&nbsp;</td>
        <td><small><strong>CPF do responsável
              legal:</strong></small><br><?php echo $row_Matricula['aluno_cpf_responsavel_legal']; ?>&nbsp;</td>
        <td colspan="3"><small><strong>Grau de parentesco do responsável legal:</strong></small><br>
          <?php

          switch ($row_Matricula['aluno_grau_responsavel_legal']) {
      ...
      <tr>
        <td class="ls-v-align-middle">
          ...
          <p style="text-align:center">
            .................................................................................<br>Aluno (ou responsável)
          </p>
        </td>
        <td class="ls-v-align-middle">
          <br><br><br>
          <p style="text-align:center">
            .................................................................................<br><?php echo $row_EscolaLogada['escola_assinatura']; ?>
          </p>
        </td>
