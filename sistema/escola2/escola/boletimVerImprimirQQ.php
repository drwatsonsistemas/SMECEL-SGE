...
$query_matricula = sprintf("SELECT 
  ...
  vinculo_aluno_situacao, vinculo_aluno_datatransferencia, vinculo_aluno_da_casa, vinculo_aluno_historico_transferencia, vinculo_aluno_multietapa, 
  vinculo_aluno_vacina_atualizada, aluno_id, aluno_nome, aluno_nascimento, aluno_foto, aluno_filiacao1, aluno_hash, turma_id, turma_nome, turma_turno, turma_multisseriada, etapa_id, etapa_id_filtro, etapa_nome 
  ...
  <p>
    ...
    <small> Aluno(a): <strong><?php echo $row_matricula['aluno_nome']; ?></strong><br>
      ...
      Turma: <strong><?php echo $row_matricula['turma_nome']; ?>
        (<?php if ($row_matricula['turma_multisseriada'] == 1) {
          echo $multietapa;
        } ?>)</strong> </small> </div>
  </p>
