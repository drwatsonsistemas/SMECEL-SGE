  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS DESISTENTES
			</div>
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_hash,aluno_endereco,aluno_cep,aluno_numero,aluno_bairro,aluno_municipio,aluno_uf,aluno_telefone,aluno_celular
