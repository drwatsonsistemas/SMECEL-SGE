...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>Dados de acesso ao painel do aluno | SMECEL - Sistema de Gestão Escolar</title>
...
<script src="js/locastyle.js"></script>
	...
	table.bordasimples tr td {border-bottom:1px dotted #000000;padding:10px 0; font-size:12px;}
	</style>
		...
		<table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
			...
			<?php do { ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<?php echo $row_ExibirTurmas['turma_nome']; ?> <?php echo $row_ExibirTurmas['turma_turno']; ?><br>
					Aluno: <?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != "" ? $row_ExibirAlunosVinculados["aluno_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?><br>
					Filiação: <?php echo $row_ExibirAlunosVinculados['aluno_filiacao1']; ?>
					</td>
					<td class="">
					<strong>DADOS DE ACESSO</strong><br>
					Nascimento: <?php echo inverteData($row_ExibirAlunosVinculados['aluno_nascimento']); ?><br>
					Código de acesso: <?php echo str_pad($row_ExibirAlunosVinculados['aluno_id'], 5, '0', STR_PAD_LEFT); ?><br>
					Senha de acesso: <?php echo substr($row_ExibirAlunosVinculados['aluno_hash'],0,5); ?>
					</td>
					<td class="">
					<strong>INSTRUÇÃO</strong><br>
					-Acessar www.smecel.com.br<br>
					-Clique no menu "Área do Aluno"<br>
