...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Vinculo = sprintf("SELECT vinculo_id, vinculo_id_escola, vinculo_id_funcionario, vinculo_id_funcao, vinculo_carga_horaria, vinculo_data_inicio, vinculo_data_final, vinculo_status, vinculo_obs, func_id, func_nome FROM smc_vinculo INNER JOIN smc_func ON func_id = vinculo_id_funcionario WHERE vinculo_id_escola = $row_EscolaLogada[escola_id] AND vinculo_id = %s", GetSQLValueString($colname_Vinculo, "int"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
 ...
 $updateSQL = sprintf("UPDATE smc_vinculo SET vinculo_id_funcao=%s, vinculo_carga_horaria=%s, vinculo_data_inicio='$nova_data', vinculo_data_final=%s, vinculo_status=%s, vinculo_obs=%s WHERE vinculo_id=%s",
   ...
   GetSQLValueString($_POST['vinculo_data_final'], "date"),
...
$updateGoTo = "funcionarios_detalhes.php?codigo=$row_Vinculo[vinculo_id_funcionario]&editado";
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <main class="ls-main">
    <div class="container-fluid">
      ...
      <div class="ls-actions-btn">
        ...
        <a class="ls-btn-dark" href="funcionarios_detalhes.php?codigo=<?= $row_Vinculo['vinculo_id_funcionario'] ?>">CANCELAR</a>
