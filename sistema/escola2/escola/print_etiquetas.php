...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>ETIQUETAS | SMECEL - Sistema de Gestão Escolar</title>
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		SELECT 
		vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, aluno_nome_social, vinculo_aluno_id_escola, vinculo_aluno_ano_letivo, 
		...
		<div style="page-break-inside: avoid;">
			<?php do { ?>
                ...
                <div style="display:block; float:left; width:5.6cm; height:4.4cm; border:#000000 solid 1px; padding:0.2cm; margin:2px; font-size:12px; text-align:center; page-break-inside: avoid;">
				<p><strong><?php echo $row_ExibirAlunosVinculados['aluno_nome_social'] != "" ? $row_ExibirAlunosVinculados["aluno_nome_social"] : $row_ExibirAlunosVinculados["aluno_nome"]; ?></strong></p>
				<h3 style="color:#FFFFFF; background-color:#000000; padding:2px;"><?php echo $row_ExibirTurmas['turma_nome']; ?> - <?php echo $row_ExibirTurmas['turma_turno']; ?></h3>
                </div>
