...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_localizacao, aluno_nome_social,aluno_endereco, aluno_numero, aluno_bairro, aluno_hash
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE aluno_localizacao = '1' AND vinculo_aluno_ano_letivo = '$anoLetivo' AND vinculo_aluno_transporte = 'S' AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
