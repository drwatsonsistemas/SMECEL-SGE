  ...
  <body>
    ...
    <main class="ls-main ">
      <div class="container-fluid">
		...
		<?php echo $totalRows_Faltas ?>
        <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td>faltas_alunos_id</td>
            <td>faltas_alunos_matricula_id</td>
            <td>faltas_alunos_disciplina_id</td>
            <td>faltas_alunos_numero_aula</td>
            <td>faltas_alunos_data</td>
            <td>faltas_alunos_justificada</td>
            <td>faltas_alunos_justificativa</td>
          </tr>
          <?php do { ?>
            <tr>
              <td><?php echo $row_Faltas['faltas_alunos_id']; ?></td>
              <td><?php echo $row_Faltas['faltas_alunos_matricula_id']; ?></td>
              <td><?php echo $row_Faltas['faltas_alunos_disciplina_id']; ?></td>
              <td><?php echo $row_Faltas['faltas_alunos_numero_aula']; ?></td>
              <td><?php echo $row_Faltas['faltas_alunos_data']; ?></td>
              <td><?php echo $row_Faltas['faltas_alunos_justificada']; ?></td>
