...
WHERE vinculo_aluno_id_escola = '$row_UsuLogado[usu_escola]' AND vinculo_aluno_situacao = '1' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
      ...
      <div class="container-fluid">
		...
		<?php if ($totalRows_Vinculos > 0) { ?>
          ...
          <?php do { ?>
            ...
            <div class="ls-box">
			<p>Aluno(a): <strong><?php echo $row_Vinculos['aluno_nome']; ?></strong></p>
			...
			<?php 
				...
				WHERE vinculo_aluno_id_aluno = '$row_Vinculos[vinculo_aluno_id_aluno]' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'";
