...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body>
    ...
    title: {
        text: 'Gráfico de alunos por IDADE no ano letivo de <?php echo $row_AnoLetivo['ano_letivo_ano']; ?>'
    },
    tooltip: {
    ...
    series: [{
		...
		?>
			<?php 
			  ...
			  ?>
			  {
				  name:' <?php echo $row_VinculosIdade['idade']; ?> anos', 
				  y: <?php echo $row_VinculosIdade['total']; ?>
			  },
