  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS SEM CÓDIGO INEP CADASTRADO
			</div>
		...
		WHERE aluno_cod_inep IS NULL AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		...
		<p>Alunos sem código INEP vinculados: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong></p>
		...
		<?php } ?>
         ...
         <?php $totalAlunosEscola = $totalAlunosEscola + $totalRows_ExibirAlunosVinculados; ?> 
		  ...
		  <p>Total de alunos sem código INEP vinculados na escola: <strong><?php echo $totalAlunosEscola; ?></strong></p>
		  </div>
		  <?php } ?>
