  ...
  <div class="container-fluid1">
    ...
    <div style="page-break-inside: avoid;">
      ...
      <h3 class="ls-txt-center">MAPA DE FREQUÊNCIA MENSAL |
        <?php echo nomeMes($mes) . "/" . $row_AlunoBoletim['vinculo_aluno_ano_letivo']; ?></h3>
      ...
      <table width="100%" class="ls-sm-space bordasimples" cellpadding="0" cellspacing="0" border="0">
        ...
        do {
          ...
          <tr>
            ...
            <?php for ($i = 1; $i <= $numero_de_dias; $i++) {
              $data = "$ano-$mes-$i";
              ...
              $e_fim_de_semana = ($dia_da_semana == 0);

              // Imprime a célula da tabela com a informação sobre ser ou não fim de semana
              if ($e_fim_de_semana) {
                echo '<td class="ls-txt-center" style="background:#ffecff;font-size:10px;padding:0px">' . ($dia_da_semana == 0 ? 'D' : '') . '</td>';
              } else {
                echo '<td></td>';
              }
            } ?>
