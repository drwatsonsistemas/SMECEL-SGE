...
if($cpfBusca != ""){ 
  $cpf_no_where = "AND aluno_cpf LIKE '%".$cpfBusca."%'"; } 
  else { 
    $cpf_no_where = ""; }
...
if($nomeBusca != ""){ 
  ...
  $ordem = "ORDER BY nome_score DESC"; } else { 
    $nome_score = ""; 
    $nome_no_where = "";
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
      ...
      <div class="container-fluid">
        ...
        <form action="" method="post" class="ls-form ls-form-horizontal row ls-box">
          <fieldset>
            ...
            <input value="<?php echo $cpfBusca; ?>" type="text" class="ls-field-sm cpf" name="cpf" id="cpf" onblur="javascript: validarCPF(this);" onkeypress="javascript: mascara(this, cpf_mask);" placeholder="CPF do aluno">
            </label>
			
		    <label class="ls-label col-md-6">
            <b class="ls-label-text">INEP</b>
            <input value="<?php echo $inepBusca; ?>" type="text" class="ls-field-sm inep" name="inep" id="inep" placeholder="Código INEP">
            </label>
            ...
            <input value="<?php echo $nomeBusca; ?>" type="text" class="ls-field-sm" name="nome" id="nome" pattern=".{4,}" title="Informe no mínimo 4 caracteres" placeholder="Nome completo ou parte" required>
            </label>
				
            <label class="ls-label col-md-2">
            <b class="ls-label-text">NASCIMENTO</b>
            <input value="<?php echo $nascimentoBusca; ?>" type="text" class="ls-field-sm date" name="nascimento" id="nascimento" placeholder="Data de nascimento" required>
            </label>
				
            <label class="ls-label col-md-5">
            <b class="ls-label-text">NOME DA FILIAÇÃO 1 OU FILIAÇÃO 2</b>
            <input value="<?php echo $maeBusca; ?>" type="text" class="ls-field-sm" name="mae" id="mae" placeholder="Nome da filiação 1 ou filiação 2" required>
            </label>
  ...
  <div class="ls-alert-info1 ls-color-success"><strong><span class="ls-ico-lamp ls-ico-left"></span> Atenção: </strong> Informe um dos campos acima e clique em pesquisar. Você pode informar apenas o primeiro nome em cada campo.</div>  
  <?php } else { ?>
  <?php if ($totalRows_buscaFuncionario > 0) { // Show if recordset not empty ?>
  <div class="ls-alert-info ls-dismissable">
    <span data-ls-module="dismiss" class="ls-dismiss">&times;</span>
    Foram encontrados <?php echo $totalRows_buscaFuncionario; ?> registros com os dados informados para esta pesquisa. Confira se todos os campos coincidem com os dados do(a) aluno(a).
  </div>
    ...
    <tbody>
      <?php do { ?>
        <tr>
		  ...
		  <p><strong>ALUNO(A):</strong> <?php echo $row_buscaFuncionario['aluno_nome']; ?> <?php if ($row_buscaFuncionario['nome_score'] > "1.0") { echo "<a href='#' class='ls-tag-success'>PROVÁVEL</a>"; }  ?></p>
		  ...
		  <td class="ls-txt-center"><a href="<?php echo $link; ?>?c=<?php echo $row_buscaFuncionario['aluno_hash']; ?>" class="ls-ico-user-add ls-btn-primary"> <?php echo $linkNome; ?></a></td>
        </tr>
