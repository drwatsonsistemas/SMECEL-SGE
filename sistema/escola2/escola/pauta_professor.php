...
WHERE pauta_id_professor = '$colname_Funcionario' AND pauta_id_escola = '$row_EscolaLogada[escola_id]' AND pauta_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]'
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
    ...
    <tbody>
	  ...
	  do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php echo $row_Ac['pauta_ano_letivo']; ?></td>
          <td class="ls-txt-center"><?php echo inverteData($row_Ac['pauta_data_inicial']); ?></td>
          <td class="ls-txt-center"><?php echo inverteData($row_Ac['pauta_data_final']); ?></td>
          ...
          <a href="pauta_feedback.php?ac=<?php echo $row_Ac['pauta_id']; ?>" class="ls-btn-primary">VISUALIZAR</a>
          <!--
  ...
  <p>Nenhuma pauta cadastrada para este professor</p>
