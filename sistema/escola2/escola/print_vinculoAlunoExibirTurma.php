...
<body onload="self.print();">
	...
	<div class="container-fluid">
		...
		aluno_id, aluno_nome, aluno_nome_social, aluno_nascimento, aluno_filiacao1, aluno_hash, aluno_cpf
							...
							<?php do { ?>
								<tr style="border-bottom:black solid 1 px;">
									...
									<td class="ls-txt-center hidden-xs">
										<?php echo $row_ExibirAlunosVinculados['vinculo_aluno_situacao_nome']; ?></td>
								</tr>
