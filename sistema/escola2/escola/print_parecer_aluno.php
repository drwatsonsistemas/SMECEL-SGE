...
SELECT 
vinculo_aluno_id, vinculo_aluno_id_aluno, vinculo_aluno_id_turma, vinculo_aluno_id_escola, vinculo_aluno_ano_letivo, vinculo_aluno_transporte, vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_multietapa, vinculo_aluno_rel_aval,
aluno_id,
aluno_cod_inep,
aluno_cpf,
aluno_nome,
...
<title><?php echo "PARECER DO ALUNO - $row_Matricula[aluno_nome] - $row_Matricula[turma_nome] - $row_EscolaLogada[escola_nome]" ?></title>
<meta charset="utf-8">
...
<table>
	<tr>
		...
		<td width="80%">
			...
			<p><?php echo $row_Secretaria['sec_cidade']; ?>-<?php echo $row_Secretaria['sec_uf']; ?> CEP: <?php echo $row_EscolaLogada['escola_cep']; ?></p>
...
<div class="row">
  <div class="col-xs-12 ls-txt-center">
	...
	<br><br><p><h1>PARECER DO ALUNO</h1></p><br><br>
...
<div class="row">
  ...
  Aluno: <strong><?php if($row_Matricula['aluno_nome_social'] == ''){ echo $row_Matricula['aluno_nome']; }else{ echo $row_Matricula['aluno_nome_social']; } ?></strong><br>
  Nascimento: <strong><?php echo inverteData($row_Matricula['aluno_nascimento']); ?></strong><br>
  Filiação: <strong><?php echo $row_Matricula['aluno_filiacao1']; ?></strong><?php if ($row_Matricula['aluno_filiacao2']<>"") { ?> e <strong><?php echo $row_Matricula['aluno_filiacao2']; ?></strong><?php } ?><br>
  Turma: <strong><?php echo $row_Matricula['turma_nome']; ?> (<?php echo $multietapa; ?>)</strong>, no turno <strong><?php 
  ...
  ?></strong><br>
  Ano Letivo: <strong><?php echo $row_Matricula['turma_ano_letivo']; ?></strong>.
  
  <hr>
  
<div class="ls-box" style="background-color:transparent !important">
	<strong>PARECER COLETIVO: </strong><br><?php if ($row_Matricula['vinculo_aluno_rel_aval']=="") { ?>Nenhum parecer coletivo lançado.<?php } else { ?><?php echo str_replace($procurar,$buscar,$row_Matricula['vinculo_aluno_rel_aval']); ?><?php } ?>
  </div>
  
  <div class="ls-box" style="background-color:transparent !important">
  <strong>PARECER INDIVIDUAL: </strong><br>
  
  <?php if ($totalRows_parecer > 0) { ?>
  
  <table class="ls-table ls-sm-space" style="background-color:transparent !important">
  <?php do { ?>
  
  <tr>
  	<td><?php echo $row_parecer['p_ind_periodo']; ?>º período | <?php echo $row_parecer['func_nome']; ?><br><br><?php echo str_replace($procurar,$buscar,$row_parecer['p_ind_texto']); ?></td>
  </tr>
  ...
  Nenhum parecer individual lançado.
...
<p style="text-align:center; font-size:10px">_________________________________________________________<br>DIRETOR(A) OU SECRETÁRIO(A) ESCOLAR</p><br>

<small>
<?php do { ?>
  <p style="text-align:center; font-size:10px">_________________________________________________________<br>
  <?php echo $row_Professores['func_nome']; ?> - 
  <?php echo $row_Professores['disciplina_nome']; ?></p><br>
