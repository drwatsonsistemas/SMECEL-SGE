...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Turmas = "
SELECT turma_id, turma_id_escola, turma_id_sec, turma_matriz_id, turma_nome, turma_etapa, turma_turno, etapa_id, etapa_id_filtro,etapa_nome,
CASE turma_turno
...
turma_total_alunos, turma_ano_letivo, matriz_id, matriz_criterio_avaliativo, matriz_nome, ca_id, ca_questionario_conceitos, ca_forma_avaliacao
FROM smc_turma
					...
					<table class="ls-table ls-table-striped ls-sm-space fonte-tabela" role="grid">
						<thead>
							<tr>
								...
								<th class="ls-txt-center">MATRIZ</th>
						...
						<tbody>
							...
							do {
								...
								<tr>
									...
									<td class="ls-txt-center"><?php echo $row_Turmas['matriz_nome']; ?></td>
									...
									<td class="ls-txt-center">
										...
										<?php if ($row_Turmas['ca_questionario_conceitos']=="S") { ?>

											<a class="ls-btn ls-color-success ls-btn-block ls-ico-stats" target="_blank" href="diario_rendimento_ef_conceitos.php?ct=<?php echo $row_Turmas['turma_id']; ?>&ano=<?php echo $anoLetivo; ?>"></a>

										<?php } else { ?>

											<?php if ($row_Turmas['etapa_id_filtro']==1) {  ?>
												<a class="ls-btn ls-color-success ls-btn-block ls-ico-stats" target="_blank" href="diario_rendimento_ed_inf.php?ct=<?php echo $row_Turmas['turma_id']; ?>&ano=<?php echo $anoLetivo; ?>"></a>
											<?php } else{ ?>
												<?php if($row_Turmas['ca_forma_avaliacao']=="Q"){ ?>
													<a class="ls-btn ls-color-success ls-btn-block ls-ico-stats" target="_blank" href="diario_rendimento_qq.php?ct=<?php echo $row_Turmas['turma_id']; ?>&ano=<?php echo $anoLetivo; ?>"></a>
												<?php }else{ ?>
													<a class="ls-btn ls-color-success ls-btn-block ls-ico-stats" target="_blank" href="diario_rendimento.php?ct=<?php echo $row_Turmas['turma_id']; ?>&ano=<?php echo $anoLetivo; ?>"></a>
												<?php } ?>
											<?php } ?>
