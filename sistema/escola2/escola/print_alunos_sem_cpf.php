...
<title>Alunos sem informação do CPF no cadastro | SMECEL - Sistema de Gestão Escolar</title>
<meta charset="utf-8">
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<h3>Alunos sem informação do CPF no cadastro</h3>
		...
		do { ?>
          ...
          <?php 
			...
			aluno_endereco, aluno_numero, aluno_bairro, aluno_telefone, aluno_celular, aluno_cpf 
			FROM smc_vinculo_aluno
			INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
			WHERE vinculo_aluno_id_turma = $row_Turmas[turma_id] AND vinculo_aluno_situacao = '1' AND aluno_cpf IS NULL
