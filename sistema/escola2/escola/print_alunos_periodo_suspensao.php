...
<script>
  ...
  gtag('config', 'UA-117872281-1');
    ...
    <title>ALUNOS EM PERÍODO DE SUPENSÃO | SMECEL - Sistema de Gestão Escolar</title>
  ...
  <body onload="self.print();">
      ...
      <div class="container-fluid">
		...
		<?php echo $row_EscolaLogada['escola_telefone1']; ?> <?php echo $row_EscolaLogada['escola_telefone2']; ?> <?php echo $row_EscolaLogada['escola_email']; ?>
			...
			RELATÓRIO DE ALUNOS EM PERÍODO DE SUPENSÃO
			</div>
		...
		vinculo_aluno_hash, vinculo_aluno_boletim, vinculo_aluno_situacao, vinculo_aluno_conselho, ocorrencia_id, ocorrencia_id_aluno,
        ocorrencia_id_turma, ocorrencia_id_escola, ocorrencia_ano_letivo, ocorrencia_tipo, 
        ocorrencia_data, ocorrencia_afastamento_de, ocorrencia_afastamento_ate, ocorrencia_total_dias,
        ...
        WHEN 3 THEN 'OUTROS'
        ELSE 'N/A' -- Caso não se encaixe em nenhum dos tipos definidos
        END AS tipo_ocorrencia
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
        INNER JOIN smc_ocorrencia on ocorrencia_id_aluno = vinculo_aluno_id_aluno
		WHERE ocorrencia_tipo = '2' AND vinculo_aluno_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' 
        AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' AND vinculo_aluno_situacao = '1'
        AND ocorrencia_afastamento_ate >= '$dataAtual' AND ocorrencia_ano_letivo = '$row_AnoLetivo[ano_letivo_ano]' 
		...
		<thead>
			<tr>
				...
				<th width="10%" class="ls-txt-center">DATA DA OCORRÊNCIA</th>
                <th width="10%" class="ls-txt-center">TIPO DA OCORRÊNCIA</th>
                <th width="10%" class="ls-txt-center">AFASTAMENTO DE</th>
                <th width="10%" class="ls-txt-center">AFASTAMENTO ATÉ</th>
                <th width="10%" class="ls-txt-center">TOTAL DIAS</th>
				<th width="40%" class="ls-txt-center">FILIAÇÃO</th>

			</tr>
			<tbody>
			<?php do { 
                $totaldias = preg_replace('/[^0-9]/', '', $row_ExibirAlunosVinculados['ocorrencia_total_dias']);
                ?>
				<tr style="border-bottom:black solid 1 px;">
					...
					<td class="ls-txt-center"><?php echo inverteData($row_ExibirAlunosVinculados['ocorrencia_data']); ?></td>
                    <td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['tipo_ocorrencia']; ?></td>
                    <td class="ls-txt-center"><?php echo inverteData($row_ExibirAlunosVinculados['ocorrencia_afastamento_de']); ?></td>
                    <td class="ls-txt-center"><?php echo inverteData($row_ExibirAlunosVinculados['ocorrencia_afastamento_ate']); ?></td>
					<td class="ls-txt-center"><?php echo $totaldias; ?></td>
		...
		<p>Alunos com ocorrência na turma: <strong><?php echo $totalRows_ExibirAlunosVinculados; ?></strong></p>
