    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <?php do { ?>                
            ...
            <a href="horariosEditar.php?c=<?php echo $row_TurmasListar['turma_id']; ?>" class="ls-ico-pencil2 ls-float-right ls-ico-right">Editar horário</a>
...
<?php } ?>
		...
		<p class="ls-txt-center"><a class="ls-btn ls-ico-paint-format" href="print_grade.php" target="_blank">Versão para impressão</a></p>
