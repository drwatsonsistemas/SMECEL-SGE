...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE smc_vinculo_aluno SET vinculo_aluno_conselho=%s, vinculo_aluno_conselho_parecer=%s WHERE vinculo_aluno_id=%s",
  ...
  $updateGoTo = "boletimLancar.php?aprovadoConselho";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<link rel="manifest" href="https://www.smecel.com.br/site.webmanifest">
  ...
  <body>
    ...
    <div class="ls-label col-md-12">
      <label class="ls-label-text">
        <input type="checkbox" name="vinculo_aluno_conselho" value=""  <?php if (!(strcmp(htmlentities($row_Matricula['vinculo_aluno_conselho'], ENT_COMPAT, 'utf-8'),"S"))) {echo "checked=\"checked\"";} ?>>
  ...
  <label class="ls-label">
    ...
    <textarea class="ls-textarea-autoresize" name="vinculo_aluno_conselho_parecer" cols="50" rows="5"><?php echo htmlentities($row_Matricula['vinculo_aluno_conselho_parecer'], ENT_COMPAT, 'utf-8'); ?></textarea>
  </label>
  </div>
