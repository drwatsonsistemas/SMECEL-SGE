...
FROM smc_turma 
WHERE turma_tipo_atendimento = '1' AND  turma_id_escola = '$row_UsuLogado[usu_escola]' AND turma_ano_letivo = '$anoLetivo' $buscaTurma
...
<head>
	...
	<title>RELATÓRIO DE ALUNOS <?php echo $nomeFiltro; ?> QUE RECEBEM BOLSA FAMÍLIA | SMECEL - Sistema de Gestão Escolar
	</title>
...
<body onload="self.print();">
	...
	<div class="container-fluid">
		...
		<div class="ls-box ls-txt-center" style="text-transform: uppercase;">
			RELATÓRIO DE ALUNOS <?php echo $nomeFiltro; ?> QUE RECEBEM BOLSA FAMÍLIA
		</div>
		...
		aluno_id, aluno_nome, aluno_nascimento, aluno_nome_social,aluno_filiacao1, aluno_hash, aluno_recebe_bolsa_familia, aluno_cpf, aluno_sus, aluno_nis, aluno_tel_mae, aluno_tel_pai
		FROM smc_vinculo_aluno 
		INNER JOIN smc_aluno ON aluno_id = vinculo_aluno_id_aluno 
		WHERE aluno_recebe_bolsa_familia = '1' AND vinculo_aluno_ano_letivo = '$anoLetivo' AND vinculo_aluno_id_turma = '$row_ExibirTurmas[turma_id]' $stqry
		ORDER BY aluno_nome ASC";
			...
			<?php if ($totalRows_ExibirAlunosVinculados > 0) { ?>
				...
				<div class="ls-box ls-sm-space">
					...
					<h5 class="ls-title-5 ls-txt-center"><?php echo $row_ExibirTurmas['turma_nome']; ?> -
						<?php echo $row_ExibirTurmas['turma_turno_nome']; ?> (<?php echo $nomeFiltro; ?>)
					</h5>

					<table class="ls-sm-space bordasimples" width="100%" style="font-size:10px;">
						<thead>
							<tr>
								<th width="" class="ls-txt-center" width="35px">Nº</th>
								<th width="">ALUNO</th>
								<th width="70" class="ls-txt-center">NASC.</th>
								<th width="" class="ls-txt-center">FILIAÇÃO</th>
								<th width="" class="ls-txt-center">CONTATO RESPONSÁVEIS</th>
								<th width="80" class="ls-txt-center">CPF</th>
								<th width="100" class="ls-txt-center">SUS</th>
								<th width="80" class="ls-txt-center">NIS</th>
						...
						<tbody>
							<?php do { ?>
								<tr style="border-bottom:black solid 1 px;">
									...
									<td class="ls-txt-center">
										<?php
										echo !empty($row_ExibirAlunosVinculados['aluno_tel_mae'])
											? $row_ExibirAlunosVinculados['aluno_tel_mae'] . " (MÃE)"
											: (!empty($row_ExibirAlunosVinculados['aluno_tel_pai'])
												? $row_ExibirAlunosVinculados['aluno_tel_pai'] . " (PAI)"
												: "Telefone não informado");
										?>
									</td>
									<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_cpf']; ?></td>
									<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_sus']; ?></td>
									<td class="ls-txt-center"><?php echo $row_ExibirAlunosVinculados['aluno_nis']; ?></td>
								</tr>
