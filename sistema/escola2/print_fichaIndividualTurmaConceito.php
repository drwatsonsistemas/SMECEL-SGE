...
if(isset($_GET['ano'])){
  ...
  $query = "ano_letivo_id_sec = '$row_UsuLogado[usu_sec]' AND ano_letivo_ano = $anoLetivo ";
} else {
	$anoLetivo = $row_AnoLetivo['ano_letivo_ano'];
  $query = " ano_letivo_aberto = 'S' AND ano_letivo_id_sec = '$row_UsuLogado[usu_sec]' ORDER BY ano_letivo_ano DESC LIMIT 1";
}

mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_AnoLetivo = "SELECT ano_letivo_id, ano_letivo_ano, ano_letivo_inicio, ano_letivo_fim, ano_letivo_aberto, ano_letivo_id_sec, ano_letivo_data_rematricula, ano_letivo_resultado_final, ano_letivo_mat_inicial, ano_letivo_mat_final FROM smc_ano_letivo WHERE $query";
...
<head>
  ...
  <title>FICHA INDIVIDUAL CONCEITO | SMECEL - Sistema de Gestão Escolar</title>
  <meta charset="utf-8">
		...
		?>
                    ...
                    <br>
                      ...
                      <br><br><br><br><br><br><br>
                        ...
                        ?>
                        <br><br> SMECEL - Sistema de Gestão Escolar | www.smecel.com.br | <small>Código de certificação: <strong><?php echo $row_AlunoBoletim['vinculo_aluno_verificacao']; ?></strong></small>
                        </p>
