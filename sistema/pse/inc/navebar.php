...
<script src="js/telaCheia.js" type="text/javascript"></script>
  ...
  <h1 class="ls-brand-name"> <a href="index.php" class="ls-ico-home"><small><?php echo PREFEITURA; ?></small><img src="../../img/logo_pse.png" width="30"><?php echo PAINEL; ?></a> </h1>
