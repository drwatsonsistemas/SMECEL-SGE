...
WHEN 'S' THEN 'SIM'
WHEN 'N' THEN '<span style=\"color:red\">NÃO</span>'
...
<?php if ($totalRows_Matricula > 0) { // Show if recordset not empty ?>
  ...
  ?>
	  ...
	  $cod++; 
	   ?>
          ...
          <td class="center"><?php echo $row_Matricula['vinculo_aluno_vacina_atualizada_nome']; ?></td>
        </tr>
		
		<?php 
		
		 if ($row_Matricula['vinculo_aluno_vacina_atualizada']=="S") {
			 $atualizada++;
		 } else {
			 $desatualizada++;
		 }
  ...
  <p class="right">Total de alunos: <?php echo $totalRows_Matricula; ?><br>Vacinas atualizadas: <?php echo $atualizada; ?>; <br>Vacinas desatualizadas: <?php echo $desatualizada; ?></p>
  <?php } else { ?>
