...
aluno_id, aluno_nome, aluno_nascimento, aluno_filiacao1, aluno_nis, aluno_sus, aluno_endereco, aluno_numero, aluno_bairro, aluno_telefone, aluno_celular, aluno_cpf,
turma_id, turma_nome
...
<h4 align="center">RELAÇÃO DE ALUNOS - ENDEREÇO E CONTATO</h4>
  ...
  <table class="bordasimples" width="100%" style="font-size:11px;">
    <thead>
      <tr>
        ...
        <th class="center">NASCIMENTO<br>IDADE</th>
        <th class="center">FILIAÇÃO</th>
        <th class="center">ENDEREÇO</th>
        <th class="center">TELEFONES</th>
        </tr>
    </thead>
    <tbody>
      <?php 
  ...
  ?>
	  ...
	  $cod++; 
	   ?>
          ...
          <td class="center" align="center"><?php echo $row_Matricula['aluno_cpf']; ?></td>
          <td class="center" align="center"><?php echo inverteData($row_Matricula['aluno_nascimento']); ?> <br>(<?php echo idade($row_Matricula['aluno_nascimento']); ?>)</td>
          <td class="center"><?php echo $row_Matricula['aluno_filiacao1']; ?></td>
          <td class="center"><?php echo $row_Matricula['aluno_endereco']; ?>, <?php echo $row_Matricula['aluno_numero']; ?> - <?php echo $row_Matricula['aluno_bairro']; ?></td>
          <td class="center" align="center" width="100"><?php echo $row_Matricula['aluno_telefone']; ?><br><?php echo $row_Matricula['aluno_celular']; ?></td>
        </tr>
