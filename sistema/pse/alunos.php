...
<div data-ls-module="dropdown" class="ls-dropdown ls-float-right1">
  ...
  <ul class="ls-dropdown-nav">
      ...
      <li><a target="_blank" href="relatorios/rel_alunos_saude_bucal.php?turma=<?php echo $colname_Alunos; ?>">Saúde Bucal</a></li>
      <li><a target="_blank" href="relatorios/rel_alunos_saude_bucal_5_anos.php?turma=<?php echo $colname_Alunos; ?>">Saúde Bucal (5 anos)</a></li>
      <li><a target="_blank" href="relatorios/rel_alunos_saude_bucal_9_anos.php?turma=<?php echo $colname_Alunos; ?>">Saúde Bucal (9 anos)</a></li>
      <li><a target="_blank" href="relatorios/rel_alunos_consumo_alimentar.php?turma=<?php echo $colname_Alunos; ?>">Consumo Alimentar</a></li>
      <li><a target="_blank" href="relatorios/rel_alunos_antropometria.php?turma=<?php echo $colname_Alunos; ?>">Antropometria</a></li>
