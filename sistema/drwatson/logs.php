...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_logs = "
SELECT log_id, log_id_usu, log_id_escola, log_data_hora, usu_id, usu_nome, usu_sec, usu_tipo 
FROM smc_log
...
<div class="ls-group-btn">
  ...
  <tr>
    ...
    <table class="ls-table ls-sm-space ls-table-striped ls-bg-header">
      ...
      <tr>
        <th width="70"></th>
        <th class="ls-txt-center">USUÁRIO</th>
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_logs['usu_nome']; ?></td>
