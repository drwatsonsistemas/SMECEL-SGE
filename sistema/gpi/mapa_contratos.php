...
<script type='text/javascript'>
    google.charts.load('current', {
        'packages': ['geochart'],
        'mapsApiKey': 'AIzaSyBtM38OqsFbYPjwQEcWkWW1T6ed6heKD4Y'
    });
    ...
    function drawMarkersMap() {
        var data = google.visualization.arrayToDataTable([
            ...
            <?php do { ?>
                ['<?php echo $row_Prefeituras['sec_cidade']; ?>-<?php echo $row_Prefeituras['sec_uf']; ?>', 1],
        ...
        var options = {
            ...
            domain: 'BR',
            resolution: 'provinces', // Pode ser ajustado para 'countries' ou 'metros' dependendo do nível de detalhe
            enableRegionInteractivity: true,
            displayMode: 'markers',
            keepAspectRatio: true,
            colorAxis: { colors: ['green', 'blue'] },
            sizeAxis: { minValue: 1, maxSize: 20 }, // Ajusta o tamanho dos marcadores
        };
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <div id="chart_div" style="width:100%; max-width:1000px; margin: 0 auto;"></div>
