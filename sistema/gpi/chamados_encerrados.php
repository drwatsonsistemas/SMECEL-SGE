...
<div class="ls-group-btn ls-group-active">
  <a href="chamados.php" class="ls-btn-primary">EM ABERTO</a>
  <a href="chamados_encerrados.php" class="ls-btn-primary ls-active">ENCERRADOS</a>
</div>      
