...
mysql_select_db($database_SmecelNovo, $SmecelNovo);
$query_Usuarios = "SELECT usu_id, usu_nome, usu_email, usu_senha, usu_tipo, usu_sec, usu_escola, usu_status, usu_cadastro FROM smc_usu WHERE usu_tipo = '99' ORDER BY usu_nome ASC";
...
<main class="ls-main">
  <div class="container-fluid">
    ...
    <a href="usuarios_cadastrar.php" class="ls-btn-primary ls-ico-plus" aria-expanded="false">CADASTRAR NOVO USUÁRIO</a>
    ...
    <thead>
      ...
      <?php do { ?>
        <tr>
          ...
          <td class="ls-txt-center"><?php if ($row_Usuarios['usu_status']=="1") { echo "<span class='ls-tag-success'>ATIVO</span>"; } else { echo "<span class='ls-tag-warning'>INATIVO</span>"; } ?></td>
          <td width="100"><a href="usuario_editar.php?usuario=<?php echo $row_Usuarios['usu_id']; ?>" class="ls-btn ls-btn-xs">Editar</a></td>
        </tr>
