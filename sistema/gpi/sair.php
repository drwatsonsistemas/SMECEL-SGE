...
$totalRows_UsuarioLogado = mysql_num_rows($UsuarioLogado);
  ...
  $updateSQL = sprintf("UPDATE smc_usu SET usu_sec='0', usu_escola='0' WHERE usu_id = '$row_UsuarioLogado[usu_id]'");
  ...
  $Result1 = mysql_query($updateSQL, $SmecelNovo) or die(mysql_error());
	...
	header("Location: sair.php?doLogout=true"); 
 	exit;
...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">SAIR</h1>
