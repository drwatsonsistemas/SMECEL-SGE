...
<main class="ls-main">
  <div class="container-fluid">
    <h1 class="ls-title-intro ls-ico-home">ALUNOS SEM VÍNCULOS</h1>
    <div class="ls-box ls-board-box"> 
    <!-- CONTEUDO -->
    
            <a href="manutencao.php" class="ls-btn-primary">VOLTAR</a>
            <a href="alunos_sem_vinculos_del.php" class="ls-btn-primary-danger">DELETAR ALUNOS SEM VÍNCULO</a>
		...
		<?php
			...
			vinculo_aluno_data, vinculo_aluno_hash, vinculo_aluno_verificacao, vinculo_aluno_boletim, vinculo_aluno_situacao, 
			vinculo_aluno_datatransferencia, vinculo_aluno_da_casa, vinculo_aluno_historico_transferencia, vinculo_aluno_vacina_atualizada, 
			vinculo_aluno_vacina_data_retorno, vinculo_aluno_conselho, vinculo_aluno_conselho_parecer, vinculo_aluno_internet, vinculo_aluno_multietapa, 
			vinculo_aluno_rel_aval, vinculo_aluno_dependencia, vinculo_aluno_reprovado_faltas 
    	  ...
    	  <?php echo $row_Alunos['aluno_nome']; ?> - <?php echo $totalRows_Vinculos; ?>
          
          <?php 
		  //$query_del = "DELETE FROM smc_aluno WHERE aluno_id = '$row_Alunos[aluno_id]'";
    	  //$del = mysql_query($query_del, $SmecelNovo) or die(mysql_error());
		  ?>
