...
$totalRows_VerificaEmail = mysql_num_rows($VerificaEmail);
	...
	";
		...
		mysql_free_result($VerificaEmail);
  ...
  $insertSQL = sprintf("INSERT INTO smc_usu (usu_nome, usu_email, usu_senha, usu_tipo, usu_status, usu_cadastro) VALUES (%s, %s, '$senha', %s, %s, %s)",
...
try {
     ...
     $mail->Subject = "Senha de acesso ao painel de suporte da GPI Sistemas [SMECEL]";//Assunto do e-mail
	 ...
	 <p>Prezado(a) $nome,</p>
	 <p>Você foi cadastrado no Sistema de Gerenciamento Escolar [SMECEL] para acessar o painel administrativo da GPI Sistemas.</p>
	 <p>
  ...
  <div class="container-fluid">
    ...
    <div class="ls-box ls-board-box">
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="ls-form-horizontal">
        ...
        <input type="hidden" name="usu_tipo" value="99">
