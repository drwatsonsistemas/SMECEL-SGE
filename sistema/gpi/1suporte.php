...
<main class="ls-main">
  ...
  <form method="post" name="form2" action="<?php echo $editFormAction; ?>"  class="ls-form">
    ...
    <select name="usu_escola" id="usu_escola" class="ls-select">
          <option value="">-</option>
          <?php do { ?>
          <option value="<?php echo $row_Escolas['escola_id']?>" <?php if (!(strcmp($row_Escolas['escola_id'], htmlentities($row_UsuarioLogado['usu_escola'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_Escolas['escola_nome']?></option>
