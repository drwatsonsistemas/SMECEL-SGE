...
<br>
  <div class="row valign-wrapper center-align card-panel yellow accent-1">
    <div class="col s3">
      <h2>SAÍDA</h2>
    </div>
    <div class="col s9 center-align">
      <form method="post" name="form1" id="cadastra_saida" action="">
        <div class="row">
            ...
            <input type="submit" class="btn" value="Registrar Saída">

        </div>
      </form>
    </div>
  </div>
  <div id="saidaResultado"></div>
...
<script>
            ...
            jQuery('#cadastra_saida').submit(function () {
                event.preventDefault();
                var dados = jQuery(this).serialize();

                jQuery.ajax({
                    type: "POST",
                    url: "inc/cadastraSaida.php",
                    data: dados,
                    success: function (data)
                    {
                        ...
                        $("#saidaResultado").html(data);

                        setTimeout(function () {
                            $("#cadastra_saida").each(function () {
                                this.reset();
                            });
