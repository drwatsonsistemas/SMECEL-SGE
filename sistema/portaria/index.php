...
<nav class="blue darken-6" role="navigation">
  <div class="nav-wrapper container"> <a id="logo-container" href="index.php" class="brand-logo">SMECEL</a>
    <ul class="right hide-on-med-and-down">
      <li><?php echo $row_UsuarioLogado['usu_nome']; ?></li>
...
<h1></h1>
<p class="center-align card-panel">

<a href="entrada.php" class="waves-effect waves-light btn-large"><i class="material-icons left">file_upload</i> REGISTRAR ENTRADAS</a>
<a href="saida.php" class="waves-effect waves-light btn-large"><i class="material-icons right">file_download</i>REGISTRAR SAÍDAS</a>
