...
WHERE turma_tipo_atendimento = '1' AND vinculo_aluno_id_aluno = '$row_Matricula[vinculo_aluno_id_aluno]'
        ...
        <div class="ls-box">
          ...
          <div class="col-md-10 col-sm-12">
            ...
            <ul class="ls-tabs-nav" id="awesome-dropdown-tab">
              ...
              <li><a data-ls-module="tabs" href="#tab7"><?php if ($totalRows_DepEnviados>0) { ?><span class="ls-ico-info ls-ico-left ls-color-danger"></span><?php } ?> EDUCONNECT</a></li>
            </ul>
              ...
              <div class="ls-tabs-btn">  
                <ul class="ls-tabs-btn-nav">
                  ...
                  <?php if($row_Matricula['aluno_laudo'] == 1){ ?>
                    <li class="col-md-3 col-xs-6"><a class="ls-btn" href="carteirinha_deficiencia_individual.php?hash=<?php echo $row_Matricula['aluno_hash']; ?>" target="_blank"> CIPTEA (modelo 1)</a></li>
                    <li class="col-md-3 col-xs-6"><a class="ls-btn" href="carteirinha_deficiencia_individual_3.php?hash=<?php echo $row_Matricula['aluno_hash']; ?>" target="_blank"> CIPTEA (modelo 2)</a></li>
                  <?php } ?>
         ...
         <div id="tab7" class="ls-tab-content">
              ...
              <p>
                <?php if ($row_Matricula['aluno_aceite_termos']=="S") { echo "<span class=\"ls-ico-checkmark-circle ls-ico-left ls-color-success\"></span> Aceitou os termos para participar do EDUCCONECT"; } else { echo "<span class=\"ls-ico-info ls-ico-left ls-color-warning\"></span> Ainda não aceitou os termos para participar do EDUCCONECT"; } ?>
                ...
                <div data-ls-module="collapse" data-target="#0" class="ls-collapse ">
                  ...
                  <?php do { ?>
                    ...
                    <tr>
                    <td><span class="ls-ico-info ls-ico-left ls-color-danger"></span> <?php echo nl2br($row_DepEnviados['aluno_depoimento_flag_texto']); ?></td>
                    <td><?php echo $row_DepEnviados['aluno_nome']; ?> | CPF: <?php echo $row_DepEnviados['aluno_cpf']; ?></td>
                    <td><?php echo date("d/m - H\hi", strtotime($row_DepEnviados['aluno_depoimento_flag_data'])) ?></td>
                    </tr>
